...
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(H,B){var K=$jscomp.propertyToPolyfillSymbol[B];if(null==K)return H[B];K=H[K];return void 0!==K?K:H[B]};
...
this.settings.format)();this.settings.cmd&&b.execCommand(this.settings.cmd)}}}},a=function(b,c){b.addButton("styleselect",{type:"menubutton",text:"Formats",menu:c,onShowMenu:function(){b.settings.style_formats_autohide&&f(b,this.menu)}})};return{register:function(b){var c=d(b);b.addMenuItem("formats",{text:"Formats",menu:c});a(b,c)}}});B("tinymce.ui.editorui.InsertButton",["ephox.katamari.api.Arr","tinymce.core.util.Tools"],function(m,h){var e=function(c,g){if("string"===typeof g)var l=g.split(" ");
else if(h.isArray(g))return m.flatten(h.map(g,function(n){return e(c,n)}));g=h.grep(l,function(n){return"|"===n||n in c.menuItems});return h.map(g,function(n){return"|"===n?{text:"-"}:c.menuItems[n]})},f=function(c){return c&&"-"===c.text},d=function(c){c=m.filter(c,function(g,l,n){return!f(g)||!f(n[l-1])});return m.filter(c,function(g,l,n){return!f(g)||0<l&&l<n.length-1})},a=function(c,g){var l=[{text:"-"}];c=h.grep(c.menuItems,function(n){return n.context===g});h.each(c,function(n){"before"===n.separator&&
l.push({text:"|"});n.prependToContext?l.unshift(n):l.push(n);"after"===n.separator&&l.push({text:"|"})});return l},b=function(c){c.addButton("insert",{type:"menubutton",icon:"insert",menu:[],oncreatemenu:function(){var g=this.menu,l=g.add;var n=(n=c.settings.insert_button_items)?d(e(c,n)):d(a(c,"insert"));l.call(g,n);this.menu.renderNew()}})};return{register:function(c){b(c)}}});B("tinymce.ui.editorui.SimpleControls",["tinymce.core.util.Tools","tinymce.ui.editorui.FormatUtils"],function(m,h){var e=
