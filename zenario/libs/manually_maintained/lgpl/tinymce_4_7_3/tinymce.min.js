...
a)return b;return-1},fa=RegExp("^[\\x20\\t\\r\\n\\f]+|((?:^|[^\\\\])(?:\\\\.)*)[\\x20\\t\\r\\n\\f]+$","g"),na=/^[\x20\t\r\n\f]*,[\x20\t\r\n\f]*/,oa=/^[\x20\t\r\n\f]*([>+~]|[\x20\t\r\n\f])[\x20\t\r\n\f]*/,S=RegExp("=[\\x20\\t\\r\\n\\f]*([^\\]'\"]*?)[\\x20\\t\\r\\n\\f]*\\]","g"),pa=RegExp(":((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|\\[[\\x20\\t\\r\\n\\f]*((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+)(?:[\\x20\\t\\r\\n\\f]*([*^$|!~]?=)[\\x20\\t\\r\\n\\f]*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|((?:\\\\.|[\\w-]|[^\\x00-\\xa0])+))|)[\\x20\\t\\r\\n\\f]*\\])*)|.*)\\)|)"),
...
"i")},ba=/^(?:input|select|textarea|button)$/i,ea=/^h\d$/i,ja=/^[^{]+\{\s*\[native \w/,la=/^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,ha=/[+~]/,ma=/'|\\/g,$=RegExp("\\\\([\\da-f]{1,6}[\\x20\\t\\r\\n\\f]?|([\\x20\\t\\r\\n\\f])|.)","ig"),aa=function(a,b,c){a="0x"+b-65536;return a!==a||c?b:0>a?String.fromCharCode(a+65536):String.fromCharCode(a>>10|55296,a&1023|56320)};try{Y.apply(V=ka.call(M.childNodes),M.childNodes),V[M.childNodes.length].nodeType}catch(ra){Y={apply:V.length?function(a,b){da.apply(a,ka.call(b))}:
function(a,b){for(var c=a.length,d=0;a[c++]=b[d++];);a.length=c-1}}}x=g.support={};u=g.isXML=function(a){return(a=a&&(a.ownerDocument||a).documentElement)?"HTML"!==a.nodeName:!1};G=g.setDocument=function(a){var b,c=a?a.ownerDocument||a:M;a=c.defaultView;if(c===E||9!==c.nodeType||!c.documentElement)return E;E=c;H=c.documentElement;F=!u(c);var d;if(d=a){a:{try{b=a.top;break a}catch(k){}b=null}d=a!==b}d&&(a.addEventListener?a.addEventListener("unload",function(){G()},!1):a.attachEvent&&a.attachEvent("onunload",
function(){G()}));x.attributes=!0;x.getElementsByTagName=!0;x.getElementsByClassName=ja.test(c.getElementsByClassName);x.getById=!0;v.find.ID=function(a,b){if(typeof b.getElementById!==W&&F){var c=b.getElementById(a);return c&&c.parentNode?[c]:[]}};v.filter.ID=function(a){var b=a.replace($,aa);return function(a){return a.getAttribute("id")===b}};v.find.TAG=x.getElementsByTagName?function(a,b){if(typeof b.getElementsByTagName!==W)return b.getElementsByTagName(a)}:function(a,b){var c,d=[],e=0,k=b.getElementsByTagName(a);
