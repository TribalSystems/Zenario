...
"g"))}}});k("tinymce.core.util.Tools",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.util.Tools")});k("tinymce.core.util.URI",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.util.URI")});k("tinymce.core.util.XHR",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.util.XHR")});k("tinymce.plugins.spellchecker.api.Events",[],function(){return{fireSpellcheckStart:function(a){return a.fire("SpellcheckStart")},fireSpellcheckEnd:function(a){return a.fire("SpellcheckEnd")}}});
