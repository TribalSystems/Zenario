'use strict';(function(){var q={},k=function(a,c,b){if("string"!==typeof a)throw"module id must be a string";if(void 0===c)throw"no dependencies for "+a;if(void 0===b)throw"no definition function for "+a;q[a]={deps:c,defn:b,instance:void 0}},r=function(a){var c=q[a];if(void 0===c)throw"module ["+a+"] was undefined";if(void 0===c.instance){for(var b=q[a],d=b.deps,f=b.defn,g=d.length,m=Array(g),l=0;l<g;++l)m[l]=r(d[l]);d=f.apply(null,m);if(void 0===d)throw"module ["+a+"] returned undefined";b.instance=
d}return c.instance},p=function(a,c){k(a,[],function(){return c})};k("ephox.katamari.api.Cell",[],function(){var a=function(c){var b=c;return{get:function(){return b},set:function(d){b=d},clone:function(){return a(b)}}};return a});p("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);k("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.PluginManager")});p("global!setInterval",setInterval);k("tinymce.core.util.LocalStorage",["global!tinymce.util.Tools.resolve"],
