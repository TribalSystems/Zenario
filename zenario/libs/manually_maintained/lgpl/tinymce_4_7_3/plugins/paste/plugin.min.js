'use strict';(function(){var T={},C=function(a,n,d){if("string"!==typeof a)throw"module id must be a string";if(void 0===n)throw"no dependencies for "+a;if(void 0===d)throw"no definition function for "+a;T[a]={deps:n,defn:d,instance:void 0}},U=function(a){var n=T[a];if(void 0===n)throw"module ["+a+"] was undefined";if(void 0===n.instance){for(var d=T[a],h=d.deps,r=d.defn,e=h.length,f=Array(e),m=0;m<e;++m)f[m]=U(h[m]);h=r.apply(null,f);if(void 0===h)throw"module ["+a+"] returned undefined";d.instance=
h}return n.instance},P=function(a,n){C(a,[],function(){return n})};C("ephox.katamari.api.Cell",[],function(){var a=function(n){var d=n;return{get:function(){return d},set:function(h){d=h},clone:function(){return a(d)}}};return a});P("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);C("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.PluginManager")});P("global!window",window);C("tinymce.plugins.paste.alien.DetectProPlugin",["global!window",
"tinymce.core.PluginManager"],function(a,n){return{hasProPlugin:function(d){return/(^|[ ,])powerpaste([, ]|$)/.test(d.settings.plugins)&&n.get("powerpaste")?("undefined"!==typeof a.console&&a.console.log&&a.console.log("PowerPaste is incompatible with Paste plugin! Remove 'paste' from the 'plugins' option."),!0):!1}}});C("tinymce.plugins.paste.api.Api",[],function(a){return{get:function(n,d){return{clipboard:n,quirks:d}}}});C("tinymce.plugins.paste.api.Events",[],function(){return{firePastePreProcess:function(a,
n,d,h){return a.fire("PastePreProcess",{content:n,internal:d,wordContent:h})},firePastePostProcess:function(a,n,d,h){return a.fire("PastePostProcess",{node:n,internal:d,wordContent:h})},firePastePlainTextToggle:function(a,n){return a.fire("PastePlainTextToggle",{state:n})},firePaste:function(a,n){return a.fire("paste",{ieFake:n})}}});C("tinymce.plugins.paste.api.Settings",[],function(){return{shouldPlainTextInform:function(a){return a.getParam("paste_plaintext_inform",!0)},shouldBlockDrop:function(a){return a.getParam("paste_block_drop",
