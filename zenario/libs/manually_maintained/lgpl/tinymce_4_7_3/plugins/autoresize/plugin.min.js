'use strict';(function(){var q={},m=function(a,f,d){if("string"!==typeof a)throw"module id must be a string";if(void 0===f)throw"no dependencies for "+a;if(void 0===d)throw"no definition function for "+a;q[a]={deps:f,defn:d,instance:void 0}},r=function(a){var f=q[a];if(void 0===f)throw"module ["+a+"] was undefined";if(void 0===f.instance){for(var d=q[a],k=d.deps,n=d.defn,l=k.length,b=Array(l),e=0;e<l;++e)b[e]=r(k[e]);k=n.apply(null,b);if(void 0===k)throw"module ["+a+"] returned undefined";d.instance=
k}return f.instance};m("ephox.katamari.api.Cell",[],function(){var a=function(f){var d=f;return{get:function(){return d},set:function(k){d=k},clone:function(){return a(d)}}};return a});(function(a,f){m(a,[],function(){return f})})("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);m("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.PluginManager")});m("tinymce.core.Env",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.Env")});
m("tinymce.core.util.Delay",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.util.Delay")});m("tinymce.plugins.autoresize.api.Settings",[],function(){return{getAutoResizeMinHeight:function(a){return parseInt(a.getParam("autoresize_min_height",a.getElement().offsetHeight),10)},getAutoResizeMaxHeight:function(a){return parseInt(a.getParam("autoresize_max_height",0),10)},getAutoResizeOverflowPadding:function(a){return a.getParam("autoresize_overflow_padding",1)},getAutoResizeBottomMargin:function(a){return a.getParam("autoresize_bottom_margin",
