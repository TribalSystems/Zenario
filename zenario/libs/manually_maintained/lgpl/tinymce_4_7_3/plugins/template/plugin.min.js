'use strict';(function(){var t={},p=function(c,b,a){if("string"!==typeof c)throw"module id must be a string";if(void 0===b)throw"no dependencies for "+c;if(void 0===a)throw"no definition function for "+c;t[c]={deps:b,defn:a,instance:void 0}},v=function(c){var b=t[c];if(void 0===b)throw"module ["+c+"] was undefined";if(void 0===b.instance){for(var a=t[c],d=a.deps,m=a.defn,k=d.length,h=Array(k),e=0;e<k;++e)h[e]=v(d[e]);d=m.apply(null,h);if(void 0===d)throw"module ["+c+"] returned undefined";a.instance=
d}return b.instance},u=function(c,b){p(c,[],function(){return b})};u("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);p("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(c){return c("tinymce.PluginManager")});u("global!Array",Array);u("global!Error",Error);p("ephox.katamari.api.Fun",["global!Array","global!Error"],function(c,b){var a=function(k){return function(){return k}},d=a(!1),m=a(!0);return{noop:function(){},compose:function(k,h){return function(){return k(h.apply(null,
arguments))}},constant:a,identity:function(k){return k},tripleEquals:function(k,h){return k===h},curry:function(k){for(var h=new c(arguments.length-1),e=1;e<arguments.length;e++)h[e-1]=arguments[e];return function(){for(var f=new c(arguments.length),g=0;g<f.length;g++)f[g]=arguments[g];f=h.concat(f);return k.apply(null,f)}},not:function(k){return function(){return!k.apply(null,arguments)}},die:function(k){return function(){throw new b(k);}},apply:function(k){return k()},call:function(k){k()},never:d,
always:m}});p("tinymce.core.util.Tools",["global!tinymce.util.Tools.resolve"],function(c){return c("tinymce.util.Tools")});p("tinymce.core.util.XHR",["global!tinymce.util.Tools.resolve"],function(c){return c("tinymce.util.XHR")});p("tinymce.core.dom.DOMUtils",["global!tinymce.util.Tools.resolve"],function(c){return c("tinymce.dom.DOMUtils")});p("tinymce.plugins.template.api.Settings",["tinymce.core.dom.DOMUtils"],function(c){return{getCreationDateClasses:function(b){return b.getParam("template_cdate_classes",
