(function(){var A={},u=function(b,e,m){if("string"!==typeof b)throw"module id must be a string";if(void 0===e)throw"no dependencies for "+b;if(void 0===m)throw"no definition function for "+b;A[b]={deps:e,defn:m,instance:void 0}},B=function(b){var e=A[b];if(void 0===e)throw"module ["+b+"] was undefined";if(void 0===e.instance){for(var m=A[b],l=m.deps,v=m.defn,t=l.length,g=Array(t),d=0;d<t;++d)g[d]=B(l[d]);l=v.apply(null,g);if(void 0===l)throw"module ["+b+"] returned undefined";m.instance=l}return e.instance};
