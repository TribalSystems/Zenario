(function(){var r={},p=function(f,g,h){if("string"!==typeof f)throw"module id must be a string";if(void 0===g)throw"no dependencies for "+f;if(void 0===h)throw"no definition function for "+f;r[f]={deps:g,defn:h,instance:void 0}},u=function(f){var g=r[f];if(void 0===g)throw"module ["+f+"] was undefined";if(void 0===g.instance){for(var h=r[f],k=h.deps,l=h.defn,m=k.length,q=Array(m),a=0;a<m;++a)q[a]=u(k[a]);k=l.apply(null,q);if(void 0===k)throw"module ["+f+"] returned undefined";h.instance=k}return g.instance};
(function(f,g){p(f,[],function(){return g})})("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);p("tinymce.core.Env",["global!tinymce.util.Tools.resolve"],function(f){return f("tinymce.Env")});p("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(f){return f("tinymce.PluginManager")});p("tinymce.plugins.autolink.api.Settings",[],function(){return{getAutoLinkPattern:function(f){return f.getParam("autolink_pattern",/^(https?:\/\/|ssh:\/\/|ftp:\/\/|file:\/|www\.|(?:mailto:)?[A-Z0-9._%+\-]+@)(.+)$/i)},
