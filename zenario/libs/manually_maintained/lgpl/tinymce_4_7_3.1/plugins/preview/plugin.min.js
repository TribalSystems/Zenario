(function(){var m={},k=function(a,d,e){if("string"!==typeof a)throw"module id must be a string";if(void 0===d)throw"no dependencies for "+a;if(void 0===e)throw"no definition function for "+a;m[a]={deps:d,defn:e,instance:void 0}},p=function(a){var d=m[a];if(void 0===d)throw"module ["+a+"] was undefined";if(void 0===d.instance){for(var e=m[a],b=e.deps,c=e.defn,g=b.length,f=Array(g),h=0;h<g;++h)f[h]=p(b[h]);b=c.apply(null,f);if(void 0===b)throw"module ["+a+"] returned undefined";e.instance=b}return d.instance};
(function(a,d){k(a,[],function(){return d})})("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);k("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.PluginManager")});k("tinymce.core.Env",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.Env")});k("tinymce.core.util.Tools",["global!tinymce.util.Tools.resolve"],function(a){return a("tinymce.util.Tools")});k("tinymce.plugins.preview.api.Settings",[],function(){return{getPreviewDialogWidth:function(a){return parseInt(a.getParam("plugin_preview_width",
