(function(){var y={},q=function(b,l,m){if("string"!==typeof b)throw"module id must be a string";if(void 0===l)throw"no dependencies for "+b;if(void 0===m)throw"no definition function for "+b;y[b]={deps:l,defn:m,instance:void 0}},z=function(b){var l=y[b];if(void 0===l)throw"module ["+b+"] was undefined";if(void 0===l.instance){for(var m=y[b],e=m.deps,n=m.defn,v=e.length,w=Array(v),t=0;t<v;++t)w[t]=z(e[t]);e=n.apply(null,w);if(void 0===e)throw"module ["+b+"] returned undefined";m.instance=e}return l.instance};
(function(b,l){q(b,[],function(){return l})})("global!tinymce.util.Tools.resolve",tinymce.util.Tools.resolve);q("tinymce.core.PluginManager",["global!tinymce.util.Tools.resolve"],function(b){return b("tinymce.PluginManager")});q("tinymce.core.dom.DOMUtils",["global!tinymce.util.Tools.resolve"],function(b){return b("tinymce.dom.DOMUtils")});q("tinymce.core.EditorManager",["global!tinymce.util.Tools.resolve"],function(b){return b("tinymce.EditorManager")});q("tinymce.core.Env",["global!tinymce.util.Tools.resolve"],
function(b){return b("tinymce.Env")});q("tinymce.core.util.Tools",["global!tinymce.util.Tools.resolve"],function(b){return b("tinymce.util.Tools")});q("tinymce.plugins.importcss.api.Settings",[],function(){return{shouldMergeClasses:function(b){return b.getParam("importcss_merge_classes")},shouldImportExclusive:function(b){return b.getParam("importcss_exclusive")},getSelectorConverter:function(b){return b.getParam("importcss_selector_converter")},getSelectorFilter:function(b){return b.getParam("importcss_selector_filter")},
