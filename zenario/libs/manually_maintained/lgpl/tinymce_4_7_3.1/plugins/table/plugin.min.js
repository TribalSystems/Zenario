...
w=k.from(r)}}});B("tinymce.plugins.table.actions.TableWire","ephox.snooker.api.ResizeWire ephox.sugar.api.dom.Insert ephox.sugar.api.dom.Remove ephox.sugar.api.node.Body ephox.sugar.api.node.Element ephox.sugar.api.properties.Css tinymce.plugins.table.alien.Util".split(" "),function(f,g,k,e,a,b,c){return{get:function(d,h){if(d.inline){h=f.body;d=c.getBody(d);var l=a.fromTag("div");b.setAll(l,{position:"static",height:"0",width:"0",padding:"0",margin:"0",border:"0"});g.append(e.body(),l);h=h.call(f,
d,l)}else h=f.only(a.fromDom(d.getDoc()));return h},remove:function(d,h){d.inline&&k.remove(h.parent())}}});B("ephox.snooker.api.CellLocation",[],function(){return{none:function(f){return{fold:function(g,k,e,a){return g(f)}}},first:function(f){return{fold:function(g,k,e,a){return k(f)}}},middle:function(f,g){return{fold:function(k,e,a,b){return a(f,g)}}},last:function(f){return{fold:function(g,k,e,a){return a(f)}}}}});B("ephox.snooker.api.CellNavigation",["ephox.katamari.api.Arr","ephox.katamari.api.Fun",
"ephox.snooker.api.CellLocation","ephox.snooker.api.TableLookup","ephox.sugar.api.dom.Compare"],function(f,g,k,e,a){var b=function(c,d){return e.table(c,d).bind(function(h){var l=e.cells(h);return f.findIndex(l,function(m){return a.eq(c,m)}).map(function(m){return{index:g.constant(m),all:g.constant(l)}})})};return{next:function(c,d){return b(c,d).fold(function(){return k.none(c)},function(h){return h.index()+1<h.all().length?k.middle(c,h.all()[h.index()+1]):k.last(c)})},prev:function(c,d){return b(c,
d).fold(function(){return k.none()},function(h){return 0<=h.index()-1?k.middle(c,h.all()[h.index()-1]):k.first(c)})}}});B("ephox.sugar.api.selection.Situ",["ephox.katamari.api.Adt","ephox.katamari.api.Fun"],function(f,g){f=f.generate([{before:["element"]},{on:["element","offset"]},{after:["element"]}]);return{before:f.before,on:f.on,after:f.after,cata:function(k,e,a,b){return k.fold(e,a,b)},getStart:function(k){return k.fold(g.identity,g.identity,g.identity)}}});B("ephox.sugar.api.selection.Selection",
["ephox.katamari.api.Adt","ephox.katamari.api.Struct","ephox.sugar.api.node.Element","ephox.sugar.api.search.Traverse","ephox.sugar.api.selection.Situ"],function(f,g,k,e,a){var b=f.generate([{domRange:["rng"]},{relative:["startSitu","finishSitu"]},{exact:["start","soffset","finish","foffset"]}]);f=g.immutable("start","soffset","finish","foffset");var c=function(d){return d.match({domRange:function(h){return k.fromDom(h.startContainer)},relative:function(h,l){return a.getStart(h)},exact:function(h,
l,m,p){return h}})};return{domRange:b.domRange,relative:b.relative,exact:b.exact,exactFromRange:function(d){return b.exact(d.start(),d.soffset(),d.finish(),d.foffset())},range:f,getWin:function(d){d=c(d);return e.defaultView(d)}}});B("ephox.sugar.api.dom.DocumentPosition",["ephox.sugar.api.dom.Compare","ephox.sugar.api.node.Element","ephox.sugar.api.search.Traverse"],function(f,g,k){var e=function(a,b,c,d){var h=k.owner(a).dom().createRange();h.setStart(a.dom(),b);h.setEnd(c.dom(),d);return h};return{after:function(a,
b,c,d){var h=e(a,b,c,d);a=f.eq(a,c)&&b===d;return h.collapsed&&!a},commonAncestorContainer:function(a,b,c,d){a=e(a,b,c,d);return g.fromDom(a.commonAncestorContainer)}}});B("ephox.sugar.api.node.Fragment",["ephox.katamari.api.Arr","ephox.sugar.api.node.Element","global!document"],function(f,g,k){return{fromElements:function(e,a){var b=(a||k).createDocumentFragment();f.each(e,function(c){b.appendChild(c.dom())});return g.fromDom(b)}}});B("ephox.sugar.selection.core.NativeRange",["ephox.katamari.api.Fun",
"ephox.katamari.api.Option","ephox.sugar.api.dom.Compare","ephox.sugar.api.node.Element"],function(f,g,k,e){var a=function(l,m){l.selectNodeContents(m.dom())},b=function(l,m){m.fold(function(p){l.setStartBefore(p.dom())},function(p,q){l.setStart(p.dom(),q)},function(p){l.setStartAfter(p.dom())})},c=function(l,m){m.fold(function(p){l.setEndBefore(p.dom())},function(p,q){l.setEnd(p.dom(),q)},function(p){l.setEndAfter(p.dom())})},d=function(l){l.deleteContents()},h=function(l){return{left:f.constant(l.left),
top:f.constant(l.top),right:f.constant(l.right),bottom:f.constant(l.bottom),width:f.constant(l.width),height:f.constant(l.height)}};return{create:function(l){return l.document.createRange()},replaceWith:function(l,m){d(l);l.insertNode(m.dom())},selectNodeContents:function(l,m){l=l.document.createRange();a(l,m);return l},selectNodeContentsUsing:a,isCollapsed:function(l,m,p,q){return k.eq(l,p)&&m===q},relativeToNative:function(l,m,p){l=l.document.createRange();b(l,m);c(l,p);return l},exactToNative:function(l,
m,p,q,t){l=l.document.createRange();l.setStart(m.dom(),p);l.setEnd(q.dom(),t);return l},deleteContents:d,cloneFragment:function(l){l=l.cloneContents();return e.fromDom(l)},getFirstRect:function(l){var m=l.getClientRects();l=0<m.length?m[0]:l.getBoundingClientRect();return 0<l.width||0<l.height?g.some(l).map(h):g.none()},getBounds:function(l){l=l.getBoundingClientRect();return 0<l.width||0<l.height?g.some(l).map(h):g.none()},isWithin:function(l,m){return 1>m.compareBoundaryPoints(l.END_TO_START,l)&&
-1<m.compareBoundaryPoints(l.START_TO_END,l)},toString:function(l){return l.toString()}}});B("ephox.sugar.selection.core.SelectionDirection","ephox.katamari.api.Adt ephox.katamari.api.Fun ephox.katamari.api.Option ephox.katamari.api.Thunk ephox.sugar.api.node.Element ephox.sugar.selection.core.NativeRange".split(" "),function(f,g,k,e,a,b){var c=f.generate([{ltr:["start","soffset","finish","foffset"]},{rtl:["start","soffset","finish","foffset"]}]),d=function(p,q,t){return q(a.fromDom(t.startContainer),
t.startOffset,a.fromDom(t.endContainer),t.endOffset)},h=function(p,q){return q.match({domRange:function(t){return{ltr:g.constant(t),rtl:k.none}},relative:function(t,u){return{ltr:e.cached(function(){return b.relativeToNative(p,t,u)}),rtl:e.cached(function(){return k.some(b.relativeToNative(p,u,t))})}},exact:function(t,u,n,v){return{ltr:e.cached(function(){return b.exactToNative(p,t,u,n,v)}),rtl:e.cached(function(){return k.some(b.exactToNative(p,n,v,t,u))})}}})},l=function(p,q){var t=q.ltr();return t.collapsed?
q.rtl().filter(function(u){return!1===u.collapsed}).map(function(u){return c.rtl(a.fromDom(u.endContainer),u.endOffset,a.fromDom(u.startContainer),u.startOffset)}).getOrThunk(function(){return d(p,c.ltr,t)}):d(p,c.ltr,t)},m=function(p,q){q=h(p,q);return l(p,q)};return{ltr:c.ltr,rtl:c.rtl,diagnose:m,asLtrRange:function(p,q){return m(p,q).match({ltr:function(t,u,n,v){var w=p.document.createRange();w.setStart(t.dom(),u);w.setEnd(n.dom(),v);return w},rtl:function(t,u,n,v){var w=p.document.createRange();
w.setStart(n.dom(),v);w.setEnd(t.dom(),u);return w}})}}});B("ephox.sugar.selection.alien.Geometry",["global!Math"],function(f){return{inRect:function(g,k,e){return k>=g.left&&k<=g.right&&e>=g.top&&e<=g.bottom},searchForPoint:function(g,k,e,a,b){if(0===b)return 0;if(k===a)return b-1;for(var c=1;c<b;c++){var d=g(c),h=f.abs(k-d.left);if(!(e>d.bottom)){if(e<d.top||h>a)return c-1;a=h}}return 0}}});B("ephox.sugar.selection.query.TextPoint",["ephox.katamari.api.Option","ephox.katamari.api.Options","ephox.sugar.api.node.Text",
"ephox.sugar.selection.alien.Geometry","global!Math"],function(f,g,k,e,a){var b=function(c,d,h,l,m){var p=function(t){var u=c.dom().createRange();u.setStart(d.dom(),t);u.collapse(!0);return u},q=k.get(d).length;h=e.searchForPoint(function(t){return p(t).getBoundingClientRect()},h,l,m.right,q);return p(h)};return{locate:function(c,d,h,l){var m=c.dom().createRange();m.selectNode(d.dom());m=m.getClientRects();return g.findMap(m,function(p){return e.inRect(p,h,l)?f.some(p):f.none()}).map(function(p){return b(c,
d,h,l,p)})}}});B("ephox.sugar.selection.query.ContainerPoint","ephox.katamari.api.Option ephox.katamari.api.Options ephox.sugar.api.node.Node ephox.sugar.api.search.Traverse ephox.sugar.selection.alien.Geometry ephox.sugar.selection.query.TextPoint global!Math".split(" "),function(f,g,k,e,a,b,c){var d=function(h,l,m,p){var q=h.dom().createRange();l=e.children(l);return g.findMap(l,function(t){q.selectNode(t.dom());return a.inRect(q.getBoundingClientRect(),m,p)?(k.isText(t)?b.locate:d)(h,t,m,p):f.none()})};
return{locate:function(h,l,m,p){var q=h.dom().createRange();q.selectNode(l.dom());q=q.getBoundingClientRect();m=c.max(q.left,c.min(q.right,m));p=c.max(q.top,c.min(q.bottom,p));return(k.isText(l)?b.locate:d)(h,l,m,p)}}});B("ephox.sugar.selection.query.EdgePoint",["ephox.katamari.api.Option","ephox.sugar.api.search.Traverse","ephox.sugar.api.selection.CursorPosition"],function(f,g,k){var e=function(c,d,h){c=c.dom().createRange();c.selectNode(d.dom());c.collapse(h);return c},a=function(c,d,h){var l=
c.dom().createRange();l.selectNode(d.dom());l=l.getBoundingClientRect();var m=h-l.left<l.right-h?!0:!1;return(!0===m?k.first:k.last)(d).map(function(p){return e(c,p,m)})},b=function(c,d,h){var l=d.dom().getBoundingClientRect();return f.some(e(c,d,h-l.left<l.right-h?!0:!1))};return{search:function(c,d,h){return(0===g.children(d).length?b:a)(c,d,h)}}});B("ephox.sugar.selection.query.CaretRange","ephox.katamari.api.Option ephox.sugar.api.node.Element ephox.sugar.api.search.Traverse ephox.sugar.api.selection.Selection ephox.sugar.selection.query.ContainerPoint ephox.sugar.selection.query.EdgePoint global!document global!Math".split(" "),
function(f,g,k,e,a,b,c,d){var h=function(t,u,n){return f.from(t.dom().caretPositionFromPoint(u,n)).bind(function(v){if(null===v.offsetNode)return f.none();var w=t.dom().createRange();w.setStart(v.offsetNode,v.offset);w.collapse();return f.some(w)})},l=function(t,u,n){return f.from(t.dom().caretRangeFromPoint(u,n))},m=function(t,u,n,v){var w=t.dom().createRange();w.selectNode(u.dom());w=w.getBoundingClientRect();n=d.max(w.left,d.min(w.right,n));v=d.max(w.top,d.min(w.bottom,v));return a.locate(t,u,
n,v)},p=function(t,u,n){return f.from(t.dom().elementFromPoint(u,n)).map(g.fromDom).bind(function(v){var w=function(){return b.search(t,v,u)};return 0===k.children(v).length?w():m(t,v,u,n).orThunk(w)})},q=c.caretPositionFromPoint?h:c.caretRangeFromPoint?l:p;return{fromPoint:function(t,u,n){t=g.fromDom(t.document);return q(t,u,n).map(function(v){return e.range(g.fromDom(v.startContainer),v.startOffset,g.fromDom(v.endContainer),v.endOffset)})}}});B("ephox.sugar.selection.query.Within","ephox.katamari.api.Arr ephox.sugar.api.node.Element ephox.sugar.api.node.Node ephox.sugar.api.search.SelectorFilter ephox.sugar.api.search.Selectors ephox.sugar.selection.core.NativeRange ephox.sugar.selection.core.SelectionDirection".split(" "),
