...
a.execCommand("mceInsertLink",!1,b)}zenario.saveScrollTop();var g;d=tinymce.extend(d,b.data);(g=d.href)?0<g.indexOf("@")&&-1==g.indexOf("//")&&-1==g.indexOf("mailto:")?c("The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?",function(b){b&&(g="mailto:"+g);a.undoManager.transact(f)}):a.settings.link_assume_external_targets&&!/^\w+:/i.test(g)||!a.settings.link_assume_external_targets&&/^\s*www[\.|\d\.]/i.test(g)?c("The URL you entered seems to be an external link. Do you want to add the required http:// prefix?",
