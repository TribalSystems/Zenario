...
0);c!==l&&(b=c-l,h.setStyle(a.iframeElement,"height",c+"px"),l=c,tinymce.isWebKit&&0>b&&k(d))}}function h(d,b,c){tinymce.util.Delay.setEditorTimeout(a,function(){k({});d--?h(d,b,c):c&&c()},b)}var f=a.settings,l=0;if(!a.settings.inline){f.autoresize_min_height=parseInt(a.getParam("autoresize_min_height",a.getElement().offsetHeight),10);f.autoresize_max_height=parseInt(a.getParam("autoresize_max_height",0),10);a.on("init",function(){var d,b;d=a.getParam("autoresize_overflow_padding",1);b=a.getParam("autoresize_bottom_margin",
