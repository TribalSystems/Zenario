'use strict';(function(c){c.fn.jPaginator=function(B){1!=this.length&&c.error("You must use this plugin with a unique element");var a={selectedPage:null,nbPages:100,nbVisible:10,widthPx:30,marginPx:1,overBtnLeft:null,overBtnRight:null,maxBtnLeft:null,maxBtnRight:null,withSlider:!0,withAcceleration:!0,speed:2,coeffAcceleration:2,minSlidesForSlider:3,onPageClicked:null},f=0,p=1,m=0,g=0,h=0,k=0,l=!1,u=!1,v=!1,w=!0;return this.each(function(){function E(b){b=1*b.html();e.find(".paginator_p.selected").removeClass("selected");
