...
this;m.off("click").on("click.dlmenu",function(){a._closeMenu()});this.$menu.addClass("dl-menuopen dl-menu-toggle").on(this.transEndEventName,function(){b(this).removeClass("dl-menu-toggle")});this.$trigger.addClass("dl-active");this.open=!0},_resetMenu:function(){this.$menu.removeClass("dl-subview");this.$menuitems.removeClass("dl-subview dl-subviewopen")}};b.fn.dlmenu=function(a){if("string"===typeof a){var c=Array.prototype.slice.call(arguments,1);this.each(function(){var d=b.data(this,"dlmenu");
d?b.isFunction(d[a])&&"_"!==a.charAt(0)?d[a].apply(d,c):e.console&&e.console.error("no such method '"+a+"' for dlmenu instance"):e.console&&e.console.error("cannot call methods on dlmenu prior to initialization; attempted to call method '"+a+"'")})}else this.each(function(){var d=b.data(this,"dlmenu");d?d._init():b.data(this,"dlmenu",new b.DLMenu(a,this))});return this}})(jQuery,window);
