...
$jscomp.polyfillIsolated=function(k,h,m,n){var q=k.split(".");k=1===q.length;n=q[0];n=!k&&n in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var v=0;v<q.length-1;v++){var x=q[v];if(!(x in n))return;n=n[x]}q=q[q.length-1];m=$jscomp.IS_SYMBOL_NATIVE&&"es6"===m?n[q]:null;h=h(m);null!=h&&(k?$jscomp.defineProperty($jscomp.polyfills,q,{configurable:!0,writable:!0,value:h}):h!==m&&($jscomp.propertyToPolyfillSymbol[q]=$jscomp.IS_SYMBOL_NATIVE?$jscomp.global.Symbol(q):$jscomp.POLYFILL_PREFIX+q,q=
$jscomp.propertyToPolyfillSymbol[q],$jscomp.defineProperty(n,q,{configurable:!0,writable:!0,value:h})))};$jscomp.initSymbol=function(){};$jscomp.initSymbolIterator=function(){};$jscomp.initSymbolAsyncIterator=function(){};$jscomp.iteratorPrototype=function(k){k={next:k};k[Symbol.iterator]=function(){return this};return k};
$jscomp.iteratorFromArray=function(k,h){k instanceof String&&(k+="");var m=0,n={next:function(){if(m<k.length){var q=m++;return{value:h(q,k[q]),done:!1}}n.next=function(){return{done:!0,value:void 0}};return n.next()}};n[Symbol.iterator]=function(){return n};return n};$jscomp.polyfill("Array.prototype.values",function(k){return k?k:function(){return $jscomp.iteratorFromArray(this,function(h,m){return m})}},"es8","es3");
zenario.lib(function(k,h,m,n,q,v,x,t,A,D,E,w,F,y,G,H,I,J,K,B,C,u,z){h=C(z.admin_box_builder=B(z.form_builder_base_class));h.showPanel=function(b,a,c){b.html("").hide();c.html("").show();b=this.getMainPanelHTML();a.html(b).show();this.currentPageId=this.currentPageId?this.currentPageId:!1;this.editingThing=this.editingThing?this.editingThing:!1;this.editingThingId=this.editingThingId?this.editingThingId:!1;this.editingThingTUIXTabId=this.editingThingTUIXTabId?this.editingThingTUIXTabId:!1;this.deletedPages=
[];this.deletedFields=[];this.deletedValues=[];this.pagesReordered=this.changeMadeOnPanel=!1;this.newItemCount=0;this.fixTUIXData();this.loadPagesList();this.loadFieldsList(this.currentPageId);"field"==this.editingThing?this.openFieldEdit(this.editingThingId,this.editingThingTUIXTabId,!0):"page"==this.editingThing?this.openPageEdit(this.editingThingId,this.editingThingTUIXTabId,!0):this.loadNewFieldsPanel(!0);this.changesSaved&&(this.changesSaved=!1,t._t({message_type:"success",message:"Your changes have been saved!"}))};
h.fixTUIXData=function(){for(var b in this.tuix.dataset_fields_in_forms)this.tuix.dataset_fields_in_forms[b]=A._tTA(this.tuix.dataset_fields_in_forms[b])};h.getMainPanelHTML=function(){return this.microTemplate("zenario_organizer_admin_box_builder",{dataset_label:this.tuix.dataset.label})};h.openEdit=function(b,a,c,d){var e=this,f=e.getItem(b,a),g=e.getTUIXModeForItemType(b);g=e.tuix[g];var l={hide_tab_bar:g.hide_tab_bar,is_system_field:f.is_system_field};"page"==b?(l.mode="edit_page",l.label=e.formatPageLabel(f.label)):
...
function(g){if(!e.is_system_field){var l=!1;g=0;for(var p=d.getOrderedFields(a),r=0;r<p.length;r++)p[r].is_protected&&(l||(l=p[r]),g++);g?(l='<p>This tab has the protected field "'+l.label+'"',g--,0<g&&(l+=" and "+g+" other protected field"+(1==g?"":"s")),t._flBo(l+" on it and cannot be deleted.</p>",!0,"warning",!0)):(l="<p>Are you sure you want to delete this tab?</p>",0<p.length&&(l+="<p>All fields on this tab will also be deleted.</p>"),t._flBo(l,"Delete tab","warning",!0,!1,k,k,function(){d.deletePage(a);
...
a.loadFieldsList(b))}});$("#organizer_form_fields .delete_icon").on("click",function(d){d.stopPropagation();var e=$(this).data("id");a.saveCurrentOpenDetails(!0)&&(d=a.tuix.items[e],d.is_protected?t._flBo("<p>This field is protected, and might be important to your site!</p><p>If you're sure you want to delete this field then first unprotect it.</p>",!0,"warning",!0):(d.record_count&&1<=d.record_count?(d="<p><strong>This field contains data on "+d.record_count+" record"+(1==d.record_count?"":"s")+
".</strong></p>",d+="<p>When you save changes to this dataset, this data will be deleted.</p>"):d="<p>This field isn't populated in any data records.</p>",t._flBo(d+"<p>Delete this dataset field?</p>","Delete dataset field","warning",!0,!1,k,k,function(){a.deleteField(e,!0)})))})};h.checkParentHasParent=function(b,a){b=_._cl(this.tuix.items[b]);var c=a;b.parent_id&&a++;c!=a&&(a=this.checkParentHasParent(b.parent_id,a));return a};h.getOrderedMergeFieldsForFields=function(b){var a=[],c=[],d={},e;for(e in this.tuix.pages[b].fields)if(u(this.tuix.pages[b].fields,
e)){var f=_._cl(this.tuix.items[e]);f.lov=this.getOrderedFieldValues(e);"show"==f.admin_box_visibility?f.indent=0:f.parent_id&&"show_on_condition"==f.admin_box_visibility&&(f.indent=1,f.indent=this.checkParentHasParent(f.parent_id,f.indent));"field"==this.editingThing&&this.editingThingId==f.id&&(f._is_current_field=!0);f.grouping_name?(f.fields=[],d[f.grouping_name]=f):f.grouping?c.push(f):(f._is_sortable=!0,a.push(f))}if(0<c.length)for(b=0;b<c.length;b++)d[c[b].grouping]&&d[c[b].grouping].fields.push(c[b]);
for(var g in d)u(d,g)&&(c=d[g],c.fields.sort(this.sortByOrd),c.fields.length&&(c._is_sortable=!0,c.fields[0].first_in_grouping=!0,a.push(c)));a.sort(this.sortByOrd);d=!1;for(b=0;b<a.length;b++)"repeat_start"==a[b].type?d=!0:"repeat_end"==a[b].type?d=!1:d&&(a[b]._is_repeat_field=!0);return a};h.updateFieldOrds=function(){var b=this;$("#organizer_form_fields div.form_field").each(function(a){var c=$(this).data("id");b.tuix.items[c].ord=a+1});b.changeMadeToPanel()};h.deletePage=function(b){var a=this.getOrderedPages();
...
w._dI("Please either save your changes, or click Reset to discard them, before exiting the form editor."),w._sB())};h.saveChanges=function(){var b=this,a={mode:"save",pages:JSON.stringify(b.tuix.pages),fields:JSON.stringify(b.tuix.items),pagesReordered:b.pagesReordered,deletedPages:JSON.stringify(b.deletedPages),deletedFields:JSON.stringify(b.deletedFields),deletedValues:JSON.stringify(b.deletedValues),currentPageId:b.currentPageId,editingThing:b.editingThing,editingThingId:b.editingThingId};t._nDS("saving",
!0);b.sendAJAXRequest(a,function(c){t._nDS();if(c){if(c.errors){for(var d="",e=0;e<c.errors.length;e++)d+=c.errors[e]+"<br>";d&&t._flBo(d)}b.currentPageId=c.currentPageId;b.editingThing=c.editingThing;b.editingThingId=c.editingThingId}n.onbeforeunload=!1;w._eI();b.changeMadeOnPanel=!1;b.changesSaved=!0;w._r()})}},zenarioO.panelTypes);
