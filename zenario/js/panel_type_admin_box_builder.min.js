...
m;a[m]||(a[m]={label:f.label,ord:++d})}}}return a};g.sortByLabel=function(b,a){return b.label<a.label?-1:b.label>a.label?1:0};g.loadPagesList=function(){var b=this,a=b.getOrderedPages();!b.currentPageId&&0<a.length&&(b.currentPageId=a[0].id);for(var c=0;c<a.length;c++)b.currentPageId==a[c].id&&(a[c]._is_current_page=!0),a[c].label=b.formatPageLabel(a[c].label);a=b.microTemplate("zenario_organizer_admin_box_builder_tabs",{pages:a});$("#organizer_form_tabs").html(a);$("#organizer_form_tabs .tab").on("click",
function(){var a=$(this).data("id");b.tuix.pages[a]&&b.clickPage(a)});$("#organizer_add_new_tab").on("click",function(){if(b.saveCurrentOpenDetails()){var a=b.createPage();b.clickPage(a,!0);b.changeMadeToPanel()}});$("#organizer_form_tabs").sortable({containment:"parent",tolerance:"pointer",items:"div.sort",start:function(a,c){b.startIndex=c.item.index()},stop:function(a,c){b.startIndex!=c.item.index()&&($("#organizer_form_tabs .tab.sort").each(function(a){var c=$(this).data("id");b.tuix.pages[c].ord=
a+1}),b.pagesReordered=!0,b.changeMadeToPanel())}});$("#organizer_form_tabs .tab").droppable({accept:"div.is_sortable:not(.system_field)",greedy:!0,hoverClass:"ui-state-hover",tolerance:"pointer",drop:function(a,c){if(b.saveCurrentOpenDetails()){var f=$(this).data("id"),g=$(c.draggable).data("id");b.moveFieldToPage(b.currentPageId,f,g);"field"==b.editingThing&&b.editingThingId==g&&b.loadNewFieldsPanel();b.loadFieldsList(b.currentPageId)}}})};g.createPage=function(){var b="t"+this.newItemCount++,a=
1,c=this.getOrderedPages();c.length&&(a=c[c.length-1].ord+1);c={};c.id=b;c.ord=a;c._just_added=!0;c.fields={};c.label="Untitled page";for(var d in this.tuix.dataset_page_details.tabs)if(n(this.tuix.dataset_page_details.tabs,d)&&(a=this.tuix.dataset_page_details.tabs[d],a.fields))for(var e in a.fields)if(n(a.fields,e)){var f=a.fields[e];r(f.value)&&!r(c[e])&&(c[e]=f.value)}this.tuix.pages[b]=c;return b};g.clickPage=function(b,a){var c=this;if(("page"!=c.editingThing||c.editingThingId!=b)&&c.saveCurrentOpenDetails()&&
c.displayPageFieldOrderErrors())if(c.currentPageId!=b){var d=!c.editingThing;c.currentPageId=b;c.editingThing=!1;c.loadPagesList();c.loadFieldsList(b);c.loadNewFieldsPanel(d);var e=c.getItem("page",b);a?c.clickPage(b):e.record_counts_fetched||c.sendAJAXRequest({mode:"get_tab_field_record_counts",pageId:b}).after(function(a){e.record_counts_fetched=!0;if(a)for(fieldId in a)n(a,fieldId)&&(recordCount=a[fieldId],c.getItem("field",fieldId).record_count=recordCount)})}else c.editingThing="page",c.editingThingId=
b,c.editingThingTUIXTabId=!1,c.openPageEdit(b)};g.clickField=function(b,a){if(("field"!=this.editingThing||this.editingThingId!=b)&&"repeat_end"!=this.tuix.items[b].type&&this.saveCurrentOpenDetails()){var c=this.getItem("field",b);!a&&c._just_added&&delete c._just_added;this.editingThing="field";this.editingThingId=b;this.editingThingTUIXTabId=!1;this.loadFieldsList(this.currentPageId);this.openFieldEdit(b)}};g.loadFieldsList=function(b){var a=this,c={fields:a.getOrderedMergeFieldsForFields(b)},
c=a.microTemplate("zenario_organizer_admin_box_builder_section",c);$("#organizer_form_fields").html(c);$("#organizer_form_fields div.form_field").on("click",function(){var b=$(this).data("id");a.tuix.items[b]&&a.clickField(b)});$("#organizer_form_fields .form_section").sortable({items:"div.is_sortable",tolerance:"pointer",placeholder:"preview",receive:function(b,c){$(this).find("div.field_type").each(function(){var b=$(this).data("type"),c=0.1,d=$(this).prev().data("id");d&&a.tuix.items[d]?c=a.tuix.items[d].ord+
0.1:(d=$(this).next().data("id"))&&a.tuix.items[d]&&(c=a.tuix.items[d].ord-0.1);b=a.createField(b,c);a.clickField(b,!0);a.updateFieldOrds()})},start:function(b,c){a.startIndex=c.item.index()},stop:function(c,e){a.startIndex!=e.item.index()&&(a.tuix.pages[b].fields_reordered=!0,a.updateFieldOrds(),a.loadFieldsList(b))}});$("#organizer_form_fields .delete_icon").on("click",function(b){b.stopPropagation();var c=$(this).data("id");a.saveCurrentOpenDetails(!0)&&(b=a.tuix.items[c],b.is_protected?(message=
"<p>This field is protected, and might be important to your site!</p>",message+="<p>If you're sure you want to delete this field then first unprotect it.</p>",m._flBo(message,!0,"warning",!0)):(b.record_count&&1<=b.record_count?(message="<p><strong>This field contains data on "+b.record_count+" record"+(1==b.record_count?"":"s")+".</strong></p>",message+="<p>When you save changes to this dataset, this data will be deleted.</p>"):message="<p>This field doesn't contain any data for any user/contact records.</p>",
message+="<p>Delete this dataset field?</p>",m._flBo(message,"Delete dataset field","warning",!0,!1,function(){a.deleteField(c,!0)})))})};g.checkParentHasParent=function(b,a){var c=_._cl(this.tuix.items[b]),d=a;c.parent_id&&a++;d!=a&&(a=this.checkParentHasParent(c.parent_id,a));return a};g.getOrderedMergeFieldsForFields=function(b){var a=[],c=[],d={},e;for(e in this.tuix.pages[b].fields)if(n(this.tuix.pages[b].fields,e)){var f=_._cl(this.tuix.items[e]);f.lov=this.getOrderedFieldValues(e);"show"==
f.admin_box_visibility?f.indent=0:f.parent_id&&"show_on_condition"==f.admin_box_visibility&&(f.indent=1,f.indent=this.checkParentHasParent(f.parent_id,f.indent));"field"==this.editingThing&&this.editingThingId==f.id&&(f._is_current_field=!0);f.grouping_name?(f.fields=[],d[f.grouping_name]=f):f.grouping?c.push(f):(f._is_sortable=!0,a.push(f))}if(0<c.length)for(b=0;b<c.length;b++)d[c[b].grouping]&&d[c[b].grouping].fields.push(c[b]);for(groupName in d)n(d,groupName)&&(group=d[groupName],group.fields.sort(this.sortByOrd),
group.fields.length&&(group._is_sortable=!0,group.fields[0].first_in_grouping=!0,a.push(group)));a.sort(this.sortByOrd);c=!1;for(b=0;b<a.length;b++)"repeat_start"==a[b].type?c=!0:"repeat_end"==a[b].type?c=!1:c&&(a[b]._is_repeat_field=!0);return a};g.updateFieldOrds=function(){var b=this;$("#organizer_form_fields div.form_field").each(function(a){var c=$(this).data("id");b.tuix.items[c].ord=a+1});b.changeMadeToPanel()};g.deletePage=function(b){var a=this.getOrderedPages();if(!(2>a.length))for(var c=
this.getOrderedFields(b),d=0;d<a.length;d++)if(a[d].id==b){for(var e=0;e<c.length;e++)this.deleteField(c[e].id);a=a[d-1]?a[d-1].id:a[d+1].id;this.deletedPages.push(b);delete this.tuix.pages[b];this.clickPage(a);this.changeMadeToPanel();break}};g.deleteField=function(b,a){var c=this.tuix.items[b];if(c){var d=this.getOrderedFields(c.page_id);if("repeat_start"==c.type){var e=this.getMatchingRepeatEnd(b);if(e){var f=this.tuix.items[e];this.deletedFields.push(e);delete this.tuix.pages[f.page_id].fields[e];
delete this.tuix.items[e]}}for(var f=e=!1,g=0;g<d.length;g++)if(d[g].id==b&&(e=g),!1!==e)if(0<e){f=d[e-1].id;break}else if(b!=d[g].id){f=d[g].id;break}f&&"repeat_end"==this.tuix.items[f].type&&(f=!1);this.deletedFields.push(b);delete this.tuix.pages[c.page_id].fields[b];delete this.tuix.items[b];this.changeMadeToPanel();a&&(this.loadFieldsList(c.page_id),f?this.clickField(f):this.loadNewFieldsPanel())}};g.createField=function(b,a){var c="t"+ ++this.newItemCount,d={};d.id=c;d.page_id=this.currentPageId;
d.type=b;d.ord=a;d.label="Untitled";d._just_added=!0;if("checkboxes"==b||"radios"==b||"select"==b){d.lov={};for(var e=1;3>=e;e++)this.addFieldValue(d,"Option "+e)}else"repeat_start"==b&&this.createField("repeat_end",a+0.01);this.tuix.pages[this.currentPageId].fields[c]=1;this.tuix.items[c]=d;this.loadFieldsList(this.currentPageId);return c};g.changeMadeToPanel=function(){this.changeMadeOnPanel||(this.changeMadeOnPanel=!0,q.onbeforeunload=function(){return"You are currently editing this dataset. If you leave now you will lose any unsaved changes."},
p._dI("Please either save your changes, or click Reset to discard them, before exiting the form editor."),p._sB())};g.saveChanges=function(){var b=this,a={mode:"save",pages:JSON.stringify(b.tuix.pages),fields:JSON.stringify(b.tuix.items),pagesReordered:b.pagesReordered,deletedPages:JSON.stringify(b.deletedPages),deletedFields:JSON.stringify(b.deletedFields),deletedValues:JSON.stringify(b.deletedValues),currentPageId:b.currentPageId,editingThing:b.editingThing,editingThingId:b.editingThingId};m._nDS("saving",
!0);b.sendAJAXRequest(a).after(function(a){m._nDS();if(a){if(a.errors){for(var d="",e=0;e<a.errors.length;e++)d+=a.errors[e]+"<br>";d&&m._flBo(d)}b.currentPageId=a.currentPageId;b.editingThing=a.editingThing;b.editingThingId=a.editingThingId}q.onbeforeunload=!1;p._eI();b.changeMadeOnPanel=!1;b.changesSaved=!0;p._r()})}},zenarioO.panelTypes);
