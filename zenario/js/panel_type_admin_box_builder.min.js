...
message:"Your changes have been saved!"}))};f.loadPanelHTML=function(){return this.microTemplate(m+"organizer_admin_box_builder",{dataset_label:this.tuix.dataset.label})};f.loadFieldDetailsPanel=function(a,b){var d=this.tuix.items[this.currentPageId].fields[a],c={mode:"field_details",field_label:d.field_label,hide_tab_bar:this.tuix.field_details.hide_tab_bar};c.record_count="("+(d.record_count?d.record_count:0)+" record"+(1==d.record_count?"":"s")+")";c.type=this.getFieldReadableType(this.currentPageId,
a);d.is_system_field&&(c.type+=", system field");c=this.microTemplate(m+"organizer_admin_box_builder_left_panel",c);c=$("#organizer_admin_form_builder .form_fields_palette .form_fields_palette_outer").html(c);b||c.hide().show("drop",{direction:"left"},200);d=this.sortAndLoadTUIXPages(this.tuix.field_details.tabs,d,this.selectedDetailsPage);c=this.getTUIXPagesHTML(d);$("#organizer_field_details_tabs").html(c);var e=this;$("#organizer_field_details_tabs .tab").on("click",function(){var b=$(this).data("name");
...
b[a]+"</p>");c.toggle(d);return d};f.getDeleteFieldErrors=function(a){var b={},d,c,e,h;for(d in this.tuix.items)if(n(this.tuix.items,d))for(e in c=this.tuix.items[d],c.parent_field_id==a&&(b[d]='Unable to delete the field because the page "'+c.tab_label+'" depends on it.'),c.fields)n(c.fields,e)&&(h=c.fields[e],a!=e&&h.parent_id==a&&(b[e]='Unable to delete the field because the field "'+h.field_label+'" depends on it.'));if(this.tuix.dataset_fields_in_forms[a]){formIds=_._tA(this.tuix.dataset_fields_in_forms[a]);
...
b.validation&&"none"!=b.validation&&!b.validation_message&&(e.validation_message="Please enter a message if not valid."))};f.loadPageDetailsPanel=function(a,b){var d=this,c={mode:"tab_details",tab_label:this.getPageLabel(this.tuix.items[a].tab_label),is_system_field:this.tuix.items[a].is_system_field,hide_tab_bar:this.tuix.tab_details.hide_tab_bar},c=this.microTemplate(m+"organizer_admin_box_builder_left_panel",c),c=$("#organizer_admin_form_builder .form_fields_palette .form_fields_palette_outer").html(c);
...
function(){d.saveCurrentOpenDetails()||d.loadNewFieldsPanel()});$("#organizer_remove_form_tab").on("click",function(a){if((a=d.tuix.items[d.selectedPageId])&&!a.is_system_field){var b=!1,c=0;if(a.fields)for(var k in a.fields)if(n(a.fields,k)){var g=a.fields[k];g.is_protected&&(b||(b=g),c++)}c?(k='<p>This page has the protected field "'+b.field_label+'"',c--,0<c&&(k+=" and "+c+" other protected field"+(1==c?"":"s")),p._flBo(k+" on it and cannot be deleted.</p>",!0,"warning",!0)):(k="<p>Are you sure you want to delete this Page?</p>",
_._isEm(a.fields)||(k+="<p>All fields on this page will also be deleted.</p>"),p._flBo(k,"Delete","warning",!0,!1,function(){d.deletePage(d.selectedPageId);d.changeMadeToPanel()}))}})};f.loadPageDetailsPage=function(a,b,d){this.selectedDetailsPage=a;var c=this.tuix.items[b],e=this.loadFields("tab_details/"+a,this.tuix.tab_details.tabs[a].fields,c);formattedFields=this.formatFieldDetails(e,c,"page",this.selectedDetailsPage);sortedFields=this.sortFields(formattedFields,c);c="";if(!_._isEm(d))for(d=
this.sortErrors(d),e=0;e<d.length;e++)c+='<p class="error">'+d[e]+"</p>";c+=this.getTUIXFieldsHTML(sortedFields);$("#organizer_tab_details_form").html(c);$("#organizer_tab_details_tabs .tab").removeClass("on");$("#field_tab__"+a).addClass("on");_._isEm(d)||$("#organizer_tab_details_form").effect({effect:"bounce",duration:125,direction:"right",times:2,distance:5,mode:"effect"});var h=this;if("details"==a)$("#field__tab_label").on("keyup",function(){var a=h.getPageLabel($(this).val());$(v+"tab_details_header_content .field_name h5, #organizer_form_tab_"+
...
a;h.loadFieldValuesListPreview(h.selectedFieldId)})):(this.tuix.items[this.currentPageId].fields[this.selectedFieldId].lov={},this.loadFieldValuesListPreview(this.selectedFieldId)))):"tab_details"==d&&(e=this.tuix.items[this.selectedPageId],this.saveItemTUIXPage(d,this.selectedDetailsPage,e),this.loadPageDetailsPage(this.selectedDetailsPage,this.selectedPageId))))};f.getFieldValuesList=function(a){var b=[],d=a.id,c=a.values,e=a._value,h=a._disabled;if("object"==typeof c){var l=0,k;for(k in c)if(n(c,
k)){var g=c[k],g={ord:++l,name:d,label:g.label,value:k,path:a.path};k==e&&(g.selected=!0);h&&(g.disabled=!0);b.push(g)}}else if("boolean_fields"==c)for(l in this.tuix.items){if(n(this.tuix.items,l)&&(a=this.tuix.items[l],a.fields)){var d=[],f;for(f in a.fields)n(a.fields,f)&&(g=a.fields[f],!g.type||"checkbox"!=g.type&&"group"!=g.type||g.id==this.selectedFieldId||(g={ord:g.ord,label:g.field_label,value:f},f==e&&(g.selected=!0),d.push(g)));d.sort(this.sortByOrd);d.length&&b.push({ord:a.ord,label:a.tab_label,
hasChildren:!0,options:d})}}else if("centralised_lists"==c){var l=0,m;for(m in this.tuix.centralised_lists.values)n(this.tuix.centralised_lists.values,m)&&(g=this.tuix.centralised_lists.values[m],g={ord:++l,label:g.label,value:m},m==e&&(g.selected=!0),b.push(g))}else if("datasets"==c){var l=0,p;for(p in this.tuix.datasets)n(this.tuix.datasets,p)&&(g=this.tuix.datasets[p],g={ord:++l,label:g.label,value:p},p==e&&(g.selected=!0),b.push(g))}b.sort(this.sortByOrd);return b};f.loadNewFieldsPanel=function(a){this.selectedFieldId=
this.selectedPageId=!1;var b=this.microTemplate(m+"organizer_admin_box_builder_left_panel",{mode:"new_fields",use_groups_field:this.tuix.use_groups_field}),b=$("#organizer_admin_form_builder .form_fields_palette .form_fields_palette_outer").html(b);a||b.hide().show("drop",{direction:"right"},200);$("#organizer_field_type_list_outer div.field_type_list div.field_type").draggable({connectToSortable:"#organizer_form_fields .form_section",appendTo:"#organizer_admin_form_builder",helper:"clone"})};f.loadPagesList=
function(a){for(var b in this.tuix.items)if(n(this.tuix.items,b)){var d=this.tuix.items[b];b==a?d._selected=!0:delete d._selected}a={tabs:this.getOrderedPages()};a=this.microTemplate(m+"organizer_admin_box_builder_tabs",a);$("#organizer_form_tabs").html(a);var c=this;$("#organizer_form_tabs .tab").on("click",function(){var a=$(this).data("id");c.tuix.items[a]&&c.clickPage(a)});$("#organizer_add_new_tab").on("click",function(){c.saveCurrentOpenDetails()||(c.addNewPage(),c.changeMadeToPanel())});$("#organizer_form_tabs").sortable({axis:"x",
containment:"parent",tolerance:"pointer",items:"div.sort",start:function(a,b){c.startIndex=b.item.index()},stop:function(a,b){c.startIndex!=b.item.index()&&($("#organizer_form_tabs .tab.sort").each(function(a){var b=$(this).data("id");c.tuix.items[b].ord=a+1}),c.pagesReordered=!0,c.changeMadeToPanel())}});$("#organizer_form_tabs .tab").droppable({accept:"div.is_sortable:not(.system_field)",greedy:!0,hoverClass:"ui-state-hover",tolerance:"pointer",drop:function(a,b){if(!c.saveCurrentOpenDetails()){var d=
$(this).data("id"),f=$(b.draggable).data("id");d==c.currentPageId||c.tuix.items[c.currentPageId].fields[f].is_system_field||(c.moveFieldToPage(c.currentPageId,d,f),f==c.selectedFieldId&&c.loadNewFieldsPanel(),c.loadFieldsList(c.currentPageId))}}})};f.moveFieldToPage=function(a,b,d,c){if(a!=b&&this.tuix.items[b]&&this.tuix.items[a]&&this.tuix.items[a].fields[d]&&"repeat_end"!=this.tuix.items[a].fields[d].type){this.tuix.items[b]._tabFieldsReordered=!0;this.tuix.items[a]._tabFieldsReordered=!0;var e=
1,h=this.getOrderedFields(b);h.length&&(e=c?h[0].ord-1:h[h.length-1].ord+1);"repeat_start"==this.tuix.items[a].fields[d].type&&(c=this.getMatchingRepeatEnd(d),this.tuix.items[b].fields[c]=this.tuix.items[a].fields[c],this.tuix.items[b].fields[c].ord=e+0.001,delete this.tuix.items[a].fields[c]);this.tuix.items[b].fields[d]=this.tuix.items[a].fields[d];this.tuix.items[b].fields[d].ord=e;delete this.tuix.items[a].fields[d];this.changeMadeToPanel()}};f.addNewPage=function(){var a="__custom_tab_t"+this.maxNewCustomPage++,
b=1;for(name in this.tuix.items)n(this.tuix.items,name)&&++b;this.tuix.items[a]={ord:b,name:a,tab_label:"Untitled page",fields:{},_is_new:!0};this.clickPage(a,!0)};f.clickPage=function(a,b){if(this.selectedPageId!=a){var d=this.saveCurrentOpenDetails(),c=this.displayPageFieldStructureErrors(this.currentPageId);if(!d&&!c)if(this.currentPageId==a)this.selectedFieldId=!1,this.selectedPageId=a,this.selectedDetailsPage=!1,this.loadPageDetailsPanel(a);else{var e=this.tuix.items[a];if(e.record_counts_fetched||
e._is_new)this.clickPage2(a,b);else{var h=this;this.sendAJAXRequest({mode:"get_tab_field_record_counts",pageId:a}).after(function(c){e.record_counts_fetched=!0;if(c=JSON.parse(c))for(fieldId in c)n(c,fieldId)&&(recordCount=c[fieldId],e.fields&&e.fields[fieldId]&&(e.fields[fieldId].record_count=recordCount));h.clickPage2(a,b)})}}}};f.clickPage2=function(a,b){this.currentPageId=a;if(b)this.selectedPageId=a,this.loadPageDetailsPanel(a);else{var d=!1;this.selectedFieldId||this.selectedPageId||(d=!0);
this.loadNewFieldsPanel(d)}this.selectedFieldId=!1;this.loadPagesList(a);this.loadFieldsList(a)};f.clickField=function(a){this.selectedFieldId!=a&&this.tuix.items[this.currentPageId]&&this.tuix.items[this.currentPageId].fields[a]&&"repeat_end"!=this.tuix.items[this.currentPageId].fields[a].type&&!this.saveCurrentOpenDetails()&&(this.highlightField(a),this.selectedFieldId=a,this.selectedDetailsPage=this.selectedPageId=!1,this.loadFieldDetailsPanel(a))};f.loadFieldsList=function(a){var b={fields:this.getOrderedFields(a,
!0,!0)},b=this.microTemplate(m+"organizer_admin_box_builder_section",b);$("#organizer_form_fields").html(b);this.selectedFieldId&&this.highlightField(this.selectedFieldId);var d=this;$("#organizer_form_fields div.form_field").on("click",function(){var a=$(this).data("id");d.tuix.items[d.currentPageId].fields[a]&&d.clickField(a)});$("#organizer_form_fields .form_section").sortable({items:"div.is_sortable",tolerance:"pointer",placeholder:"preview",receive:function(a,b){$(this).find("div.field_type").each(function(){var a=
$(this).data("type"),b=1,c=$(this).prev().data("id");c&&d.tuix.items[d.currentPageId].fields[c]&&(b=d.tuix.items[d.currentPageId].fields[c].ord+1);d.addNewField(a,b);d.updateFieldOrds()})},start:function(a,b){d.startIndex=b.item.index()},stop:function(b,e){d.startIndex!=e.item.index()&&(d.tuix.items[a]._tabFieldsReordered=!0,d.updateFieldOrds(),d.loadFieldsList(a))}});$("#organizer_form_fields .delete_icon").on("click",function(a){a.stopPropagation();var b=$(this).data("id");if(d.tuix.items[d.currentPageId].fields[b]&&
!d.saveCurrentOpenDetails(!0)){a=d.tuix.items[d.currentPageId].fields[b];var h;a.is_protected?(message="<p>This field is protected, and might be important to your site!</p>",message+="<p>If you're sure you want to delete this field then first unprotect it.</p>",p._flBo(message,!0,"warning",!0)):(a.record_count&&1<=a.record_count?(h=1==a.record_count?"":"s",message="<p><strong>This field contains data on "+a.record_count+" record"+h+".</strong></p>",message+="<p>When you save changes to this dataset, that data will be deleted.</p>"):
message="<p>This field doesn't contain any data for any user/contact records.</p>",message+="<p>Delete this dataset field?</p>",p._flBo(message,"Delete","warning",!0,!1,function(){d.deleteField(b)}))}})};f.updateFieldOrds=function(){var a=this;$("#organizer_form_fields div.is_sortable").each(function(b){var d=$(this).data("id");a.tuix.items[a.currentPageId].fields[d].ord=b+1});this.changeMadeToPanel()};f.deletePage=function(a){for(var b=this.getOrderedPages(),d=0,c=0;c<b.length;c++)if(b[c].name==
a){d=0<c?c-1:1;this.deletedPages.push(a);if(this.tuix.items[a].fields)for(var e in this.tuix.items[a].fields)n(this.tuix.items[a].fields,e)&&(field=this.tuix.items[a].fields[e],this.deletedFields.push(e));delete this.tuix.items[a];this.clickPage(b[d].name)}};f.deleteField=function(a){pageId=this.currentPageId;if(this.tuix.items[pageId].fields[a]){this.changeMadeToPanel();this.deletedFields.push(a);var b=this.tuix.items[pageId].fields[a];if("repeat_start"==b.type){var d=this.getMatchingRepeatEnd(a);
...
f.addNewField=function(a,b){var d="t"+this.maxNewCustomField++,c={id:d,type:a,ord:b,field_label:"Untitled",_is_new:!0},e;for(e in this.tuix.items[this.currentPageId].fields)if(n(this.tuix.items[this.currentPageId].fields,e)){var f=this.tuix.items[this.currentPageId].fields[e];f.ord>=b&&f.ord++}if("checkboxes"==a||"radios"==a||"select"==a)for(c.lov={},e=1;3>=e;e++)this.addFieldValue(c,"Option "+e);else"repeat_start"==a&&this.addNewField("repeat_end",b+0.01);this.tuix.items[this.currentPageId].fields[d]=
c;this.loadFieldsList(this.currentPageId);this.clickField(d)};f.getOrderedPages=function(){var a=[],b;for(b in this.tuix.items)n(this.tuix.items,b)&&a.push(this.tuix.items[b]);a.sort(this.sortByOrd);return a};f.getOrderedFields=function(a,b,d){var c=[],e=[],f={},l,k,g,m,p=!1;if(this.tuix.items[a]&&this.tuix.items[a].fields)for(l in this.tuix.items[a].fields)n(this.tuix.items[a].fields,l)&&(k=this.tuix.items[a].fields[l],g=_._cl(k),b&&(g.lov=this.getOrderedFieldValues(a,l,!0)),d&&k.grouping_name?(g._fields=
[],f[k.grouping_name]=g):d&&k.grouping?e.push(g):(g._isSortable=!0,c.push(g)));if(0<e.length)for(a=0;a<e.length;a++)f[e[a].grouping]&&f[e[a].grouping]._fields.push(e[a]);for(m in f)n(f,m)&&(e=f[m],e._fields.sort(this.sortByOrd),e._fields.length&&(e._isSortable=!0,c.push(e)));c.sort(this.sortByOrd);for(a=0;a<c.length;a++)"repeat_start"==c[a].type?p=!0:"repeat_end"==c[a].type?p=!1:p&&(c[a]._inRepeat=!0);return c};f.getOrderedFieldValues=function(a,b,d){var c=[],e,f;if(this.tuix.items[a]&&this.tuix.items[a].fields&&
this.tuix.items[a].fields[b]&&this.tuix.items[a].fields[b].lov){for(e in this.tuix.items[a].fields[b].lov)n(this.tuix.items[a].fields[b].lov,e)&&(f=this.tuix.items[a].fields[b].lov[e],c.push(f));a=this.tuix.items[a].fields[b].type;!d||"select"!=a&&"centralised_select"!=a||c.push({id:"empty_value",label:"-- Select --",ord:-1})}c.sort(this.sortByOrd);return c};f.changeMadeToPanel=function(){this.changeDetected||(this.changeDetected=!0,r.onbeforeunload=function(){return"You are currently editing this dataset. If you leave now you will lose any unsaved changes."},
q._dI("Please either save your changes, or click Reset to discard them, before exiting the form editor."),q._sB())};f.saveChanges=function(){var a=this,b={mode:"save",data:JSON.stringify(this.tuix.items),pagesReordered:this.pagesReordered,deletedPages:JSON.stringify(this.deletedPages),deletedFields:JSON.stringify(this.deletedFields),currentPageId:this.currentPageId};this.selectedPageId&&(b.selectedPageId=this.selectedPageId);this.selectedFieldId&&(b.selectedFieldId=this.selectedFieldId);(function(){p._nDS("saving",
!0);a.sendAJAXRequest(b).after(function(b){if(b){b=JSON.parse(b);if(b.errors){for(var c="",e=0;e<b.errors.length;e++)c+=b.errors[e]+"<br>";c&&p._flBo(c)}a.currentPageId=b.currentPageId;a.selectedPageId=b.selectedPageId;a.selectedFieldId=b.selectedFieldId}p._nDS();r.onbeforeunload=!1;q._eI();a.changeDetected=!1;a.changesSaved=!0;q._r()})})()}},zenarioO.panelTypes);
