...
1<=b.record_count?(message="<p><strong>This field contains data on "+b.record_count+" record"+(1==b.record_count?"":"s")+".</strong></p>",message+="<p>When you save changes to this dataset, this data will be deleted.</p>"):message="<p>This field doesn't contain any data for any user/contact records.</p>",message+="<p>Delete this dataset field?</p>",m._flBo(message,"Delete dataset field","warning",!0,!1,p,p,function(){a.deleteField(c,!0)})))})};g.checkParentHasParent=function(b,a){var c=_._cl(this.tuix.items[b]),
...
a.currentPageId;b.editingThing=a.editingThing;b.editingThingId=a.editingThingId}r.onbeforeunload=!1;q._eI();b.changeMadeOnPanel=!1;b.changesSaved=!0;q._r()})}},zenarioO.panelTypes);
