...
l){f=$(this).data("language_id");var h=$(this).data("field_column");c.translations||(c.translations={});c.translations[h]||(c.translations[h]={});c.translations[h][f]||(c.translations[h][f]="");c.translations[h][f]=l.value}),c._changed=!0):"crm_values"==a.type?($("#organizer_field_crm_values input.crm_value_input").map(function(f,l){f=$(this).data("id");c.crm_lov[f]=$(this).val()}),c._changed=!0):(a=this.getTUIXFieldValue(a,b),null!==a&&a!==e&&(c[b]=a));g!=c[b]&&(c._changed=!0)};d.getTUIXFieldValue=
function(a,b){var c=null;if("select"==a.type||"text"==a.type||"textarea"==a.type)c=$("#field__"+b).val(),"text"!=a.type&&"textarea"!=a.type||!c||(c=c.trim());else if("checkbox"==a.type)c=$("#field__"+b).is(":checked");else if("radios"==a.type)c=$('#organizer_field_details_form input[name="'+b+'"]:checked').val();else if("checkboxes"==a.type||"sortable_selection"==a.type)c=[],$('#organizer_field_details_form input[name="'+b+'"]:checked').each(function(){c.push($(this).val())});return c};d.openItemTUIXTab=
function(a,b,c,g,f,l){var h=this.getTUIXModeForItemType(a),k=this.getItem(a,b);h=this.getTUIXTags(h,k,a);this.formatTUIX(a,k,c,h,f);f="";if(g&&0<g.length){for(var p=0;p<g.length;p++)f+='<p class="error">'+g[p]+"</p>";$("#organizer_field_details_form").effect({effect:"bounce",duration:125,direction:"right",times:2,distance:5,mode:"effect"})}if(l)for(p=0;p<l.length;p++)f+='<p class="success">'+l[p]+"</p>";f+=this.getTUIXFieldsHTML(h,c,k,a);$("#organizer_field_details").html(f);this.addTUIXTabEvents(a,
b,c)};d.tuixFieldDetailsChanged=function(a,b,c,g){var f=this.getTUIXModeForItemType(a),l=this.tuix[f].tabs[c].fields[g],h=this.getItem(a,b),k=this.getTUIXFieldValue(l,g);null!==k&&k!=h[g]&&this.changeMadeToPanel();B(l.format_onchange)&&(this.saveTUIXTab(this.tuix[f],c,h),this.openItemTUIXTab(a,b,c,e,g))};d.showButtons=function(a){var b=this;b.changeMadeOnPanel?(a.html(b.microTemplate("zenario_organizer_apply_cancel_buttons",{confirm_text:"Save changes",confirm_css:"form_editor",cancel_text:"Reset"})),
a.find("#organizer_applyButton").click(function(){b.saveCurrentOpenDetails()&&b.displayPageFieldOrderErrors()&&b.saveChanges()}),a.find("#organizer_cancelButton").click(function(){confirm("Are you sure you want to discard all your changes?")&&(q.onbeforeunload=!1,A._rj7(),b.editingThing=!1,b.currentPageId=!1,b.changeMadeOnPanel=!1,A._131())})):a.html("").show()};d.displayPageFieldOrderErrors=function(){return!1};d.sendAJAXRequest=function(a,b){var c=A._i1(),g="zenario/ajax.php?__pluginClassName__="+
this.tuix.class_name+"&__path__="+A.path+"&method_call=handleOrganizerPanelAJAX",f=function(){E("organizer_preloader_circle").style.display="none";I._8nu();q.onbeforeunload=!1};$.extend(c,a);E("organizer_preloader_circle").style.display="block";return z.ajax(z._ozg(g),c,!0,!1,!0,!0,e,e,e,e,e,f).after(function(l){f();b!==e&&b(l)})};d.displayToastMessage=function(a,b){};d.returnShowLeftColumn=function(){return!1};d.returnPanelTitle=function(){return F(C.grid).returnPanelTitle.call(this)};d.returnMultipleSelectEnabled=
function(){return!1};d.returnSearchingEnabled=function(){return!1};d.returnInspectionViewEnabled=function(){return!1}},zenarioO.panelTypes);
