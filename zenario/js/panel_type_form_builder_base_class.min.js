...
else if("crm_values"==f.type){var g="crm";"salesforce"==f.crm_type&&(g="salesforce");if("checkbox"==a.type||"group"==a.type||"consent"==a.type)a["_"+g+"_data"]={},a["_"+g+"_data"].values={unchecked:{ord:1,label:0},checked:{ord:2,label:1}};$("#organizer_field_crm_values input.crm_value_input").map(function(b,c){var e=$(this).data("id");"checkbox"==a.type||"group"==a.type||"consent"==a.type?a["_"+g+"_data"].values[e][g+"_value"]=$(this).val():a.lov&&a.lov[e]&&(a.lov[e][g+"_value"]=$(this).val())})}f.validation&&
f.validation.required&&!a[b]&&(d[b]=f.validation.required)}}this.validateFieldDetails(c,a,e,this.selectedDetailsPage,d)};d.saveItemTUIXPage=function(a,c,e){var d={};this.tuix[a]&&this.tuix[a].tabs&&this.tuix[a].tabs[c]&&(this.saveItemTUIXFields(e,this.tuix[a].tabs[c].fields,a,d),e._changed=!0);return d};d.addFieldValue=function(a,c,e){c||(c="Untitled");"undefined"===typeof a.lov&&(a.lov={});newValueId="t"+this.maxNewCustomFieldValue++;a.lov[newValueId]={id:newValueId,label:c,ord:e||_._si(a.lov)+100,
_is_new:!0}};d.getPageLabel=function(a){a&&""===a.trim()&&(a="Untitled");return a};d.getMatchingRepeatEnd=function(a){var c=!1,e=!1,d=this.getOrderedFields(this.currentPageId),b;for(b=0;b<d.length;b++)if("repeat_end"==d[b].type&&(c=d[b].id),d[b].id==a)e=b;else if(!1!==e&&"repeat_end"==d[b].type){c=d[b].id;break}return c};d.showButtons=function(a){var c=this;c.changeDetected?(a.html(c.microTemplate("zenario_organizer_apply_cancel_buttons",{confirm_text:"Save changes",confirm_css:"form_editor",cancel_text:"Reset"})),
a.find("#organizer_applyButton").click(function(){var a=c.saveCurrentOpenDetails();a||(a=c.displayPageFieldStructureErrors(c.currentPageId))||c.saveChanges()}),a.find("#organizer_cancelButton").click(function(){confirm("Are you sure you want to discard all your changes?")&&(p.onbeforeunload=!1,l._eI(),c.selectedFieldId=!1,c.selectedPageId=!1,c.currentPageId=!1,c.changeDetected=!1,l._r())})):a.html("").show()};d.displayPageFieldStructureErrors=function(){return!1};d.displayToastMessage=function(a,
c){};d.returnShowLeftColumn=function(){return!1};d.returnPanelTitle=function(){return s(n.grid).returnPanelTitle.call(this)};d.returnMultipleSelectEnabled=function(){return!1};d.returnSearchingEnabled=function(){return!1};d.returnInspectionViewEnabled=function(){return!1}},zenarioO.panelTypes);
