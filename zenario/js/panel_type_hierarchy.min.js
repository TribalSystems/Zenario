'use strict';zenario.lib(function(l,z,D,E,F,G,v,A,B,H,I,n,J,r,u,x,K,L,M,C,y,q,w){l=y(w.hierarchy=C(w.list,function(){this.openItemsInHierarchy={}}));l.returnPageSize=function(){return!1};l.returnInspectionViewEnabled=function(){return!1};l.parentIdColumn=function(){return this.tuix.hierarchy&&this.tuix.hierarchy.column||"parent_id"};l.showPanel=function(b,c,d){var a={},e,f=this.getItems(),h=this.ordinalColumn(),p=this.parentIdColumn();this.itemsById={};this.parentIdOf={};this.ordinals={};this.changingHierarchy=
!1;this.setHeader(b);for(e in f.items)if(q(f.items,e)){var k=f.items[e];k.items=[];this.itemsById[k.id]=k}for(e=f.items.length-1;0<=e;--e){k=f.items[e];var m=k.tuix[p];v._eTB(m)?(f.items.splice(e,1),this.itemsById[m]&&(this.itemsById[m].items.splice(0,0,k),this.parentIdOf[k.id]=m)):m=0;h&&(a[m]||(a[m]=[],this.ordinals[m]={}),a[m].push(this.ordinals[m][k.id]={id:k.id,ord:k.tuix[h]}),k.canDrag=!0)}for(m in a)if(q(a,m))for(k=a[m],k.sort(B.sortArrayByOrd),e=0;e<k.length;++e)k[e].normOrd=e+1;a=this.getHierarchyMicroTemplateHTML(f);
...
e)&&a.parentIdOf[e]&&(b[a.parentIdOf[e]]=!0);for(;f;)for(e in f=!1,b)q(b,e)&&a.parentIdOf[e]&&!b[a.parentIdOf[e]]&&(f=b[a.parentIdOf[e]]=!0);for(e in b)q(b,e)&&(c=$(x("organizer_item_"+e)).parent(),c.length&&h.nestable("expandItem",c))}h.on("collapseItem",function(){a.collapseItem();a.hideHandles(h)});h.on("expandItem",function(){a.expandItem();a.hideHandles(h)});if(a.ordinalColumn()&&!r(a.searchTerm))h.on("change",function(){(a.changingHierarchy=a.scanNewHier(!1))?n._dI():n._eI();n._sB()});a.$dd=
h;a.hideHandles(h)};l.hideHandles=function(b){var c=this.tuix.hierarchy;c&&(u(c.disable_dragging_top_level)?(b.find(".dd-handle").hide(),u(c.disable_dragging_children)||b.find(".dd-item .dd-item .dd-handle").show()):u(c.disable_dragging_children)&&b.find(".dd-item .dd-item .dd-handle").hide())};l.collapseItem=function(){this.recordOpenItems();var b=!1,c;for(c in this.selectedItems)q(this.selectedItems,c)&&!this.openItemsInHierarchy[c]&&(delete this.selectedItems[c],b=!0);b&&(n._sB(!0),n._sH())};l.expandItem=
function(){this.recordOpenItems()};l.showButtons=function(b){var c=this;c.changingHierarchy?(b.html(c.microTemplate("zenario_organizer_apply_cancel_buttons",{})),b.find("#organizer_applyButton").click(function(){c.scanNewHier(!0)}),b.find("#organizer_cancelButton").click(function(){n._eI();n._r()})):y(w.list).showButtons.call(c,b)};l.scanNewHier=function(b){var c=this.$dd.nestable("serialize_zenario_modified_version"),d,a,e=!1,f={},h={},p=this.ordinalColumn();for(d in c)if(q(c,d)){var k=!1,m=c[d].length;
for(a=1;a<=m;++a){var g=c[d][a-1];if(r(g))if(h[g]={parentId:d,ordinal:a},this.ordinals&&this.ordinals[d]&&this.ordinals[d][g]&&this.ordinals[d][g].normOrd==a)this.ordinals[d][g].ord!=a&&(k=!0);else if(e=!0,b&&k){for(a=1;a<=m;++a)g=c[d][a-1],r(g)&&(f[g]={parentId:d,ordinal:a});break}else f[g]={parentId:d,ordinal:a}}}if(!b)return e;if(e){b=n._gK();c="";b.hierarchy=!0;b.ordinals={};b.parent_ids={};this.tuix.hierarchy&&u(this.tuix.hierarchy.send_full_hierarchy_onchange)&&(f=h);for(g in f)q(f,g)&&(c+=
(c?",":"")+g,b.parent_ids[g]=f[g].parentId,b.ordinals[g]=f[g].ordinal,b.reorder=!0,this.tuix.items[g][p]=f[g].ordinal);b.id=c;g="zenario/ajax.php?__pluginClassName__="+this.tuix.class_name+"&__path__="+n.path+"&method_call=handleOrganizerPanelAJAX";delete v.rev;v._a(z+g,b).after(function(t){t&&A._sM(t);n._eI();n._r()})}};l.recordOpenItems=function(){var b=this;b.openItemsInHierarchy={};$("#organizer_hierarchy_view li.dd-item[data-id]:visible").each(function(c,d){var a;c=$(d);c.find("ol.dd-list:visible").length&&
(a=c.data("id"))&&(b.openItemsInHierarchy[a]=!0)})};l.returnDoSortingAndSearchingOnServer=function(){return!1};l.sortAndSearchItems=function(b){var c,d,a=this.sortItems(),e=this.searchItems(_._cl(a),b),f=_._o(e,e),h=this.parentIdColumn(),p={};n.nonSearchMatches={};if(e.length!=a.length){for(d=0;d<e.length;++d)b=e[d],(c=this.tuix.items[b]&&this.tuix.items[b][h])&&!r(f[c])&&(e.push(c),f[c]=c,n.nonSearchMatches[c]=!0);for(d=a.length;0<=d;--d)b=a[d],r(f[b])||a.splice(d,1)}for(d=0;d<a.length;++d)b=a[d],
c=this.tuix.items[b]&&this.tuix.items[b][h]||"","0"==c&&(c=""),r(p[c])||(p[c]=[]),p[c].push(b);a=p[""]||[];for(d=0;d<a.length;++d)b=a[d],r(p[b])&&(a=a.concat(p[b]));return a}},zenarioO.panelTypes);
