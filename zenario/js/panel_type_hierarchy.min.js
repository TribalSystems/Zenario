zenario.lib(function(m,t,f,w,x,y,r,q,z,A,h,u,B,C,D,E,F,v,n,l,p){f=n(p.hierarchy=v(p.list,function(){this.openItemsInHierarchy={}}));f.returnPageSize=function(){return!1};f.returnInspectionViewEnabled=function(){return!1};f.parentIdColumn=function(){return this.tuix.hierarchy&&this.tuix.hierarchy.column||"parent_id"};f.showPanel=function(b,c,d){var e={},a,k,g,f=this.getItems(),h=this.ordinalColumn(),m=this.parentIdColumn();this.itemsById={};this.parentIdOf={};this.ordinals={};this.changingHierarchy=
!1;this.setHeader(b);for(a in f.items)l(f.items,a)&&(k=f.items[a],k.items=[],this.itemsById[k.id]=k);for(a=f.items.length-1;0<=a;--a)k=f.items[a],g=k.tuix[m],r.engToBoolean(g)?(f.items.splice(a,1),this.itemsById[g]&&(this.itemsById[g].items.splice(0,0,k),this.parentIdOf[k.id]=g)):g=0,h&&(e[g]||(e[g]=[],this.ordinals[g]={}),e[g].push(this.ordinals[g][k.id]={id:k.id,ord:k.tuix[h]}),k.canDrag=!0);for(g in e)if(l(e,g))for(k=e[g],k.sort(q.sortArrayByOrd),a=0;a<k.length;++a)k[a].normOrd=a+1;e=this.getHierarchyMicroTemplateHTML(f);
