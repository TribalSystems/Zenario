...
g)&&(c+=(c?",":"")+g,b.parent_ids[g]=f[g].parentId,b.ordinals[g]=f[g].ordinal,b.reorder=!0,this.tuix.items[g][p]=f[g].ordinal);b.id=c;g=v.ajaxURL("handleOrganizerPanelAJAX",this.tuix.class_name,n.path);delete v.rev;v.ajax(g,b).after(function(t){t&&z._s34(t);n._rj7();n._131()})}};l.recordOpenItems=function(){var b=this;b.openItemsInHierarchy={};$("#organizer_hierarchy_view li.dd-item[data-id]:visible").each(function(c,d){var a;c=$(d);c.find("ol.dd-list:visible").length&&(a=c.data("id"))&&(b.openItemsInHierarchy[a]=
!0)})};l.returnDoSortingAndSearchingOnServer=function(){return!1};l.sortAndSearchItems=function(b){var c,d,a=this.sortItems(),e=this.searchItems(_.clone(a),b),f=_._4z(e,e),h=this.parentIdColumn(),p={};n.nonSearchMatches={};if(e.length!=a.length){for(d=0;d<e.length;++d)b=e[d],(c=this.tuix.items[b]&&this.tuix.items[b][h])&&!r(f[c])&&(e.push(c),f[c]=c,n.nonSearchMatches[c]=!0);for(d=a.length;0<=d;--d)b=a[d],r(f[b])||a.splice(d,1)}for(d=0;d<a.length;++d)b=a[d],c=this.tuix.items[b]&&this.tuix.items[b][h]||
"","0"==c&&(c=""),r(p[c])||(p[c]=[]),p[c].push(b);a=p[""]||[];for(d=0;d<a.length;++d)b=a[d],r(p[b])&&(a=a.concat(p[b]));return a}},zenarioO.panelTypes);
