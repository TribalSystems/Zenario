...
this.drawItems(b);this.setScroll(b);this.setTooltips(a,b,e)};f.drawItems=function(a){this.items=this.getMergeFieldsForItemsAndColumns(!0);a.html(this.microTemplate("zenario_organizer_grid",this.items));a.show()};f.showViewOptions=function(a){a.find("#organizer_viewOptions").show()};f.showButtons=function(c){var b,e={itemButtons:!1,collectionButtons:!1};0<a.itemsSelected?e.itemButtons=a.getItemButtons():e.collectionButtons=a.getCollectionButtons();b=this.microTemplate("zenario_organizer_panel_buttons",
...
f.disableDragDropUpload=function(){n.clearHTML5UploadFromDragDrop();$("#organizer_rightColumn").removeClass("upload_enabled").removeClass("dragover")};f.setHeader=function(c){var b={quickFilters:a.getQuickFilters()};c.html(this.microTemplate("zenario_organizer_panel_header",b));c.show()};f.sizePanel=function(a,b,e,d){this.items&&this.drawPagination(e)};f.drawPagination=function(c){c.html(this.microTemplate("zenario_organizer_pagination",this.items)).show();var b=a.getPageCount(),e=c.find("#organizer_pagination");
