...
"organizer_panel_buttons",d);e.html(k).show();this.enableDragDropUpload(d.collectionButtons,d.itemButtons);m._to(e.find("a[title]"));m._to(e.find(".toolbarButtons ul ul a[title]"),{position:{my:"left+2 center",at:"right center",collision:"flipfit"}})};c.setScroll=function(e){var k=this,d=function(){var b;if(b=a._gKI(!0)){if(b=k.getItemPosition(b))b=Math.max(0,b.top+e.scrollTop()-Math.floor(e.height()/4)),e.scrollTop(b).trigger("scroll")}else k.restoreScrollPosition(e)};s.zenarioONotFull?setTimeout(d,
