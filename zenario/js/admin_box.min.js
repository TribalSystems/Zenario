'use strict';var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.arrayIteratorImpl=function(d){var f=0;return function(){return f<d.length?{done:!1,value:d[f++]}:{done:!0}}};$jscomp.arrayIterator=function(d){return{next:$jscomp.arrayIteratorImpl(d)}};$jscomp.ASSUME_ES5=!1;$jscomp.ASSUME_NO_NATIVE_MAP=!1;$jscomp.ASSUME_NO_NATIVE_SET=!1;$jscomp.SIMPLE_FROUND_POLYFILL=!1;$jscomp.ISOLATE_POLYFILLS=!1;
...
zenario.lib(function(d,f,h,k,m,v,r,x,G,a,H,t,I,A,E,l,B,J,K,L,C,y,D){a.openingKey={};a.start=function(b,c,e,g){a.openingKey=c;t._lM(function(){C(D).start.call(a,b,c,e,g)})};a.openBox=function(b){x._oB(b,a.baseCSSClass,"AdminFloatingBox",!1,960,50,2,!0,!0,".zenario_fabHead",!1);l("zenario_fbAdminFloatingBox").style.display="none"};a.closeBox=function(){x._cB("AdminFloatingBox");a._uH()};a.updateHash=function(){t.path&&t.tuix&&t._sH()};a.setTitle=function(b){var c,e,g,n=$("#zenario_fabBox"),q=$("#zenario_fabId"),
p=$("#zenario_fabTitleWrap"),u=$("#zenario_fabLastUpdated");(c=a.getTitle())?(p.css("display","block"),p.addClass(" zenario_no_drag"),l("zenario_fabTitle").innerHTML=B(c)):p.css("display","none");(e=a.tuix.last_updated)?u.show().html(B(e)):u.hide();b?$("#zenario_fabBox_readonlyMarker").css("display","block"):$("#zenario_fabBox_readonlyMarker").css("display","none");a.tuix.key&&(g=a.tuix.identifier)&&(g.value=g.value||a.tuix.key.id&&r._dIIFO(a.tuix.key.id))?(q.show().html(a.microTemplate(this.mtPrefix+
"_identifier",g)),n.addClass("zfab_with_identifier")):(q.hide(),n.removeClass("zfab_with_identifier"));t.path&&t.tuix&&t._sH()};a.lastSize=!1;a.previewHidden=!0;a.size=function(b){a.sizing&&clearTimeout(a.sizing);var c=Math.floor($(k).width()),e=Math.floor($(k).height()),g,n,q,p=a.tuix||{};c&&e&&!a.isSlidUp&&((g=a.lastSize!=c+"x"+e)||b)&&(a.lastSize=c+"x"+e,g=E(p.hide_tab_bar),l("zenario_fbMain")&&(g?(l("zenario_fbMain").style.top="0px",l("zenario_fabTabs").style.display="none"):(l("zenario_fbMain").style.top=
"24px",l("zenario_fabTabs").style.display=r._bII()?"":"inherit")),b=193,g&&(b-=53),b+=$("#zenario_fabTitleWrap").height(),e=Math.floor(.96*e),c=Math.floor(.96*c),g=e-b,(n=1*p.max_height)&&g>n&&(g=n,e=n+b),g&&0<g&&$("#zenario_fbAdminInner").height(g),a.tabContainerHeight=g,e&&0<e&&($("#zenario_fabBox").height(e),$("#zenario_fabPreview").height(e)),p.css_class&&p.css_class.m(/zenario_fab_plugin\b/)?($("#zenario_fabBox").width(800),(b=!a.hasPreviewWindow||1100>c)?(c=800,a.previewMD5=a.previewWidth=a.previewPost=
!1):(c=a.previewSlotWidth?Math.min(c,804+a.previewSlotWidth):c,a.previewWidth=c-800-4,$("#zenario_fabPreview").width(a.previewWidth),a.previewSlotWidthInfo?$("#zenario_fabPreviewInfo").show().text(a.previewSlotWidthInfo):$("#zenario_fabPreviewInfo").hide())):($("#zenario_fabBox").width(960),c=960,a.previewMD5=a.previewWidth=a.previewPost=!1,b=!0),a.hasPreviewWindow?b?$("#zenario_fbAdminFloatingBox").removeClass("zenario_fab_with_no_preview").addClass("zenario_fab_with_preview").addClass("zenario_fab_with_preview_hidden").removeClass("zenario_fab_with_preview_shown"):
$("#zenario_fbAdminFloatingBox").removeClass("zenario_fab_with_no_preview").addClass("zenario_fab_with_preview").removeClass("zenario_fab_with_preview_hidden").addClass("zenario_fab_with_preview_shown"):$("#zenario_fbAdminFloatingBox").addClass("zenario_fab_with_no_preview").removeClass("zenario_fab_with_preview").removeClass("zenario_fab_with_preview_hidden").removeClass("zenario_fab_with_preview_shown"),(q=p.tabs.global_area)&&!_._isEm(q.fields)?$("#zenario_fbAdminFloatingBox").removeClass("zenario_fab_with_no_global_area").addClass("zenario_fab_with_global_area"):
$("#zenario_fbAdminFloatingBox").removeClass("zenario_fab_with_global_area").addClass("zenario_fab_with_no_global_area"),a.previewHidden!=b&&((a.previewHidden=b)||a.updatePreview()),x._aB("AdminFloatingBox",!1,c,50,2),a._mFATAP());a.sizing=setTimeout(a.size,250)};a.makeFieldAsTallAsPossible=function(){var b=a.tallAsPossibleField,c=a.tallAsPossibleFieldType,e,g,n;if(A(b)&&"editor"!=c&&(e=a.tabContainerHeight)&&(e-=20,g=a.get(b))){var q=$(g);q.height("");g=$("#zenario_abtab").outerHeight();e>g&&(q.height(q.height()+
e-g),"code_editor"==c&&(n=ace.edit(b))&&n.resize())}};a.clickTab=function(b){C(D).clickTab.call(a,b)};a.validateAlias=function(){r._aADINS("validateAlias",function(){a._vAG()})};a.validateAliasGo=function(){var b=l("alias");b&&(b={_validate_alias:1,alias:b.value},a.tuix.key.cID&&(b.cID=a.tuix.key.cID),a.tuix.key.cType&&(b.cType=a.tuix.key.cType),a.tuix.key.equivId&&(b.equivId=a.tuix.key.equivId),l("language_id")&&(b.langId=l("language_id").value),l("update_translations")&&(b.lang_code_in_url="show",
"update_this"==l("update_translations").value&&l("lang_code_in_url")&&(b.lang_code_in_url=l("lang_code_in_url").value)),r._a(f+"zenario/admin/quick_ajax.php",b,!0).after(function(c){var e="",g=l("alias_warning_display");if(c)for(var n in c)y(c,n)&&(e+=(e?"<br />":"")+c[n]);g&&(g.innerHTML=e)}))};a.generateAlias=function(b){b=b.toLowerCase().r(/[\u00e1\u00c1\u00e0\u00c0\u00e2\u00c2\u00e5\u00c5\u00e4\u00c4\u00e3\u00c3\u00c6\u00e6\u00e7\u00c7\u00f0\u00d0\u00e9\u00c9\u00e8\u00c8\u00ea\u00ca\u00eb\u00cb\u00ed\u00cd\u00ec\u00cc\u00ee\u00ce\u00ef\u00cf\u00f1\u00d1\u00f3\u00d3\u00f2\u00d2\u00f4\u00d4\u00f6\u00d6\u00f5\u00d5\u00f8\u00d8\u0161\u0160\u00fa\u00da\u00f9\u00d9\u00fb\u00db\u00fc\u00dc\u00fd\u00dd\u017e\u017d]/g,
...
b.substr(0,50)};a.contentTitleChange=function(){var b=l("menu_text"),c=l("alias");b&&!a.tuix.___menu_text_changed&&(b.value=l("title").value.r(/\s+/g," "));!c||c.disabled||c.readOnly||a.tuix.___alias_changed||(c.value=a._gA(l("title").value),a._vA())};a.viewFrameworkSource=function(){var b=f+"organizer.php#zenario__modules/show_frameworks//"+a.tuix.key.moduleId+"//"+r._eIIFO(a.readField("framework"));k.open(b);return!1};a.svgSelected=function(b){var c=a.field(b);b=a.value(b);c=c&&b&&a.pickedItemsArray(c,
b);var e;if(c)for(e in c)if(y(c,e)&&(b=c[e],_._iS(b)||(b=b.label),b&&b.m(/\.svg( \[.*?\]|)$/i)))return!0;return!1};a.adminPermChange=function(b,c,e,g,n){var q=!0,p=a.tuix.tabs[a.tuix.tab].fields;A(g)||(n=0,g=$("input[name="+c+"]").each(function(u,w){w.checked&&++n}).length);0==n?(q=!1,c="zenario_permgroup_empty"):c=n<g?"zenario_permgroup_half_full":"zenario_permgroup_full";l(b).checked=p[b].current_value=q;$(l("row__"+b)).removeClass("zenario_permgroup_empty").removeClass("zenario_permgroup_half_full").removeClass("zenario_permgroup_full").addClass(c);
p[b].row_class=p[b].row_class.r(" zenario_permgroup_empty","").r(" zenario_permgroup_half_full","").r(" zenario_permgroup_full","")+" "+c;l(e).value=p[e].value=p[e].current_value=n+"/"+g};a.adminParentPermChange=function(b,c,e){var g=0,n=0,q="",p=l(b).checked,u=$("input[name="+c+"]"),w=!!u.length,z;for(z in a.tuix.tabs[a.tuix.tab].fields[c].values)y(a.tuix.tabs[a.tuix.tab].fields[c].values,z)&&(++g,p&&(q+=(q?",":"")+z,++n));w&&u.each(function(M,F){F.checked=p});a.tuix.tabs[a.tuix.tab].fields[c].current_value=
q;a._aPC(b,c,e,g,n);p&&!w&&a.turnToggleOn(e)};a.previewDateFormat=function(b,c){r._aADINS(b,function(){a._pDFG(b,c)})};a.previewDateFormatGo=function(b,c){(b=l(b))&&(c=l(c))&&(c.value=r._mNAA("zenario_common_features",{previewDateFormat:b.value}))};a.openSiteSettings=function(b,c){a.open("site_settings",{id:b},c,d,function(){t._rePa()})};a.enableOrDisableSite=function(){a.open("zenario_enable_site",d,d,d,function(){t._rePa()})};a.updateSEP=function(){r._aADINS("updateSEP",function(){$("#microtemplate__search_engine_preview").html(a.microTemplate("zenario_admin_box_search_engine_preview",
