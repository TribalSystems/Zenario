...
(a.icon=this.onIconURL),b.extend(e),google.maps.event.addListener(a,"click",this.makeSelectItemCallback(g,a)),google.maps.event.addListener(a,"dblclick",this.makeOpenAdminBoxCallback(g,a,k)))}m&&d.fitBounds(b);google.maps.event.addDomListener(r,"resize",function(){var a=d.getCenter();google.maps.event.trigger(d,"resize");d.setCenter(a)});a=this.microTemplate("zenario_organizer_google_map_footer",{items:m,total:p});c.html(a).show()};c.showButtons=function(a){var b;b={itemButtons:!1,collectionButtons:!1};
0<d.itemsSelected?b.itemButtons=d._geItBu():b.collectionButtons=d._gCB();b=this.microTemplate("zenario_organizer_panel_buttons",b);a.html(b).show()};c.makeOpenAdminBoxCallback=function(a,b,c){var e=this;return function(){e.itemClick(a.id,b,!0);d._itBuCl(c)}};c.makeSelectItemCallback=function(a,b){var c=this;return function(){c.itemClick(a.id,b)}};c.itemClick=function(a,b,c){d.multipleSelectEnabled?!c&&this.selectedItems[a]?this.deselectItem(a,b):this.selectItem(a,b):d.multipleSelectEnabled||!this.selectedItems[a]||
c?(d._dAI(),this.selectItem(a,b)):d._dAI();this.lastItemClicked=a;d._sH();d._sB()};c.selectItem=function(a,b){b.setIcon(this.onIconURL);f(e.base).selectItem.call(this,a)};c.deselectItem=function(a,b){b.setIcon(this.offIconURL);f(e.base).deselectItem.call(this,a)};c.updateItemCheckbox=function(a,b){}},zenarioO.panelTypes);
