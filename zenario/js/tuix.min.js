...
b.responseText&&-1!=(end=b.responseText.indexOf('{"')))try{var a=JSON.parse(b.responseText.substr(end));"object"==typeof a&&(b.data=a,b.responseText=b.responseText.substr(0,end))}catch(c){}return b};c.parse=function(b){return JSON.parse(b.r(/\~/g,'"').r(/%S/g,"~").r(/\+/g,":").r(/%P/g,"+").r(/%0/g,'":false').r(/%1/g,'":true').r(/%2/g,'"pre_field_html":').r(/%3/g,'"post_field_html":').r(/%4/g,'"redraw_immediately_onchange":').r(/%5/g,'"redraw_onchange":').r(/%7/g,'"hide_if_previous_value_isnt":').r(/%8/g,
