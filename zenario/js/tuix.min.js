...
(a.title=b.applyMergeFields(b.popoutLabelFormat,!1,p)));l&&l.href&&!m(a.href)?a.href=l.href:l&&l.frontend_link&&!m(a.href)?a.href=u._pRL(l.frontend_link,"_show_page_preview=1"):l&&a.href&&(a.href+=-1===a.href.indexOf("?")?"?":"&",l.checksum?(a.href+="c="+H(l.checksum),p==1*p&&(a.href+="&id="+p)):a.href=p==1*p?a.href+("id="+p):a.href+("c="+H(p)),f=b.getKey().usage||l.usage)&&(a.href+="&usage="+H(f));if(a.href){if(f=l&&l.filename||a.options&&a.options.filename||a.filename){if(p=f.m(/(.*) \[.*\]/))f=
p[1];a.href+="&filename="+H(f)}a.href=h._aBP(a.href)}if(a.css_class){var D=(""+a.css_class).s(" ");a.onOpen=function(){h._aCTC(D)};a.onClosed=function(){h._rCTC(D)}}a.iframe&&!m(a.width)&&(a.width="93%");a.iframe&&!m(a.height)&&(a.height="90%");l&&l.width&&(a.initialWidth=l.width);l&&l.height&&(a.initialHeight=l.height);m(a.preloading)||(a.preloading=!1);$.colorbox(a)}else if(a.organizer_quick)l=a.organizer_quick.path,f&&(p=b.getKeyId(!0))&&(l=l.r(/\[\[id\]\]/g,p)),q._oQ(l,a.organizer_quick.min_path||
