...
c.uploadCallBack&&c.uploadCallBack(c.uploadResponses)};c.uploadProgress=function(b){var a=0;b.lengthComputable&&(a=100*b.loaded/b.total);D("zenario_progress_wrap").style.display="block";D("zenario_progressbar").style.width=a+"%"};c.uploadDone=function(b){if(c.uploader.responseText&&1!=c.uploader.responseText)try{data=JSON.parse(c.uploader.responseText);if("object"!=typeof data)throw 0;c.uploadResponses.push(data)}catch(a){n.showMessage?n._sM(c.uploader.responseText,!0,"error",!1,!0):alert(c.uploader.responseText)}c._dNU()};
...
break;case "zenarioAB":case "zenarioSE":w="handleAdminBoxAJAX";break;default:w="handlePluginAJAX"}!k&&a.link?k=a.link:!k&&a.panel&&a.panel._path_here&&(k={path:a.panel._path_here});if(!k||!u._pNA(k)){u.yourWorkInProgressLastUpdated=0;b.pickItemsItemLevel=f;b.postPickItemsObject=!1;var G,A,q;if((q=a.upload)||(q=a.ajax))x?(G=x,A=b.getKey(f)):!f&&a.ajax&&a.ajax.pass_matched_ids&&"zenarioO"==b.globalName?(G=E+"zenario/admin/organizer.ajax.php?__pluginClassName__="+q.class_name+"&path="+u.path+"&_get_matched_ids=1&method_call="+
w+h._uR(u.lastRequests),A={}):(G=E+"zenario/ajax.php?__pluginClassName__="+q.class_name+"&__path__="+b.path+"&method_call="+w,A=b.getKey(f)),q.request&&$.extend(A,q.request),d&&$.extend(A,d);if(a.upload){x=!c._cDHTML5U();d='<input type="file" name="Filedata"';var s,t;if(t=a.upload.accept||a.upload.extensions){t=c._tTA(t);for(s in t)if(y(t,s))switch(q=t[s],q){case "text":t[s]="text/*";break;case "images":t[s]="image/*";break;case "video":t[s]="video/*";break;case "audio":t[s]="audio/*";break;default:-1==
q.indexOf("/")&&"."!=q.substr(0,1)&&(t[s]="."+q)}d+=' accept="'+J(t.join(","))+'"'}else"Images"==a.upload.fileDesc&&(d+=' accept="image/*"');x&&(d+=' id="zenario_fallback_fileupload"');!x&&v(a.upload.multi)&&(d+=" multiple");d+="/>";if(x)a=h._cl(a),A._html5_backwards_compatibility_hack=1,a.ajax={class_name:a.upload.class_name,confirm:{message:d,html:!0,button_message:B.upload,cancel_button_message:B.cancel,form:!0},request:A};else{a=$(d);a.change(function(){b.uploadStart&&b.uploadStart();c._dHTML5U(this.files,
G,A,function(a){b.uploadComplete(a)})});a.click();return}}if(k)v(k.unselect_items)&&(u.selectedItems={},u.saveSelection()),u.go(k.path,e,k.refiner?{id:f?u._gKI():"",name:k.refiner}:g,g,g,g,g,C);else if(a.frontend_link){var p,l;a=a.frontend_link;var z=!1;f&&(p=b.getKeyId(!0))&&(l=b.tuix.items[p])&&l.frontend_link&&(a=l.frontend_link);"zenarioO"==b.globalName&&(a=u._pRL(a),-1!=a.indexOf("&zenario_sk_return=")&&(z=!0));z||"zenario/admin/welcome.php"==a.substr(0,25)?h._gTU(h._aBP(a)):-1!==a.indexOf("://")&&
0!==a.indexOf(E)?r.open(a):"zenarioAT"==b.globalName?h._gTU(h._aBP(a)):K&&!K.zenarioO?r.opener.location=h._aBP(a):r.storekeeperChildWindow&&!r.storekeeperChildWindow.closed?r.storekeeperChildWindow.location=h._aBP(a):r.storekeeperChildWindow=r.open(h._aBP(a))}else if(a.navigation_path)a=a.navigation_path,f&&(p=b.getKeyId(!0))&&(l=b.tuix.items[p])&&l.navigation_path&&(a=l.navigation_path),"zenarioO"==b.globalName?u.go(a,-1):h._gTU(h._aBP((r.zenarioATLinks&&r.zenarioATLinks.organizer||"zenario/admin/organizer.php")+
"#"+a));else if(a.admin_box){n._nDS("loading");f=b.getKey(f)||{};if(a.admin_box.key)for(z in a.admin_box.key)y(a.admin_box.key,z)&&(f[z]=a.admin_box.key[z]);F.open(a.admin_box.path,f,a.admin_box.tab,a.admin_box.values,g,v(a.admin_box.create_another)?a.admin_box:!1,g,v(a.admin_box.pass_matched_ids))}else if(a.popout){a=h._cl(a.popout);f&&(p=b.getKeyId(!0))&&(l=b.tuix.items[p])&&(l.popout&&(a=$.extend(a,l.popout)),!a.title&&b.popoutLabelFormat&&(a.title=b.applyMergeFields(b.popoutLabelFormat,!1,p)));
l&&l.href&&!m(a.href)?a.href=l.href:l&&l.frontend_link&&!m(a.href)?a.href=u._pRL(l.frontend_link,"_show_page_preview=1"):l&&a.href&&(a.href+=-1===a.href.indexOf("?")?"?":"&",l.checksum?(a.href+="c="+H(l.checksum),p==1*p&&(a.href+="&id="+p)):a.href=p==1*p?a.href+("id="+p):a.href+("c="+H(p)),f=b.getKey().usage||l.usage)&&(a.href+="&usage="+H(f));if(a.href){if(f=l&&l.filename||a.options&&a.options.filename||a.filename){if(p=f.match(/(.*) \[.*\]/))f=p[1];a.href+="&filename="+H(f)}a.href=h._aBP(a.href)}if(a.css_class){var D=
(""+a.css_class).split(" ");a.onOpen=function(){h._aCTC(D)};a.onClosed=function(){h._rCTC(D)}}a.iframe&&!m(a.width)&&(a.width="93%");a.iframe&&!m(a.height)&&(a.height="90%");l&&l.width&&(a.initialWidth=l.width);l&&l.height&&(a.initialHeight=l.height);m(a.preloading)||(a.preloading=!1);$.colorbox(a)}else if(a.organizer_quick)l=a.organizer_quick.path,f&&(p=b.getKeyId(!0))&&(l=l.replace(/\[\[id\]\]/g,p)),n._oQ(l,a.organizer_quick.min_path||a.organizer_quick.max_path||a.organizer_quick.path,a.organizer_quick.min_path,
a.organizer_quick.max_path,v(a.organizer_quick.disallow_refiners_looping_on_min_path),g,g,b.globalName);else if(a.pick_items&&!f)a.pick_items.ajax&&(b.postPickItemsObject=a.pick_items),b.actionTarget=E+"zenario/ajax.php?__pluginClassName__="+a.pick_items.class_name+"&__path__="+b.path+"&method_call="+w,b.actionRequests=b.getKey(f),a.pick_items.request&&$.extend(b.actionRequests,a.pick_items.request),n._oS(b.globalName,"pickItems",a.pick_items.multiple_select,a.pick_items.path,a.pick_items.target_path,
...
"submit_selected","value",a.ajax.confirm.button_message,"onclick",b.globalName+".action2()");e+=I("type","button","class","submit","value",a.ajax.confirm.cancel_button_message);n._sM(d,e,a.ajax.confirm.message_type,g,!l);a.upload&&(h._bII()||$("#zenario_fallback_fileupload").click())}else b.action2();else a.help&&(f=a.help.message_type||"question",l=!v(a.help.html),a.help.message&&n._sM(a.help.message,!0,f,!1,l))}};c.eval=function(b,a,f,e,k,d,C,x,w,n,m){var q,s;m=m||a&&a.tuix||g;f=f||d||C||x||e||
w||n;if("object"==typeof b){for(q in b)if(y(b,q)){s=b[q];q=q.split(".",2);f=q[0];e=q[1];if(!e)e=f,a=r;else if("lib"!=f&&!(a=r[f]))return!1;if(!a[e]||!a[e].apply(a,c._tTA(s)))return!1}return!0}try{s=c._dE(b+"",a,f,e,k,d,C,x,w,n,m)}catch(t){throw r.console&&console.error&&console.error("JavaScript error in evaluated expression:",b),t;}"function"==typeof s&&(s=s(f,e,k,m,d,C,x,w,n));return h._eTB(s)};c.hidden=function(b,a,f,e,k,d,h,g,m,n){b=b||k||d||h||f||g||m;return!b||v(b.hidden)||b.visible_if&&!c._e(b.visible_if,
a,b,f,e,k,d,h,g,m,n)||b.js_condition&&!c._e(b.js_condition,a,b,f,e,k,d,h,g,m,n)};c.checkFunctionExists=function(b,a){return a?r[a]&&"function"==typeof r[a][b]:"function"==typeof r[b]};c.sortArray=function(b,a){return c._sL(b,a,1)};c.sortArrayByOrd=function(b,a){return c._sL(b,a,"ord")};c.sortArrayByOrdinal=function(b,a){return c._sL(b,a,"ordinal")};c.sortArrayWithGrouping=function(b,a){return b[2]===a[2]?c._sL(b,a,1):m(b[2])?m(a[2])?c._sL(b,a,2):c._sL(b,a,2,1):c._sL(b,a,1,2)};c.sortLogic=function(b,
a,c,e){b=b[c];a=m(e)?a[e]:a[c];if(b===a)return 0;c=b==1*b;e=a==1*a;return c&&e?1*b<1*a?-1:1:c||e?c?-1:1:(""+b).toUpperCase()<(""+a).toUpperCase()?-1:1};c.getSortedIdsOfTUIXElements=function(b,a,f,e){var k,d,h=!1,g=[];f||(f="ord");"items"==a&&b.columns&&b.columns[f]&&(h=b.columns[f].format);_._isOb(a)||(a=b[a]);if(a)for(d in a)y(a,d)&&(b=a[d])&&(b=b[f],"true_or_false"==h||"yes_or_no"==h?g.push([d,v(b),!0]):"remove_zero_padding"!=h&&b==(k=1*b)?g.push([d,k,!0]):b?g.push([d,b.toLowerCase(),!1]):g.push([d,
...
b.responseText&&-1!=(end=b.responseText.indexOf('{"')))try{var a=JSON.parse(b.responseText.substr(end));"object"==typeof a&&(b.data=a,b.responseText=b.responseText.substr(0,end))}catch(c){}return b};c.onChangeOrSearch=function(){return h._bII()||h._bIE()?"onchange":"onsearch"};c.showDevTools=function(){return(n.adminSettings||{}).show_dev_tools};c.filter=function(b){return!1===b?function(a){return!a.location}:"string"==typeof b?function(a){return a.location==b}:b};c.find=function(b,a){return _._fi(b,
