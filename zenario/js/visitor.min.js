...
for(var c in b)a.has(b,c)&&$("#colorbox").removeClass(b[c])};a.addJQueryElements=function(b,c){b&&b!==m||(b="");$(b+"a[rel^='colorbox'], a[rel^='fancybox'], a[rel^='lightbox']").colorbox({title:function(){return $(this).attr("data-box-title")}});a.browserIsIE(9)&&($(b+"input[placeholder]").placeholder(),$(b+"textarea[placeholder]").placeholder());$(b+"input.jquery_datepicker").each(function(b,c){a.loadDatePicker();c.id&&q(c.id+"__0")&&q(c.id+"__1")&&q(c.id+"__2")&&q(c.id+"__3")?(c.value=$.datepicker.formatDate(a.dpf,
$.datepicker.parseDate("yy-mm-dd",q(c.id+"__0").value)),$("#"+c.id).datepicker({dateFormat:a.dpf,altField:"#"+c.id+"__0",altFormat:"yy-mm-dd",showOn:"focus"}),$("#"+c.id+"__1").remove(),$("#"+c.id+"__2").remove(),$("#"+c.id+"__3").remove()):$(c).datepicker({dateFormat:a.dpf,showOn:"focus"})});var d;d=c&&k.init?k.tooltips:a.tooltips;d(b+"div[title]");d(b+"input[title]");/android|iphone|ipod|series60|symbian|windows ce|blackberry/i.test(navigator.userAgent)||(d(b+"a[title]"),d(b+"img[title]"),d(b+"area[title]"),
k.init&&k.addJQueryElements(b));$(".clickablebox").click(function(){var a=$(this).find("a");a&&a.length&&("_blank"==a.attr("target")?l.open(a.attr("href")):l.location=a.attr("href"));return!1});$(b+":submit").click(function(){a.buttonClick(this)});$(b+" submit").click(function(){a.buttonClick(this)})};$(p).ready(function(){a.addJQueryElements()});a.loadDatePicker=function(){$.datepicker||$.ajax({async:!1,url:r+"zenario/libraries/mit/jquery/jquery-ui.datepicker.min.js?v="+zenarioCSSJSVersionNumber,
dataType:"script"})};a.dateFieldKeyUp=function(b,c,d){if(8==c.keyCode||32==c.keyCode||46==c.keyCode)d&&(t.blankField(d),t.fieldChange(d)),a.clearDateField(b)};a.clearDateField=function(b){"string"===typeof b&&(b=q(b));b&&(a.loadDatePicker(),$(b).datepicker("hide"),b.value="",b.id&&q(b.id+"__0")&&(q(b.id+"__0").value=""),b.blur())};a.lastButtonClickedName=!1;a.lastButtonClickedValue=!1;a.buttonClick=function(b){b.name?(a.lastButtonClickedName=b.name,a.lastButtonClickedValue=b.value):(a.lastButtonClickedName=
!1,a.lastButtonClickedValue=!1)};a.formatDate=function(b,c,d){if(!b)return"";var e,f=!1;try{if(b&&("number"==typeof b||"string"==typeof b)){var h=(""+b).length;if("number"==typeof b||1*b==1*b)b=new Date(1E3*b),f=!0;else{if("string"!=typeof b||10!=h&&19!=h)return"";var g=b.replace(/[:-]/g," ").split(" ");b=c&&19==h?new Date(1*g[0],1*g[1]-1,1*g[2],1*g[3],1*g[4],1*g[5]):new Date(1*g[0],1*g[1]-1,1*g[2])}}a.loadDatePicker();e=d?$.datepicker.formatDate(d,b):k.siteSettings&&k.siteSettings.organizer_date_format?
$.datepicker.formatDate(k.siteSettings.organizer_date_format,b):$.datepicker.formatDate("d M yy",b);if(c){var n=b.getHours();b.getMinutes();d=11<n;h="";switch(k.siteSettings&&k.siteSettings.vis_time_format||"%H:%i"){case "%H:%i":n=a.rightHandedSubStr("0"+n,2);break;case "%l:%i %p":n=n%12||12;h=d?k.phrase.pm:k.phrase.am;break;case "%h:%i %p":n=n%12||12,h=d?k.phrase.pm:k.phrase.am,n=a.rightHandedSubStr("0"+n,2)}e+=" "+n+":"+a.rightHandedSubStr("0"+b.getMinutes(),2);"datetime_with_seconds"==c&&(e+=":"+
a.rightHandedSubStr("0"+b.getSeconds(),2));h&&(e+=" "+h);f&&b.getTimezoneOffset()!=(new Date).getTimezoneOffset()&&(e=0<b.getTimezoneOffset()?e+(" (UCT -"+b.getTimezoneOffset()/60+")"):e+(" (UCT +"+b.getTimezoneOffset()/-60+")"))}return e}catch(l){return""}};a.tooltips=function(b,c){a.closeTooltip();b===m?(a.tooltips("a[title]",c),a.tooltips("img[title]",c),a.tooltips("area[title]",c),a.tooltips("input[title]",c)):(c||(c={}),c.tooltipClass===m&&(c.tooltipClass="zenario_visitor_tooltip"),c.show===
m&&(c.show={duration:750,easing:"zenarioLinearWithBigDelay"}),c.hide===m&&(c.hide=100),c.position===m&&(c.position={my:"center top+2",at:"center bottom",collision:"flipfit"}),c.content===m&&(c.content=function(){var a=this.title,b=this.title.indexOf("|");return-1!=b?"<h3>"+this.title.substr(0,b)+"</h3><p>"+this.title.substr(b+1)+"</p>":a}),$(".ui-tooltip").remove(),$(b).each(function(b,e){var f,h=$(e),g=h.attr("data-tooltip-options");if(g)try{f=$.extend(!0,{},c,JSON.parse(g))}catch(k){try{f=$.extend(!0,
{},c,JSON.parse(a.fixJSON(g)))}catch(l){f=c}}else f=c;f.position&&f.position.using===m&&(f.position.using=a.tooltipsUsing);h.jQueryTooltip(f)}))};a.tooltipsUsing=function(a,c){$(this).css(a).addClass("tooltip_"+c.vertical+"_"+c.horizontal);$("<span>").addClass("tooltip_arrow").appendTo(this)};a.closeTooltip=function(){q("tiptip_holder")&&(q("tiptip_holder").style.display="none");$("body > .mce-tooltip").remove()};a.fixJSON=function(b){var c,d,e;e=b.split("{");for(var f in e)if(a.has(e,f)){e[f]=e[f].split(",");
for(var h in e[f])if(a.has(e[f],h)){e[f][h]=e[f][h].split("}");for(var g in e[f][h])if(a.has(e[f][h],g)){e[f][h][g]=e[f][h][g].split(":");for(var k in e[f][h][g])a.has(e[f][h][g],k)&&(e[f][h][g][k]=e[f][h][g][k].replace(/^\s+/,"").replace(/\s+$/,""),0<(d=e[f][h][g][k].length)&&(b=e[f][h][g][k].substr(0,1),c=e[f][h][g][k].substr(d-1,1),'"'==b&&'"'==c||1*e[f][h][g][k]==e[f][h][g][k]||(e[f][h][g][k]="'"==b&&"'"==c?'"'+e[f][h][g][k].substr(1,d-2).replace(/\"/g,'\\"')+'"':'"'+e[f][h][g][k]+'"')));e[f][h][g]=
e[f][h][g].join(":")}e[f][h]=e[f][h].join("}")}e[f]=e[f].join(",")}return e=e.join("{")};a.javaScriptOnPage={};a.addPluginJavaScript=function(b,c){filePath="zenario/js/plugin.wrapper.js.php?ids="+b+"&v="+zenarioCSSJSVersionNumber;k.init&&(filePath+="&admin=1");if(c||!a.javaScriptOnPage[filePath])eval(a.nonAsyncAJAX(r+filePath)),a.javaScriptOnPage[filePath]=!0};a.captcha=function(b,c,d){d&&(RecaptchaOptions.callback=function(){a.captchaHideAudio()});l.Recaptcha?Recaptcha.create(b,c,RecaptchaOptions):
$.getScript(a.httpOrhttps()+"www.google.com/recaptcha/api/js/recaptcha_ajax.js",function(){Recaptcha.create(b,c,RecaptchaOptions)})};a.captchaHideAudio=function(){$(".recaptcha_only_if_image").attr("href","#").attr("title","").css("cursor","default");$(".recaptcha_only_if_image img").attr("alt","").attr("tooltip","").attr("src",$(".recaptcha_only_if_audio img").attr("src"))};a.rightHandedSubStr=function(b,c){return a.browserIsIE()?b.substr(b.length-c,c):b.substr(-c)};a.fireChangeEvent=function(a){if(a.fireEvent)a.fireEvent("onchange");
else{var c=p.createEvent("HTMLEvents");c.initEvent("change",!1,!0);a.dispatchEvent(c)}};a.stop=function(a){if(a=a||l.event)a.stopPropagation?a.stopPropagation():a.cancelBubble=!0;return!1};a.rev="";a.lastLoadNum=!1;a.checkSessionStorage=function(b,c,d,e){return a.checkLocalStorage(b,c,d,e,!0)};a.checkLocalStorage=function(b,c,d,e,f){a.checkLastUrl=b;if(a.browserIsIE(7))return!1;b+=a.urlRequest(c);if(-1!=b.indexOf("no_cache")){c=b.split(/&|\?/g);for(var h in c)if(a.has(c,h)&&("no_cache"==c[h]||"no_cache="==
c[h].substr(0,9)&&D(c[h].substr(9))))return!1}b=a.sGetItem(f,a.userId+"_"+a.adminId+"_"+b,d);if(!b)return!1;(d=a.sGetItem(f,"rev"))&&e&&a.lastLoadNum===e?a.rev=d:a.checkDataRevisionNumber(!1);a.lastLoadNum=e;if(d&&a.rev&&d==a.rev)return b;a.sClear(f);a.sSetItem(f,"rev",a.rev);return!1};a.setSessionStorage=function(b,c,d,e){a.setLocalStorage(b,c,d,e,!0)};a.setLocalStorage=function(b,c,d,e,f){if(a.browserIsIE(7))return!1;a.rev||a.checkDataRevisionNumber(!1);a.rev&&b&&(c+=a.urlRequest(d),a.sSetItem(f,
a.userId+"_"+a.adminId+"_"+c,b,e))};a.checkDataRevisionNumber=function(b){if(!t.tuix||"install"!=t.tuix.path){var c=r+"zenario/quick_ajax.php",d={_get_data_revision:1,admin:!!k.init};b?$.ajax({type:"POST",url:c,data:d,success:function(b){a.rev=b},dataType:"text"}):a.rev=a.nonAsyncAJAX(c,d)}};a.ls={l:{},s:{}};a.sClear=function(b){var c;b?(c="s",b=l.sessionStorage):(c="l",b=l.localStorage);a.canSetCookie&&b?b.clear():(delete a.ls[c],a.ls[c]={})};a.sSetItem=function(b,c,d,e,f){var h,g;b?(g="s",h=l.sessionStorage):
