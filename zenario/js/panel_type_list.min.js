...
c._dk1(!1)}};k.addExtraMergeFieldsForColumns=function(a,b){var d=b.id,e=c.panelPrefs(this.path,this.refiner);(d=e.colSizes&&e.colSizes[d]?Math.max(e.colSizes[d],c.columnWidths.xxsmall):this.tuix.columns[d].width)&&c.columnWidths[d]?d=c.columnWidths[d]:(d*=1)||(d=c.defaultColumnWidth);a.totalWidth&&(a.totalWidth+=c.columnSpacing);a.totalWidth+=d+c.columnPadding;b.width=d};k.addExtraMergeFieldsForCells=function(a,b,d,e){e.width=b.width};k.addExtraMergeFields=function(a){C(this.tuix.use_tall_rows)&&
(a.useTallRows=!0);C(this.tuix.two_line_list)&&(a.useTwoLine=!0)};k.setupListViewColumns=function(a){var b=this,d=a.find(".organizer_header");d.length&&a.scroll(function(){d.css("top",a.scrollTop())});var e=a.find(".organizer_sort_and_resize_wrapper"),q=a.find(".organizer_sort_and_resize_wrapper .organizer_sortable"),l=a.find(".organizer_sort_and_resize_wrapper .organizer_resizable"),p={},n={},t=function(){var f,g=$("#organizer_non_sortable_resizeable_cols").width();l.each(function(r,E){if(f=$(E).outerWidth())g+=
...
{attribute:"data-id"});for(e=m.length;0<=e;--e)""!==m[e]&&z(m[e])||m.splice(e,1);for(l in m)w(m,l)&&(e=m[l],n[e]=!0);for(l in c.searchedItems)w(c.searchedItems,l)&&(e=c.searchedItems[l],n[e]&&(u.push(e),t.push(b.tuix.items[e][d])));n=c._i1();n.ordinals={};for(l in m)w(m,l)&&(e=m[l],e!=u[l]&&(p+=(p?",":"")+e,n.ordinals[e]=t[l]));n.reorder=!0;n.id=p;n.dropped_item=$(q.item).data("id");q=B.ajaxURL("handleOrganizerPanelAJAX",b.tuix.reorder.class_name,c.path);delete B.rev;$.post(q,n,function(){c._131()})}})};
k.ordinalColumn=function(){return!y.zenarioOSelectMode&&this.tuix.reorder&&this.tuix.reorder.column}},zenarioO.panelTypes);
