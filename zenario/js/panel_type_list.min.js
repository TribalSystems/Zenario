...
function(a,b,c,d){d.width=b.width};d.addExtraMergeFields=function(a){x(this.tuix.use_tall_rows)&&(a.useTallRows=!0)};d.setupListViewColumns=function(a){var d=a.find(".organizer_header");d.length&&a.scroll(function(){d.css("top",a.scrollTop())});var c=this,l=a.find(".organizer_sort_and_resize_wrapper"),m=a.find(".organizer_sort_and_resize_wrapper .organizer_sortable"),e=a.find(".organizer_sort_and_resize_wrapper .organizer_resizable"),f={},n={},h=function(){var a,b=$("#organizer_non_sortable_resizeable_cols").width();
e.each(function(c,d){if(a=$(d).outerWidth())b+=a});$("#organizer_list_view").css("min-width",b+"px");$("#organizer_list_view .organizer_row").css("min-width",b+"px")},q=function(b,d){c.saveScrollPosition(a);m.each(function(a,b){var c=b.id;if(c){f[c]||(f[c]=$("."+c+"__cell"));var d=1*$(b).position().left-n[c];f[c].css("left",d+"px")}});c.restoreScrollPosition(a)},r=function(d,e,g){c.saveScrollPosition(a);if(d=$(e.element).attr("id"))f[d]||(f[d]=$("."+d+"__cell")),g?b.resizeColumn(d.replace("organizer_column__",
""),e.element.width()):(l.css("width","auto"),f[d].width(e.element.width()),h());c.restoreScrollPosition(a)};e.resizable({handles:"e",minWidth:b.columnWidths.xxsmall,start:function(a,c){b.resizingColumn=!0},resize:r,stop:function(a,c){r(a,c,!0);setTimeout(function(){delete b.resizingColumn},50)}});l.sortable({containment:"parent",items:".organizer_sortable",start:function(a,c){b.sortingColumn=!0},sort:q,stop:function(d,e){c.saveScrollPosition(a);q(d,e);setTimeout(function(){delete b.sortingColumn},
50);var f=l.sortable("toArray"),g;for(g in f)p.has(f,g)&&(f[g]=f[g].replace("organizer_column__",""));b.switchColumnOrder(f);c.restoreScrollPosition(a)}});h();m.each(function(a,b){b.id&&(n[b.id]=1*$(b).position().left)})};d.setupReordering=function(a){var d=this,c=d.ordinalColumn();c&&this.searchTerm===s&&a.find("#organizer_items_wrapper").sortable({opacity:0.8,cancel:".organizer_slidedown_view,input,textarea,button,select,option",start:function(){d.closeInspectionView();b.disableInteraction()},stop:function(l,
m){b.enableInteraction();var e,f,n="",h={},q=[],r=[],k=a.find("#organizer_items_wrapper").sortable("toArray",{attribute:"data-id"});for(e=k.length;0<=e;--e)""!==k[e]&&k[e]!==s||k.splice(e,1);for(f in k)p.has(k,f)&&(e=k[f],h[e]=!0);for(f in b.searchedItems)p.has(b.searchedItems,f)&&(e=b.searchedItems[f],h[e]&&(r.push(e),q.push(d.tuix.items[e][c])));h=b.getKey();h.ordinals={};for(f in k)p.has(k,f)&&(e=k[f],e!=r[f]&&(n+=(n?",":"")+e,h.ordinals[e]=q[f]));h.reorder=!0;h.id=n;h.dropped_item=$(m.item).data("id");
e="zenario/ajax.php?__pluginClassName__="+d.tuix.reorder.class_name+"&__path__="+b.path+"&method_call=handleOrganizerPanelAJAX";delete p.rev;$.post(v+e,h,function(){b.reload()})}})};d.ordinalColumn=function(){return!w.zenarioOSelectMode&&this.tuix.reorder&&this.tuix.reorder.column}},zenarioO.panelTypes);
