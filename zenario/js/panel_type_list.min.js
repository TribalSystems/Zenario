...
h)&&(f[h]=f[h].r("organizer_column__",""));c._sCO(f);b.restoreScrollPosition(a)}});t();q.each(function(f,g){g.id&&(n[g.id]=1*$(g).position().left)})};k.setupReordering=function(a){var b=this,d=b.ordinalColumn();d&&!z(b.searchTerm)&&a.find("#organizer_items_wrapper").sortable({opacity:.8,cancel:".organizer_slidedown_view,input,textarea,button,select,option",start:function(){b.closeInspectionView();c._dI()},stop:function(e,q){c._eI();var l,p="",n={},t=[],u=[],m=a.find("#organizer_items_wrapper").sortable("toArray",
{attribute:"data-id"});for(e=m.length;0<=e;--e)""!==m[e]&&z(m[e])||m.splice(e,1);for(l in m)w(m,l)&&(e=m[l],n[e]=!0);for(l in c.searchedItems)w(c.searchedItems,l)&&(e=c.searchedItems[l],n[e]&&(u.push(e),t.push(b.tuix.items[e][d])));n=c._gK();n.ordinals={};for(l in m)w(m,l)&&(e=m[l],e!=u[l]&&(p+=(p?",":"")+e,n.ordinals[e]=t[l]));n.reorder=!0;n.id=p;n.dropped_item=$(q.item).data("id");q="zenario/ajax.php?__pluginClassName__="+b.tuix.reorder.class_name+"&__path__="+c.path+"&method_call=handleOrganizerPanelAJAX";
delete D.rev;$.post(C+q,n,function(){c._r()})}})};k.ordinalColumn=function(){return!y.zenarioOSelectMode&&this.tuix.reorder&&this.tuix.reorder.column}},zenarioO.panelTypes);
