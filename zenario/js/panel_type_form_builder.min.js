...
c.label=datasetField.label,c.dataset_field_id=a,c.lov=datasetField.lov):(c.type=b,c.name="Untitled "+this.getFieldReadableType(c.type).toLowerCase());if(!c.lov&&-1<$.inArray(c.type,["checkboxes","radios","select"]))for(c.lov={},b=1;3>=b;b++)a="t"+this.maxNewCustomFieldValue++,c.lov[a]={is_new_value:!0,id:a,ord:b,label:"Option "+b};else if(a||"centralised_radios"!=c.type&&"centralised_select"!=c.type)"page_break"==c.type?(c.next_button_text="Next",c.previous_button_text="Previous",c.name="Page break "+
