...
this.changesSaved&&(this.changesSaved=!1,y._t({message_type:"success",message:"Your changes have been saved!"}))};k.fixTUIXData=function(){for(var d=this.getOrderedPages(),a=0;a<d.length;a++){var c=this.getItem("page",d[a].id);c.visible_condition_checkboxes_field_value&&(c.visible_condition_checkboxes_field_value=z._tTA(c.visible_condition_checkboxes_field_value));c=this.getOrderedFields(c.id);for(var b=0;b<c.length;b++){var e=this.getItem("field",c[b].id);"calculated"==e.type&&e.calculation_code&&
(e.calculation_code=z._tTA(e.calculation_code));e.invalid_responses&&(e.invalid_responses=z._tTA(e.invalid_responses));e.visible_condition_checkboxes_field_value&&(e.visible_condition_checkboxes_field_value=z._tTA(e.visible_condition_checkboxes_field_value));e.mandatory_condition_checkboxes_field_value&&(e.mandatory_condition_checkboxes_field_value=z._tTA(e.mandatory_condition_checkboxes_field_value))}}};k.getMainPanelHTML=function(){return this.microTemplate("zenario_organizer_form_builder",{form_title:this.tuix.form_title})};
...
f?this.clickField(f):this.loadNewFieldsPanel()};k.addTUIXTabEvents=function(d,a,c){var b=this,e=b.getItem(d,a),f=b.tuix[b.getTUIXModeForItemType(d)];if("page"==d)$("#organizer_remove_form_page").on("click",function(g){g="<p>Are you sure you want to delete this step?</p>";e.fields.length&&(g+="<p>All fields on this page will be moved onto the previous page.</p>");y._flBo(g,"Delete","warning",!0,!1,l,l,function(){b.deletePage(a)})});else if("field"==d)if("details"==c)$("#field__label").on("keyup",function(){$("#organizer_form_field_"+
...
!_._isEm(a.visible_condition_checkboxes_field_value)||""==a.mandatory_condition_field_value&&_._isEm(a.visible_condition_checkboxes_field_value)||!_.contains(a.visible_condition_checkboxes_field_value,a.mandatory_condition_field_value))error=1;break;case "mandatory_if":""==a.mandatory_condition_field_value?error=1:a.visible_condition_checkboxes_field_value&&(error=_.contains(a.visible_condition_checkboxes_field_value,a.mandatory_condition_field_value)?0:1)}1==error&&(b.tabs[c].fields.visibility.error=
"A field cannot be mandatory while hidden. If this field is both mandatory and visible on a condition, both fields and values must be the same.")}else if("mandatory_if_one_of"==a.mandatory_condition_field_type)if(error=0,_._isEm(a.mandatory_condition_checkboxes_field_value)&&""!=a.mandatory_condition_field_id)b.tabs[c].fields.mandatory_condition_field_value.error="Please select a checkbox for mandatory condition.";else{if("visible"==a.visibility)error=0;else if(a.visible_condition_field_id!=a.mandatory_condition_field_id)error=
1;else switch(a.visible_condition_field_type){case "visible_if_one_of":if(""!=a.visible_condition_checkboxes_field_value&&a.mandatory_condition_checkboxes_field_value)for(e=0;e<a.mandatory_condition_checkboxes_field_value.length;e++)if(!_.contains(a.visible_condition_checkboxes_field_value,a.mandatory_condition_checkboxes_field_value[e])){error=1;break}break;case "visible_if_not":if(""==a.visible_condition_field_value&&!_._isEm(a.mandatory_condition_checkboxes_field_value)||""==a.visible_condition_field_value&&
_._isEm(a.mandatory_condition_checkboxes_field_value)||_.contains(a.mandatory_condition_checkboxes_field_value,a.visible_condition_field_value))error=1;break;case "visible_if":if(""!=a.visible_condition_field_value)if(a.mandatory_condition_checkboxes_field_value&&1!=a.mandatory_condition_checkboxes_field_value.length)error=1;else if(a.mandatory_condition_checkboxes_field_value)for(e=0;e<a.mandatory_condition_checkboxes_field_value.length;e++)if(a.mandatory_condition_checkboxes_field_value[e]!=a.visible_condition_field_value){error=
...
case "attachment":return"Attachment";case "page_break":return"Step";case "section_description":return"Subheading";case "section_spacer":return"Spacer";case "calculated":return"Calculated";case "restatement":return"Mirror";case "repeat_start":return"Start of repeating section";case "repeat_end":return"End of repeating section";case "document_upload":return"Multi-upload";case "sortable_selection":return"Sortable selection";default:return"Unknown";case "group":return"Group";case "consent":return"Consent";
case "file_picker":return"File picker"}};k.getCalculationCodeDisplay=function(d){var a="";if(d)for(var c=!1,b=0;b<d.length;b++){c||"parentheses_close"==d[b].type?c&&(c=!1):a+=" ";switch(d[b].type){case "operation_addition":a+="+";break;case "operation_subtraction":a+="-";break;case "operation_multiplication":a+="\u00d7";break;case "operation_division":a+="\u00f7";break;case "parentheses_open":a+="(";c=!0;break;case "parentheses_close":a+=")";break;case "static_value":a+=d[b].value;break;case "field":var e=
this.getItem("field",d[b].value);a+='"'+(e?e.name:"UNKNOWN FIELD")+'"'}a=a.trim()}return a};k.calculationAdminBoxAddSomthing=function(d,a){var c=!1;switch(d){case "operation_addition":case "operation_subtraction":case "operation_multiplication":case "operation_division":case "parentheses_open":case "parentheses_close":c={type:d};break;case "static_value":""===a||isNaN(+a)||(c={type:d,value:+a},$("#static_value").val(""));break;case "field":c={type:d,value:a},$("#numeric_field").val("")}c&&(d=[],$("#calculation_code").val()&&
(d=JSON.parse($("#calculation_code").val())),d.push(c),$("#calculation_code").val(JSON.stringify(d)),this.calculationAdminBoxUpdateDisplay(d))};k.calculationAdminBoxDelete=function(){var d=[];$("#calculation_code").val()&&(d=JSON.parse($("#calculation_code").val()))&&(d.pop(),$("#calculation_code").val(JSON.stringify(d)));this.calculationAdminBoxUpdateDisplay(d)};k.calculationAdminBoxUpdateDisplay=function(d){d=this.getCalculationCodeDisplay(d);$("#zenario_calculation_display").text(d)};k.openFormSettings=
function(){var d=this;D.open("zenario_user_form",{id:A.pi.refiner.id},l,l,function(a,c){a="";c.details.show_title&&(a=c.details.title);d.tuix.title=a;$("#organizer_form_builder .form_outer .form_header h5").text(a)})};k.changeMadeToPanel=function(){this.changeMadeOnPanel||(this.changeMadeOnPanel=!0,q.onbeforeunload=function(){return"You are currently editing this form. If you leave now you will lose any unsaved changes."},A._dI("Please either save your changes, or click Reset to discard them, before exiting the form editor."),
A._sB())};k.saveChanges=function(){var d=this;if(d.tuix.not_used_or_on_public_page){for(var a=!1,c=!1,b=d.getOrderedFields(),e=0;e<b.length;e++)b[e].dataset_field_id&&("email"==b[e].db_column?c=!0:a=!0);if(a&&!c&&!confirm("Warning: this form contains fields that are linked to the Users Dataset, but doesn't contain the Email field from the Users Dataset.\n\nIf this form is used on a public web page by anonymous visitors, form responses will not be stored in the Users & Contacts database table.\n\nTo overcome this, please add the Email field linked to the Users Dataset.\n\nSave anyway?"))return}a=
{mode:"save",pages:JSON.stringify(d.tuix.pages),fields:JSON.stringify(d.tuix.items),fieldsTUIX:JSON.stringify(d.tuix.form_field_details),pagesReordered:d.pagesReordered,deletedPages:JSON.stringify(d.deletedPages),deletedFields:JSON.stringify(d.deletedFields),deletedValues:JSON.stringify(d.deletedValues),currentPageId:d.currentPageId,editingThing:d.editingThing,editingThingId:d.editingThingId};y._nDS("saving",!0);d.sendAJAXRequest(a,function(f){y._nDS();if(f){if(f.errors){for(var g="",h=0;h<f.errors.length;h++)g+=
f.errors[h]+"<br>";g&&y._flBo(g)}d.currentPageId=f.currentPageId;d.editingThing=f.editingThing;d.editingThingId=f.editingThingId}q.onbeforeunload=!1;A._eI();d.changeMadeOnPanel=!1;d.changesSaved=!0;A._r()})}},zenarioO.panelTypes);
