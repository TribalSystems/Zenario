...
this.globalName+".meMarkChanged('"+s(d)+"', this.value, '"+s(e.value)+"');");r["class"]+="input_"+e.type;if("select"==e.type)e.slider&&(v=!0,c+=this.drawSlider(a,d,e,m,!0)),c+="<select";else if("textarea"==e.type)c+="<textarea";else if("code_editor"==e.type)c+="<div",r["class"]=" zenario_embedded_ace_editor",console.log(e),a.after(function(){var a=ace.edit(d);a.session.setUseSoftTabs(!1);a.setShowPrintMargin(!1);m&&(a.setReadOnly(!0),a.setBehavioursEnabled(!1));p(e.wrap_text)&&a.session.setUseWrapMode(!0);
a.session.setOption("useWorker",!1);if(language=e.language)try{language=language.match(/\.twig\.html$/i)?"ace/mode/twig":language.match(/\./)?ace.require("ace/ext/modelist").getModeForPath(language).mode:"ace/mode/"+language,a.session.setMode(language)}catch(b){console.log("Ace editor could not load that language",language)}});else if("color_picker"==e.type||"colour_picker"==e.type)c+="<input",r["class"]=" zenario_color_picker",a.after(function(){var a=e.color_picker_options||e.colour_picker_options||
{};a.disabled=m;a.preferredFormat=a.preferredFormat||"hex";$(l(d)).spectrum(a)});else if("editor"==e.type){c+="<textarea";q.getSkinDesc();var J;f={script_url:H+q.tinyMCEPath,inline:!1,menubar:!1,statusbar:!1,plugins:"autoresize",document_base_url:h,convert_urls:!1,readonly:!0,inline_styles:!1,allow_events:!0,allow_script_urls:!0,autoresize_max_height:Math.max(Math.floor(0.5*$(L).height()),300),onchange_callback:function(a){B.fieldChange(a.id)},init_instance_callback:function(a){q.enableDragDropUploadInTinyMCE(!1,
h,l("row__"+x(a.editorId,a.id)));var b;(b=a.editorContainer)&&(b=$("#"+a.editorContainer.id+" iframe"))&&(b=b[0])&&(b=b.contentWindow)&&q.enableDragDropUploadInTinyMCE(!1,h,b)}};b=_.extend({},f,{plugins:["advlist autolink lists link image charmap hr anchor","searchreplace code fullscreen","nonbreaking table contextmenu directionality","paste autoresize"],image_advtab:!0,visual_table_class:" ",browser_spellcheck:!0,paste_preprocess:q.tinyMCEPasteRreprocess,readonly:!1,convert_urls:!0,relative_urls:!1,
content_css:h,toolbar:"undo redo | bold italic | removeformat | fontsizeselect | formatselect | numlist bullist | outdent indent | code",style_formats:q.skinDesc.style_formats,oninit:h});t=_.extend({},b,{toolbar:"undo redo | image link unlink | bold italic | removeformat | fontsizeselect | formatselect | numlist bullist | outdent indent | code",file_browser_callback:q.fileBrowser,init_instance_callback:function(a){q.enableDragDropUploadInTinyMCE(!0,H,l("row__"+x(a.editorId,a.id)));var b;(b=a.editorContainer)&&
(b=$("#"+a.editorContainer.id+" iframe"))&&(b=b[0])&&(b=b.contentWindow)&&q.enableDragDropUploadInTinyMCE(!0,H,b)}});u=_.extend({},t,{toolbar:"undo redo | image | bold italic | removeformat | fontsizeselect | formatselect | numlist bullist | outdent indent | code"});var K=_.extend({},u,{toolbar:"undo redo | link unlink | bold italic | removeformat | fontsizeselect | formatselect | numlist bullist | outdent indent | code"});m?(J=f,r["class"]=" tinymce_readonly"):e.insert_image_button?e.insert_link_button?
(J=t,r["class"]=" tinymce_with_images_and_links"):(J=u,r["class"]=" tinymce_with_images"):e.insert_link_button?(J=K,r["class"]=" tinymce_with_links"):(J=b,r["class"]=" tinymce");r.style="visibility: hidden;";_.isObject(e.editor_options)&&(J=_.extend(J,e.editor_options));a.after(function(){var a=$(l(d)),b=l("zenario_abtab"),c=b.style.display;b.style.display="block";a.tinymce(J);b.style.display=c})}else if("submit"==e.type||"toggle"==e.type){c+="<input";r.type="button";if(!m||p(e.can_be_pressed_in_view_mode))E.onclick=
this.globalName+".clickButton(this, '"+d+"');",delete r.disabled;"submit"==e.type&&(this.tuix.tabs[b].fields[d].pressed=!1);"toggle"==e.type&&(r["class"]+=this.tuix.tabs[b].fields[d].pressed?" pressed":" not_pressed")}else"date"==e.type||"datetime"==e.type?(c+="<input",r.type="text",r["class"]+=" zenario_datepicker",p(e.change_month_and_year)&&(r["class"]+=" zenario_datepicker_change_month_and_year"),r.readonly="readonly",m||(r.onkeyup=x(r.onkeyup,"","")+"zenario.dateFieldKeyUp(this, event, '"+s(d)+
"');")):"url"==e.type?(c+="<input",r.type="url",r.onfocus=x(r.onfocus,"","")+"if(!this.value) this.value = 'http://';",r.onblur=x(r.onblur,"","")+"if(this.value == 'http://') this.value = '';"):(e.slider&&(v=!0,c+=this.drawSlider(a,d,e,m,!0)),c+="<input",r.type=e.type,F=!0);if("checkbox"==e.type||"radio"==e.type)p(k)&&(r.checked="checked"),k=h,p(e.indeterminate)&&a.after(function(){var a;if(a=l(d))a.indeterminate=!0});v&&(r.onchange=x(r.onchange,"","")+"$('#zenario_slider_for__"+d+"').slider('value', $(this).val());",
r.onkeyup=x(r.onkeyup,"","")+"$('#zenario_slider_for__"+d+"').slider('value', $(this).val());");f=e;g===h?f.id=d:(f=$.extend({},f,z),f.id=d+"___"+g,r["class"]+=" control_for__"+d);"radio"==f.type&&f.name||(f.name=d);for(var w in f)if(n.has(f,w)&&I[w])if("disabled"==w||"readonly"==w){if(p(r[w])||p(f[w]))c+=" "+w+'="'+w+'"'}else c+=" "+w+'="',r[w]&&(c+=r[w]+" ",delete r[w]),c+=s(f[w]),E[w]&&(c+=" "+E[w],delete E[w]),c+='"';for(w in r)n.has(r,w)&&(c+=" "+w+'="'+s(r[w]),E[w]&&(c+=" "+E[w],delete E[w]),
c+='"');for(w in E)n.has(E,w)&&(c+=" "+w+'="'+s(E[w])+'"');"select"==e.type?c+=">":"textarea"==e.type||"editor"==e.type?c+=">"+s(k,!1,"asis")+"</textarea>":"code_editor"==e.type?c+=">"+s(k,!1,"asis")+"</div>":"date"==e.type||"datetime"==e.type?(c+=' value="'+s(n.formatDate(k,"datetime"==e.type))+'"/>',c+='<input type="hidden" id="_value_for__'+s(d)+'" value="'+s(k)+'"/>',m||(c+='<input type="button" class="zenario_remove_date" value="x" onclick="'+this.globalName+".blankField('"+s(d)+"'); $(zenario.get('"+
s(d)+"')).change();\"/>")):c=k!==h?c+(' value="'+s(k,!1,"asis")+'"/>'):c+"/>";if("select"==e.type)e.empty_value&&(c+='<option value="">'+s(e.empty_value)+"</option>"),e.values&&(c+=this.hierarchicalSelect(k,e,A,D,G)),c+="</select>";else if(F&&e.values&&!m){var M=[];for(y in A)n.has(A,y)&&(t=A[y],M.push({label:e.values[t],value:t}));a.after(function(){var a=$(l(d)),b={source:M,minLength:0,appendTo:a.parent()};e.return_key_presses_button&&(b.select=function(){setTimeout(function(){$("#"+e.return_key_presses_button).click()},
0)});a.autocomplete(b);a.focus(function(){a.autocomplete("widget").is(":visible")||a.autocomplete("search","")})})}}g===h&&("url"!=e.type||m||(c+='&nbsp; <input type="button" class="submit" value="Test" onclick="if (get(\''+s(d)+"').value) window.open(zenario.addBasePath(get('"+s(d)+"').value));\"/>"),e.post_field_label!==h&&(c+='<label for="'+s(d)+'" id="label_for__'+s(d)+'"> '+s(e.post_field_label)+"</label>"),e.post_field_html!==h&&(c+=e.post_field_html),v&&(c+=this.drawSlider(a,d,e,m,!1)));return c};
f.hierarchicalSelect=function(a,b,d,c,g,e){var k="",m,f,l,q,z;for(q in d)n.has(d,q)&&(z=d[q],l=b.values[z],f=m="",_.isString(l)?l={label:l}:p(l.disabled)&&(m=' disabled="disabled"'),z==a&&(f=' selected="selected"'),e===h&&c&&g[z]?k+='<optgroup label="'+s(l,!1,!0)+'"'+m+">"+this.hierarchicalSelect(a,b,d,c,g,z)+"</optgroup>":e===l.parent&&(k+='<option value="'+s(z)+'"'+f+m+">"+s(l,!1,!0)+"</option>"));return k};f.chooseFromDropbox=function(a){var b=this,d;if(!this.tuix.tabs[this.tuix.tab]||!(d=this.tuix.tabs[this.tuix.tab].fields[a])||
!d.upload)return!1;d={cancel:function(){q.hideAJAXLoader()},linkType:"direct",multiselect:!!p(d.upload.multi),extensions:d.upload.extensions?_.toArray(d.upload.extensions):h,success:function(c){q.showAJAXLoader();var d,e,k=new n.callback;for(d in c)n.has(c,d)&&(e=c[d],k.add(n.ajax("zenario/ajax.php?method_call=handleAdminBoxAJAX&fetchFromDropbox=1",e,!0)));k.after(function(){var c,d,e,g,k;if(!b.tuix.tabs[b.tuix.tab]||!(e=b.tuix.tabs[b.tuix.tab].fields[a])||!e.upload)return!1;g=e.current_value===h?
e.value:e.current_value;k=p(e.upload.multi);for(c in arguments)n.has(arguments,c)&&(d=arguments[c])&&d.id&&(g=k&&g?g+(","+d.id):d.id);q.hideAJAXLoader();b.redrawPickedItems(a,e,g)})}};q.showAJAXLoader();Dropbox.choose(d)};f.upload=function(a,b){var d=this,c;if(!this.tuix.tabs[this.tuix.tab]||!(c=this.tuix.tabs[this.tuix.tab].fields[a])||!c.upload)return!1;c={class_name:c.class_name,upload:c.upload};this.uploadCallback=function(b){if(b){var c,k,m,f,l;if(!d.tuix.tabs[d.tuix.tab]||!(m=d.tuix.tabs[d.tuix.tab].fields[a])||
!m.upload)return!1;f=m.current_value===h?m.value:m.current_value;l=p(m.upload.multi);for(c in b)n.has(b,c)&&(k=b[c])&&k.id&&(f=l&&f?f+(","+k.id):k.id);d.redrawPickedItems(a,m,f)}};b?q.setHTML5UploadFromDragDrop(H+"zenario/ajax.php?method_call=handleAdminBoxAJAX",{fileUpload:1},!1,this.uploadCallback,l("zenario_fbAdminInner")):q.action(this,c,h,h,h,{fileUpload:1})};f.uploadComplete=function(a){this.uploadCallback!==h&&this.uploadCallback(a);delete this.uploadCallback};f.drawSlider=function(a,b,d,c,
g){var e=this,k=_.clone(d.slider);d="";if(p(k.before_field)?g:!g)c&&(d+='<div class="ui-disabled">'),d+='<div id="zenario_slider_for__'+s(b)+'" class="'+s(k["class"])+'" style="'+s(k.style)+'"></div>',c&&(d+="</div>"),a.after(function(){var a;if(a=l("zenario_slider_for__"+b))k.min!==h&&(k.min*=1),k.max!==h&&(k.max*=1),k.step!==h&&(k.step*=1),k.disabled=!e.editModeOn(),k.value=$(l(b)).val(),k.slide=function(a,c){$(l(b)).val(c.value)},k.change=function(a,b){e&&e.id&&e.fieldChange(e.id.replace("zenario_slider_for__",
""))},$(a).slider(k)});return d};f.pickedItemsArray=function(a,b){if(!1===b||null===b||b===h||!(0!==b&&"0"!==b||a.values&&(a.values[0]||a.values["0"])))return{};var d=(b+"").split(","),c={},g,e,k,f;a._display_value=!1;for(k in d)n.has(d,k)&&(f=d[k])&&(a.upload&&(e=n.decodeItemIdForStorekeeper(f))&&(e=e.split("/"))&&e[1]?(c[f]=e[1],p(e[2])&&p(e[3])&&(c[f]+=" ["+e[2]+" \u00d7 "+e[3]+"px]")):a.values&&a.values[f]&&"string"==typeof a.values[f]?c[f]=a.values[f]:a.values&&a.values[f]&&a.values[f].label?
c[f]=a.values[f].label:a.pick_items&&(a.pick_items.target_path&&(g=q.getSKItem(a.pick_items.target_path,f))||a.pick_items.path&&a.pick_items.path!=a.pick_items.target_path&&-1==a.pick_items.path.indexOf("//")&&(g=q.getSKItem(a.pick_items.path,f)))?(a.values||(a.values={}),a.values[f]=c[f]=q.formatSKItemName(g,f)):a.upload&&f==1*f&&(e=q.lookupFileDetails(f))?(a.values||(a.values={}),c[f]=e.filename,p(e.width)&&p(e.height)&&(c[f]+=" ["+e.width+" \u00d7 "+e.height+"px]"),a.values[f]=c[f]):c[f]=f,!1===
a._display_value&&(a._display_value=c[f]));return c};f.pickedItemsValue=function(a){var b,d="";if(a)for(b in a)n.has(a,b)&&(d+=(""===d?"":",")+b);return d};f.hierarchicalBoxes=function(a,b,d,c,g,e,f,m,N,A,x,z,B){var C=1;if(!B)B=0,C=1*g.cols||1;else if(10<B)return"";z||(z={});x&&(z[x]=!0);var y=0,t="",u,v,r;B&&(t+='<div class="zenario_hierarchical_box_children" id="'+s("children_for___"+d+"___"+x)+'">');for(var E in N)if(n.has(N,E)){u={};v=N[E];v==1*v&&(v*=1);var F=h;r="object"==typeof g.values[v]?
g.values[v]:{label:g.values[v]};g.tag_colors&&(u.tag_color=g.tag_colors[v]||"blue");F=r.parent;"0"===F&&(F=!1);if(!x&&!F||x==F){if(u.newRow=++y>C)y=1;u.col=y;u.cols=C;F=c?!0===c||1===c||"1"===c?!0===v||1===v||"1"===v:f?f[v]!==h?!0:!1:v==c:!v;if("checkboxes"==g.type&&p(g.checking_child_checks_parents)){var D="";x&&(D+="if (this.checked) { for (var cb in "+JSON.stringify(z)+") { get('"+s(d)+"___' + cb).checked = true; } } ");A[v]&&(D+="if (!this.checked) { $('#children_for___' + this.id + ' input').attr('checked', false); } ");
D?e.onchange=g.onchange?D+" "+g.onchange:D:g.onchange?e.onchange=g.onchange:delete e.onchange}else"checkboxes"==g.type&&p(g.checking_parent_checks_children)&&(D="",A[v]&&(D+="if (this.checked) { $('#children_for___' + this.id + ' input').each(function(i, el) {el.checked = true;}) }; "),D?e.onchange=g.onchange?D+" "+g.onchange:D:g.onchange?e.onchange=g.onchange:delete e.onchange);u.lovId=d+"___"+v;u.lovField=r;g.indeterminates&&p(g.indeterminates[v])&&function(b){a.after(function(){var a;if(a=l(b))a.indeterminate=
!0})}(u.lovId);u.lovHTML=this.drawField(a,b,d,!0,v,e,F,!1,m,N,A,r);u.childrenHTML="";A[v]&&(u.childrenHTML=this.hierarchicalBoxes(a,b,d,c,g,e,f,m,N,A,v,_.extend({},z),B+1),y=0);t+=q.microTemplate("zenario_admin_box_radio_or_checkbox",u)}}B&&(t+="</div>");return t};f.drawPickedItems=function(a,b,d,c){c===h&&(c=this.tuix.tab);var g=this.tuix.tabs[c].fields[a],e=!1,f,m=this.value(a,c,b),l=this.pickedItemsArray(g,m);c=g.upload&&p(g.upload.reorder_items);var s=1*g.cols||1,G=0;for(f in l)if(n.has(l,f)){e=
!0;break}if(e){var e=[],z=[];if(c)for(f in m=m.split(","),m)n.has(m,f)&&z.push([m[f],l[m[f]]]);else{for(f in l)n.has(l,f)&&z.push([f,l[f]]);z.sort(q.sortArray)}for(f=0;f<z.length;++f){var l=z[f][0],B=z[f][1],I=l==1*l,y,t,m={id:a,item:l,label:B,first:0==f,last:f==z.length-1,readOnly:b,tempReadOnly:d};if(m.newRow=++G>s)G=1;m.col=G;m.cols=s;g.tag_colors&&(m.tag_color=g.tag_colors[l]||"blue");!g.pick_items||g.upload&&!I||!(t=g.pick_items.path)||t!=g.pick_items.target_path&&g.pick_items.min_path!=g.pick_items.target_path||
(t="//"==n.rightHandedSubStr(t,2)?t+l:"/"==n.rightHandedSubStr(t,1)?t+("/"+l):t+("//"+l),m.organizerPath=t);g.upload&&(m.isUpload=!0,y=(y=(""+B).match(/(.*?)\.(\w+)$/)||(""+B).match(/(.*?)\.(\w+) \[.*\]$/))&&y[2]?y[2].toLowerCase():"unknown",m.extension=y,I=I?H+"zenario/file.php?id="+l:H+"zenario/file.php?getUploadedFileInCacheDir="+encodeURIComponent(l),y.match(/gif|jpg|jpeg|png/)?(m.thumbnail={onclick:this.globalName+".showPickedItemInPopout('"+I+"&popout=1&dummy_filename="+encodeURIComponent("image."+
y)+"', '"+B+"');",src:I+"&og=1"},(B=(""+B).match(/.*\[\s*(\d+)p?x?\s*[\u00d7x]\s*(\d+)p?x?\s*\]$/))&&B[1]&&B[2]&&q.resizeImage(B[1],B[2],180,120,m.thumbnail)):m.adminDownload=I+"&adminDownload=1",c&&(m.first||(m.nudgeUp={onclick:this.globalName+".nudge('"+K(a)+"', "+(f-1)+", "+f+");"}),m.last||(m.nudgeDown={onclick:this.globalName+".nudge('"+K(a)+"', "+f+", "+(f+1)+");"})));b||g.pick_items&&p(g.pick_items.hide_remove_button)||(m.removeButton={onclick:this.globalName+".removePickedItem('"+K(a)+"', '"+
K(l)+"');"});e.push(m)}}else e={readOnly:b,tempReadOnly:d,noItemSelected:!0,nothing_selected_phrase:x(g.pick_items&&g.pick_items.nothing_selected_phrase,C.nothing_selected)};return q.microTemplate(this.mtPrefix+"_picked_item",e)};f.showPickedItemInPopout=function(a,b){q.action(this,{popout:{href:a,title:b,css_class:"zenario_show_colobox_above_fab"}})};f.pickItems=function(a){if(!this.tuix.tabs[this.tuix.tab]||!this.tuix.tabs[this.tuix.tab].fields[a])return!1;var b=this.tuix.tabs[this.tuix.tab].fields[a],
d,c;if(!(b.pick_items&&b.pick_items.path&&b.pick_items.min_path&&b.pick_items.target_path))return!1;c=b.pick_items.path;p(b.pick_items.multiple_select)||c!=b.pick_items.target_path&&b.pick_items.min_path!=b.pick_items.target_path||!(d=this.readField(a))||-1!=d.indexOf(",")||(c="//"==n.rightHandedSubStr(c,2)?c+d:"/"==n.rightHandedSubStr(c,1)?c+("/"+d):c+("//"+d));this.SKTarget=a;q.organizerSelect(this.globalName,"setPickedItems",b.pick_items.multiple_select,c,b.pick_items.target_path,b.pick_items.min_path,
b.pick_items.max_path,b.pick_items.disallow_refiners_looping_on_min_path,h,b.pick_items.one_to_one_choose_phrase,b.pick_items.one_to_many_choose_phrase,h,!0,h,h,h,h,h,h,h,h,b.pick_items)};f.setPickedItems=function(a,b,d,c){a=this.SKTarget;var f;values={};for(f in b._items)n.has(b._items,f)&&(d=n.decodeItemIdForStorekeeper(f),values[d]=q.formatSKItemName(c,f));this.addToPickedItems(values,a)};f.addToPickedItems=function(a,b,d){d||(d=this.tuix.tab);d=this.tuix.tabs[d].fields[b];var c=d.current_value===
h?d.value:d.current_value,f,e,k;if(_.isString(a))for(f in k=a.split(","),a={},k)n.has(k,f)&&(e=k[f],a[e]=e);c=p(d.pick_items.multiple_select)&&c?this.pickedItemsArray(d,c):{};for(e in a)if(n.has(a,e)&&(f=a[e],d.values||(d.values={}),d.values[e]||(d.values[e]=f),c[e]=!0,!p(d.pick_items.multiple_select)))break;this.redrawPickedItems(b,d,c)};f.removePickedItem=function(a,b){var d=this.tuix.tabs[this.tuix.tab].fields[a],c=d.current_value===h?d.value:d.current_value,c=c.split(","),f;for(f in c)if(n.has(c,
