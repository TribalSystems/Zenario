zenario.lib(function(h,Z,S,fa,Aa,Ba,q,F,K,Ca,Ja,aa,T,Da,p,H,W,Q,Ka,Ea,u,Fa,La,M,ba,ia,Ma,Na,N,Oa,Pa,Qa,Ra,Sa,Ta,Ua,Va,Wa,Ga,Ha){K.lib(function(ga,ja,f,ha,ta,qa,Aa,Ba,X,R,C,ca,I,la,ua){f=Ea(Fa);f.init=function(a,e,d){this.globalName=a;this.mtPrefix=e;this.containerId=d;this.baseCSSClass="";this.onKeyUpNum=0;Ca.sizing=!1;this.cachedAJAXSnippets={};this.changed={};this.toggleLevelsPressed={};this.fieldThatTriggeredRedraw=this.lastFieldInFocus=!1;this.editingPositions={}};f.get=function(a){return this.containerId&&
$("#"+this.containerId+" #"+q._cE(a))[0]||Da(a)};f.microTemplate=function(a,e,d){return K._mT(a,e,d)};f.onThisRow=function(a,e){return a+e.replace(/(.*_|\D)/g,"")};f.valueOnThisRow=function(a,e){return this.value(this.onThisRow(a,e))};f.fieldOnThisRow=function(a,e){return this.field(this.onThisRow(a,e))};f.getKey=function(a){return this.tuix&&this.tuix.key};f.getKeyId=function(a){return this.tuix&&this.tuix.key&&this.tuix.key.id};f.getLastKeyId=function(a){return this.getKeyId(a)};f.getTitle=function(){var a,
...
$(N+"abtab").removeClass(M+"abtab_changed")}};f.clickTab=function(a){this.loaded&&this.validate(a!=this.tuix.tab,a)};f.clickButton=function(a,e){var d;if(d=this.field(e))if(d.type==ca)d.pressed=!0,this.validate(!0);else if("toggle"==d.type){var b=$(this.get(e)),k=$(this.get("row__"+e));(d.pressed=!p(d.pressed))?(b.removeClass("not_pressed").addClass("pressed"),k.addClass("zfea_row_pressed")):(b.removeClass("pressed").addClass("not_pressed"),k.removeClass("zfea_row_pressed"));this.markAsChanged();
...
s=!1,w,q=this.fields(y),V={},L={},t={},B=!1,D,H,F,J=!1,E={},z={fields:{},rows:[],tabId:y,path:this.path,tuix:this.tuix,revert:"",errors:[],notices:{}};if(!d){this.ffoving=0;this.splitValues={};K._cHTML5UFDD();!this.savedAndContinued(y)&&this.editCancelEnabled(y)&&(z.revert=ja(C,M+"editCancelButton",K._i(C,ca,X,R,la,this.globalName+".changeMode(); return false;",I,this.editModeOn()?Q.cancel:Q.edit)));if(this.editModeOn()){if(f.errors)for(w in f.errors)u(f.errors,w)&&(g=f.errors[w],z.errors.push({message:g}));
if(q)for(w in q)u(q,w)&&(g=q[w],g.error&&z.errors.push({message:g.error}))}if(f.notices)for(w in f.notices)u(f.notices,w)&&(g=f.notices[w],p(g.show)&&{error:1,warning:1,question:1,success:1}[g.type]&&(z.notices[w]=g));this.setPhiVariables()}for(b in r)u(r,b)&&(k=r[b],g=q[k],w=!1,D=g.grouping,H!==D&&(H=D,J=n[D]!==h&&q[n[D]],s=D&&(!J||K._h(h,this,h,n[D],h,h,J))),F!==D&&(w=!0),g._id=k,g._html=this.drawField(a,y,k,g,V,L,t,d,s),d||s||!1===g._html||((w||g._startNewRow||!z.rows.length)&&z.rows.push({fields:[],
grouping:J}),w&&J&&(J.legend||J.snippet)&&(J=_._ex({grouping:D},J),J._id=D,J._html=this.drawField(a,y,D,J),J._hideOnOpen=!0,J._showOnOpen=!0,J._lastVisibleGrouping=F,F=D,z.rows[z.rows.length-1].fields.push(J),z.fields[D]=J,E[D]=J,z.rows.push({fields:[]})),B||f.show_errors_after_field!=k||(z.rows[z.rows.length-1].errors=z.errors,z.rows[z.rows.length-1].notices=z.notices,B=!0),g._lastVisibleGrouping=F,F=D,z.rows[z.rows.length-1].fields.push(g),z.fields[k]=g));for(k in z.fields)u(z.fields,k)&&(g=z.fields[k],
D=g.grouping)&&(J=E[D])&&(J._hideOnOpen&=g._hideOnOpen,J._showOnOpen&=g._showOnOpen);d||(z.rows.length&&(z.rows[z.rows.length-1].fields[0]._isLastRow=!0),B||z.rows.splice(0,0,{errors:z.errors,notices:z.notices}),e=e||f.template||this.mtPrefix+"_current_tab",l+=this.microTemplate(e,z));for(b in r)u(r,b)&&(k=r[b],delete q[k]._lastVisibleGrouping,delete q[k]._startNewRow,delete q[k]._hideOnOpen,delete q[k]._showOnOpen,delete q[k]._isLastRow,delete q[k]._html,delete q[k]._id);return l};f.insertHTML=function(a,
...
X||b===I&&this.isFormField(e)||"current_value"===b||!e[b].match(/(\{\{|\{\%|\<\%)/)||function(a,b,e){e=q._gMT("<% "+d.defineLibVarBeforeCode()+" %>"+a[b],h);a[b]=function(){return e(a)}}(e,b)}};f.drawField=function(a,e,d,b,k,g,f,A,n,r,l,s,w,ka,V){b===h&&(b=this.field(d,e));b.id===h&&(b.id=d);p(b.enable_microtemplates_in_properties)&&this.enableMicroTemplates(b,b);var L=this,t=b.type,B=b.upload,D=b.pick_items,ra=b.disabled,N="date"==t||"datetime"==t,J,E,z,G,m="",P,O,U={},S="multiselect"==t,T=!1,x=
{"class":""},da={},ma={},aa=!1,ea=!1,ba,ia=!1,ja=!1,va=!1,wa=!1,sa=O=!1,na,oa;s===h&&(s=!this.editModeOn(e)||p(b.read_only)||p(b.readonly));D&&ra&&(s=!0);t&&"datetime"==t&&(s=!0);V?V.disabled_if!==h&&K._e(V.disabled_if,this,V,h,r,h,h,b)&&(s=!0):b.disabled_if!==h&&K._e(b.disabled_if,this,h,h,d,h,h,b)&&(s=!0);!b[C]&&b.css_class&&(b[C]=b.css_class);b.snippet||l!==h||(l=this.value(d,e));l===h&&(l="");if(r===h){delete b.selected_option;if(l&&b.values)if(E=_._isOb(b.values)?b.values[l]:this.tuix.lovs&&
this.tuix.lovs[b.values]&&this.tuix.lovs[b.values][l],_._isOb(E)&&K._h(E,this,h,l,h,h,b,h,this.tuix.tabs[e])&&(E=!1),E)b.selected_option=E;else if("radio"==t||"select"==t)b.current_value=l="";(B||D||S)&&""!=l&&(U=this.pickedItemsArray(b,l));b.values&&_._iS(b.values)&&this.tuix.lovs&&this.tuix.lovs[b.values]?b.values=this.tuix.lovs[b.values]:b.load_values_from_organizer_path&&!b.values&&this.loadValuesFromOrganizerPath(b);for(z in b)u(b,z)&&"<"==z[0]&&(ba=z.match(/^<(\/?)(\w+)/))&&(b[z]&&_._iS(b[z])&&
(z+=b[z]),P={table:1,tr:2,td:3,th:4,div:5,p:6,span:7}[ba[2]]||8,5>P&&(wa=!0),ba[1]?(sa||(sa=!0,oa="       ".split(" ")),oa[8-P]+=z):(O||(O=!0,na="       ".split(" ")),na[P-1]+=z,1==P&&(va=!0)))}A||t!=R&&t!=ca||(b.pressed=!1);if(A||r===h){z=b.same_row===h?va||!wa:!p(b.same_row);b._startNewRow=z;E=1*b.indent||0;n=n||K._h(h,this,h,d,h,h,b)||p(g&&g.last?b.hide_with_previous_field:b.hide_if_previous_field_is_not_hidden)||p(g&&g.beforeLast?b.hide_with_previous_previous_field:b.hide_if_previous_previous_field_is_not_hidden)||
p(b.hide_with_previous_indented_field)&&g&&g[E]||p(b.hide_with_previous_outdented_field)&&0<E&&g&&g[E-1]||p(b.hide_with_previous_indented_fields)&&!k[E]||b.hide_if_previous_value_isnt!==h&&!q._iL(b.hide_if_previous_value_isnt,f&&f.last)||b.hide_if_previous_outdented_value_isnt!==h&&0<E&&!q._iL(b.hide_if_previous_outdented_value_isnt,f&&f[E-1]);f&&(f.last=l,z&&(f[E]=l));if(g){g.beforeLast=g.last;g.last=n;z&&(g[E]=n);if(k.last===h||k.last!==E)k.last<E&&(k[E]=!1),k.last=E;n||(k[E]=!0)}b._startNewRow&&
!1!==this.shownTab&&this.shownTab==this.tuix.tab&&"editor"!=t&&"code_editor"!=t&&b._was_hidden_before&&!n?b._showOnOpen=!0:b._startNewRow&&!1!==this.shownTab&&this.shownTab==this.tuix.tab&&"editor"!=t&&"code_editor"!=t&&!b._was_hidden_before&&n&&(b._hideOnOpen=J=!0,b._was_hidden_before=!0);if(n){if(b._was_hidden_before=!0,!J)return!1}else delete b._was_hidden_before;if(A)return;b.multiple_edit&&(k="",g=s||b.multiple_edit._changed===h?b.multiple_edit.changed:p(b.multiple_edit._changed),p(b.multiple_edit.hide_ui)||
!b.multiple_edit.select_list?(f=p(b.multiple_edit.hide_ui),k+=ha(X,"checkbox",C,"multiple_edit","id","multiple_edit__"+d,"checked",g,"style",f?"display: none;":"","disabled",s,"onchange",s||f?"":this.globalName+".meChange(this.checked, '"+H(d)+"');",">")):k+=ta(C,"multiple_edit","id","multiple_edit__"+d,"disabled",s,"onchange",this.globalName+'.meChange(this.value == 1, "'+W(d)+'");',qa(I,"","selected",!g,b.multiple_edit.select_list.not_changed_label||Q.notChanged)+qa(I,1,"selected",g,b.multiple_edit.select_list.changed_label||
Q.changed)),m+=k,k=h);O&&(m+=na.join(""));b.pre_field_html!==h&&(m+=q._un(b.pre_field_html))}if(!(w&&ka||"object"!=typeof b.values))if(w=[],ka={},B&&p(B.reorder_items))for(P in O=l.split(","),O)u(O,P)&&(G=O[P],w.push(G));else{for(G in b.values)u(b.values,G)&&(O=b.values[G],"object"==typeof O?(O.parent!==h&&(ea=!0,ka[O.parent]=!0),K._h(O,this,h,G,h,h,b,h,this.tuix.tabs[e])||(O.ord!==h?w.push([G,O.ord]):O.label!==h?w.push([G,O.label]):w.push([G,G]))):w.push([G,O]));w.sort(K.sortArray);for(P in w)u(w,
P)&&(w[P]=w[P][0])}s&&(x.readonly=!0,this.isButton(b)&&(x.disabled=!0,x[C]+="disabled "));if(s&&p(b.show_as_a_label_when_readonly)&&"checkboxes"!=t){w=H(l);if("select"==t||"radios"==t)b.values&&b.values[l]?w=H(b.values[l]):b.empty_value&&(w=H(b.empty_value));m+=ga("label","id","label__"+d,C,b.css_class,w)}else if(G=b.snippet){for(var pa in xa)l=xa[pa],G[l]&&(m+=ga(l,"id",l+"__"+d,C,G[l+"_class"],ua,G[l+"_style"],H(G[l])));G.show_split_values_from&&this.splitValues&&this.splitValues[G.show_split_values_from]&&
(m+=this.splitValues[G.show_split_values_from],delete this.splitValues[G.show_split_values_from]);G.html?m+=ga("span","id","snippet__"+d,q._un(G.html)):G.url&&(m=p(G.cache)?this.cachedAJAXSnippets[G.url]?m+this.cachedAJAXSnippets[G.url]:m+(this.cachedAJAXSnippets[G.url]=q._nAA(q._aBP(G.url))):m+q._nAA(q._aBP(G.url)))}else if(("checkboxes"==t||"radios"==t)&&r===h)b.values&&(U=this.pickedItemsArray(b,l),ea=_._ex({},b),ea.name=b.name||d,ea.type="checkboxes"==t?"checkbox":"radio",s&&(ea.disabled=!0),
m=_._isEm(w)?m+ga("label",C,M+"no_values_message",H(b.no_values_message)):m+this.hierarchicalBoxes(a,e,d,l,b,ea,s,U,w,ka));else if(B||D||S){var ya=S||D&&p(D.multiple_select)||B&&p(B.multi);l={id:d,pickerHTML:"",wrappedId:"name_for_"+d,readOnly:s};s||(D&&(D.target_path||D.path)&&!p(D.hide_select_button)&&(l.select={onclick:this.globalName+".pickItems('"+H(d)+"');",phrase:D.select_phrase||Q.selectDotDotDot}),B&&(l.upload={onclick:this.globalName+".upload('"+H(d)+"');",phrase:B.upload_phrase||Q.uploadDotDotDot},
p(B.drag_and_drop)&&this.upload(d,!0),fa.Dropbox&&Dropbox.isBrowserSupported()&&(l.dropbox={onclick:this.globalName+".chooseFromDropbox('"+H(d)+"');",phrase:B.dropbox_phrase||Q.dropboxDotDotDot})));l.pickerHTML+=ta("id",d,"multiple",ya,"class",b.css_class,"style",b.style,">");!b.values||_._isEm(U)&&!S||(l.pickerHTML+=this.hierarchicalSelect(U,b,w,ea,ka));l.pickerHTML+="</select>";m+=this.microTemplate(this.mtPrefix+"_picked_items",l);a.after(function(){S?L.setupMultipleSelect(d,e,b,s||ra):L.setupPickedItems(d,
e,b,s,ya)})}else if(t){da.onchange=r?"lib.fieldChange('"+H(d)+"', '"+H(r)+"');":"lib.fieldChange('"+H(d)+"');";ra&&(x[C]+="disabled ");b.validation&&b.validation.numeric&&(x.onkeyup=(x.onkeyup||"")+"lib.keepNumeric(this)");b.return_key_presses_button&&!s&&(x.onkeyup=(x.onkeyup||"")+"if (event.keyCode == 13) {$('#"+H(b.return_key_presses_button)+"').click();}");p(b.multiple_edit)&&!s&&(x.onkeyup=(x.onkeyup||"")+"if (event && event.keyCode == 9) return true; lib.meMarkChanged('"+H(d)+"', this.value, '"+
H(b.value)+"');");x[C]+="input_"+t;switch(t){case "select":b.slider&&(T=!0,m+=this.drawSlider(a,d,b,s,!0));s&&(x.disabled=!0);m+="<select";break;case "code_editor":m+="<div";x[C]=" zenario_embedded_ace_editor";a.after(function(){var a=ace.edit(d),g=!1;a.session.setUseSoftTabs(!1);a.setShowPrintMargin(!1);s&&(a.setReadOnly(!0),a.setBehavioursEnabled(!1));p(b.wrap_text)&&a.session.setUseWrapMode(!0);a.session.setOption("useWorker",!1);a.on("blur",function(a){g&&q._aADINS("code_editor_"+d,function(){L.fieldChange(d)},
0);g=!1});a.on("change",function(a){L.markAsChanged();g=!0;q._aADINS("code_editor_"+d,function(){L.fieldChange(d)},5E3)});if(language=b.language)try{language=language.match(/\.twig\.html$/i)?"ace/mode/twig":language.match(/\./)?ace.require("ace/ext/modelist").getModeForPath(language).mode:"ace/mode/"+language,a.session.setMode(language),a.setOptions({enableBasicAutocompletion:!0,enableLiveAutocompletion:!0})}catch(k){console.log("Ace editor could not load that language",language)}a.$blockScrolling=
Infinity;L.setCodeEditorPosition(a,L.editingPositions[e+"/"+d])});break;case "color_picker":case "colour_picker":m+="<input";x[C]=" zenario_color_picker";a.after(function(){var a=b.color_picker_options||b.colour_picker_options||{};a.disabled=s;a.preferredFormat=a.preferredFormat||"hex";$(L.get(d)).spectrum(a)});break;case "editor":m+="<textarea";F._gSD();var Y,U={script_url:Z+q.tinyMCEPath,inline:!1,menubar:!1,statusbar:!1,plugins:"autoresize",document_base_url:h,convert_urls:!1,readonly:!0,inline_styles:!1,
allow_events:!0,allow_script_urls:!0,autoresize_max_height:Math.max(Math.floor(0.5*$(fa).height()),300),autoresize_bottom_margin:10,onchange_callback:function(a){L.fieldChange(a.id)},init_instance_callback:function(a){F._eDDUITM(!1,h,L.get("row__"+(a.editorId||a.id)));var b;(b=a.editorContainer)&&(b=$("#"+a.editorContainer.id+" iframe"))&&(b=b[0])&&(b=b.contentWindow)&&F._eDDUITM(!1,h,b)}},B=_._ex({},U,{plugins:["advlist autolink lists link image charmap hr anchor","searchreplace code fullscreen",
"nonbreaking table contextmenu directionality","paste autoresize"],image_advtab:!0,visual_table_class:" ",browser_spellcheck:!0,paste_preprocess:F.tinyMCEPasteRreprocess,readonly:!1,convert_urls:!0,relative_urls:!1,content_css:h,toolbar:"undo redo | bold italic | removeformat | fontsizeselect | formatselect | numlist bullist | blockquote outdent indent | code",style_formats:F.skinDesc.style_formats,oninit:h}),D=_._ex({},B,{toolbar:"undo redo | image link unlink | bold italic | removeformat | fontsizeselect | formatselect | numlist bullist | blockquote outdent indent | code",
...
s?(Y=U,x[C]=" tinymce_readonly"):b.insert_image_button?b.insert_link_button?(Y=D,x[C]=" tinymce_with_images_and_links"):(Y=pa,x[C]=" tinymce_with_images"):b.insert_link_button?(Y=G,x[C]=" tinymce_with_links"):(Y=B,x[C]=" tinymce");x.style="visibility: hidden;";_._isOb(b.editor_options)&&(Y=_._ex(Y,b.editor_options));Y.setup=function(a){a.on("change",function(a){L.fieldChange(a.id)})};a.after(function(){var a=$(L.get(d)),b=L.get(M+"abtab"),e=b.style.display;try{a.tinymce().remove()}catch(g){}b.style.display=
"block";a.tinymce(Y);b.style.display=e});break;case R:case ca:case "toggle":ia=!0;p(b.use_button_tag)?(m+="<"+R,ja=!0):(m+="<input",x.type=R);if(!s||p(b.can_be_pressed_in_view_mode))da.onclick="lib.clickButton(this, '"+d+"');",delete x.disabled;"toggle"==t&&(x[C]+=b.pressed?" pressed":" not_pressed");break;default:"textarea"==t?m+="<textarea":N?(m+='<span class="zenario_datepicker_wrap"><input',x.type="text",x[C]+=" zenario_datepicker",x.readonly="readonly",s||(x.onkeyup=(x.onkeyup||"")+"zenario._dFKU(this, event, '"+
H(d)+"');"),a.after(function(){var a=$(L.get(d)),e=!!p(b.change_month_and_year);a.datepicker({changeMonth:e,changeYear:e,dateFormat:F.siteSettings&&F.siteSettings.organizer_date_format||q.dpf,altField:"#_value_for__"+d,altFormat:"yy-mm-dd",showOn:"focus",disabled:s,onSelect:function(b,e){a.change()}})})):"url"==t?(m+="<input",x.type="url",x.onfocus=(x.onfocus||"")+"if(!this.value) this.value = 'http://';",x.onblur=(x.onblur||"")+"if(this.value == 'http://') this.value = '';"):(b.slider&&(T=!0,m+=
this.drawSlider(a,d,b,s,!0)),"text"==t&&b.values&&!s&&(m+='<span class="zenario_textbox_with_autocomplete">',aa=!0),m+="<input",x.type=t),this.addExtraAttsForTextFields(b,x)}if("checkbox"==t||"radio"==t)p(l)&&(x.checked="checked"),l=h,s&&(x.disabled=!0),p(b.indeterminate)&&a.after(function(){var a;if(a=this.get(d))a.indeterminate=!0});T&&(x.onchange='$("#zenario_slider_for__'+W(d)+'").slider("value", $(this).val());',x.onkeyup=(x.onkeyup||"")+'$("#zenario_slider_for__'+W(d)+'").slider("value", $(this).val());');
r===h?(V=b,ma.id=d):(V=$.extend({},b,V),ma.id=d+"___"+r,x[C]+=" control_for__"+d);"radio"==t&&b.name||(ma.name=d);s&&(ma.placeholder="");m+=this.outputAtts(V,x,da,ma);da=H(ia?b.value:l,!1,"asis");x="";"select"==t?m+=">":ja?(m+=">",b.icon_left&&(m+='<i class="'+H(b.icon_left)+'" aria-hidden="true"></i>'),m+=da,b.icon_right&&(m+='<i class="'+H(b.icon_right)+'" aria-hidden="true"></i>'),m+="</button>"):"textarea"==t||"editor"==t?m+=">"+da+"</textarea>":"code_editor"==t?m+=">"+da+"</div>":N?(m+=' value="'+
H(q._fD(l,"datetime"==t))+'"/>',m+=ha(X,"hidden","id","_value_for__"+d,I,l),s||(m+=ha(X,R,C,M+"remove_date",I,"x",la,this.globalName+'.blankField("'+W(d)+'"); $('+this.globalName+'.get("'+W(d)+'")).change();'))):m=l!==h?m+(' value="'+da+'"/>'):m+"/>";"select"==t&&(b.empty_value&&(x=qa(I,"","data-hide_in_iconselectmenu",1,"selected",!l,H(b.empty_value)),b.show_empty_value_at_end||(m+=x,x="")),b.values&&(U={},U[l]=!0,m+=this.hierarchicalSelect(U,b,w,ea,ka)),m+=x+"</select>");if(aa){var za=[];for(P in w)u(w,
P)&&(G=w[P],za.push({label:b.values[G],value:G}));a.after(function(){var a=$(L.get(d)),e={source:za,minLength:b.autocomplete_min_length||0,appendTo:a.parent()};b.return_key_presses_button&&(e.select=function(){setTimeout(function(){$("#"+b.return_key_presses_button).click()},0)});a.autocomplete(e);a.focus(function(){a.autocomplete("widget").is(":visible")||a.autocomplete("search","")})});m+=ha(X,R,C,M+"open_autocomplete",I,"\u25be",la,"$("+this.globalName+'.get("'+W(d)+'")).autocomplete("search", "");')}if(N||
aa)m+="</span>"}r===h&&("url"!=t||s||(m+="&nbsp; "+ha(X,R,C,ca,I,Q.test,la,this.globalName+'.testURL("'+W(d)+'");')),!b.label||"checkbox"!=t&&"radio"!=t&&"toggle"!=t||(m+=" "+ga("label",C,b.label_class,"for",d,"id","label_for__"+d,H(b.label))),b.post_field_label!==h&&(m+=" "+ga("label","for",d,"id","label_for__"+d,H(b.post_field_label))),b.post_field_html!==h&&(m+=q._un(b.post_field_html)),sa&&(m+=oa.join("")),T&&(m+=this.drawSlider(a,d,b,s,!1)));return m};f.addExtraAttsForTextFields=function(a,e){};
var Ia={id:!0,name:!0,size:!0,maxlength:!0,accesskey:!0,"class":!0,cols:!0,dir:!0,readonly:!0,rows:!0,style:!0,tabindex:!0,title:!0,disabled:!0,onblur:!0,onchange:!0,onclick:!0,ondblclick:!0,onfocus:!0,onmousedown:!0,onmousemove:!0,onmouseout:!0,onmouseover:!0,onmouseup:!0,onkeydown:!0,onkeypress:!0,onkeyup:!0,onselect:!0,autocomplete:!0,autofocus:!0,max:!0,min:!0,pattern:!0,placeholder:!0,required:!0,step:!0},xa="hr h1 h2 h3 h4 label".split(" ");f.outputAtts=function(a,e,d,b,k){var g,f="";for(g in a)if(u(a,
g)&&(!b||b[g]==h)&&(k||Ia[g]||"data-"==g.substr(0,5)))if("disabled"==g||"readonly"==g||"selected"==g){if(p(a[g])||e&&p(e[g])&&delete e[g])f+=" "+g+'="'+g+'"'}else f+=" "+g+'="'+this.defineLibVarBeforeCode(g),e&&e[g]&&(f+=e[g]+" ",delete e[g]),f+=H(a[g]),d&&d[g]&&(f+=" "+d[g],delete d[g]),f+='"';b&&(f+=this.outputAtts(b,!1,!1,!1,!0));e&&(f+=this.outputAtts(e,!1,!1,!1,!0));d&&(f+=this.outputAtts(d,!1,!1,!1,!0));return f};f.defineLibVarBeforeCode=function(a){if(a===h||"on"==a.substr(0,2)){if(!this.globalName){for(a=
1;fa[this.globalName="zenarioLib"+a];++a);fa[globalName]=this}return"var lib = "+H(this.globalName)+"; "}return""};f.testURL=function(a){var e=this.get(a).value;a=this.get(this.onThisRow("target_blank_",a))||this.get(this.onThisRow("target_blank",a));if(e)if(a&&2==a.value)$[Ga]({href:e,iframe:!0,width:"95%",height:"95%",className:M+"url_test_colorbox"});else fa.open(q._aBP(e))};f.keepNumeric=function(a){var e=a.value.replace(/[^\d\.]/g,"").replace(/\.(.*)\./g,".$1");a.value!=e&&(a.value=e)};f.hierarchicalSelect=
function(a,e,d,b,k,g){var f="",A,n,r,l,s;for(l in d)if(u(d,l)){s=d[l];r=e.values[s];n=A=!1;if(_._iS(r))r={label:r};else if(p(r.disabled)||r.disabled_if!==h&&K._e(r.disabled_if,this,r,h,s,h,h,e))A=!0;a[s]&&(n=!0);showWithoutChildren=!p(r.hide_when_children_are_not_visible);if(g===h&&b&&k[s]){if((childrenHTML=this.hierarchicalSelect(a,e,d,b,k,s))||showWithoutChildren)f+=ga("optgroup","label",r,"disabled",!childrenHTML,childrenHTML)}else showWithoutChildren&&g===r.parent&&(f+="<option "+this.outputAtts(r,
!1,!1,{disabled:A,selected:n,value:s})+">"+H(r,!1,!0)+"</option>")}return f};f.setupMultipleSelect=function(a,e,d,b){var k=this,g=!1;e=$(this.get(a));e.multiselect({columns:d.cols,texts:{placeholder:d.empty_value||Q.selectListSelect,overridePlaceholder:d.placeholder},onOptionClick:function(){g=!0},onControlClose:function(){g&&k.fieldChange(a)}});b&&e.multiselect("disable")};f.setupPickedItems=function(a,e,d,b,k){var g=this,f=!1,h=!1,n,r,l,s,w=d.pick_items||{},C=d.upload||{};if(d.pick_items&&!p(w.disable_type_ahead_search)){n=
w.path&&aa._cNPTTPAR(w.path);s=w.target_path&&aa._cNPTTPAR(w.target_path);if(n=n&&s&&n.path==s.path?n:s||n)r=Z+ba+"admin/organizer.ajax.php?_typeahead_search=1&path="+T(n.path)+q._uR(n.request),l="_search";h=p(d.pick_items.allow_typing_anything)}d=$(this.get(a)).tokenize({datas:r,searchParam:l,debounce:200,sortable:p(C.reorder_items),placeholder:w.nothing_selected_phrase||C.nothing_selected_phrase||Q.nothing_selected,onAddToken:function(b,d,h){f||(k||(f=!0,g.addToPickedItems(b,a,e),f=!1),g.$getPickItemsInput(a).focus())},
...
{fileUpload:1},!1,this.uploadCallback,d.get(M+"fbAdminInner")):K._a(this,b,h,h,h,{fileUpload:1},h,this.ajaxURL())};f.ajaxURL=function(){return Z+Ha+"?method_call=handleAdminBoxAJAX&path="+T(this.path)};f.uploadComplete=function(a){this.uploadCallback!==h&&this.uploadCallback(a);delete this.uploadCallback};f.drawSlider=function(a,e,d,b,k){var g=this,f=_._cl(d.slider);d="";if(p(f.before_field)?k:!k)b&&(d+='<div class="ui-disabled">'),d+=ja("id",M+"slider_for__"+e,C,f[C],ua,f.style),b&&(d+="</div>"),
a.after(function(){var a;if(a=g.get(M+"slider_for__"+e))f.min!==h&&(f.min=q.num(f.min)),f.max!==h&&(f.max=q.num(f.max)),f.step!==h&&(f.step=q.num(f.step)),f.disabled=!g.editModeOn(),f.value=$(g.get(e)).val(),f.slide=function(a,b){$(g.get(e)).val(b.value)},f.change=function(a,b){g.fieldChange(e)},$(a).slider(f)});return d};f.pickedItemsArray=function(a,e){if(!1===e||null===e||e===h||!(0!==e&&"0"!==e||a.values&&(a.values[0]||a.values["0"])))return{};var d=(e+"").split(","),b={},f,g,y,A,n,r,l;a._display_value=
!1;for(r in d)u(d,r)&&(l=d[r])&&(a.upload&&(n=q._dIIFO(l))&&(n=n.split("/"))&&n[1]?(b[l]=n[1],p(n[2])&&p(n[3])&&(b[l]+=" ["+n[2]+" \u00d7 "+n[3]+"px]")):a.values&&a.values[l]&&"string"==typeof a.values[l]?b[l]=a.values[l]:a.values&&a.values[l]&&a.values[l].label?b[l]=a.values[l].label:((y=a.pick_items&&a.pick_items.target_path)||(y=a.pick_items&&a.pick_items.path))&&(f=F._gIFO(y,l))?(a.values||(a.values={}),g=F._fOIN(f,l),A=f.items&&f.items[l]||{},b[l]=g,a.values[l]={list_image:A.list_image,css_class:A.css_class||
f.item&&f.item.css_class,label:g}):a.upload&&l==1*l&&(n=F._lFD(l))?(this.setFileDetails(a,n),b[l]=a.values[l]):b[l]=l,!1===a._display_value&&(a._display_value=b[l]));return b};f.pickedItemsValue=function(a){var e,d="";if(a)for(e in a)u(a,e)&&(d+=(""===d?"":",")+e);return d};f.hierarchicalBoxes=function(a,e,d,b,f,g,y,q,n,r,l,s,w){var F=1,K=0,L="",t,B,D,I,N=!1;if(!w)w=0,F=1*f.cols||1;else if(10<w)return"";s||(s={});l&&(s[l]=!0);w&&(L+=ja(C,M+"hierarchical_box_children","id","children_for___"+d+"___"+
l,">"));for(var J in n)if(u(n,J)&&(t={},B=n[J],B==1*B&&(B*=1),I=h,D="object"==typeof f.values[B]?f.values[B]:{label:f.values[B]},f.tag_colors&&(t.tag_color=f.tag_colors[B]||"blue"),I=D.parent,"0"===I&&(I=!1),!l&&!I||l==I)){I=b?!0===b||1===b||"1"===b?!0===B||1===B||"1"===B:q?q[B]!==h?!0:!1:B==b:!B;if(!y||I||!f.hide_unselected_values_when_readonly||r[B]){t.checked=I;if(t.newRow=++K>F)K=1;t.col=K;t.cols=F;if("checkboxes"==f.type&&p(f.checking_child_checks_parents)){var E="";l&&(E+="if (this.checked) { for (var cb in "+
JSON.stringify(s)+") { "+this.globalName+".get('"+H(d)+"___' + cb).checked = true; } } ");r[B]&&(E+="if (!this.checked) { $('#children_for___' + this.id + ' input').attr('checked', false); } ");E?g.onchange=f.onchange?E+" "+f.onchange:E:f.onchange?g.onchange=f.onchange:delete g.onchange}else"checkboxes"==f.type&&p(f.checking_parent_checks_children)&&(E="",r[B]&&(E+="if (this.checked) { $('#children_for___' + this.id + ' input').each(function(i, el) {el.checked = true;}) }; "),E?g.onchange=f.onchange?
E+" "+f.onchange:E:f.onchange?g.onchange=f.onchange:delete g.onchange);t.lovId=d+"___"+B;t.lovField=D;f.indeterminates&&p(f.indeterminates[B])&&function(b){a.after(function(){var a;if(a=this.get(b))a.indeterminate=!0})}(t.lovId);t.lovHTML=this.drawField(a,e,d,g,h,h,h,h,h,B,I,!1,n,r,D);t.childrenHTML="";r[B]&&(t.childrenHTML=this.hierarchicalBoxes(a,e,d,b,f,g,y,q,n,r,B,_._ex({},s),w+1),K=0);N?(this.splitValues||(this.splitValues={}),this.splitValues[d]||(this.splitValues[d]=""),this.splitValues[d]+=
this.microTemplate(this.mtPrefix+"_radio_or_checkbox",t)):L+=this.microTemplate(this.mtPrefix+"_radio_or_checkbox",t)}I&&D.split_values_if_selected&&!w&&"radios"===f.type&&(N=!0)}w&&(L+="</div>");return L};f.drawPickedItem=function(a,e,d,b){d===h&&(d=this.field(e));var f={},g=d.values&&d.values[a];_._isOb(g)?(f=g,g=g.label):(g||(g=a),f.label=g);var y=a==1*a,A,n;e={id:e,item:a,label:g,readOnly:b,css_class:f.css_class,list_image:f.list_image};d.tag_colors&&(e.tag_color=d.tag_colors[a]||"blue");!d.pick_items||
p(d.pick_items.hide_info_button)||d.upload&&!y||!(A=d.pick_items.path)||A!=d.pick_items.target_path&&d.pick_items.min_path!=d.pick_items.target_path||(A="//"==q._rHSS(A,2)?A+a:"/"==q._rHSS(A,1)?A+("/"+a):A+("//"+a),e.organizerPath=A);d.upload&&(e.isUpload=!0,A=(A=(""+g).match(/(.*?)\.(\w+)$/)||(""+g).match(/(.*?)\.(\w+) \[.*\]$/))&&A[2]?A[2].toLowerCase():"unknown",e.extension=A,y?(n=d.values&&d.values[a]&&d.values[a].file)&&n.checksum?(a=Z+ba+"file.php?c="+T(n.checksum),n.usage&&(a+="&usage="+T(n.usage))):
a=Z+ba+"file.php?id="+a:a=Z+ba+"file.php?getUploadedFileInCacheDir="+T(a),A.match(/gif|jpg|jpeg|png|svg/)?(e.thumbnail={onclick:this.globalName+".showPickedItemInPopout('"+a+"&popout=1&dummy_filename="+T("image."+A)+"', '"+g+"');",src:a+"&og=1"},(g=(""+g).match(/.*\[\s*(\d+)p?x?\s*[\u00d7x]\s*(\d+)p?x?\s*\]$/))&&g[1]&&g[2]&&K._rI(g[1],g[2],180,120,e.thumbnail)):e.adminDownload=a+"&adminDownload=1");return this.microTemplate(this.mtPrefix+"_picked_item",e)};f.showPickedItemInPopout=function(a,e){K._a(this,
...
f.meChange=function(a,e,d){var b=this.field(e);if(a)b.multiple_edit._changed=!0;else{if(!d&&p(b.multiple_edit.warn_when_abandoning_changes)&&b.multiple_edit.original_value!==h&&this.readField(e)!=b.multiple_edit.original_value){a=ha(X,R,C,"submit_selected",I,Q.abandonChanges,la,this.globalName+'.meChange(false, "'+W(e)+'", true);')+ha(X,R,C,ca,I,Q.cancel);F._flBo(Q.abandonChangesConfirm,a,"warning");this.meSetCheckbox(e,!0);return}b.multiple_edit._changed=!1;delete b.current_value;d=b.value;b.multiple_edit.original_value!==
...
this.mode())};f.modeIs=function(a){return this.mode()==a};f.valueIn=function(a){return _.contains(arguments,this.value(a),1)};f.valueIs=function(a,e){return this.value(a)==e};f.valueIsNot=function(a,e){return this.value(a)!=e};f.isButton=function(a){return a&&(a.type==ca||"toggle"==a.type||a.type==R)};f.isFormField=function(a){return!(!a||a.snippet||"grouping"==a.type||a.type==ca||"toggle"==a.type||a.type==R)};f.getCodeEditorPosition=function(a){return{top:a.session.getScrollTop(),left:a.session.getScrollLeft(),
...
b.multiple_edit&&g&&delete b.multiple_edit._changed;if("checkboxes"==b.type||"radios"==b.type){if(!g&&!y&&b.values){var A,y="",n=!0;for(A in b.values)u(b.values,A)&&this.get(a+"___"+A)&&this.get(a+"___"+A).checked&&(y+=(n?"":",")+A,n=!1);b.current_value=y}y=!0}if(y)return g||b.current_value===h?b.value:b.current_value;if(this.get("_value_for__"+a))b.current_value=e=this.get("_value_for__"+a).value;else if("editor"!=b.type&&"code_editor"!=b.type||g)if(!g&&(f=this.get(a))){if("checkbox"==b.type||"radio"==
b.type)e=f.checked?!0:!1;else if("color_picker"==b.type||"colour_picker"==b.type)try{e=$(f).spectrum("get").toHexString()}catch(r){e=$(f).val()}else e=$(f).val();_._isAr(e)&&(e=e.join(","));b.current_value=e}else delete b.current_value,e=b.value;else if(e=h,"editor"==b.type?fa.tinyMCE&&tinyMCE.get(a)&&(e=q._tMGC(tinyMCE.get(a))):"code_editor"==b.type&&(f=ace.edit(a))&&(e=f.getValue(),this.editingPositions[d+"/"+a]=this.getCodeEditorPosition(f)),e!==h&&!1!==e)e=b.current_value=e;else return b.current_value===
...
q,A,n,r,l={};if(this.tuix&&this.tuix.tabs)for(g in this.tuix.tabs)if(u(this.tuix.tabs,g)&&(q=this.tuix.tabs[g],q.fields))for(A in q.fields)u(q.fields,A)&&(n=q.fields[A],r=A,this.isFormField(n)&&!(b&&(!this.editModeOn(g)||p(n.read_only)||p(n.readonly))||f&&(n._was_hidden_before||p(n.read_only)||p(n.readonly))||a&&!(r=n.plugin_setting&&n.plugin_setting.name))&&(n=this.currentValue(A,g,d),e||(l[r]=n),e||e===h))&&(l[g+"/"+A]=n);return l};f.insertText=function(a,e){_._iS(a)&&(a=this.get(a));if(a){var d=
$(a),b=a.selectionStart,f=a.selectionEnd,g=d.val();d.val(g.substring(0,b)+e+g.substring(f));a.selectionStart=a.selectionEnd=b+e.length;a.focus()}};f.callFunctionOnEditors=function(a){var e,d,b;if(fa.tinyMCE&&(e=this.fields()))for(d in e)if(u(e,d)&&(b=e[d],"editor"==b.type&&tinyMCE.get(d)))if("remove"==a)tinyMCE.get(d).remove();else if("isDirty"==a&&tinyMCE.get(d).isDirty())return!0;return!1};f.format=function(a){var e;if(this.loaded&&(e=this.getURL("format"))){var d=this,b=this.tuix&&this.tuix.tab;
