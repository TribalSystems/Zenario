...
if(a.fields)for(var b in a.fields)if(x(a.fields,b)){var l=a.fields[b];this.isFormField(l)&&("code_editor"==l.type&&q._cAD("code_editor_"+b),m(l.current_value)||(l.current_value=this.value(b,d,!0)),e&&(m(l.value)||(l.value=this.value(b,d,!1)),l.multiple_edit&&!m(l.multiple_edit._changed)&&m(l.multiple_edit.changed)&&(l.multiple_edit._changed=l.multiple_edit.changed)))}}R&&R.activeElement&&(this.lastFocus=this.setLastFocus(R.activeElement))};f.setLastFocus=function(a){var d;"object"===typeof a?(d=a,
...
b)}};f.displayAsTag=function(a,d){return a.show_as_a_label||d&&a.show_as_a_label_when_readonly?"label":a.show_as_a_span||d&&a.show_as_a_span_when_readonly?"span":!1};f.drawField=function(a,d,e,b,l,g,f,ca,p,y,k,t,A,da,G){m(b)||(b=this.field(e,d));m(b.id)||(b.id=e);r(b.enable_microtemplates_in_properties)&&this.enableMicroTemplates(b,b);var J=this,w=b.type,B=b.upload,N=b.pick_items,O=b.disabled,V="date"==w||"datetime"==w,H,D,z,E,P,n="",K,R,L,S={},Q="multiselect"==w,T=!1,u={"class":""},Y={},ea={},la=
!1,Z=!1,ma,pa=!1,qa=!1,ra=!1,sa=!1,ta=!1,na=L=!1,ga,ha;m(t)||(t=this.fieldIsReadonly(e,b,d));N&&O&&(t=!0);w&&"datetime"==w&&(t=!0);G?m(G.disabled_if)&&I._e(G.disabled_if,this,G,h,y,h,h,b)&&(t=!0):m(b.disabled_if)&&I._e(b.disabled_if,this,h,h,e,h,h,b)&&(t=!0);!b["class"]&&b.css_class&&(b["class"]=b.css_class);b.snippet||m(k)||(k=this.value(e,d));m(k)||(k="");if(!m(y)){delete b.selected_option;if(k&&b.values)if(D=_._isOb(b.values)?b.values[k]:this.tuix.lovs&&this.tuix.lovs[b.values]&&this.tuix.lovs[b.values][k],
_._isOb(D)&&I._h(D,this,h,k,h,h,b,h,this.tuix.tabs[d])&&(D=!1),D)b.selected_option=D;else if("radio"==w||"select"==w)b.current_value=k="";(B||N||Q)&&""!=k&&(S=this.pickedItemsArray(b,k));b.values&&_._iS(b.values)&&this.tuix.lovs&&this.tuix.lovs[b.values]?b.values=this.tuix.lovs[b.values]:b.load_values_from_organizer_path&&!b.values&&this.loadValuesFromOrganizerPath(b);for(z in b)x(b,z)&&"<"==z[0]&&(ma=z.match(/^<(\/?)(\w+)/))&&(b[z]&&_._iS(b[z])&&(z+=b[z]),K={table:1,tr:2,td:3,th:4,br:5,div:6,p:7,
span:8}[ma[2]]||9,5>K&&(ta=!0),ma[1]?(na||(na=!0,ha="        ".split(" ")),ha[9-K]+=z):(L||(L=!0,ga="        ".split(" ")),ga[K-1]+=z,1==K&&(sa=!0),5==K&&(ra=!0)))}ca||"button"!=w&&"submit"!=w||(b.pressed=!1);if(ca||!m(y)){z=m(b.same_row)?!r(b.same_row):!ra&&(sa||!ta);b._startNewRow=z;D=1*b.indent||0;p=p||I._h(h,this,h,e,h,h,b)||t&&b.hide_when_readonly||r(g&&g.last?b.hide_with_previous_field:b.hide_if_previous_field_is_not_hidden)||r(g&&g.beforeLast?b.hide_with_previous_previous_field:b.hide_if_previous_previous_field_is_not_hidden)||
r(b.hide_with_previous_indented_field)&&g&&g[D]||r(b.hide_with_previous_outdented_field)&&0<D&&g&&g[D-1]||r(b.hide_with_previous_indented_fields)&&!l[D]||m(b.hide_if_previous_value_isnt)&&!q._iL(b.hide_if_previous_value_isnt,f&&f.last)||m(b.hide_if_previous_outdented_value_isnt)&&0<D&&!q._iL(b.hide_if_previous_outdented_value_isnt,f&&f[D-1]);f&&(f.last=k,z&&(f[D]=k));g&&(g.beforeLast=g.last,g.last=p,z&&(g[D]=p),m(l.last)&&l.last===D||(l.last<D&&(l[D]=!1),l.last=D),p||(l[D]=!0));b._startNewRow&&!1!==
this.shownTab&&this.shownTab==this.tuix.tab&&"editor"!=w&&"code_editor"!=w&&b._was_hidden_before&&!p?b._showOnOpen=!0:b._startNewRow&&!1!==this.shownTab&&this.shownTab==this.tuix.tab&&"editor"!=w&&"code_editor"!=w&&!b._was_hidden_before&&p&&(b._hideOnOpen=H=!0,b._was_hidden_before=!0);if(p){if(b._was_hidden_before=!0,!H)return!1}else delete b._was_hidden_before;if(ca)return;p||!b.tall_as_possible||m(this.tallAsPossibleField)||(this.tallAsPossibleField=e,this.tallAsPossibleFieldType=b.type);b.multiple_edit&&
(l="",g=!t&&m(b.multiple_edit._changed)?r(b.multiple_edit._changed):b.multiple_edit.changed,r(b.multiple_edit.hide_ui)||!b.multiple_edit.select_list?(f=r(b.multiple_edit.hide_ui),l+=ba("type","checkbox","class","multiple_edit","id","multiple_edit__"+e,"checked",g,"style",f?"display: none;":"","disabled",t,"onchange",t||f?"":this.globalName+".meChange(this.checked, '"+C(e)+"');",">")):l+=oa("class","multiple_edit","id","multiple_edit__"+e,"disabled",t,"onchange",this.globalName+'.meChange(this.value == 1, "'+
U(e)+'");',ja("value","","selected",!g,b.multiple_edit.select_list.not_changed_label||M.notChanged)+ja("value",1,"selected",g,b.multiple_edit.select_list.changed_label||M.changed)),n+=l,l=h);L&&(n+=ga.join(""));m(b.pre_field_html)&&(n+=q._un(b.pre_field_html))}if(!(A&&da||"object"!=typeof b.values))if(A=[],da={},B&&r(B.reorder_items)||N&&r(N.reorder_items))for(K in L=k.split(","),L)x(L,K)&&(E=L[K],A.push(E));else{for(E in b.values)x(b.values,E)&&(L=b.values[E],"object"==typeof L?(m(L.parent)&&(Z=
!0,da[L.parent]=!0),I._h(L,this,h,E,h,h,b,h,this.tuix.tabs[d])||(m(L.ord)?A.push([E,L.ord]):m(L.label)?A.push([E,L.label]):A.push([E,E]))):A.push([E,L]));A.sort(I.sortArray);for(K in A)x(A,K)&&(A[K]=A[K][0])}t?(u.readonly=!0,this.isButton(b)&&(u.disabled=!0,u["class"]+="disabled ")):b.error&&(u["class"]+="zenario_field_with_error ");if("checkboxes"!=w&&(P=this.displayAsTag(b,t))){A=C(k);if("select"==w||"radios"==w)b.values&&b.values[k]?A=C(b.values[k]):b.empty_value&&(A=C(b.empty_value));n+=ia(P,
"id",P+"__"+e,"class",b.css_class,A)}else if(E=b.snippet){for(R in ua)P=ua[R],E[P]&&(n+=ia(P,"id",P+"__"+e,"class",E[P+"_class"],"style",E[P+"_style"],C(E[P])));E.show_split_values_from&&this.splitValues&&this.splitValues[E.show_split_values_from]&&(n+=this.splitValues[E.show_split_values_from],delete this.splitValues[E.show_split_values_from]);E.html&&(n+=Ba("id","snippet__"+e,q._un(E.html)));E.microtemplate&&(n+=fa("id","microtemplate__"+e,this.microTemplate(E.microtemplate,b)));E.url&&(n=r(E.cache)?
this.cachedAJAXSnippets[E.url]?n+this.cachedAJAXSnippets[E.url]:n+(this.cachedAJAXSnippets[E.url]=q._nAA(q._aBP(E.url))):n+q._nAA(q._aBP(E.url)))}else if(("checkboxes"==w||"radios"==w)&&!m(y))t&&b.display_as_text_when_readonly?n+=C(this.displaySelectedItems(e,b,k,d)):b.values&&(Z=_._ex({},b),S=this.pickedItemsArray(b,k),Z.name=b.name||e,Z.type="checkboxes"==w?"checkbox":"radio",t&&(Z.disabled=!0),n=_._isEm(A)?n+ka("class","zenario_no_values_message",C(b.no_values_message)):n+this.hierarchicalBoxes(a,
d,e,k,b,Z,t,S,A,da));else if(B||N||Q){var va=Q||N&&r(N.multiple_select)||B&&r(B.multi);k={id:e,pickerHTML:"",wrappedId:"name_for_"+e,readOnly:t};t||(N&&(N.target_path||N.path)&&!r(N.hide_select_button)&&(k.select={onclick:this.globalName+".pickItems('"+C(e)+"');",phrase:N.select_phrase||M.selectDotDotDot}),B&&(k.upload={onclick:this.globalName+".upload('"+C(e)+"');",phrase:B.upload_phrase||M.uploadDotDotDot},r(B.drag_and_drop)&&this.upload(e,!0),aa.Dropbox&&Dropbox.isBrowserSupported()&&(k.dropbox=
{onclick:this.globalName+".chooseFromDropbox('"+C(e)+"');",phrase:B.dropbox_phrase||M.dropboxDotDotDot})));k.pickerHTML+=oa("id",e,"multiple",va,"class",b.css_class,"style",b.style,">");!b.values||_._isEm(S)&&!Q||(k.pickerHTML+=this.hierarchicalSelect(S,b,A,Z,da));k.pickerHTML+="</select>";n+=this.microTemplate(this.mtPrefix+"_picked_items",k);a.after(function(){Q?J.setupMultipleSelect(e,d,b,t||O):J.setupPickedItems(e,d,b,t,va)})}else if(w){Y.onchange=y?"lib.fieldChange('"+C(e)+"', '"+C(y)+"');":
