...
zenario.lib(function(h,G,H,I,P,sa,z,O,L,wa,Xa,Ia,xa,m,w,Ta,J,ca,W,Ya,Ua,B,Va){L.lib(function(ya,ja,ea,Ja,za,ka,ta){var g=Ua(Va);g.init=function(a,c,d){this.globalName=a;this.mtPrefix=c;this.containerId=d;this.baseCSSClass="";this.onKeyUpNum=0;wa.sizing=!1;this.cachedAJAXSnippets={};this.changed={};this.toggleLevelsPressed={};this.fieldThatTriggeredRedraw=this.lastFocus=!1;this.editingPositions={}};g.enableInlineErrors=function(){return!0};g.get=function(a){var c;return this.containerId&&(c=$("#"+
this.containerId+" #"+z._cE(a)))&&c[0]||Ta(a)};g.tooltips=function(a,c){this.isAdminFacing()?O._to(a,c):z._t(a,c)};g.vaPhrase=function(a){return this.isAdminFacing()?O.phrase[a]:z.vphrase[a]};g.microTemplate=function(a,c,d,b,e){d=L._f(d);var f=z._aLP(c,this);a=z._mT(a,c,d,h,h,b,e);f&&z._tLP(c);return a};g.pMicroTemplate=function(a,c,d){return this.microTemplate(this.mtPrefix+"_"+a,c,d,this.tuix&&this.tuix.pre_microtemplate&&this.tuix.pre_microtemplate[a],this.tuix&&this.tuix.post_microtemplate&&this.tuix.post_microtemplate[a])};
...
function(){var a=this.tuix.tab,c,d,b,e,f=this.tuix.lovs||{};if(this.tuix.tabs)for(c in this.tuix.tabs)if(B(this.tuix.tabs,c)&&(b=this.fields(c))){var k=!1;for(d in b)B(b,d)&&(e=b[d])&&(e.pick_items&&e.plugin_setting&&e.plugin_setting.use_value_for_plugin_name?this.pickedItemsArray(e,this.value(d,c,!1)):e.values&&_._isSt(e.values)&&f[e.values]?e.values=f[e.values]:e.load_values_from_organizer_path&&!e.values&&this.loadValuesFromOrganizerPath(e),e.validation&&m(e.validation.required_if_not_hidden)&&
...
this.tabHidden&&this.draw2()};g.draw2=function(){};g.size=function(){};g.makeFieldAsTallAsPossible=function(){};g.getNextTab=function(){m(this.prevTab)||m(this.nextTab)||this.drawTabs(" ");return this.nextTab};g.getPrevTab=function(){m(this.prevTab)||m(this.nextTab)||this.drawTabs(" ");return this.prevTab};g.goToNextTab=function(){var a=this.getNextTab();if(m(a))return wa._cT(a),!0};g.goToPrevTab=function(){var a=this.getPrevTab();if(m(a))return wa._cT(a),!0};g.drawTabs=function(a){a||(a=this.mtPrefix+
...
n.enableMicroTemplates(b,b);var u=b.type,Q=b.upload,C=b.pick_items,F=b.disabled,y=b.validation||{},M="currency"==u,da="date"==u||"datetime"==u,S=M||!!y.numeric,aa=b.decimal_places,ma,Y,v="",Ka,T={},na="multiselect"==u,ua=!1,x={"class":""},fa={},oa={},Aa=!1,ha=!1,Ba,la=!1,La=!1,Ma=!1,Na=!1,Oa=!1,Pa=!1,Ca=!1,Da=!1,pa=n.tuix.tabs[c];m(r)||(r=n.fieldIsReadonly(d,b,c));C&&F&&(r=!0);u&&"datetime"==u&&(r=!0);N?m(N.disabled_if)&&L._e(N.disabled_if,n,N,h,t,h,h,b)&&(r=!0):m(b.disabled_if)&&L._e(b.disabled_if,
n,h,h,d,h,h,b)&&(r=!0);S&&(aa=m(aa)?1*aa:M?2:h);!b["class"]&&b.css_class&&(b["class"]=b.css_class);b.snippet||m(p)||(p=n.value(d,c));m(p)||(p="");if(!m(t)){delete b.selected_option;if(p&&b.values){var R=_._isOb(b.values)?b.values[p]:n.tuix.lovs&&n.tuix.lovs[b.values]&&n.tuix.lovs[b.values][p];_._isOb(R)&&L._h(R,n,h,p,h,h,b,h,pa)&&(R=!1);if(R)b.selected_option=R;else if("radio"==u||"select"==u)b.current_value=p=""}(Q||C||na)&&""!=p&&(T=n.pickedItemsArray(b,p));b.values&&_._isSt(b.values)&&n.tuix.lovs&&
n.tuix.lovs[b.values]?b.values=n.tuix.lovs[b.values]:b.load_values_from_organizer_path&&!b.values&&n.loadValuesFromOrganizerPath(b);for(X in b)if(B(b,X)&&"<"==X[0]&&(Ba=X.m(/^<(\/?)(\w+)/))){b[X]&&_._isSt(b[X])&&(X+=b[X]);var U={table:1,tr:2,td:3,th:4,br:5,div:6,p:7,span:8}[Ba[2]]||9;5>U&&(Pa=!0);if(Ba[1]){if(!Da){Da=!0;var Ea="        ".split(" ")}Ea[9-U]+=X}else{if(!Ca){Ca=!0;var Fa="        ".split(" ")}Fa[U-1]+=X;1==U&&(Oa=!0);5==U&&(Na=!0)}}}l||"button"!=u&&"submit"!=u||(b.pressed=!1);if(l||
!m(t)){var X=m(b.same_row)?!w(b.same_row):!Na&&(Oa||!Pa);b._startNewRow=X;R=1*b.indent||0;var ia=q||L._h(h,n,h,d,h,h,b)||b.hide_if_empty&&!p||r&&b.hide_when_readonly||w(f&&f.last?b.hide_with_previous_field:b.hide_if_previous_field_is_not_hidden)||w(f&&f.beforeLast?b.hide_with_previous_previous_field:b.hide_if_previous_previous_field_is_not_hidden)||w(b.hide_with_previous_indented_field)&&f&&f[R]||w(b.hide_with_previous_outdented_field)&&0<R&&f&&f[R-1]||w(b.hide_with_previous_indented_fields)&&!e[R]||
m(b.hide_if_previous_value_is)&&z._iL(b.hide_if_previous_value_isnt,k&&k.last)||m(b.hide_if_previous_value_isnt)&&!z._iL(b.hide_if_previous_value_isnt,k&&k.last)||m(b.hide_if_previous_outdented_value_is)&&0<R&&z._iL(b.hide_if_previous_outdented_value_is,k&&k[R-1])||m(b.hide_if_previous_outdented_value_isnt)&&0<R&&!z._iL(b.hide_if_previous_outdented_value_isnt,k&&k[R-1]);k&&(k.last=p,X&&(k[R]=p));f&&(f.beforeLast=f.last,f.last=ia,X&&(f[R]=ia),m(e.last)&&e.last===R||(e.last<R&&(e[R]=!1),e.last=R),ia||
...
b.multiple_edit&&(e="",f=!r&&m(b.multiple_edit._changed)?w(b.multiple_edit._changed):b.multiple_edit.changed,w(b.multiple_edit.hide_ui)||!b.multiple_edit.select_list?(k=w(b.multiple_edit.hide_ui),e+=ea("type","checkbox","class","multiple_edit","id","multiple_edit__"+d,"checked",f,"style",k?"display: none;":"","disabled",r,"onchange",r||k?"":n.globalName+".meChange(this.checked, '"+J(d)+"');",">")):e+=Ja("class","multiple_edit","id","multiple_edit__"+d,"disabled",r,"onchange",n.globalName+'.meChange(this.value == 1, "'+
ca(d)+'");',za("value","","selected",!f,b.multiple_edit.select_list.not_changed_label||W.notChanged)+za("value",1,"selected",f,b.multiple_edit.select_list.changed_label||W.changed)),v+=e,e=h)}if(!(A&&E||"object"!=typeof b.values))if(A=[],E={},Q&&w(Q.reorder_items)||C&&w(C.reorder_items))for(U in e=p.s(","),e){if(B(e,U)){var V=e[U];A.push(V)}}else{for(V in b.values)B(b.values,V)&&(e=b.values[V],"object"==typeof e?(m(e.parent)&&(ha=!0,E[e.parent]=!0),L._h(e,n,h,V,h,h,b,h,pa)||b.values_visible_if&&!L._e(b.values_visible_if,
...
b.empty_value&&(A=J(b.empty_value));v+=ya(Y,"id",Y+"__"+d,"class",b.css_class,"style",b.style,A)}else if(y=b.snippet){for(Ka in Qa)Y=Qa[Ka],y[Y]&&(v+=ya(Y,"id",Y+"__"+d,"class",y[Y+"_class"],"style",y[Y+"_style"],J(y[Y])));!ia&&y.show_split_values_from&&n.splitValues&&n.splitValues[y.show_split_values_from]&&(v+=n.splitValues[y.show_split_values_from],delete n.splitValues[y.show_split_values_from]);y.html&&(v+=ka("id","snippet__"+d,z._un(y.html)));y.microtemplate&&(v+=ja("id","microtemplate__"+d,
...
J(b.no_values_message)):v+n.hierarchicalBoxes(a,c,d,p,b,ha,r,T,A,E)),v+=n.displayMissingItems(b);else if(Q||C||na){var Ra=na||C&&w(C.multiple_select)||Q&&w(Q.multi);p={id:d,pickerHTML:"",wrappedId:"name_for_"+d,readOnly:r};r||(C&&(C.target_path||C.path)&&!w(C.hide_select_button)&&(p.select={onclick:n.globalName+".pickItems('"+J(d)+"');",phrase:C.select_phrase||W.selectDotDotDot}),Q&&(p.upload={onclick:n.globalName+".upload('"+J(d)+"');",phrase:Q.upload_phrase||W.uploadDotDotDot},w(Q.drag_and_drop)&&
n.upload(d,!0),I.Dropbox&&Dropbox.isBrowserSupported()&&(p.dropbox={onclick:n.globalName+".chooseFromDropbox('"+J(d)+"');",phrase:Q.dropbox_phrase||W.dropboxDotDotDot})));p.pickerHTML+=Ja("id",d,"multiple",Ra,"class",b.css_class,"style",b.style,">");!b.values||_._isEm(T)&&!na||(p.pickerHTML+=n.hierarchicalSelect(T,b,pa,A,ha,E));p.pickerHTML+="</select>";v+=n.microTemplate(n.mtPrefix+"_picked_items",p);a.after(function(){na?n.setupMultipleSelect(b,d,c,r||F):n.setupPickedItems(b,d,c,r,Ra)})}else if(b.captcha)v+=
...
a.after(function(){var D=ace.edit(d),K=!1;D.session.setUseSoftTabs(!1);D.setShowPrintMargin(!1);r&&(D.setReadOnly(!0),D.setBehavioursEnabled(!1));w(b.wrap_text)&&D.session.setUseWrapMode(!0);D.session.setOption("useWorker",!1);D.on("blur",function(Sa){K&&z._aADINS("code_editor_"+d,function(){n.fieldChange(d)},0);K=!1});D.on("change",function(Sa){n.markAsChanged();K=!0;z._aADINS("code_editor_"+d,function(){n.fieldChange(d)},5E3)});var Z;if(Z=b.language)try{var qa="html"==Z;Z=Z.m(/\.twig\.html$/i)?
"ace/mode/twig":Z.m(/\./)?ace.require("ace/ext/modelist").getModeForPath(Z).mode:"ace/mode/"+Z;var Ga=ace.require("ace/ext/language_tools");D.session.setMode(Z);var ra=b.code_editor_options||{};m(ra.enableBasicAutocompletion)||(ra.enableBasicAutocompletion=!qa);m(ra.enableLiveAutocompletion)||(ra.enableLiveAutocompletion=!qa);qa?Ga.setCompleters([]):Ga.setCompleters([Ga.keyWordCompleter]);D.setOptions(ra)}catch(Sa){console.log("Ace editor could not load this language",Z)}D.$blockScrolling=Infinity;
...
try{D.tinymce().remove()}catch(qa){}if(K){var Z=K.style.display;K.style.display="block"}D.tinymce(ba);K&&(K.style.display=Z)});break;case "button":case "submit":case "toggle":La=!0;w(b.use_button_tag)?(v+="<button",Ma=!0):(v+="<input",x.type="button");if(!r||w(b.can_be_pressed_in_view_mode))fa.onclick="lib.clickButton('"+d+"');",delete x.disabled;"toggle"==u&&(x["class"]+=b.pressed?" pressed":" not_pressed");break;default:"textarea"==u?v+="<textarea":da?(la=!0,v+="<input",x.type="text",x["class"]+=
...
"")+"if(this.value && !this.value.m('://') && $.trim(this.value)[0] != '#') this.value = 'http://' + this.value;"):M?(v+="<input",x.type="text",x.onfocus="this.value = $(this).data('og_value');"+(x.onfocus||""),x.onblur="$(this).data('og_value', this.value); this.value = zenarioT._nF(1*this.value, "+aa+");"+(x.onblur||"")):(b.slider&&(ua=!0,v+=n.drawSlider(a,d,b,r,!0)),"text"==u&&b.values&&!r&&(v+='<span class="zenario_textbox_with_autocomplete">',Aa=!0),"checkbox"==u&&b.onoff&&(x["class"]="onoffswitch-checkbox",
...
x.onkeyup=(x.onkeyup||"")+'$("#zenario_slider_for__'+ca(d)+'").slider("value", $(this).val());');m(t)?(N=$.extend({},b,N),oa.id=d+"___"+t,x["class"]+=" control_for__"+d):(N=b,oa.id=d);"radio"==u&&b.name||(oa.name=d);r&&(oa.placeholder="");v+=n.outputAtts(N,x,fa,oa);fa=J(La?b.value:p,!1,"asis");x="";"select"==u?v+=">":Ma?(v+=">",b.icon_left&&(v+='<i class="'+J(b.icon_left)+'" aria-hidden="true"></i>'),v+=fa,b.icon_right&&(v+='<i class="'+J(b.icon_right)+'" aria-hidden="true"></i>'),v+="</button>"):
...
v+"/>";"checkbox"==u&&b.onoff&&(v+=ta("class","onoffswitch-label","for",d,ka("class","onoffswitch-inner")+ka("class","onoffswitch-switch"))+"</div>");"select"==u&&(b.empty_value&&(x=za("value","","data-hide_in_iconselectmenu",1,"selected",!p,J(b.empty_value)),b.show_empty_value_at_end||(v+=x,x="")),b.values&&(T={},T[p]=!0,v+=n.hierarchicalSelect(T,b,pa,A,ha,E)),v=v+(x+"</select>")+n.displayMissingItems(b));if(Aa){var Ha=[];for(U in A)B(A,U)&&(V=A[U],e=b.values[V],_._isSt(e)?Ha.push({label:e,value:V}):
Ha.push({label:e.label,value:V}));a.after(function(){var D=$(n.get(d)),K={source:Ha,minLength:b.autocomplete_min_length||0,appendTo:D.parent()};b.return_key_presses_button&&(K.select=function(){setTimeout(function(){$("#"+b.return_key_presses_button).click()},0)});D.autocomplete(K);m(b.autocomplete)&&D.attr("autocomplete",b.autocomplete);D.focus(function(){D.autocomplete("widget").is(":visible")||D.autocomplete("search","")})});v+=ea("type","button","class","zenario_open_autocomplete","value","\u25be",
"onclick","$("+n.globalName+'.get("'+ca(d)+'")).autocomplete("search", "");')}Aa&&(v+="</span>")}m(t)||("url"!=u||r||(v+="&nbsp; "+ea("type","button","class","submit","value",W.test,"onclick",n.globalName+'.testURL("'+ca(d)+'");'),la=!0),!b.label||"checkbox"!=u&&"radio"!=u||(v+=" "+ta("class",b.label_class,"for",d,"id","label_for__"+d,J(b.label)),la=!0),m(b.post_field_label)&&(v+=" "+ta("for",d,"id","label_for__"+d,J(b.post_field_label)),la=!0),Ca&&(v=Fa.join("")+v),m(b.pre_field_html)&&(v=z._un(b.pre_field_html)+
...
"zenario_field_tooltip","title",b.tooltip,displayItem)),Da&&(v+=Ea.join("")),ua&&(v+=n.drawSlider(a,d,b,r,!1)));return v};g.addExtraAttsForTextFields=function(a,c){};g.copyField=function(a,c){c=this.readField(c);m(c)&&z._co(c)&&(this.tooltips(a,{content:this.vaPhrase("copied")}),$(a).hide(),setTimeout(function(){$(a).show()},0))};var Wa={id:!0,name:!0,size:!0,maxlength:!0,accesskey:!0,"class":!0,cols:!0,dir:!0,readonly:!0,rows:!0,style:!0,tabindex:!0,title:!0,disabled:!0,onblur:!0,onchange:!0,onclick:!0,
ondblclick:!0,onfocus:!0,oninput:!0,onpaste:!0,onmousedown:!0,onmousemove:!0,onmouseout:!0,onmouseover:!0,onmouseup:!0,onkeydown:!0,onkeypress:!0,onkeyup:!0,onselect:!0,autocomplete:!0,autofocus:!0,max:!0,min:!0,pattern:!0,placeholder:!0,required:!0,step:!0},Qa="hr h1 h2 h3 h4 label div p span".split(" ");g.outputAtts=function(a,c,d,b,e){var f,k="";for(f in a)if(B(a,f)&&!(b&&m(b[f])||!e&&!Wa[f]&&"data-"!=f.substr(0,5)))if("disabled"==f||"readonly"==f||"selected"==f){if(w(a[f])||c&&w(c[f])&&delete c[f])k+=
...
"$1");break;case 4:b=b.r(/(\d*\.\d\d\d\d)\d*/,"$1")}b=e+b;a.value!=b&&(a.value=b)};g.hierarchicalSelect=function(a,c,d,b,e,f,k){var l="",q,t;for(t in b)if(B(b,t)){var p=b[t];var r=c.values[p];if(r!==h){var A=q=!1;if(_._isSt(r))r={label:r};else if(w(r.disabled)||r.disabled_if&&L._e(r.disabled_if,this,r,h,p,h,h,c,h,d)||c.values_disabled_if&&L._e(c.values_disabled_if,this,r,h,p,h,h,c,h,d))q=!0;a[p]&&(A=!0);var E=!w(r.hide_when_children_are_not_visible);if(!m(k)&&e&&f[p]){if((childrenHTML=this.hierarchicalSelect(a,
c,d,b,e,f,p))||E)l+=ya("optgroup","label",r,"disabled",!childrenHTML,childrenHTML)}else E&&k===r.parent&&(l+="<option "+this.outputAtts(r,!1,!1,{disabled:q,selected:A,value:p})+">"+J(r,!1,!0)+"</option>")}}return l};g.setupMultipleSelect=function(a,c,d,b){var e=this,f=!1;d=$(e.get(c));d.multiselect({columns:a.cols,texts:{placeholder:a.empty_value||W.selectListSelect,overridePlaceholder:a.placeholder},onOptionClick:function(){f=!0},onControlClose:function(){f&&e.fieldChange(c)}});b&&d.multiselect("disable")};
g.typeaheadSearchEnabled=function(a,c,d){};g.typeaheadSearchAJAXURL=function(a,c,d){};g.parseTypeaheadSearch=function(a,c,d,b,e){};var va=!1;g.setupPickedItems=function(a,c,d,b,e){var f=this,k,l,q=a.pick_items||{},t=a.upload||{},p=w(q.allow_typing_anything),r=w(t.reorder_items||q.reorder_items);f.typeaheadSearchEnabled(a,c,d)&&(k=f.typeaheadSearchAJAXURL(a,c,d))&&(l="_search");l=$(f.get(c)).tokenize({datas:k,searchParam:l,debounce:200,nbDropdownElements:30,sortable:r,placeholder:q.nothing_selected_phrase||
t.nothing_selected_phrase||W.nothing_selected,onAddToken:function(A,E,N){f._tokenizeNoRecurse||(va&&(clearTimeout(va),va=!1),e?f.pickedItemsChanged(c,a):f.addToPickedItems(A,c,d),f.$getPickItemsInput(c).focus(),f.tooltips("#name_for_"+c+" .TokensContainer *[title]"))},maxElements:e?0:1,parseData:function(A){return f.parseTypeaheadSearch(f.tuix.tabs[d].fields[c],c,d,b,A)},formatTokenHTML:function(A,E){var N=f.tuix.tabs[d].fields[c];return N.values&&N.values[A]?f.drawPickedItem(A,c,N,b):p?(N.values=
N.values||{},N.values[A]=E,f.drawPickedItem(A,c,N,b)):!1},onRemoveToken:function(A,E){f._tokenizeNoRecurse||f.removeFromPickedItems(A,c,d)}});b?l.disable():(r&&l.container.addClass("zenario_reorder_items"),k||p?(l.container.addClass("zenario_picker_with_typeahead"),p&&f.$getPickItemsInput(c).blur(function(){var A,E;if(A=f.$getPickItemsInput(c).val())va=setTimeout(function(){E={};E[A]=A;f.addToPickedItems(E,c,d)},150)})):l.disableTypeAhead())};g.chooseFromDropbox=function(a){var c=this,d,b,e;if(!(d=
c.field(a))||!d.upload)return!1;if(e=d.upload.extensions||d.upload.accept)e=_._isSt(e)?e.s(","):_._tA(e);for(b in e)if(B(e,b)){var f=e[b];var k=f.s("/");m(k[1])?e[b]="images"==k[0]?"image":k[0]:"text"!=f&&"documents"!=f&&"images"!=f&&"video"!=f&&"audio"!=f&&"."!=f.substr(0,1)&&(e[b]="."+f)}d={cancel:function(){O._hAL()},linkType:"direct",multiselect:!!w(d.upload.multi),extensions:e,success:function(l){O._sAL();var q,t=new z.callback;for(q in l)if(B(l,q)){var p=l[q];t.add(z._a(c.ajaxURL()+"&fetchFromDropbox=1",
p,!0))}t.after(function(){var r,A,E,N="";if(!(E=c.field(a))||!E.upload)return!1;for(r in arguments)B(arguments,r)&&((A=arguments[r])&&A.id&&(N+=","+A.id),c.setFileDetails(E,A));""!==N&&c.addToPickedItems(N,a);O._hAL()})}};O._sAL();Dropbox.choose(d)};g.setFileDetails=function(a,c){a.values||(a.values={});c.label=this.formatLabelFromFile(c);a.values[c.id]=c};g.formatLabelFromFile=function(a){if(m(a.filename)){var c=a.filename;a.ssc&&(c+=" [checksum "+a.short_checksum+"]");w(a.width)&&w(a.height)&&(c+=
" ["+a.width+" \u00d7 "+a.height+"px]")}else(fileDetails=z._dIIFO(a.id))&&(fileDetails=fileDetails.s("/"))&&fileDetails[1]?(c=fileDetails[1],w(fileDetails[2])&&w(fileDetails[3])&&(c+=" ["+fileDetails[2]+" \u00d7 "+fileDetails[3]+"px]")):c=a.id;return c};g.upload=function(a,c){var d=this,b;if(!(b=d.field(a))||!b.upload)return!1;b={class_name:b.class_name,upload:b.upload};d.uploadCallback=function(e){if(e){var f,k,l,q="";if(!(l=d.field(a))||!l.upload)return!1;for(f in e)B(e,f)&&(k=e[f])&&k.id&&(q+=
","+k.id,d.setFileDetails(l,k));""!==q&&d.addToPickedItems(q,a)}};c?d.enableDragDropUpload():L._a(d,b,h,h,h,{fileUpload:1},h,d.ajaxURL())};g.ajaxURL=function(){return G+"zenario/ajax.php?method_call=handleAdminBoxAJAX&path="+xa(this.path)};g.enableDragDropUpload=function(){};g.disableDragDropUpload=function(){};g.uploadComplete=function(a){m(this.uploadCallback)&&this.uploadCallback(a);delete this.uploadCallback};g.drawSlider=function(a,c,d,b,e){var f=this,k=_._cl(d.slider);d="";if(w(k.before_field)?
e:!e)b&&(d+='<div class="ui-disabled">'),d+=ja("id","zenario_slider_for__"+c,"class",k["class"],"style",k.style),b&&(d+="</div>"),a.after(function(){var l;if(l=f.get("zenario_slider_for__"+c))m(k.min)&&(k.min=z.num(k.min)),m(k.max)&&(k.max=z.num(k.max)),m(k.step)&&(k.step=z.num(k.step)),k.disabled=!f.editModeOn(),k.value=$(f.get(c)).val(),k.slide=function(q,t){$(f.get(c)).val(t.value)},k.change=function(q,t){f.fieldChange(c)},$(l).slider(k)});return d};g.lookupFileDetails=function(a){return O._lFD(a)};
g.displayMissingItems=function(a){var c="",d=this.tuix.missing_items_warning,b=[],e;if(!m(d)||!d||!a.value)return"";var f=(a.value+"").s(",");for(e in f)if(B(f,e)){var k=f[e];a.values&&a.values[k]||b.push("#"+J(k))}b.length&&(c=ja("class","zenario_missing_items",z._aMF(d,{items:b.join(", ")})));return c};g.pickedItemsArray=function(a,c){if(!1===c||!m(c))return{};a.values&&_._isSt(a.values)&&this.tuix.lovs&&this.tuix.lovs[a.values]&&(a.values=this.tuix.lovs[a.values]);if(!(0!==c&&"0"!==c||a.values&&
(a.values[0]||a.values["0"])))return{};c=(c+"").s(",");var d={},b,e,f,k,l;a._display_value=!1;for(k in c)if(B(c,k)&&(l=c[k])){if(a.upload&&(f=z._dIIFO(l))&&(f=f.s("/"))&&f[1])d[l]=f[1],w(f[2])&&w(f[3])&&(d[l]+=" ["+f[2]+" \u00d7 "+f[3]+"px]");else if(a.values&&a.values[l]&&"string"==typeof a.values[l])d[l]=a.values[l];else if(a.values&&a.values[l]&&a.values[l].label)d[l]=a.values[l].label;else if(((e=a.pick_items&&a.pick_items.target_path)||(e=a.pick_items&&a.pick_items.path))&&(b=O._gIFO(e,l,h,a.pick_items.add_conductor_vars_to_type_ahead_search?
this.getConductorVars():h))){a.values||(a.values={});var q=O._fOIN(b,l);var t=b.items&&b.items[l]||{missing:!0};d[l]=q;a.values[l]={missing:t.missing,image:t.image,css_class:t.css_class||b.item&&b.item.css_class,label:q}}else a.upload&&l==1*l&&(f=this.lookupFileDetails(l))?(this.setFileDetails(a,f),d[l]=a.values[l]):d[l]=l;!1===a._display_value&&(a._display_value=d[l])}return d};g.pickedItemsValue=function(a){var c,d="";if(a)for(c in a)B(a,c)&&(d+=(""===d?"":",")+c);return d};g.displaySelectedItems=
function(a,c,d,b){m(c)||(c=this.field(a,b));m(d)||(d=this.value(a,b));a=this.pickedItemsArray(c,d);return _._isEm(a)?w(d)?d:m(c.empty_value)?c.empty_value:"":_._tA(a).join(", ")};g.hierarchicalBoxes=function(a,c,d,b,e,f,k,l,q,t,p,r,A){var E=this,N=1*e.cols||1,n=0,u="",Q=!1;if(!A)A=0,N=1*e.cols_at_top_level||N;else if(10<A)return"";r||(r={});p&&(r[p]=!0);A&&(u+=ja("class","zenario_hierarchical_box_children","id","children_for___"+d+"___"+p,">"));for(var C in q)if(B(q,C)){var F={};var y=q[C];y==1*y&&
(y*=1);var M=h;var da="object"==typeof e.values[y]?e.values[y]:{label:e.values[y]};e.tag_colors&&(F.tag_color=e.tag_colors[y]||"blue");M=da.parent;"0"===M&&(M=!1);if(!p&&!M||p==M){M=b?!0===b||1===b||"1"===b?!0===y||1===y||"1"===y:l?m(l[y])?!0:!1:y==b:!y;if(!k||M||!e.hide_unselected_values_when_readonly||t[y]){F.checked=M;if(F.newRow=++n>N)n=1;F.col=n;F.cols=N;if("checkboxes"==e.type&&w(e.checking_child_checks_parents)){var S="";p&&(S+="if (this.checked) { for (var cb in "+JSON.stringify(r)+") { "+
E.globalName+".get('"+J(d)+"___' + cb).checked = true; } } ");t[y]&&(S+="if (!this.checked) { $('#children_for___' + this.id + ' input').prop('checked', false); } ");S?f.onchange=e.onchange?S+" "+e.onchange:S:e.onchange?f.onchange=e.onchange:delete f.onchange}else"checkboxes"==e.type&&w(e.checking_parent_checks_children)&&(S="",t[y]&&(S+="if (this.checked) { $('#children_for___' + this.id + ' input').each(function(i, el) {el.checked = true;}) }; "),S?f.onchange=e.onchange?S+" "+e.onchange:S:e.onchange?
f.onchange=e.onchange:delete f.onchange);F.lovId=d+"___"+y;F.lovField=da;e.indeterminates&&w(e.indeterminates[y])&&function(aa){a.after(function(){var ma;if(ma=E.get(aa))ma.indeterminate=!0})}(F.lovId);F.lovHTML=E.drawField(a,c,d,f,h,h,h,h,h,y,M,!1,q,t,da);F.childrenHTML="";t[y]&&(F.childrenHTML=E.hierarchicalBoxes(a,c,d,b,e,f,k,l,q,t,y,_._ex({},r),A+1),n=0);Q?(E.splitValues||(E.splitValues={}),E.splitValues[d]||(E.splitValues[d]=""),E.splitValues[d]+=E.microTemplate(E.mtPrefix+"_radio_or_checkbox",
F)):u+=E.microTemplate(E.mtPrefix+"_radio_or_checkbox",F)}M&&da.split_values_if_selected&&!A&&"radios"===e.type&&(Q=!0)}}A&&(u+="</div>");return u};g.drawPickedItem=function(a,c,d,b,e){m(d)||(d=this.field(c));label=d.values&&d.values[a];pick_items=d.pick_items||{};thumbnail={};mi={};_._isOb(label)?_._ex(mi,label):label?mi.label=label:(mi.label=a,mi.missing=!0);mi.id=c;mi.item=a;mi.readOnly=b;mi.width&&mi.height&&((a=mi.checksum||mi.short_checksum)?(thumbnail.src=G+"zenario/file.php?c="+xa(a)+"&og=1",
mi.usage&&(thumbnail.src+="&usage="+xa(mi.usage))):mi.link&&(thumbnail.src=z._aBP(mi.link)),thumbnail.src&&(L._rI(mi.width,mi.height,180,120,thumbnail),mi.thumbnail=thumbnail));return this.drawPickedItem2(c,pick_items,e,mi)};g.drawPickedItem2=function(a,c,d,b){var e=this;return d?(e.__addTT=!0,setTimeout(function(){e.__addTT&&e.tooltips("#name_for_"+a+" .Dropdown *[title]");delete e.__addTT},1),e.microTemplate(c.dropdown_item_microtemplate||e.mtPrefix+"_dropdown_item",b)):e.microTemplate(c.picked_item_microtemplate||
e.mtPrefix+"_picked_item",b)};g.showPickedItemInPopout=function(a,c){L._a(this,{popout:{href:a,title:c,css_class:"zenario_show_colobox_above_fab"}})};g.pickItems=function(a){var c,d,b,e;(c=this.field(a))&&(d=c.pick_items)&&(d.path||d.target_path)&&(c=e=d.path,Ia.map&&(e=Ia._cNPTTP(d.path).path),w(d.multiple_select)||d.target_path&&d.target_path!=e||!(b=this.readField(a))||-1!=b.indexOf(",")||(c="//"==z._rHSS(c,2)?c+b:"/"==z._rHSS(c,1)?c+("/"+b):c+("//"+b)),this.SKTarget=a,O._oS(this.globalName,"setPickedItems",
d.multiple_select,c,d.target_path,d.min_path,d.max_path,d.disallow_refiners_looping_on_min_path,h,d.one_to_one_choose_phrase,d.one_to_many_choose_phrase,h,!0,h,h,h,h,h,h,h,h,d))};g.setPickedItems=function(a,c,d,b){a=this.SKTarget;var e,f={};for(e in c._items)if(B(c._items,e)){d=z._dIIFO(e);var k=b.items&&b.items[d]||{missing:!0};f[d]={missing:k.missing,image:k.image,css_class:k.css_class||b.item&&b.item.css_class,label:O._fOIN(b,d)}}this.addToPickedItems(f,a)};g.removeFromPickedItems=function(a,c,
d){this.addToPickedItems(a,c,d,!0)};g.addToPickedItems=function(a,c,d,b){this._tokenizeNoRecurse=!0;d=this.field(c,d);var e=this.readField(c),f=d.pick_items&&w(d.pick_items.multiple_select)||d.upload&&w(d.upload.multi),k,l={};a=L._cTO(a);var q=e?this.pickedItemsArray(d,e):{};for(k in a)if(B(a,k))if(e=a[k],d.values||(d.values={}),b)delete d.values[k];else if(d.values[k]||(d.values[k]=e),q[k]&&(l[k]=!0),f)q[k]=!0;else{q={};q[k]=!0;break}this.redrawPickedItems(c,d,q,l);this._tokenizeNoRecurse=!1};g.redrawPickedItems=
