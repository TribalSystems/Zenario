...
e});break;case R:case ca:case "toggle":ia=!0;p(b.use_button_tag)?(m+="<"+R,ja=!0):(m+="<input",x.type=R);if(!s||p(b.can_be_pressed_in_view_mode))da.onclick="lib.clickButton(this, '"+d+"');",delete x.disabled;"toggle"==t&&(x[C]+=b.pressed?" pressed":" not_pressed");break;default:"textarea"==t?m+="<textarea":N?(m+='<span class="zenario_datepicker_wrap"><input',x.type="text",x[C]+=" zenario_datepicker",x.readonly="readonly",s||(x.onkeyup=(x.onkeyup||"")+"zenario._dFKU(this, event, '"+H(d)+"');"),a.after(function(){var a=
$(L.get(d)),e=!!p(b.change_month_and_year);a.datepicker({changeMonth:e,changeYear:e,dateFormat:F.siteSettings&&F.siteSettings.organizer_date_format||q.dpf,altField:"#_value_for__"+d,altFormat:"yy-mm-dd",showOn:"focus",disabled:s,onSelect:function(b,e){a.change()}})})):"url"==t?(m+="<input",x.type="url",x.onfocus=(x.onfocus||"")+"if(!this.value) this.value = 'http://';",x.onblur=(x.onblur||"")+"if(this.value == 'http://') this.value = '';"):(b.slider&&(T=!0,m+=this.drawSlider(a,d,b,s,!0)),"text"==
t&&b.values&&!s&&(m+='<span class="zenario_textbox_with_autocomplete">',aa=!0),m+="<input",x.type=t),this.addExtraAttsForTextFields(b,x)}if("checkbox"==t||"radio"==t)p(l)&&(x.checked="checked"),l=h,s&&(x.disabled=!0),p(b.indeterminate)&&a.after(function(){var a;if(a=this.get(d))a.indeterminate=!0});T&&(x.onchange='$("#zenario_slider_for__'+W(d)+'").slider("value", $(this).val());',x.onkeyup=(x.onkeyup||"")+'$("#zenario_slider_for__'+W(d)+'").slider("value", $(this).val());');r===h?(V=b,ma.id=d):(V=
...
t||s||(m+="&nbsp; "+ha(X,R,C,ca,I,Q.test,la,this.globalName+'.testURL("'+W(d)+'");')),!b.label||"checkbox"!=t&&"radio"!=t&&"toggle"!=t||(m+=" "+ga("label",C,b.label_class,"for",d,"id","label_for__"+d,H(b.label))),b.post_field_label!==h&&(m+=" "+ga("label","for",d,"id","label_for__"+d,H(b.post_field_label))),b.post_field_html!==h&&(m+=q._un(b.post_field_html)),sa&&(m+=oa.join("")),T&&(m+=this.drawSlider(a,d,b,s,!1)));return m};f.addExtraAttsForTextFields=function(a,e){};var Ia={id:!0,name:!0,size:!0,
maxlength:!0,accesskey:!0,"class":!0,cols:!0,dir:!0,readonly:!0,rows:!0,style:!0,tabindex:!0,title:!0,disabled:!0,onblur:!0,onchange:!0,onclick:!0,ondblclick:!0,onfocus:!0,onmousedown:!0,onmousemove:!0,onmouseout:!0,onmouseover:!0,onmouseup:!0,onkeydown:!0,onkeypress:!0,onkeyup:!0,onselect:!0,autocomplete:!0,autofocus:!0,max:!0,min:!0,pattern:!0,placeholder:!0,required:!0,step:!0},xa="hr h1 h2 h3 h4 label".split(" ");f.outputAtts=function(a,e,d,b,k){var g,f="";for(g in a)if(u(a,g)&&(!b||b[g]==h)&&
(k||Ia[g]||"data-"==g.substr(0,5)))if("disabled"==g||"readonly"==g||"selected"==g){if(p(a[g])||e&&p(e[g])&&delete e[g])f+=" "+g+'="'+g+'"'}else f+=" "+g+'="'+this.defineLibVarBeforeCode(g),e&&e[g]&&(f+=e[g]+" ",delete e[g]),f+=H(a[g]),d&&d[g]&&(f+=" "+d[g],delete d[g]),f+='"';b&&(f+=this.outputAtts(b,!1,!1,!1,!0));e&&(f+=this.outputAtts(e,!1,!1,!1,!0));d&&(f+=this.outputAtts(d,!1,!1,!1,!0));return f};f.defineLibVarBeforeCode=function(a){if(a===h||"on"==a.substr(0,2)){if(!this.globalName){for(a=1;fa[this.globalName=
"zenarioLib"+a];++a);fa[globalName]=this}return"var lib = "+H(this.globalName)+"; "}return""};f.testURL=function(a){var e=this.get(a).value;a=this.get(this.onThisRow("target_blank_",a))||this.get(this.onThisRow("target_blank",a));if(e)if(a&&2==a.value)$[Ga]({href:e,iframe:!0,width:"95%",height:"95%",className:M+"url_test_colorbox"});else fa.open(q._aBP(e))};f.keepNumeric=function(a){var e=a.value.replace(/[^\d\.]/g,"").replace(/\.(.*)\./g,".$1");a.value!=e&&(a.value=e)};f.hierarchicalSelect=function(a,
e,d,b,k,g){var f="",A,n,r,l,s;for(l in d)if(u(d,l)){s=d[l];r=e.values[s];n=A=!1;if(_._iS(r))r={label:r};else if(p(r.disabled)||r.disabled_if!==h&&K._e(r.disabled_if,this,r,h,s,h,h,e))A=!0;a[s]&&(n=!0);showWithoutChildren=!p(r.hide_when_children_are_not_visible);if(g===h&&b&&k[s]){if((childrenHTML=this.hierarchicalSelect(a,e,d,b,k,s))||showWithoutChildren)f+=ga("optgroup","label",r,"disabled",!childrenHTML,childrenHTML)}else showWithoutChildren&&g===r.parent&&(f+="<option "+this.outputAtts(r,!1,!1,
{disabled:A,selected:n,value:s})+">"+H(r,!1,!0)+"</option>")}return f};f.setupMultipleSelect=function(a,e,d,b){var k=this,g=!1;e=$(this.get(a));e.multiselect({columns:d.cols,texts:{placeholder:d.empty_value||Q.selectListSelect,overridePlaceholder:d.placeholder},onOptionClick:function(){g=!0},onControlClose:function(){g&&k.fieldChange(a)}});b&&e.multiselect("disable")};f.setupPickedItems=function(a,e,d,b,k){var g=this,f=!1,h=!1,n,r,l,s,w=d.pick_items||{},C=d.upload||{};if(d.pick_items&&!p(w.disable_type_ahead_search)){n=
