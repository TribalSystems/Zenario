...
return JSON.stringify(a)};g.syncAdminBoxFromClientToServerR=function(a,d,b,f,e,g,p,n){if("object"==typeof d){var l,m;for(m in d)if((l="array")&&b===h&&"_sync"==m||(l="value")&&f===h&&"_sync"==b&&"session"==m||(l="value")&&f===h&&"_sync"==b&&"cache_dir"==m||(l="value")&&f===h&&"_sync"==b&&"password"==m||(l="value")&&f===h&&"_sync"==b&&"iv"==m||(l="value")&&b===h&&"shake"==m||(l="value")&&b===h&&"download"==m||(l="array")&&b===h&&"tabs"==m||(l="array")&&f===h&&"tabs"==b||(l="array")&&e===h&&"tabs"==
f&&"edit_mode"==m||(l="value")&&g===h&&"tabs"==e&&"edit_mode"==b&&"on"==m||(l="array")&&e===h&&"tabs"==f&&"fields"==m||(l="array")&&g===h&&"tabs"==e&&"fields"==b||(l="value")&&p===h&&"tabs"==g&&"fields"==f&&"current_value"==m||(l="value")&&p===h&&"tabs"==g&&"fields"==f&&"_display_value"==m||(l="value")&&p===h&&"tabs"==g&&"fields"==f&&"_was_hidden_before"==m||(l="value")&&p===h&&"tabs"==g&&"fields"==f&&"pressed"==m||(l="array")&&p===h&&"tabs"==g&&"fields"==f&&"multiple_edit"==m||(l="value")&&n===h&&
"tabs"==p&&"fields"==e&&"multiple_edit"==b&&"_changed"==m)"value"==l?"function"!=typeof d[m]&&"object"!=typeof d[m]&&(a[m]=d[m]):"array"==l&&"object"==typeof d[m]&&(a[m]={},this.syncAdminBoxFromClientToServerR(a[m],d[m],m,b,f,e,g,p))}};g.getValueArrayofArrays=function(a){return x._nAA(this.getURL(),x._uR({_read_values:!0,_box:this.sendStateToServer()}),!a)};g.getValues1D=function(a,d,b,f,e){var g,r,n,l,m,q={};if(this.tuix&&this.tuix.tabs)for(g in this.tuix.tabs)if(u(this.tuix.tabs,g)&&(r=this.tuix.tabs[g],
...
!g.errorOnTab(g.tuix.tab)&&d!==h&&(g.tuix.tab=d);g.sortTabs();g.switchToATabWithErrors();g.draw();f&&f()},"loading")}}},zenarioF);
