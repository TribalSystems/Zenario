...
this.tabHidden=!1;this.changes(this.tuix.tab)?$(d).addClass("zenario_abtab_changed"):$(d).removeClass("zenario_abtab_changed");e.call();!b&&this.lastFieldInFocus&&(f=w(this.lastFieldInFocus))&&f.focus()};h.hideShowFields=function(a){var e=$(".zenario_hide_on_open"),b=$(".zenario_hide_row_on_open"),d=$(".zenario_show_on_open"),f=function(b,a){a.style.display="none"};d.length&&!e.length?d.show("blind",200,a):!d.length&&e.length?e.hide("blind",200,function(){b.each(f)}):d.length&&e.length&&(e.each(f),
...
h.sendStateToServerDiff=function(){var a={};this.syncAdminBoxFromClientToServerR(a,this.tuix);return JSON.stringify(a)};h.syncAdminBoxFromClientToServerR=function(a,e,b,d,f,g,h,q){if("object"==typeof e){var l,m;for(m in e)if((l="array")&&b===k&&"_sync"==m||(l="value")&&d===k&&"_sync"==b&&"session"==m||(l="value")&&d===k&&"_sync"==b&&"cache_dir"==m||(l="value")&&d===k&&"_sync"==b&&"password"==m||(l="value")&&d===k&&"_sync"==b&&"iv"==m||(l="array")&&b===k&&"key"==m||(l="value")&&d===k&&"key"==b||(l=
"value")&&b===k&&"shake"==m||(l="value")&&b===k&&"download"==m||(l="array")&&b===k&&"tabs"==m||(l="array")&&d===k&&"tabs"==b||(l="array")&&f===k&&"tabs"==d&&"edit_mode"==m||(l="value")&&g===k&&"tabs"==f&&"edit_mode"==b&&"on"==m||(l="array")&&f===k&&"tabs"==d&&"fields"==m||(l="array")&&g===k&&"tabs"==f&&"fields"==b||(l="value")&&h===k&&"tabs"==g&&"fields"==d&&"current_value"==m||(l="value")&&h===k&&"tabs"==g&&"fields"==d&&"_display_value"==m||(l="value")&&h===k&&"tabs"==g&&"fields"==d&&"_was_hidden_before"==
m||(l="value")&&h===k&&"tabs"==g&&"fields"==d&&"pressed"==m||(l="array")&&h===k&&"tabs"==g&&"fields"==d&&"multiple_edit"==m||(l="value")&&q===k&&"tabs"==h&&"fields"==f&&"multiple_edit"==b&&"_changed"==m)"value"==l?"function"!=typeof e[m]&&"object"!=typeof e[m]&&(a[m]=e[m]):"array"==l&&"object"==typeof e[m]&&(a[m]={},this.syncAdminBoxFromClientToServerR(a[m],e[m],m,b,d,f,g,h))}};h.getValueArrayofArrays=function(a){return y.nonAsyncAJAX(this.getURL(),y.urlRequest({_read_values:!0,_box:this.sendStateToServer()}),
!a)};h.getValues1D=function(a,e,b,d,f){var g,h,r,l,m,p={};if(this.tuix&&this.tuix.tabs)for(g in this.tuix.tabs)if(t(this.tuix.tabs,g)&&(h=this.tuix.tabs[g],h.fields))for(r in h.fields)t(h.fields,r)&&(l=h.fields[r],m=r,this.isFormField(l)&&!(d&&(!this.editModeOn(g)||q(l.read_only))||f&&(l._was_hidden_before||q(l.read_only))||a&&!(m=l.plugin_setting&&l.plugin_setting.name))&&(l=this.currentValue(r,g,b),e||(p[m]=l),e||e===k))&&(p[g+"/"+r]=l);return p};h.callFunctionOnEditors=function(a){var e,b,d;if(N.tinyMCE&&
(e=this.fields()))for(b in e)if(t(e,b)&&(d=e[b],"editor"==d.type&&tinyMCE.get(b)))if("remove"==a)tinyMCE.get(b).remove();else if("isDirty"==a&&tinyMCE.get(b).isDirty())return!0;return!1};h.format=function(a){var e;if(this.loaded&&(e=this.getURL("format"))){var b=this;this.loaded=!1;this.hideTab();this.checkValues(a);this.retryAJAX(e,{_format:!0,_box:this.sendStateToServer()},function(a){b.load(a);b.sortTabs();b.draw()},"loading")}};h.validate=function(a,e,b,d){var f;if(this.loaded&&(f=this.getURL("validate"))){this.differentTab=
a;this.loaded=!1;this.hideTab(a);this.checkValues(b);var g=this;this.retryAJAX(f,{_validate:!0,_box:this.sendStateToServer()},function(a){g.load(a)&&!g.errorOnTab(g.tuix.tab)&&e!==k&&(g.tuix.tab=e);g.sortTabs();g.switchToATabWithErrors();g.draw();d&&d()},"loading")}}},zenarioF);
