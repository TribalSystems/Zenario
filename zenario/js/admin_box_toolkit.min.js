...
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(g,m,d){if(!d||null!=g){d=$jscomp.propertyToPolyfillSymbol[m];if(null==d)return g[m];d=g[d];return void 0!==d?d:g[m]}};
$jscomp.polyfill=function(g,m,d,p){m&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(g,m,d,p):$jscomp.polyfillUnisolated(g,m,d,p))};$jscomp.polyfillUnisolated=function(g,m,d,p){d=$jscomp.global;g=g.split(".");for(p=0;p<g.length-1;p++){var t=g[p];if(!(t in d))return;d=d[t]}g=g[g.length-1];p=d[g];m=m(p);m!=p&&null!=m&&$jscomp.defineProperty(d,g,{configurable:!0,writable:!0,value:m})};
