...
encodeURIComponent(this.path)+"&path="+encodeURIComponent(p.path)+d._uR(p.lastRequests)+d._uR(this.getRequestKey):r+"zenario/admin/admin_boxes.ajax.php?path="+encodeURIComponent(this.path)+d._uR(this.getRequestKey)};b.pluginPreviewDetails=function(a,c,b){var f=_._cl(g.importantGetRequests),h,k=!b;switch(this.path){case "zenario_skin_editor":k=!1;case "plugin_css_and_framework":b="overrideFrameworkAndCSS";h=JSON.stringify(this.getValues1D(!1,!0,!1,!0,!0));break;case "plugin_settings":b="overrideSettings";
h=JSON.stringify(this.getValues1D(!0,!1));break;default:return!1}f.cVersion=d.cVersion;a=a||this.tuix&&this.tuix.key&&this.tuix.key.slotName;c=c||this.tuix&&this.tuix.key&&this.tuix.key.instanceId||d.slots&&d.slots[a]&&d.slots[a].instanceId;if(k){if(!a||!c)return!1;var e=g._gGSD(a),l,k=e&&e.cssClass&&e.cssClass.split(" ")||[];f.method_call="showSingleSlot";f.fakeLayout=1;f.grid_columns=e.columns;f.grid_container=e.container;this.previewSlotWidth=e.pxWidth;this.previewSlotWidthInfo=e.widthInfo;f.grid_pxWidth=
this.previewWidth?this.previewWidth:this.previewSlotWidth;f.grid_cssClass="";for(l in k)q(k,l)&&(e=k[l],"alpha"==e||"omega"==e||e.match(/^span[\d_]*$/)||(f.grid_cssClass+=e+" "))}else f._show_page_preview=1;a&&(f.slotName=a);c&&(f.instanceId=c);return{url:d._lTI(d.cID,d.cType,f),postName:b,postValues:h}};b.addExtraAttsForTextFields=function(a,c){this.hasPreviewWindow&&(c.onkeyup=u(c.onkeyup,"","")+" "+this.globalName+".updatePreview();")};b.fieldChange=function(a,c){this.updatePreview(750);t(v).fieldChange.call(this,
a,c)};b.updatePreview=function(a){var c=this;this.hasPreviewWindow&&!this.previewHidden&&d._aADINS("fabUpdatePreview",function(){var a=c.pluginPreviewDetails();a&&c.lastPreviewValues!=a.postValues&&(c.lastPreviewValues=c.previewValues=a.postValues,c.submitPreview(a,"zenario_fabPreviewFrame"))},a||1E3)};b.submitPreview=function(a,c){$('<form action="'+m(a.url)+'" method="post" target="'+m(c)+'"><input name="'+m(a.postName)+'" value="'+m(a.postValues)+'"/></form>').appendTo("body").hide().submit().remove()};
b.showPreviewInPopoutBox=function(a){var c,b=this,f=this.pluginPreviewDetails(e,e,a);f&&(this.previewValues=f.postValues,a=f.url+"&"+encodeURIComponent(f.postName)+"="+encodeURIComponent(f.postValues),a.length>=(d._bII()?2E3:4E3)&&(a="",c=function(){b.submitPreview(f,$("#cboxLoadedContent iframe").attr("name"))}),$.colorbox({width:"95%",height:"90%",iframe:!0,preloading:!1,open:!0,title:this.previewSlotWidthInfo||s.preview,className:"zenario_plugin_preview_popout_box",href:a,onComplete:c}),$("#colorbox,#cboxOverlay,#cboxWrapper").css("z-index",
"333000"))};b.editModeOn=function(a){if(!this.tuix||!this.tuix.tabs)return!1;a||(a=this.tuix.tab);return this.tuix.tabs[a].edit_mode?this.tuix.tabs[a].edit_mode.on=h(this.tuix.tabs[a].edit_mode.enabled)&&(h(this.tuix.tabs[a].edit_mode.on)||this.editModeAlwaysOn(a)):!1};b.editModeAlwaysOn=function(a){return this.tuix.tabs[a].edit_mode.always_on===e||h(this.tuix.tabs[a].edit_mode.always_on)||this.savedAndContinued(a)};b.editCancelEnabled=function(a){return this.tuix.tabs[a].edit_mode&&h(this.tuix.tabs[a].edit_mode.enabled)&&
!this.editModeAlwaysOn(a)};b.revertEnabled=function(a){return this.tuix.tabs[a].edit_mode&&h(this.tuix.tabs[a].edit_mode.enabled)&&this.editModeAlwaysOn(a)&&!this.savedAndContinued(a)&&(this.tuix.tabs[a].edit_mode.enable_revert===e&&this.tuix.key&&this.tuix.key.id||h(this.tuix.tabs[a].edit_mode.enable_revert))};b.savedAndContinued=function(a){return!1};b.editModeOnBox=function(){if(this.tuix&&this.tuix.tabs&&this.sortedTabs)for(var a in this.sortedTabs)if(q(this.sortedTabs,a)&&this.editModeOn(this.sortedTabs[a]))return!0;
...
a,function(a){e.save2(a,c,b)},"saving"))};b.save2=function(a,b,d){delete this.saving;"\x3c!--Valid--\x3e"==(""+a).substr(0,12)?(a=a.substr(12),"\x3c!--Confirm--\x3e"==(""+a).substr(0,14)?(a=a.substr(14),this.load(a),this.sortTabs(),this.draw(),this.showConfirm(b,d)):"\x3c!--Download--\x3e"==(""+a).substr(0,15)?(l("zenario_iframe_form").action=this.getURL("download"),l("zenario_iframe_form").innerHTML='<input type="hidden" name="_download" value="1"/><input type="hidden" name="_box" value="'+m(this.sendStateToServer())+
'"/>',l("zenario_iframe_form").submit(),b&&(a=a.substr(15),this.load(a)),this.refreshParentAndClose(!0,b,d)):"\x3c!--Saved--\x3e"==(""+a).substr(0,12)?(a=a.substr(12),this.load(a),this.refreshParentAndClose(!1,b,d)):(this.close(),g._sM(a,!0,"error"))):(this.load(a),this.sortTabs(),this.switchToATabWithErrors(),this.draw())};b.showConfirm=function(a,b){if(this.tuix&&this.tuix.confirm&&h(this.tuix.confirm.show)){var d=this.tuix.confirm.message;h(this.tuix.confirm.html)||(d=m(d,!0));var e='<input type="button" class="submit_selected" value="'+
this.tuix.confirm.button_message+'" onclick="'+this.globalName+".save(true, "+h(a)+", "+h(b)+');"/><input type="button" class="submit" value="'+this.tuix.confirm.cancel_button_message+'" onclick="zenarioA._cFB();"/>';g._flBo(d,e,u(this.tuix.confirm.message_type,"none"))}};b.stopPoking=function(){this.poking&&clearInterval(this.poking);this.poking=!1};b.startPoking=function(){this.poking||(this.poking=setInterval(this.poke,12E4))};b.poke=function(){d._a(r+"zenario/admin/quick_ajax.php?keep_session_alive=1")}},
