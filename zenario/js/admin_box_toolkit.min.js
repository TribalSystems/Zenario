...
zenario.lib(function(f,m,e,n,r,F,h,t,u,H,D,w,y,A,v,L,I,M,G,N,B,z,C,J){var x=n.zenarioABG=new C;x.init("zenarioABG","zenario_admin_box");e=B(J);e.open=function(a,c,d,b,g,k,l,p){if(t._cIBIO("AdminOrganizer"))return!1;h._dS(this.globalName);h._bIF()&&(this.ffScrollTop=h._sT(),h._sT(0));c||(c={});a=(""+a).s("//",2);a[1]&&!c.id&&(c.id=a[1]);a=a[0];this.isOpen=!0;this.callBack=g;this.passMatchedIds=p;this.createAnotherObject=k;this.getRequestKey=c;this.changed={};this.isSlidUp=this.heightBeforeSlideUp=
this.hasPreviewWindow=this.previewMD5=this.previewPost=this.previewSlotWidth=!1;this.previewSlotWidthInfo="";this.previewHidden=!0;this.baseCSSClass="zenario_fbAdmin zenario_admin_box zenario_fab_"+a;l||(g=this.microTemplate(this.mtPrefix,{}),this.openBox(g));n.onbeforeunload=u.onbeforeunload;this.start(a,c,d,b);return this.cb=new h.callback};e.openBox=function(a){};e.closeBox=function(){};e.updateHash=function(){};e.initFields=function(){this.hasPreviewWindow=!!this.pluginPreviewDetails();B(C).initFields.call(this)};
e.refreshParentAndClose=function(a,c,d){t._nDS(!1);var b,g={};c||(this.isOpen=!1,this.updateHash());if(this.callBack&&!c){var k;(k=this.getValueArrayofArrays())&&this.callBack(this.tuix.key,k)}else if(w.init&&(t.isFullOrganizerWindow||t._cIBIO("og"))){a=!1;if(A(this.tuix.key.id))a=this.tuix.key.id;else for(var l in this.tuix.key)if(z(this.tuix.key,l)){a=this.tuix.key[l];break}w._rTSI(a,d&&G.createdAnother,!c&&G.savedButNotShown)}else h.cID&&(b=this.tuix.key.slotName)?(h._rS(b,t.importantGetRequests),
D.init&&D.init()):!h.cID||"zenario_menu"!=this.path&&"zenario_menu_text"!=this.path?a||c||(this.tuix.key.cID?(this.tuix.key.cID==h.cID&&this.tuix.key.cType==h.cType&&(g=t.importantGetRequests),h._gTU(h._lTI(this.tuix.key.cID,this.tuix.key.cType,g))):D.init&&(g=_._cl(t.importantGetRequests),g.cVersion=h.cVersion,h._gTU(h._lTI(h.cID,h.cType,g)))):(t._rMP(),D.init&&D.init());a=this.tuix.popout_message;d=d&&this.createAnotherObject;c||d||(this.cb&&this.cb.done(),this.close());a&&t._sM(a,!0,!1);if(c){this.changed=
{};if(this.tuix.tabs)for(l in this.tuix.tabs)z(this.tuix.tabs,l)&&this.tuix.tabs[l]&&this.editModeOn(l)&&(this.tuix.tabs[l]._saved_and_continued=!0);this.sortTabs();this.draw()}else d&&($("#zenario_abtab").clearQueue(),delete this.tuix,this.open(this.createAnotherObject.path,this.getRequestKey,this.createAnotherObject.tab,this.createAnotherObject.values,f,this.createAnotherObject,!0,this.passMatchedIds))};e.close=function(a){this.callFunctionOnEditors("remove");t._nDS(!1);this.sizing&&clearTimeout(this.sizing);
h._stPo(this);h._cAD();a||t._cFB();this.isOpen=!1;this.closeBox();h._eS(this.globalName);h._bIF()&&A(this.ffScrollTop)&&(h._sT(this.ffScrollTop),delete this.ffScrollTop);delete this.cb;delete this.tuix;delete this.previewMD5;delete this.previewPost;delete this.previewSlotWidth;delete this.previewSlotWidthInfo;return!1};e.closeButton=function(a){var c=u._o();(!A(c)||!a&&confirm(c))&&this.isOpen&&this.close();return!1};e.draw=function(){this.isOpen&&this.loaded&&this.tabHidden&&this.draw2()};e.draw2=
function(){var a=this;if(a.tuix.tabs){a.get("zenario_fbAdminFloatingBox").className=a.baseCSSClass+" "+(a.tuix.css_class||"zenario_fab_default_style")+" "+(v(a.tuix.hide_tab_bar)?"zenario_admin_box_with_tabs_hidden":"zenario_admin_box_with_tabs_shown");var c=a.tuix;!c.tab||c.tabs[c.tab]&&!u._h(f,a,f,c.tab,f,f,f,f,c.tabs[c.tab])||(c.tab=!1);a.get("zenario_fabTabs").innerHTML=a.drawTabs();var d=!a.editModeOnBox(),b="";b={isReadOnly:d};a.setTitle(d);a.showCloseButton();a.get("zenario_fbButtons").innerHTML=
a.microTemplate(a.mtPrefix+"_buttons",b);h._aJQE("#zenario_fbButtons ",!0);a.get("zenario_fbAdminFloatingBox").style.display="block";a.tallAsPossibleField=f;a.size(!0);t._nDS(!1);d=new h.callback;b=a.drawFields(d);var g;d.after(a.makeFieldAsTallAsPossible);a.animateInTab(b,d,$("#zenario_abtab"));a.shownTab=c.tab;delete a.lastScrollTop;h._sP(a);(g=c.tabs.global_area)&&!_._isEm(g.fields)?(x.tuix={tab:"global_area",tabs:{global_area:JSON.parse(JSON.stringify(g))}},x.sortTabs(),x.validate=function(){a.validate()},
x.format=function(){a.format()},x.redrawTab=function(){a.redrawTab()},x.readTab=function(){B(C).readTab.call(x);var k,l=a.tuix.tabs.global_area;for(k in l.fields)if(z(l.fields,k)){var p=l.fields[k];var q=x.tuix.tabs.global_area.fields[k];p.value=q.value;p.current_value=q.current_value;p.pressed=q.pressed;p.selected_option=q.selected_option;p._display_value=q._display_value;p.hidden=q.hidden;p._was_hidden_before=q._was_hidden_before}},d=new h.callback,b=x.drawFields(d),$("#zenario_fabGlobalArea").show().html(b),
a.addJQueryElements("#zenario_fabGlobalArea"),d.done()):$("#zenario_fabGlobalArea").hide()}};e.readTab=function(){B(C).readTab.call(this);this.tuix.tabs.global_area&&x.readTab()};e.sortTabs=function(){B(C).sortTabs.call(this);this.sortedTabs=_._f(this.sortedTabs,function(a){return"global_area"!=a})};e.setTitle=function(a){};e.showCloseButton=function(){this.tuix.cancel_button_message?$("#zenario_fbAdminFloatingBox .zenario_fabClose").css("display","none"):$("#zenario_fbAdminFloatingBox .zenario_fabClose").css("display",
"block")};e.returnAJAXURL=function(a){return"start"==a&&this.passMatchedIds&&w.lastRequests?m+"zenario/admin/organizer.ajax.php?_get_matched_ids=1&_fab_path="+y(this.path)+"&path="+y(w.path)+h._uR(w.lastRequests)+h._uR(this.getRequestKey):m+"zenario/admin/admin_boxes.ajax.php?path="+y(this.path)+h._uR(this.getRequestKey)};e.typeaheadSearchEnabled=function(a,c,d){return(a=a.pick_items)&&(a.path||a.target_path)&&!1!==a.enable_type_ahead_search};e.typeaheadSearchAJAXURL=function(a,c,d){var b,g;a=a.pick_items;
c=a.path&&w._cNPTTPAR(a.path);d=a.target_path&&w._cNPTTPAR(a.target_path);if(c=c&&d&&c.path==d.path?c:d||c){if(a.add_conductor_vars_to_type_ahead_search&&(b=this.getConductorVars()))for(g in b)z(b,g)&&(a=b[g],c.request[g]=a);return m+"zenario/admin/organizer.ajax.php?_typeahead_search=1&path="+y(c.path)+h._uR(c.request)}};e.parseTypeaheadSearch=function(a,c,d,b,g){var k,l=[];if(g.items)for(k in g.items)if(z(g.items,k)){d=g.items[k];var p=t._fOIN(g,k);a.values=a.values||{};a.values[k]={image:d.image,
