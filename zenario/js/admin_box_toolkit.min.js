...
h.stopPoking(this);h._cAD();a||t._cFB();this.isOpen=!1;this.closeBox();h._eS(this.globalName);h._bIF()&&A(this.ffScrollTop)&&(h._sT(this.ffScrollTop),delete this.ffScrollTop);delete this.cb;delete this.tuix;delete this.previewMD5;delete this.previewPost;delete this.previewSlotWidth;delete this.previewSlotWidthInfo;return!1};e.closeButton=function(a){var c=u._o();(!A(c)||!a&&confirm(c))&&this.isOpen&&this.close();return!1};e.draw=function(){this.isOpen&&this.loaded&&this.tabHidden&&this.draw2()};e.draw2=
...
a.microTemplate(a.mtPrefix+"_buttons",b);h._aJQE("#zenario_fbButtons ",!0);a.get("zenario_fbAdminFloatingBox").style.display="block";a.tallAsPossibleField=f;a.size(!0);t._nDS(!1);d=new h.callback;b=a.drawFields(d);var g;d.after(a.makeFieldAsTallAsPossible);a.animateInTab(b,d,$("#zenario_abtab"));a.shownTab=c.tab;delete a.lastScrollTop;h.startPoking(a);(g=c.tabs.global_area)&&!_._isEm(g.fields)?(x.tuix={tab:"global_area",tabs:{global_area:JSON.parse(JSON.stringify(g))}},x.sortTabs(),x.validate=function(){a.validate()},
