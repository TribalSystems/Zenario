...
c=!c;switch(this.path){case "zenario_skin_editor":c=!1;a&&(h.md5=hex_md5(h.post.overrideFrameworkAndCSS=JSON.stringify(this.getValues1D(!1,!0,!1,!0,!0))));break;case "plugin_settings":a&&(h.md5=hex_md5((h.post.overrideSettings=JSON.stringify(this.getValues1D(!0,!1)))+(h.post.overrideFrameworkAndCSS=JSON.stringify(this.getValues1D(!1,!0,!1,!0,!0,["this_css_tab","all_css_tab","framework_tab"])))));break;default:return!1}b=b||this.tuix&&this.tuix.key&&this.tuix.key.slotName;g=g||this.tuix&&this.tuix.key&&
this.tuix.key.instanceId||k.slots&&k.slots[b]&&k.slots[b].instanceId;b&&zenario_conductor._e(b)&&(l=zenario_conductor._re(b,"refresh",l));l.cVersion=k.cVersion;if(c){if(!b||!g)return!1;c=t._gGSD(b);var p;a=c&&c.cssClass&&c.cssClass.s(" ")||[];l.method_call="showSingleSlot";l.fakeLayout=1;l.grid_columns=c.columns;l.grid_container=c.container;this.previewSlotWidth=c.pxWidth;this.previewSlotWidthInfo=c.widthInfo;l.grid_pxWidth=this.previewWidth&&!d?this.previewWidth:this.previewSlotWidth;l.grid_cssClass=
"";for(p in a)z(a,p)&&(d=a[p],"alpha"==d||"omega"==d||d.m(/^span[\d_]*$/)||(l.grid_cssClass+=d+" "))}else l._show_page_preview=1;b&&(l.slotName=b);g&&(l.instanceId=g);h.url=k._lTI(k.cID,k.cType,l);return h};e.addExtraAttsForTextFields=function(a,c){this.hasPreviewWindow&&(c.onkeyup=(c.onkeyup||"")+" "+this.globalName+".updatePreview();")};e.fieldChange=function(a,c){this.updatePreview(750);A(B).fieldChange.call(this,a,c)};e.updatePreview=function(a){var c=this;c.hasPreviewWindow&&!c.previewHidden&&
k._aADINS("fabUpdatePreview",function(){var d=c.pluginPreviewDetails(!0);d&&c.previewMD5!=d.md5&&(c.previewMD5=d.md5,c.previewPost=d.post,c.submitPreview(d))},a||1E3)};var K=0;e.submitPreview=function(a,c,d){c=c||$("#zenario_fabPreview");d=d||"zenario_fabPreviewFrame";var b="zenario_previewFrame"+ ++K,g=c.find("."+d).not(".beingRemoved");d=$(u._ht("iframe","id",b,"name",b,"class",d));var h=g[0]&&g[0].contentDocument;if(h=1*(h&&$(h).scrollTop()))a.url+="&_scroll_to="+h;g[0]&&(g.width(g.width()).height(g.height()).attr("id",
