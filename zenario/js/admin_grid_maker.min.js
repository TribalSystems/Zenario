'use strict';zenario.lib(function(A,x,B,y,E,m,k,q,F,G,H,I,C,u,J,r,v,K,w,L,D,z,a){a.initVars();a.gridId="grid";a.mtPrefix="zenario_grid_maker_";a.addToolbarId="grid_add_toolbar";a.init=function(c,b,f){a.data="object"==typeof c?c:JSON.parse(c);f&&(a.layoutName=f);b&&(a.layoutId=b);a.checkData(f);a.checkDataR(a.data.cells);a.rememberNames(a.data.cells);a.editing=!0;a.data.cells.length||(a.editing=!0);m&&!m.zenarioGM&&m.$&&m.$.colorbox?$("#close_button").click(function(){if(a.savedAtPos==a.pos||confirm(w.gridConfirmClose))k.stopPoking(a),
m.zenario&&m.zenario.cID?m.location.reload(!0):m.$.colorbox.close()}):r("close_button").style.display="none";k.startPoking(a)};a.draw=function(c){c||a.drawOptions();a.editing?a.drawEditor():a.drawPreview()};a.drawOptions=function(){var c=a.microTemplate(a.mtPrefix+"top",{formId:"settings"});$(".ui-tooltip").remove();r("settings").innerHTML=c;q._to("#settings  *[title]");a.data.fluid||a.recalcColumnAndGutterOptions(a.data);$("#settings input.zenario_grid_setting_break_1").change(a.update).spinner({stop:a.update,
...
c.gutterLeftEdge-c.gutterRightEdge;f=Math.floor(g/c.cols);var e=0,l=!1,h=0;b||(d=r("settings--setting_col_width"));if(!c.cols)return!1;if(d)for(h=d.length-1;0<=h;--h)d.remove(h);if(1==c.cols)d&&d.add(new Option(f+" px / "+e+" px",f+"/"+e),++h),l={colWidth:f,gutter:e};else{e=c.cols-1;b=g/e;g=c.cols/e;var p=999999;for(h=-1;0<f;--f)if(e=b-g*f,e=Math.round(1E4*e)/1E4,e==Math.floor(e)){d&&d.add(new Option(f+" px / "+e+" px",f+"/"+e),++h);var n=Math.abs(c.gutter/c.colWidth-e/f);p>n&&(d&&(d.selectedIndex=
...
onComplete:function(){$("#zenario_grid_slotname_button").click(function(){var d,g={},e=$("#colorbox .zenario_grid_properties_form").serializeArray();for(d in e)z(e,d)&&(g[e[d].name]=e[d].value);a.saveProperties(c,g)});$(".zenario_grid_properties_form input,textarea")[1].focus()}})};a.ajaxURL=function(){return x+"zenario/admin/grid_maker/ajax.php"};a.ajaxSrc=function(){var c=a.ajaxData(),b=a.ajaxURL()+"?data="+C(c);400<b.length&&(b=a.ajaxURL()+"?cdata="+k._nAA(a.ajaxURL(),{compress:1,data:c}));return b};
a.drawPreview=function(){a.clearAddToolbar();a.checkData();var c=Math.max(a.desktopSmallestSize,100*Math.round(($(y).width()-a.previewPaddingLeftRight)/100)),b=Math.min(c-20,a.data.maxWidth),f=a.microTemplate(a.mtPrefix+"preview",{gridId:a.gridId,topHack:5,leftHack:10,min:100,max:c,startingValue:b});$("#"+a.gridId).css("margin","auto");$(".ui-tooltip").remove();r(a.gridId).innerHTML=f;q._to("#"+a.gridId+"  *[title]");$('<form action="'+v(a.ajaxURL())+'" method="post" target="'+a.gridId+'-iframe"><input name="data" value="'+
...
$("#settings--tabs").removeClass("zenario_grid_tabs_slots_selected").addClass("zenario_grid_tabs_grid_selected");a.drawLinks()};a.drawEditor=function(c,b,f,d,g,e,l,h,p,n,t){f||$("#settings--tabs").removeClass("zenario_grid_tabs_grid_selected").addClass("zenario_grid_tabs_slots_selected");return D(zenarioG).drawEditor.call(this,c,b,f,d,g,e,l,h,p,n,t)};a.clearAddToolbar=function(){$("#"+a.addToolbarId).hide().html("")};a.drawAddToolbar=function(){$("#"+a.addToolbarId).show().html(a.microTemplate(a.mtPrefix+
"add_toolbar",{}));$("#"+a.addToolbarId+" a").draggable({connectToSortable:".zenario_grids",helper:"clone",revert:"invalid"});var c=$("#"+a.addToolbarId),b=c.position();b&&u(b.top)&&u(b.left)&&c.css({right:"auto",top:b.top,left:b.left});$("#"+a.addToolbarId).draggable({cursor:"move"})};$(B).ready(function(){$("#"+a.addToolbarId).hover(function(){$(this).css("cursor","move")},function(){$(this).css("cursor","pointer")})});a.resizePreview=function(){var c,b=0;(c=r(a.gridId+"-iframe"))&&c.contentWindow&&
...
c);$(".ui-tooltip").remove();q._to("#download_links  *[title]");c=$("#"+a.gridId);a.editing?c.addClass("zenario_grid_slot_view").removeClass("zenario_grid_grid_view"):(c.addClass("zenario_grid_grid_view").removeClass("zenario_grid_slot_view"),c.css({height:"auto"}),c=$("#"+a.gridId+" .zenario_grid_preview_frame"));c.height(0);c.height(Math.max(a.gridAreaSmallestHeight,$(y).height()-$("body").height()-a.bodyPadding));var b=["zenario_grid_box","zenario_grid_copy_box","zenario_grid_copy_css_box"];$("#download_links a.zenario_grid_copy_css").colorbox({onOpen:function(){k._aCTC(b)},
onClosed:function(){k._rCTC(b)},onComplete:function(){$("#colorbox textarea").focus()}});var f=["zenario_grid_box","zenario_grid_copy_box","zenario_grid_copy_html_box"];$("#download_links a.zenario_grid_copy_html").colorbox({onOpen:function(){k._aCTC(f)},onClosed:function(){k._rCTC(f)},onComplete:function(){$("#colorbox textarea").focus()}})};a.confirmDeleteSlot=function(c,b){k._a(x+"zenario/ajax.php?moduleClassName=zenario_common_features&method_call=handleAJAX"+k._uR({removeSlot:1,level:2,slotName:c.oName,
layoutId:a.layoutId})).after(function(f){q._flBo(f,q.phrase.gridDelete,"warning",!1,!1,!0,A,b)})};a.save=function(c){a.layoutId||(c=!0);var b;if(c){var f=["zenario_grid_box","zenario_grid_new_layout_box"];(b=k._nAA(a.ajaxURL(),{saveas:1,data:a.ajaxData(),layoutId:a.layoutId},!0))&&$.colorbox({transition:"none",html:a.microTemplate(a.mtPrefix+"save_prompt",{name:a.newLayoutName||b.oldLayoutName||""}),onOpen:function(){k._aCTC(f)},onClosed:function(){k._rCTC(f)},onComplete:function(){$("#zenario_grid_new_layout_save").click(function(){$("#zenario_grid_error").hide();
(b=k._nAA(a.ajaxURL(),{saveas:1,confirm:1,data:a.ajaxData(),layoutId:a.layoutId,layoutName:a.newLayoutName=r("zenario_grid_layout_name").value},!0))?b.error?$("#zenario_grid_error").html(v(b.error)).slideDown():($.colorbox.close(),a.layoutName=a.newLayoutName,a.markAsSaved(b)):$.colorbox.close()});r("zenario_grid_layout_name").focus()}})}else if(b=k._nAA(a.ajaxURL(),{save:1,data:a.ajaxData(),layoutId:a.layoutId},!0))b.success?a.markAsSaved(b,!0):(q._flBo(b.message,w.gridSave,"warning",!0,!0),$("#zenario_fbMessageButtons .submit_selected").click(function(){setTimeout(function(){var d;
(d=k._nAA(a.ajaxURL(),{save:1,data:a.ajaxData(),layoutId:a.layoutId,confirm:1},!0))&&a.markAsSaved(d)},50)}))};a.markAsSaved=function(c,b){a.savedAtPos=a.pos;u(c.layoutId)&&(a.layoutId=c.layoutId);a.rememberNames(a.data.cells);c.success&&(b?q._flBo(c.success,!0,"success"):toastr.success(c.success));if(m&&m.zenarioO.init)switch(m.zenarioO.path){case "zenario__layouts/panels/layouts":c.layoutId&&m.zenarioO._rTSI(c.layoutId)}};a.readSettings=function(c){c.fluid=$("#settings input.zenario_grid_setting_flu").prop("checked");
...
!0)};a.recalc=function(c,b,f){var d=$.extend(!1,{},a.data),g=!1,e=!1,l=0,h=c.className,p;d.fluid?(delete d.gutter,delete d.gutterLeftEdge,delete d.gutterRightEdge):(delete d.gutterFlu,delete d.gutterLeftEdgeFlu,delete d.gutterRightEdgeFlu);f||(g=JSON.stringify(d));a.readSettings(d);e=a.checkDataNonZeroAndNumeric(d,e);if(d.fluid)delete d.gutter,delete d.gutterLeftEdge,delete d.gutterRightEdge;else{switch(h.s(" ")[0]){case "zenario_grid_setting_full_width":l=1;break;case "zenario_grid_setting_cols":l=
2;break;case "zenario_grid_setting_gutter_left":l=3;break;case "zenario_grid_setting_gutter_right":l=4;break;case "zenario_grid_setting_col_and_gutter":l=5}if(l){if(f||$(c).val()!=$(c).attr("data-initial-value"))$(c).attr("data-initial-value",$(c).val());else return;do if(!d.maxWidth||1>d.cols)e=!0;else{if(d.gutterLeftEdge+d.cols+d.gutterRightEdge>d.maxWidth)if(3>l)d.gutterLeftEdge=d.gutterRightEdge=0;else{e=!0;break}5>l&&(p=a.recalcColumnAndGutterOptions(d))&&(d.colWidth=p.colWidth,d.gutter=p.gutter);
e=a.checkDataNonZeroAndNumeric(d,e);h=0;var n=[{l:3,c:"zenario_grid_setting_gutter_left",v:d.gutterLeftEdge},{l:4,c:"zenario_grid_setting_gutter_right",v:d.gutterRightEdge},{l:5,c:"zenario_grid_setting_col_and_gutter",v:d.colWidth+"/"+d.gutter}];for(h in n)if(z(n,h)&&l<n[h].l){var t=$("#settings ."+n[h].c);t.val()!=n[h].v&&t.animate({opacity:.3},"fast").val(n[h].v).animate({opacity:1},"fast")}}while(0)}delete d.gutterFlu;delete d.gutterLeftEdgeFlu;delete d.gutterRightEdgeFlu}if(f||g!=JSON.stringify(d))$("#settings .zenario_grid_setting_warning").removeClass("zenario_grid_setting_warning"),
b?e?a.revert():(a.readSettings(a.data),a.checkDataNonZeroAndNumeric(a.data),a.change(!1,!0)):e&&$(c).parent().addClass("zenario_grid_setting_warning");return!e}},window.zenarioGM=new zenarioG);
