'use strict';zenario.lib(function(D,z,A,x,E,m,k,r,F,G,H,I,B,u,J,q,v,K,w,L,C,y,a){a.initVars();a.gridId="grid";a.mtPrefix="zenario_grid_maker_";a.addToolbarId="grid_add_toolbar";a.init=function(c,b,f){a.data="object"==typeof c?c:JSON.parse(c);f&&(a.layoutName=f);b&&(a.layoutId=b);a.checkData(f);a.checkDataR(a.data.cells);a.rememberNames(a.data.cells);a.editing=!0;a.data.cells.length||(a.editing=!0);m&&!m.zenarioGM&&m.$&&m.$.colorbox?$("#close_button").click(function(){if(a.savedAtPos==a.pos||confirm(w.gridConfirmClose))k.stopPoking(a),
