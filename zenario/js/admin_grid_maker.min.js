zenario.lib(function(A,t,w,u,B,g,h,m,C,D,E,F,x,y,G,l,q,H,r,I,z,v,a){a.initVars();a.gridId="grid";a.mtPrefix="zenario_grid_maker_";a.addToolbarId="grid_add_toolbar";a.init=function(c,b,e,d){a.data="object"==typeof c?c:JSON.parse(c);e&&(a.layoutName=e);b&&(a.layoutId=b);a.checkData(e,d);a.checkDataR(a.data.cells);a.rememberNames(a.data.cells);a.editing=!0;a.data.cells.length||(a.editing=!0);g&&!g.zenarioGM&&g.$&&g.$.colorbox?$("#close_button").click(function(){if(a.savedAtPos==a.pos||confirm(r.gridConfirmClose))a.stopPoking(),
g.zenario&&g.zenario.cID?g.location.reload(!0):g.$.colorbox.close()}):l("close_button").style.display="none";a.startPoking()};a.draw=function(c){c||a.drawForm();a.editing?a.drawEditor():a.drawPreview()};a.drawForm=function(){var c=a.microTemplate(a.mtPrefix+"top",{formId:"settings"});$(".ui-tooltip").remove();l("settings").innerHTML=c;m._to("#settings");a.data.fluid||a.recalcColumnAndGutterOptions(a.data);$("#settings input.zenario_grid_setting_break_1").change(a.update).spinner({stop:a.update,min:10,
step:10}).after('<span class="zenario_grid_unit">px</span>');$("#settings input.zenario_grid_setting_break_2").change(a.update).spinner({stop:a.update,min:300,step:10}).after('<span class="zenario_grid_unit">px</span>');$("#settings input.zenario_grid_setting_min_width").change(a.recalcOnChange).spinner({stop:a.recalcOnInc,min:100,step:10}).after('<span class="zenario_grid_unit">px</span>');$("#settings input.zenario_grid_setting_max_width").change(a.recalcOnChange).spinner({stop:a.recalcOnInc,min:320,
step:10}).after('<span class="zenario_grid_unit">px</span>');$("#settings input.zenario_grid_setting_gutter_flu").change(a.recalcOnChange).spinner({stop:a.recalcOnInc,min:0,step:0.1}).after('<span class="zenario_grid_unit">%</span>');$("#settings input.zenario_grid_setting_gutter_left_flu").change(a.recalcOnChange).spinner({stop:a.recalcOnInc,min:0,step:0.1}).after('<span class="zenario_grid_unit">%</span>');$("#settings input.zenario_grid_setting_gutter_right_flu").change(a.recalcOnChange).spinner({stop:a.recalcOnInc,
...
a.gutterLeftEdge-a.gutterRightEdge;e=Math.floor(p/a.cols);var f=0,s=!1,k=0;b||(d=l("settings--setting_col_width"));if(!a.cols)return!1;if(d)for(k=d.length-1;0<=k;--k)d.remove(k);if(1==a.cols)d&&d.add(new Option(e+" px / "+f+" px",e+"/"+f),++k),s={colWidth:e,gutter:f};else{f=a.cols-1;b=p/f;for(var p=a.cols/f,h,g=999999,k=-1;0<e;--e)f=b-p*e,f=Math.round(1E4*f)/1E4,f==Math.floor(f)&&(d&&d.add(new Option(e+" px / "+f+" px",e+"/"+f),++k),h=Math.abs(a.gutter/a.colWidth-f/e),g>h&&(d&&(d.selectedIndex=k),
g=h,s={colWidth:e,gutter:f}))}return s};a.editProperties=function(c){var b=$(c),e=["zenario_grid_box","zenario_grid_rename_slot_box"],b={type:b.data("type"),name:b.data("name"),small:b.data("small"),height:b.data("height"),is_full:b.data("is_full"),is_last:b.data("is_last"),css_class:b.data("css_class"),html:b.data("html"),grid_css_class:b.data("grid_css_class")};$.colorbox({transition:"none",html:a.microTemplate(a.mtPrefix+"object_properties",b),onOpen:function(){h._aCTC(e)},onClosed:function(){h._rCTC(e)},
onComplete:function(){$("#zenario_grid_slotname_button").click(function(){var b,e={},f=$("#colorbox .zenario_grid_properties_form").serializeArray();for(b in f)v(f,b)&&(e[f[b].name]=f[b].value);a.saveProperties(c,e)});$(".zenario_grid_properties_form input,textarea")[1].focus()}})};a.ajaxURL=function(){return t+"zenario/admin/grid_maker/ajax.php"};a.ajaxSrc=function(){var c=a.ajaxData(),b=a.ajaxURL()+"?data="+x(c);400<b.length&&(b=a.ajaxURL()+"?cdata="+h._nAA(a.ajaxURL(),{compress:1,data:c}));return b};
a.drawPreview=function(){a.clearAddToolbar();a.checkData();var c=Math.max(a.desktopSmallestSize,100*Math.round(($(u).width()-a.previewPaddingLeftRight)/100)),b=Math.min(c-20,a.data.maxWidth),e=a.microTemplate(a.mtPrefix+"preview",{gridId:a.gridId,topHack:5,leftHack:10,min:100,max:c,startingValue:b});$("#"+a.gridId).css("margin","auto");$(".ui-tooltip").remove();l(a.gridId).innerHTML=e;m._to("#"+a.gridId);$('<form action="'+q(a.ajaxURL())+'" method="post" target="'+a.gridId+'-iframe"><input name="data" value="'+
...
$("#settings--tabs").removeClass("zenario_grid_tabs_slots_selected").addClass("zenario_grid_tabs_grid_selected");a.drawLinks()};a.drawEditor=function(a,b,e,d,h,f,g,k,l,n,m){e||$("#settings--tabs").removeClass("zenario_grid_tabs_grid_selected").addClass("zenario_grid_tabs_slots_selected");return z(zenarioG).drawEditor.call(this,a,b,e,d,h,f,g,k,l,n,m)};a.clearAddToolbar=function(){$("#"+a.addToolbarId).hide().html("")};a.drawAddToolbar=function(){$("#"+a.addToolbarId).show().html(a.microTemplate(a.mtPrefix+
"add_toolbar",{}));$("#"+a.addToolbarId+" a").draggable({connectToSortable:".zenario_grids",helper:"clone",revert:"invalid"});$("#"+a.addToolbarId).draggable({cursor:"move"})};$(w).ready(function(){$("#"+a.addToolbarId).hover(function(){$(this).css("cursor","move")},function(){$(this).css("cursor","pointer")})});a.resizePreview=function(){var c,b=0;(c=l(a.gridId+"-iframe"))&&c.contentWindow&&c.contentWindow.document&&c.contentWindow.document.body&&(b=$(c.contentWindow.document.body).height()||360,
360>b&&(b=360),$("#"+a.gridId+"-iframe").height(b),$("#"+a.gridId+"-slider_overlay").height(b),$("#"+a.gridId+"-slider a").css("position","absolute").css("z-index",20).css("top","-"+(b+5)+"px").height(b+5).html('<span style="margin-top: '+Math.ceil((b+5)/2)+'px;"></span>'));a.lastIframeHeight=b};a.drawLinks=function(){a.checkData();var c={src:a.ajaxSrc()};a.microTemplate(a.mtPrefix+"bottom_links",c);$(".ui-tooltip").remove();m._to("#download_links");c=$("#"+a.gridId);a.editing?c.addClass("zenario_grid_slot_view").removeClass("zenario_grid_grid_view"):
(c.addClass("zenario_grid_grid_view").removeClass("zenario_grid_slot_view"),c.css({height:"auto"}),c=$("#"+a.gridId+" .zenario_grid_preview_frame"));c.height(0);c.height(Math.max(a.gridAreaSmallestHeight,$(u).height()-$("body").height()-a.bodyPadding));var b=["zenario_grid_box","zenario_grid_copy_box","zenario_grid_copy_css_box"];$("#download_links a.zenario_grid_copy_css").colorbox({onOpen:function(){h._aCTC(b)},onClosed:function(){h._rCTC(b)},onComplete:function(){$("#colorbox textarea").focus()}});
...
$.colorbox.close()});l("zenario_grid_layout_name").focus()}})}else if(b=h._nAA(a.ajaxURL(),{save:1,data:a.ajaxData(),layoutId:a.layoutId},!0))b.success?a.markAsSaved(b,!0):(m._flBo(b.message,r.gridSave,"warning",!0,!0),$("#zenario_fbMessageButtons .submit_selected").click(function(){setTimeout(function(){var b;(b=h._nAA(a.ajaxURL(),{save:1,data:a.ajaxData(),layoutId:a.layoutId,confirm:1},!0))&&a.markAsSaved(b)},50)}))};a.markAsSaved=function(c,b){a.savedAtPos=a.pos;y(c.layoutId)&&(a.layoutId=c.layoutId);
...
$(c).val()!=$(c).attr("data-initial-value"))$(c).attr("data-initial-value",$(c).val());else return;do if(!d.maxWidth||1>d.cols)f=!0;else{if(d.gutterLeftEdge+d.cols+d.gutterRightEdge>d.maxWidth)if(3>g)d.gutterLeftEdge=d.gutterRightEdge=0;else{f=!0;break}5>g&&(l=a.recalcColumnAndGutterOptions(d))&&(d.colWidth=l.colWidth,d.gutter=l.gutter);var f=a.checkDataNonZeroAndNumeric(d,f),k=0,n=[{l:3,c:"zenario_grid_setting_gutter_left",v:d.gutterLeftEdge},{l:4,c:"zenario_grid_setting_gutter_right",v:d.gutterRightEdge},
{l:5,c:"zenario_grid_setting_col_and_gutter",v:d.colWidth+"/"+d.gutter}];for(k in n)if(v(n,k)&&g<n[k].l){var m=$("#settings ."+n[k].c);m.val()!=n[k].v&&m.animate({opacity:0.3},"fast").val(n[k].v).animate({opacity:1},"fast")}}while(0)}delete d.gutterFlu;delete d.gutterLeftEdgeFlu;delete d.gutterRightEdgeFlu}if(e||h!=JSON.stringify(d))$("#settings .zenario_grid_setting_warning").removeClass("zenario_grid_setting_warning"),b?f?a.revert():(a.readSettings(a.data),a.checkDataNonZeroAndNumeric(a.data),a.change(!1,
!0)):f&&$(c).parent().addClass("zenario_grid_setting_warning");return!f};a.stopPoking=function(){a.poking&&clearInterval(a.poking);a.poking=!1};a.startPoking=function(){a.poking||(a.poking=setInterval(a.poke,12E4))};a.poke=function(){h._a(t+"zenario/admin/quick_ajax.php?keep_session_alive=1")}},window.zenarioGM=new zenarioG);
