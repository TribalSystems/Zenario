...
{save:1,data:a.ajaxData(),layoutId:a.layoutId,confirm:1},!0))&&a.markAsSaved(b)},50)}));toastr.success(u.gridSaveSuccessMessage);e&&e.zenario_conductor&&e.zenario_conductor.refreshAll&&e.zenario_conductor.refreshAll()}};a.markAsSaved=function(b,c){a.savedAtPos=a.pos;s(b.layoutId)&&(a.layoutId=b.layoutId);a.rememberNames(a.data.cells);b.success&&(c&&r.floatingBox?r._flBo(b.success,!0,"success"):toastr.success(b.success));if(e&&e.zenarioO.init)switch(e.zenarioO.path){case "zenario__layouts/panels/layouts":b.layoutId&&
...
$("#settings .zenario_grid_setting_redo").click(function(){a.redo()})}h&&(l=b+"__cell"+h.join("-"),$("#"+l+"s").on("click",function(){}));return x(zenarioG).drawEditor.call(this,b,c,h,d,g,v,e,n,p,m,k)};a.microTemplate=function(b,c,h){var d;d=f._aLP(c,a);b=f._mT(b,c,h,a.microTemplates);d&&f._tLP(c);return b};var y=p.zenarioSP=f._cZL("SP",zenarioFEA);k=x(y);a.editProperties=function(b){b=$(b).data("for");var c=$("#"+b);b=c.data("i");var h=c=c.data("levels"),d=a.data;if(c){var c=(""+c).s("-"),g;for(g in c)l(c,
