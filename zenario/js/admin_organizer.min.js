...
!w._bII(7)?w.currentHash.r("#",""):a._gH());d||c||(d="zenario__administration/panels/site_settings//site_reset"==b?"site_reset":b&&"zenario__administration/panels/backups"==b.substr(0,31)?"restore":"reload_sk");c=M+"admin.php?task="+d;w.cID?c+="&cID="+w.cID+"&cType="+w.cType+"&cVersion="+w.cVersion:(c+="&og="+T(b),q.cID&&(c+="&fromCID="+q.fromCID+"&fromCType="+q.fromCType));l.location.href=c};a.refreshToShowItem=function(b,c,d){if(a.stop)return!1;if("zenario__administration/panels/site_settings"==
