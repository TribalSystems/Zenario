...
(b=b.s("//"),c=b.length);if(2>=c)l=[{path:b[0],branch:-1}];else{var e,f,g,h,s,F,l;for(f=0;f<c-1;f+=2){0==f?(g=a._gFTFL(b[0]),l=[{path:g.from,branch:-1}]):(g="/"==b[f].substr(0,1)?b[f].substr(1):e.to+"/"+b[f],g=a._gFTFL(g),e.to!=g.from&&l.push({path:g.from}));e={};b[f+1]&&(e=t._cTO(b[f+1]));s=h=!1;g.refiner&&(s=g.refiner,h=b[f+1]);F=g.to;if(!F)return q._sM('The requested path "'+b.join("//")+"\" was not found in the system. If you have just updated or added files to Zenario, you will need to reload the page and possibly clear Zenario's cache.",
...
a._iSC(c,!0)&&d.push(c));return d};a.exportPanelAsCSV=function(){var b=a._gA(1E4);b&&q._dD(b,{_export:1,_csvExport:1,_exportCols:a._sC().join(",")});a._r(!1,!0)};a.exportPanelAsExcel=function(){var b=a._gA(1E4);b&&q._dD(b,{_export:1,_excelExport:1,_exportCols:a._sC().join(",")});a._r(!1,!0)};a.getAJAXURL=function(b){return a.go(a.path,k,k,k,k,k,!1,k,k,k,!1,!1,k,k,!0,b)};a.goNum=0;a.loadNum=0;a.lastSuccessfulGoNum=0;a.go=function(b,c,d,e,f,g,h,s,F,Z,R,O,G,x,B,t){R||(a.lastActivity=Date.now());if(q.isFullOrganizerWindow||
q._cIBIO("og")){if(a.stop)return!1;if(a.map&&a.initRun){l.zenarioOCheckPaths&&(delete l.zenarioOCheckPaths,l.zenarioOTargetPath&&(l.zenarioOTargetPath=a._cNPTTP(l.zenarioOTargetPath).path),l.zenarioOMinPath&&(l.zenarioOMinPath=a._cNPTTP(l.zenarioOMinPath).path),l.zenarioOMaxPath&&v(l.zenarioOMaxPath)&&(l.zenarioOMaxPath=a._cNPTTP(l.zenarioOMaxPath).path));B||a._cPOU();e||(l.zenarioOQueue=!1);var A,u,y;h={};r(b)&&(Y(b,"~k",h,!0)&&(b=h.path,u=h.info),Y(b,"~t",h)&&(b=h.path,y=h.info),Y(b,"~.",h)&&(b=
h.path,A=h.info),Y(b,"~_",h,!0)&&(b=h.path,x=h.info),Y(b,"~-",h)&&(b=h.path,G=h.info),A&&!Q.isOpen&&Q.open(A,u,y));if(A=b){u=b.s("//");y=u.length;if(2<y){s=k;O=!1;if(!(B=a._pNP(u,y,!0)))return!1;r(G)&&(B[B.length-1].searchTerm=G);r(x)&&(B[B.length-1].filters=x);l.zenarioOQueue=B;a._cQ(!0);return}2==y?(s=k,O=!1,b=u[0],-1==u[1].indexOf(",")&&(s=u[1])&&(y=s.length-1,"/"==s.substr(y)&&(s=s.substr(0,y),O=!0))):s||(O=!1);b=a._shPa(b)}b||(b=l.zenarioONotFull?a.defaultPathInIframePreload:a.defaultPath,O=
!1);if(!a._fPOM(b))return q._sM('The requested path "'+A+'" was not found in the system. If you have just updated or added files to the CMS, you will need to reload the page.',k,"error",!1,!0),!1;var z=++a.goNum;F||++a.loadNum;var N=!1;r(x)||(x=a._lFB(b,c,"filters"));r(G)||(G=a._lFB(b,c,"searches"));r(d)||(d=a._lR(b,c));if(!d&&v(a._fPOM(b,"refiner_required")))q._sM("A refiner was required, but none was set.",!0,"error");else{var E,I={};A=a.branches.length-1;if(-1!==c){N=a._lFB(b,c,"panel_instances");
for(u=0;u<A;++u)if(F=a.branches[u].refiners[a.branches[u+1].from])I["refiner__"+(E=F.name)]=F.id;if(F=a.branches[A].refiners[a.path])I["refiner__"+(E=F.name)]=F.id;d&&(I["refiner__"+d.name]=d.id)}N?(N.cmsSetsPath(b),N.cmsSetsRefiner(d)):N=a._iNPI(b,d);var J=a._fPOM(b,"default_sort_column");J||(J="name");F=a._fPOM(b);N.cmsSetsPanelTUIX(F);N.cmsSetsRequestedItem(s);N.cmsSetsSearchTerm(G);x=x&&!_._isEm(x)?w._cl(x):{};for(var H in x)p(x,H)&&(A=x[H],a._fSOC(H,x)?(r(A.not)&&(A.not?A.not=1:delete A.not),
r(A.s)&&(A.s=v(A.s))):x[H]&&(x[H]={}));r(t)||(t=1*N.returnPageSize());H=F.reorder;var L=N.returnDoSortingAndSearchingOnServer(),K=N.returnAJAXURL(),M=N.returnDevToolsAJAXURL(),D={};A=function(e){a.go2(b,K,M,D,c,z,J,t,O,s,N,G,x,d,E,I,L,g,Z,e)};if(K){l.zenarioONotFull&&(l.zenarioOSelectMode?K+="&_select_mode=1":l.zenarioOQuickMode&&(K+="&_quick_mode=1"));a._aWPI(D);e&&!f&&(D._queued=1);r(d)&&(D.refinerId=d.id,D.refinerName=d.name,d.languageId&&(D.languageId=d.languageId));l.zenarioOCombineItem&&(D._combineItem=
l.zenarioOCombineItem);for(var C in I)p(I,C)&&(D[C]=I[C]);if(L||a.CSVExport){if(t)if(D._limit=t,D._start=a.refreshToPage?(a.refreshToPage-1)*t:0,s)D._item=s;else if(g)if("object"==typeof g&&g.selectedItemFromLastPanel)D._item=g.selectedItemFromLastPanel;else if(e=a._gSIFLP(b))D._item=e;H&&H.column?D._sort_col=H.column:a.prefs[b]&&a.prefs[b].sortBy?(D._sort_col=a.prefs[b].sortBy,D._sort_desc=a.prefs[b].sortDesc?1:0):(D._sort_col=J,D._sort_desc=v(a._fPOM(b,"default_sort_desc")))}x&&!_._isEm(x)&&(D._filters=
JSON.stringify(x));(L||a.CSVExport)&&r(G)&&(D._search=G)}if(B)return K+w._uR(D);a._stRe();b!=a.defaultPathInIframePreload&&(m("organizer_preloader_circle").style.display="block");r(l.zenarioOFirstLoad)&&(l.zenarioOFirstLoad?l.zenarioOFirstLoad=!1:a._rOIIR(b));K?w._a(K+w._uR(D),!1,!0,!0,!0,!0).after(A):A(F)}}else l.zenarioONotFull||(l.zenarioOQueue=[{path:b,branch:-1}])}};a.go2=function(b,c,d,e,f,g,h,s,F,m,u,t,G,x,B,y,A,z,I,E){E&&r(E.comment)&&l.console&&console.log(E.comment);if((q.isFullOrganizerWindow||
q._cIBIO("og"))&&g==a.goNum){a._stRe();var N=a.path,Q,S;a.tuix&&(Q=B&&a.tuix.refiners&&a.tuix.refiners[B]&&a.tuix.refiners[B].title||a.tuix.title,S=v(a.tuix.no_return));a.url=c+w._uR(e);a.devToolsURL=d!=c?d+w._uR(e):k;a.lastRequests=e;a.path=b;a.defaultSortColumn=h;a.thisPageSize=s;a.server_side=A;a.inspectionView=F;a.inspectionViewItem=m;a.prefs[b]||(a.prefs[b]={});-1===f?a._reBr():f&&a._br(b,N,Q,S);a.pi=a.branches[a.branches.length-1].panel_instances[a.path]=u;r(E._filters)&&(G=E._filters,delete E._filters);
a.branches[a.branches.length-1].filters[a.path]=G;a._sS(t);delete a.tuix;a.tuix=E;a.focus=a.tuix;a.pi.cmsSetsPanelTUIX(a.tuix);a.filtersSet=!1;a.filtersSetInViewOptions=!1;for(var J in G)if(p(G,J)&&a._fSOC(J,G)&&(a.filtersSet=!0,a._cFC(J))){a.filtersSetInViewOptions=!0;break}a._mIVIF();a._sR(x);a.lastRefiners=y;a.tuix.columns||(a.tuix.columns={name:{title:"Name"}});(c=a._fPOM(b,"reorder"))&&c.column?(a.sortBy=c.column,a.sortDesc=!1):a.prefs[b].sortBy&&a.tuix.columns[a.prefs[b].sortBy]?(a.sortBy=a.prefs[b].sortBy,
a.sortDesc=a.prefs[b].sortDesc):((h=a._fPOM(b,"default_sort_column"))?a.sortBy=h:a.sortBy=a.defaultSortColumn,a.sortDesc=v(a._fPOM(b,"default_sort_desc")));a.pi.cmsSetsSortColumn(a.sortBy,a.sortDesc);a.sortedColumns=a._gSIOTE("columns");a.sortedItemButtons=a._gSIOTE("item_buttons");a.sortedInlineButtons=a._gSIOTE("inline_buttons");a.sortedCollectionButtons=a._gSIOTE("collection_buttons");a.sortedQuickFilterButtons=a._gSIOTE("quick_filter_buttons");a.shownColumns=a._gSC(b,h,a.tuix.columns);if(a.prefs[b].sortedColumns){c=
{};for(var H in a.prefs[b].sortedColumns)p(a.prefs[b].sortedColumns,H)&&(J=a.prefs[b].sortedColumns[H],c[J]=H);h=!1;for(H in a.sortedColumns)if(p(a.sortedColumns,H)){J=a.sortedColumns[H];if(a._iSC(J,!1,!0)&&!r(c[J])){h=c[h];h=r(h)?1*h+1:0;a.prefs[b].sortedColumns.splice(h,0,J);for(var L in c)p(c,L)&&c[L]>=h&&++c[L];c[J]=h}h=J}a.sortedColumns=a.prefs[b].sortedColumns}a.tuix.items&&1==a.tuix.__item_count__&&v(a.tuix.allow_bypass)?a.branches[a.branches.length-1].bypasses[a.path]=!0:delete a.branches[a.branches.length-
1].bypasses[a.path];if(!a._cQ(!0)){if(a.tuix.items&&1==a.tuix.__item_count__&&v(a.tuix.allow_bypass))if(z){if(!1!==a._gBBT()){a._b();return}}else{if(a.tuix.items)for(var K in a.tuix.items)if(p(a.tuix.items,K)){H={};H[K]=!0;a.pi.cmsSetsSelectedItems(H);if(a._iCTA(K))return;break}}else if((!a.tuix.items||!a.tuix.__item_count__)&&v(a.tuix.return_if_empty)&&!1!==a._gBBT()){a._b();return}K={};L={};H={};var U,D,C,P;for(J in a.tuix.columns)if(p(a.tuix.columns,J)&&(c=a.tuix.columns[J],a._iSC(J)&&(b=c.item_link)))switch(b){case "content_item":case "content_item_or_url":for(D in a.tuix.items)p(a.tuix.items,
D)&&(U=a.tuix.items[D][J])&&(c=U.s("_"),c[0]&&"null"!=c[0]&&c[0]===c[0].r(/\W/,"")&&c[1]&&c[1]==1*c[1]&&(C=a._iL(D),P=a._iP(D),L[C]||(L[C]={}),L[C][P]=L[C][P]?L[C][P]+",":"",L[C][P]+=c[0]+"_"+c[1]));break;case "menu_item":for(D in a.tuix.items)p(a.tuix.items,D)&&(U=a.tuix.items[D][J])&&U==1*U&&(C=a._iL(D),K[C]=K[C]?K[C]+",":"",K[C]+=U);break;default:for(D in a.tuix.items)p(a.tuix.items,D)&&(U=a.tuix.items[D][J])&&(H[b]=H[b]?H[b]+",":"",H[b]+=U)}a.contentItems={};a.menuItems={};a.otherItemLinks={};
a.itemLinkRequestsLeft=0;a.shallowLinks={content_item:"zenario__content/panels/content",content_item_or_url:"zenario__content/panels/content",menu_item:"zenario__menu/panels/menu_nodes"};for(C in L)if(p(L,C))for(P in L)p(L,P)&&L[C][P]&&(a.contentItems[C]||(a.contentItems[C]={}),a.contentItems[C][P]||(a.contentItems[C][P]={}),c=M+"zenario/admin/organizer.ajax.php?path="+a.shallowLinks.content_item+"&_get_item_links="+L[C][P]+"&languageId="+T(C),++a.itemLinkRequestsLeft,a._gDH(c,C,function(b,c){g==
a.goNum&&(a.contentItems[b][P]=c,--a.itemLinkRequestsLeft||a.go3(g,t,z,I))}));for(C in K)p(K,C)&&(J=K[C])&&(a.menuItems[C]||(a.menuItems[C]={}),c=M+"zenario/admin/organizer.ajax.php?path="+a.shallowLinks.menu_item+"&_get_item_links="+T(J)+"&languageId="+T(C)+"&refinerName=language&refinerId="+T(C)+"&refiner__language="+T(C),++a.itemLinkRequestsLeft,a._gDH(c,C,function(b,c){g==a.goNum&&(a.menuItems[b]=c,--a.itemLinkRequestsLeft||a.go3(g,t,z,I))}));for(b in H)p(H,b)&&(J=H[b])&&(a.otherItemLinks[b]||
(a.otherItemLinks[b]={}),c=M+"zenario/admin/organizer.ajax.php?path="+T(b)+"&_get_item_links="+T(J),++a.itemLinkRequestsLeft,a._gDH(c,b,function(b,c){g==a.goNum&&(a.otherItemLinks[b]=c,--a.itemLinkRequestsLeft||a.go3(g,t,z,I))}));a.itemLinkRequestsLeft?(a.go3Timeout&&clearTimeout(a.go3Timeout),a.go3Timeout=setTimeout(function(){a.go3(g,t,z,I)},a.getItemLinkTimeoutTime)):a.go3(g,t,z,I)}}};a.getDataHack=function(a,c,d){w._a(a,2E3<a.length,!0,!0,!0).after(function(a){d(c,a)})};a.go3=function(b,c,d,e){(q.isFullOrganizerWindow||
q._cIBIO("og"))&&b==a.goNum&&(a.lastSuccessfulGoNum=++a.goNum,a.go3Timeout&&clearTimeout(a.go3Timeout),m("organizer_preloader_circle").style.display="none",a._sN(),!d&&a.tuix.popout_message&&(r(a.refreshToPage)&&a.tuix.popout_message==a.lastPopoutMessage||q._sM(a.tuix.popout_message,!0,!1),a.lastPopoutMessage=a.tuix.popout_message),a._sASI(c),a.firstLoaded||(a.firstLoaded=!0,q._hAL()),a._sWC("loaded",!0),a._sWC("filters_set",a.filtersSet),a._sWC("filters_set_in_view_options",a.filtersSetInViewOptions),
...
!1,f=!1,g={};a.prefs&&a.prefs[b]&&a.prefs[b].shownColumns&&(g=a.prefs[b].shownColumns);if(d)for(var h in d)p(d,h)&&(e||(e=h),v(d[h].always_show)?f=g[h]=!0:r(g[h])?g[h]&&(f=!0):v(d[h].show_by_default)&&(f=g[h]=!0));f||(g[e||c]=!0);return g};a.nextPage=function(){if(a.lockPageClicks)return!1;a.page<a.pageCount&&a._gTP(a.page+1)};a.prevPage=function(){if(a.lockPageClicks)return!1;1<a.page&&a._gTP(a.page-1)};a.goToPage=function(b){if(a.stop)return!1;a.page!=b&&a._dAI();a.lockPageClicks=!0;a.inspectionView=
...
a.searchedItems=a.pi.sortAndSearchItems(),a.searchMatches=a.searchedItems.length);a.itemsOrder={};for(var d in a.searchedItems)p(a.searchedItems,d)&&(c=a.searchedItems[d],a.itemsOrder[c]=1*d);b=1;if(a.thisPageSize)if(a.server_side&&a.server_side)b=a.tuix.__page__||a.refreshToPage||1;else if(r(a.refreshToPage))b=a.refreshToPage;else{if(!a.inspectionViewItem)for(c in d=a.pi.returnSelectedItems(),d)if(p(d,c)){a.inspectionViewItem=c;break}if(c=a.itemsOrder[a.inspectionViewItem])b=Math.floor(c/a.thisPageSize)+
...
a.resetBranches=function(){a.branches=[{panel_instances:{},bypasses:{},filters:{},refiners:{},searches:{}}]};a.branch=function(b,c,d,e){b=a._shPa(b);a.branches[a.branches.length]={from:c,to:b,title:d,no_return:e,panel_instances:{},bypasses:{},filters:{},refiners:{},searches:{}}};a.setHash=function(){if(!l.zenarioONotFull){if(!w._bII(7)){var b=a._gH();V.location.hash=b;w.currentHash=V.location.hash}q.homeLink&&m("home_page_button_link")&&(m("home_page_button_link").href=a._pRL(q.homeLink));q.backLink&&
m("last_page_button_link")&&(m("last_page_button_link").href=a._pRL(q.backLink))}};a.getHash=function(b){var c="",d=a.path,e,f,g,h=!1;e=!1;var s="",F=a.pi&&a.pi.returnSelectedItems(),l=Q.isOpen&&Q.path,k=Q.isOpen&&Q.openingKey,m=Q.isOpen&&Q.tuix&&Q.tuix.tab;if(!b&&F){for(var q in F)if(p(F,q)&&F[q])if(!1===e)e=q;else{e=!1;break}e&&(s=a.inspectionView?e+"/":e)}for(q in a.branches)if(p(a.branches,q)&&0<q)if(e=a.branches[q],e.to&&a.knownBranches[e.from]&&a.knownBranches[e.from][e.to]&&(f=a.knownBranches[e.from][e.to][e.refiners[e.to]?
e.refiners[e.to].name:1])){f=a._shPa(f);if(g){if(f.substr(0,g.length)==g)f=a._shPa(f.substr(g.length+1));else{h=!0;break}c+="//"}c+=f+"//";g=a.branches[q-1];if(g=g.panel_instances[e.from])c+=a._iK(g.returnSelectedItems());g=e.to}else{h=!0;break}!h&&g&&d.substr(0,g.length)==g&&(d=c+"//"+a._shPa(d.substr(g.length+1)));s&&(d="//"==w._rHSS(d,2)?d+s:"/"==w._rHSS(d,1)?d+("/"+s):d+("//"+s));!b&&r(a.searchTerm)&&(d+="~-"+X(a.searchTerm));!b&&a.path&&a.branches.length&&a.branches[a.branches.length-1]&&a.branches[a.branches.length-
1].filters[a.path]&&!_._isEm(a.branches[a.branches.length-1].filters[a.path])&&(d+="~_"+X(a.branches[a.branches.length-1].filters[a.path],!0));l&&(d+="~."+X(l),m&&(d+="~t"+X(m)),k&&(d+="~k"+X(k,!0)));return d};a.searchOnClick=function(a){};a.searchOnKeyUp=function(b){a.doSearchAfterDelay&&clearTimeout(a.doSearchAfterDelay);a.doSearchAfterDelay=setTimeout(function(){a._dS(m("organizer_search_term"))},a.searchDelayTime)};a.searchOnChange=function(b){a.server_side&&a.doSearchAfterDelay&&(clearTimeout(a.doSearchAfterDelay),
a._dS(b))};a.markIfViewIsFiltered=function(){a.filteredView=r(a.searchTerm)||a.filtersSet};a.doSearch=function(b){a.doSearchAfterDelay&&clearTimeout(a.doSearchAfterDelay);""===b.value?b=k:(b=b.value,"0"!==b.substr(0,1)&&b==1*b&&(b*=1));b!==a.searchTerm&&(a.searchTerm=b,a._mIVIF(),a._sS(a.searchTerm),a._rS())};a.runSearch=function(){if(a.stop)return!1;a.lockPageClicks=!0;a.inspectionView=!1;a.server_side||(a.server_side=a.pi.returnDoSortingAndSearchingOnServer())?a._rASP():a._sASI(a.searchTerm)};a.allItemsSelected=
function(){if(0==a.shownItemsLength)return!1;var b,c=0,d=a.pi.returnSelectedItems();for(b in d)p(d,b)&&++c;return c==a.shownItemsLength};a.noItemsSelected=function(){if(0==a.shownItemsLength)return!0;var b,c=a.pi.returnSelectedItems();for(b in c)if(p(c,b))return!1;return!0};a.parseReturnLink=function(a,c){r(c)||(c=a&&w.currentHash&&!w._bII(7)?"zenario_sk_return="+w.currentHash.r("#",""):"");return w._aBP((""+a).r("zenario_sk_return=navigation_path",c))};a.panelProp=function(b,c){var d,e;if(c=c||a.tuix)return(d=
a.refiner&&a.refiner.name)&&(e=c.refiners&&c.refiners[d])&&r(e[b])?e[b]:c[b]};a.saveRefiner=function(b){a.branches[a.branches.length-1].refiners[a.path]=a.refiner=b};a.loadRefiner=function(b,c){return-1===c||c?k:a.branches[a.branches.length-1].refiners[b]?a.branches[a.branches.length-1].refiners[b]:k};a.clearRefiner=function(){a.refiner=k;a._sR()};a.saveSearch=function(b){a.branches[a.branches.length-1].searches[a.path]=b;a.pi.cmsSetsSearchTerm(b)};a.loadFromBranches=function(b,c,d){return-1===c||
c?k:a.branches[a.branches.length-1]&&a.branches[a.branches.length-1][d]&&a.branches[a.branches.length-1][d][b]?a.branches[a.branches.length-1][d][b]:k};a.setSearch=function(b){var c;a.pi&&a.pi.returnSearchingEnabled()?(c="visible",a.searchTerm=b):(c="hidden",a.searchTerm=k);a._mIVIF();m("organizer_search").style.visibility=c;r(a.searchTerm)?m("organizer_search_term").value=a.searchTerm:m("organizer_search_term").value=""};a.clearSearch=function(){m("organizer_search_term").value="";a.searchTerm=k;
...
a.selectItems=function(b){var c,d,e={},f=!1,g=a.pi.returnSelectedItems();if(_._isAr(b))for(c in b)p(b,c)&&(d=b[c],e[d]=!0);else _._isOb(b)?e=b:e[b]=!0;for(d in a.shownItems)p(a.shownItems,d)&&((b=e[d])&&!g[d]?(a.pi.selectItem(d),f=!0):!b&&g[d]&&(a.pi.deselectItem(d),f=!0));f&&(a._cIV(),a._sB(),a._sH())};a.itemClickThrough=function(b,c){if(a.stop)return!1;w._st(c);if(!a.tuix||!a.tuix.items||!a.tuix.items[b])return!1;a._iCTA(b);return!1};a.itemClickThroughAction=function(b){var c=a._iCTL(b),d;return c?
(v(c.unselect_items)||(d={},d[b]=!0,a.pi.cmsSetsSelectedItems(d)),t._a(a,a.tuix.items[b],!0,!0,c),!0):!1};a.itemClickThroughLink=function(b){var c=a.tuix.items[b].link;b=a.tuix.items[b].panel;r(c)||r(b)||!a.tuix.item||(c=a.tuix.item.link,b=a.tuix.item.panel);b&&(c={path:b._path_here});return c&&l.zenarioONotFull&&a.path===l.zenarioOMaxPath&&(a.path!==c.path||l.zenarioODisallowRefinersLoopingOnMinPath)?!1:c};a.topRightButtonClick=function(b){if(a.stop)return!1;t._a(a,a.map.top_right_buttons[b],!1,
-1)};a.topLevelClick=function(b,c,d){if(a.stop)return!1;a._cR();a._cS();a._reBr();r(c)?(b=w._cl(a.map[b].nav[c]),t._a(a,b,!1,-1)):t._a(a,a.map[b],!1,-1)};a.viewTrash=function(){!l.zenarioOSelectMode&&a.tuix&&a.tuix.trash&&!v(a.tuix.trash.empty)&&t._a(a,a.tuix.trash,!1,!0);return!1};a.collectionButtonClick=function(b,c){a.tuix&&a.tuix.collection_buttons&&a.tuix.collection_buttons[b]&&t._a(a,a.tuix.collection_buttons[b],!1,!0,k,c)};a.itemButtonClick=function(b,c){a.tuix&&a.tuix.item_buttons&&a.tuix.item_buttons[b]&&
(r(c)&&a._sI(c),t._a(a,a.tuix.item_buttons[b],!0,!0))};a.inlineButtonClick=function(b,c){a.tuix&&a.tuix.inline_buttons&&a.tuix.inline_buttons[b]&&(a._sI(c),t._a(a,a.tuix.inline_buttons[b],!0,!0))};a.toggleQuickFilter=function(b,c){var d,e,f,g,h=!1,s=a.tuix&&a.tuix.quick_filter_buttons;if(button=s&&s[b]){if(v(button.clear_all))for(e in s)p(s,e)&&(f=s[e],e==b||button.parent&&button.parent!=e&&button.parent!=f.parent||!(d=f.column)||!a._gFV("s",d)||(a._sFV("s",d,!1),a._clFi(d),h=!0));(d=button.column)&&
(g=a._gCFT(d))&&a._cICPCAA(d)&&(v(button.remove_filter)?c=!1:r(c)||(c=!a._qFE(b)),a._sFV("s",d,c),a._clFi(d),c&&(a._sFV("not",d,v(button.invert)),"yes_or_no"==g?a._sFV("v",d,1):r(button.value)&&a._sFV("v",d,button.value)),h=!0);h&&a._rASP()}};a.quickFilterEnabled=function(b){var c,d,e;if((c=a.tuix.quick_filter_buttons[b])&&(d=c.column)&&(e=a._gCFT(d))){if(v(c.remove_filter))return!a._gFV("s",d);if(a._gFV("s",d)&&v(c.invert)==v(a._gFV("not",d))){if("yes_or_no"==e)return!0;if(r(c.value))return a._gFV("v",
d)===c.value}}return!1};a.applyMergeFields=function(b,c,d,e){var f=b=(b+"").r(/~/g,"~1"),g,h;r(d)||(d=a._gKI());for(h in a.tuix.items[d])if(p(a.tuix.items[d],h)&&(f=a.tuix.items[d][h],-1!=b.indexOf("[["+h+"]]")))for(g=a.tuix.columns&&a.tuix.columns[h]?a._cV(d,h,!c):c?u(f):f,!e&&r(g)&&(g=(g+"").r(/\n/g," ")),g=(g+"").r(/~/g,"~1").r(/\[/g,"~2").r(/\]/g,"~3");b!=(f=b.r("[["+h+"]]",g));)b=f;return b.r(/~2/g,"[").r(/~3/g,"]").r(/~1/g,"~")};a.applyMergeFieldsToLabel=function(b,c,d,e){d&&e&&1<a.itemsSelected&&
...
u(d)+"');",value:l,"class":"grid"==a.view_mode||v(f.always_show)?"notused":""}}b["sortcol_"+d]={ord:100*e+6,same_row:!0,snippet:{html:'<label class="zenario_filter_column_name" for="showcol_'+d+'">'+u(f.title)+"</label>"}};if(a._cFC(d)){var t=l=!a._gFV("s",d),R=a._gFV("v",d),O,G="",x="",B=f.filter_format||f.format;O='<a class="'+(a._gFV("not",d)?"organizer_inverter organizer_not":"organizer_inverter")+'" title="'+y.invertFilter+'" onclick="zenarioO._iF(this, \''+u(d)+"', '"+u(B)+"');\">";if("date"==
B||"datetime"==B||"datetime_with_seconds"==B)R&&(O=R.s(","),G=O[1],x=O[0]),b["date_after_col_"+d]={ord:100*e+7,row_class:"zenario_date_filters_for_field",label:'<span class="zenario_date_filters_phrase">'+y.after+"</span>",type:"date",onchange:"zenarioO._uDF('"+u(d)+"');",value:x,hidden:l,_was_hidden_before:t},b["date_before_col_"+d]={ord:100*e+8,row_class:"zenario_date_filters_for_field",label:'<span class="zenario_date_filters_phrase">'+y.before+"</span>",type:"date",onchange:"zenarioO._uDF('"+
u(d)+"');",value:G,hidden:l,_was_hidden_before:t},b["v"+d]={ord:100*e+9,same_row:!0,type:"hidden",value:R,hidden:l,_was_hidden_before:t};else if("yes_or_no"==B)R=""+f.title,-1==R.indexOf(":")&&(R+=":",R.r(/\s*:/,":")),b["v"+d]={ord:100*e+7,row_class:"zenario_filters_for_field yes_or_no",snippet:{html:O+(a._gFV("not",d)?y.no:y.yes)+"</a>"},hidden:l,_was_hidden_before:t};else if("enum"==B&&f.values||"language_english_name_with_id"==B||"language_english_name"==B||"language_local_name_with_id"==B||"language_local_name"==
...
value:R,hidden:l,_was_hidden_before:t}}else v(f.searchable)&&(f="id"==f.format||f.encrypted,f=a._gFV("not",d)?f?y.isnt:y.notLike:f?y.is:y.like,b["v"+d]={ord:100*e+7,row_class:"zenario_filters_for_field",label:O+f+"</a>",type:"text",onkeyup:"zenarioVO._cFAD();",value:R,hidden:l,_was_hidden_before:t});a._gCFT(d)&&(b["togglefilter_"+d]={ord:100*e+2,same_row:!0,pre_field_html:'<div class="organizer_togglefilter">',type:"toggle",onclick:"zenarioO._tF(this, '"+u(d)+"');","class":l?"togglefilter_closed":
...
a.otherItemLinks[g]&&(k=a.otherItemLinks[g].items)&&(k=k[f])}if(k){if(d)return k.name;d="";if(a.tuix.items[b].cell_css_classes&&a.tuix.items[b].cell_css_classes[c]&&-1!=(""+a.tuix.items[b].cell_css_classes[c]).indexOf("ghost"))if(d=' style="cursor: default;"',"menu_item"==g)d+=' title="'+u(u(k.name))+'|"';else{if("content_item"==g||"content_item_or_url"==g)d+=' title="'+u(u(k.name))+'|"'}else if(h&&!l.zenarioONotFull?(c="",e=a.shallowLinks[g]||g,d=k.navigation_path?k.navigation_path:a.shallowLinks[g]?
a.shallowLinks[g]+"//"+f:g+"//"+f,a.shallowLinks[g]&&(c=", name: 'following_item_link', languageId: '"+u(a._iL(b))+"'"),d=' href="organizer.php#'+u(d)+'" onclick="zenarioO._dAI();var selectedItems = {};selectedItems[\''+u(b)+"'] = true;zenarioO.pi.cmsSetsSelectedItems(selectedItems);zenarioO._sH();zenarioO.go('"+u(e)+"', true, {id: '"+u(f)+"'"+c+"}, undefined, undefined, undefined, undefined, '"+u(f)+"');return zenario._st(event);\""):k.navigation_path?d=' href="'+M+"zenario/admin/organizer.php#/"+
u(k.navigation_path)+'" target="_blank"':(h=!1,k.frontend_link&&(s=!0,d=' href="'+u(w._aBP(k.frontend_link))+'" target="_blank"')),h)if("menu_item"==g)d+=' title="'+u(u(k.name))+"|"+y.clkToViewLinkedMenuNode+'"';else{if("content_item"==g||"content_item_or_url"==g)d+=' title="'+u(u(k.name))+"|"+y.clkToViewLinkedCItem+'"'}else s&&(d+=' title="'+u(u(k.name))+"|"+y.clkToViewLinkInNewWindow+'"');switch(g){case "content_item":case "content_item_or_url":b=u(k.name);break;case "menu_item":b=u(k.name);h=b.r(/.*?\-\&gt\; /g,
"-&gt; ");h==b&&(h=b.r(/.*?\: /g,""));b=h;break;default:b=q._fOIN(a.otherItemLinks[g],f)}return t._mT("zenario_organizer_item_link",{item:k,item_link:g,itemName:b,href:d,panel:a.otherItemLinks[g],value:f})}}if(e.format||e.empty_value)f=q._fSIF(f,e);g=e.length_limit&&f.length>e.length_limit;return d?g?f.substr(0,e.length_limit)+"...":f:g?'<span class="tooltip" title="'+u(f)+'">'+u(f.substr(0,e.length_limit))+"...</span>":u(f)};a.rowCssClass=function(b){b=a.tuix.items[b]||{};return b.row_class||b.row_css_class||
...
a.branches[b].refiners[a.branches[b].to].name:1].substr(-4))return a._gFLP(b-1,a.branches[b].from,d,e,f,g,h,!0);q=!0;c=e?a.branches[b-1][d]:a.branches[b][d]}else if(a.branches[b][d])q=!0,c=a.branches[b][d];else if(p=k||c!=a.path?a._fPOM(c,"back_link"):a.tuix.back_link){if(l.zenarioONotFull&&l.zenarioOMinPath&&c==l.zenarioOMinPath&&(l.zenarioODisallowRefinersLoopingOnMinPath||p!=c))return!1;t=!0;c=a._fPOM(p,d)}else return!1;q?(h.path=a.branches[b].from,++h.pops):t&&p&&(h.path=p);if(0!=--f)if(q)m=a._gFLP(b-
1,a.branches[b].from,d,e,f,g,h,!0);else if(t&&p)m=a._gFLP(b,p,d,e,f,g,h,!0);else return!1;return g?(m||(m=[]),m[m.length]=c,m):!1!==m?m:c};a.setNavigation=function(b){var c,d,e,f,g=-1,h,l,r,u=-1,w,z={items:[],selected1st:0};r=a.path;var y=a._gH(!0),x;a.sortedTopLevelItems||(a.sortedTopLevelItems=a._gSIOTE(a.map));a.currentTopLevelPathHasRefiner=!1;1<a.branches.length&&(r=a.branches[1].from);for(c in a.map)if(p(a.map,c)&&"top_right_buttons"!=c&&"object"==typeof a.map[c]&&a.map[c].nav)for(d in a.map[c].nav)p(a.map[c].nav,
d)&&"object"==typeof a.map[c].nav[d]&&(x=c+"/nav/"+d+"/panel",a.map[c].nav[d].link&&a.map[c].nav[d].link.path&&(x=a.map[c].nav[d].link.path),r=(x+"").length,u<r&&(w=(y+"/").substr(0,r))&&(w==x||w==x+"/")&&(u=r,h=c,l=d));for(e in a.sortedTopLevelItems)if(p(a.sortedTopLevelItems,e)){c=a.sortedTopLevelItems[e];w=!0;y=-1;x=a.map[c];var B,E,A,I;if("top_right_buttons"!=c&&!t._h(k,a,k,c,k,k,k,x)&&(E=z.items[++g]={id:c,items:[],selected:c===h,css_class:x.css_class,label:x.label||x.name,tooltip:x.tooltip,
href:x.href,onclick:x.onclick,youtube_video_id:x.youtube_video_id,youtube_thumbnail_title:x.youtube_thumbnail_title},a._sDA(x,E),c===h&&(z.selected1st=g),x.nav&&_._isOb(x.nav)))for(f in u=a._gSIOTE(x.nav),u)p(u,f)&&(d=u[f],B=x.nav[d],r=B.link&&B.link.path?B.link.path:c+"/nav/"+d+"/panel",c===h&&d===l&&(a.currentTopLevelPath=r,r.m(/\/\//)&&(a.currentTopLevelPathHasRefiner=!0)),t._h(k,a,k,d,B,k,k,x)||(A=B.css_class,!A&&b&&(I=a._fPOM(r,"item"))&&(A=I.css_class),A=E.items[++y]={id:d,selected:c===h&&d===
l,href:B.href,onclick:B.onclick,css_class:A,label:B.label||B.name,tooltip:B.tooltip,item_css_class:A},B.href||B.onclick||(A.href="#"+r,A.onclick="zenarioO._tLC('"+W(c)+"', '"+W(d)+"', "+v(0==y)+"); return false;"),w&&(w=!1,E.href||E.onclick||(E.href=A.href,E.onclick=A.onclick))))}if(b)return z;m("organizer_leftColumn").innerHTML=t._mT("zenario_organizer_nav",z);q._to("#organizer_leftColumn #organizer_topLevelNav a[title]",{position:{my:"left+2 center",at:"right center",collision:"flipfit"},show:!1,
...
a.tuix.items[c],q=a.itemsSelected,r=a.tuix.item&&a.tuix.item.css_class;if(0<q)for(h in 1==q&&(r=m.css_class||r),a.sortedItemButtons)if(p(a.sortedItemButtons,h)){c=a.sortedItemButtons[h];e=a.tuix.item_buttons[c];var u=g=1;v(e.multiple_select)&&(g=e.multiple_select_max_items,v(e.multiple_select_only)&&(u=2),e.multiple_select_min_items&&(u=Math.max(u,e.multiple_select_min_items)));q<u||g&&q>g||a._cBH(e,l)||!a._cIBH(e,l)||(g=a._cD(e,c,l),f[++d]=a._sBA("zenarioO.itemButtonClick",e,g,c,k,m),f[d].label=
a._aMFTL(e.label||e.name,!1,!0,e.multiple_select_label),f[d].tooltip=g&&e.disabled_tooltip?a._aMFTL(e.disabled_tooltip,!1,!0):a._aMFTL(e.tooltip,!1,!0,e.multiple_select_tooltip))}t._sBK(f);b.itemButtons=f;b.itemCSSClass=r;b.itemsSelected=q};a.setButtonAction=function(b,c,d,e,f,g,h){r(h)||(h="label_without_icon");h={id:e,tuix:c,css_class:c.css_class||h,label:c.label||c.name,disabled:d};d?h.onclick="return false;":c.navigation_path?h.href=g&&g.navigation_path?"#/"+g.navigation_path:"#/"+c.navigation_path:
...
(b=l.zenarioOChooseMultiplePhrase)):l.zenarioOAllowNoSelection&&l.zenarioONoSelectionChoosePhrase&&(b=l.zenarioONoSelectionChoosePhrase);m("organizer_choose_button").disabled=c;m("organizer_choose_button").className=d;m("organizer_choose_button").value=u(b)}};a.getCurrentPage=function(){return a.page};a.getPageCount=function(){a.thisPageSize&&r(a.searchMatches)?a.pageCount=Math.ceil(a.searchMatches/a.thisPageSize):a.pageCount=1;return a.pageCount};a.setPanelTitle=function(){var b,c;if(a.pi&&a.tuix&&
(b=m("organizer_rightColumnTitle"))){c=m("organizer_noticeBar");b.style.display="";b=a.pi.returnPanelTitle();a.tuix.item&&a.tuix.item.css_class?m("organizer_panelTitle").innerHTML='<div class="listicon organizer_item_image '+a.tuix.item.css_class+'"></div><div>'+u(b)+"</div>":m("organizer_panelTitle").innerHTML=u(b);Math.max(0,($("#organizer_rightColumnTitle").width()||0)-75-($("#organizer_collectionToolbar").width()||90));q._sTITL("#organizer_panelTitle",b,q.tooltipLengthThresholds.organizerPanelTitle);
q.isFullOrganizerWindow&&(V.title=a.pageTitle+y.colon+b);if((b=a.tuix.notice)&&v(b.show)&&!t._h(b,a)&&{error:1,warning:1,question:1,information:1,success:1}[b.type])return c.className=b.type,b.html?$(c).html(b.message):$(c).text(b.message),$(c).show(),!0;$(c).hide().html("")}return!1};a.setTrash=function(){!l.zenarioOSelectMode&&a.tuix&&a.tuix.trash?(m("organizer_trash_button").style.display="",m("organizer_trash_button").className=v(a.tuix.trash.empty)?a.tuix.trash.empty_css_class||"trash_button_empty":
a.tuix.trash.full_css_class||"trash_button_full",q._to("#organizer_trash_button a",{position:{my:"center bottom-12",at:"center top",collision:"flipfit",using:w.tooltipsUsing},items:"*",content:v(a.tuix.trash.empty)?a.tuix.trash.empty_tooltip||y.viewTrash:a.tuix.trash.full_tooltip||y.viewTrash})):m("organizer_trash_button").style.display="none"};a.getItemCSSClass=function(b){return a.tuix.items[b].css_class?a.tuix.items[b].css_class:a.tuix.item?a.tuix.item.css_class:k};a.setOrganizerIcons=function(){var a,
c=t.div,d=[],e=[],f;t._sDT()&&e.push([c("id","organizer_debug_button","class","zenario_debug","onmouseover","zenarioO._iB(this);","onclick","zenarioO._cIB(); zenarioA._d('zenarioO');",c()),99]);if(q.isFullOrganizerWindow&&!q.openedInIframe){e.push([t._mT("zenario_organizer_top_right_icons",{}),1]);c=w._sS("eventSetOrganizerIcons");for(a in c)p(c,a)&&(f=c[a],f["\u2197"]&&(e=e.concat(f["\u2197"])),f["\u2199"]&&(d=d.concat(f["\u2199"])));d.sort(t.sortArray);e.sort(t.sortArray)}for(a in d)p(d,a)&&(d[a]=
d[a][0]);for(a in e)p(e,a)&&(e[a]=e[a][0]);$("#organizer_lowerLeftColumn").html(d.join("\n"));$("#organizer_topRightIcons").html(e.join("\n"))};a.closeSelectMode=function(){a._cIB();q.isFullOrganizerWindow?(E.zenarioA._cB("AdminOrganizer",!0),a.go(a.defaultPathInIframePreload),q._sAL()):(a.go(a.defaultPathInIframePreload),q._cB("og"));return a.firstLoaded=!1};a.choose=function(){if(a.lastSuccessfulGoNum==a.goNum&&E&&l.zenarioOSelectMode&&(a.path==l.zenarioOTargetPath||!1===l.zenarioOTargetPath)&&
(0<a.itemsSelected||l.zenarioOAllowNoSelection)&&(1>=a.itemsSelected||l.zenarioOMultipleSelect)){a._stRe();var b=a._gK(!0),c=a.path,d=w._cl(a.tuix),e;e=a.pi.returnSelectedItems();var f=!1;b._items={};for(var g in e)if(p(e,g)&&(b._items[g]=!0,!l.zenarioOMultipleSelect))break;!l.zenarioOMultipleSelect&&b.id?(e=d.items[b.id],e.__label_tag__=a.defaultSortColumn):e={};a._cSM();_._isFu(l.zenarioOCallbackObject)?f=l.zenarioOCallbackObject:_._isFu(l.zenarioOCallbackFunction)&&(f=l.zenarioOCallbackFunction);
if(f)l.zenarioOMultipleSelect?f(c,b,k,d):f(c,b,e,d);else if(l.zenarioOMultipleSelect)E[l.zenarioOCallbackObject][l.zenarioOCallbackFunction](c,b,k,d);else E[l.zenarioOCallbackObject][l.zenarioOCallbackFunction](c,b,e,d)}};a.infoBox=function(a){var c=t._mT("zenario_organizer_debug_info",{});q._oB(c,"zenario_fbDebugInfoBox","DebugInfoBox",a,600,-286,28,!1,!1,k,k,k,k,!1,!1)};a.closeInfoBox=function(){q._cB("DebugInfoBox")};a.yourWorkInProgressLastUpdated=0;a.updateYourWorkInProgress=function(){var b=
(new Date).getTime(),c;a.yourWorkInProgressLastUpdated-b<-a.yourWorkInProgressLastUpdateFrequency&&(c=$("#zenario_ywip_dropdown"))&&(a.yourWorkInProgressLastUpdated=b,c.removeClass("zenario_ywip_loaded").addClass("zenario_ywip_loading"),b=M+"zenario/admin/organizer.ajax.php?path=zenario__content/panels/content&_sort_col=last_modified_datetime&_sort_desc=1&_start=0&_limit="+a.yourWorkInProgressItemCount+"&refinerId=&refinerName=work_in_progress&refiner__work_in_progress=&_get_item_data=1",w._a(b,!1,
!0,!0).after(function(a){a=t._mT("zenario_ywip",a);c.removeClass("zenario_ywip_loading").addClass("zenario_ywip_loaded").html(a)}))};$(V).ready(function(){setTimeout(a.updateYourWorkInProgress,100)});a.sizing=!1;a.lastSize=!1;a.size=function(b){var c=57,d=30,e=0,f=55,g=m("zenario_fbog"),h=$(g),k,p;a.sizing&&clearTimeout(a.sizing);if(m("organizer__box_wrap")){q.isFullOrganizerWindow?(k=Math.floor($(l).width()),p=Math.floor($(l).height())):(k=Math.floor(h.width()),p=Math.floor(h.height()));if(k&&p&&
(k<q.orgMinWidth&&(k=q.orgMinWidth),400>p&&(p=400),b||a.lastSize!=k+"x"+p)){b=a._sPT();var r=$(m("organizer_noticeBar"));b?(r.show(),e+=r.height()+6):r.hide();m("organizer_search").style.top=e+45+"px";a.showLeftColumn=a.pi?a.pi.returnShowLeftColumn():!l.zenarioONotFull;b=m("organizer_rightColumnContent");var r=m("organizer_lowerLeftColumn"),t=m("organizer_lowerMiddleColumn"),u=m("organizer_lowerRightColumn"),v=a._geHe(),x=$(b),z=$(t),y=$("#organizer_buttons"),A=$("#organizer_bottomWrap");v.is(":visible")||
(f=0);y.is(":visible")||(d=0);A.is(":visible")||(c=0);g&&(g.className=q._gSBC(l,a.pi&&a.pi.panelType));q.isFullOrganizerWindow||h.height(p);m("organizer_rightColumn").style.height=m("organizer_preloader_circle").style.height=1*p-35-c+"px";m("organizer_leftColumn").style.height=1*p-35-c-2+"px";m("organizer_Outer").style.height=1*p-35+"px";m("organizer_colsortfields")&&(w._bII(6)?m("organizer_colsortfields").style.height=1*p-35-130+"px":m("organizer_colsortfields").style.maxHeight=1*p-35-130+"px");
c=1*p-e-35-c-40-d-2-a.columnPadding+0-f-13;b&&(b.style.height=c+"px");a.showLeftColumn?(c=204,m("organizer_leftColumn").style.display=m("organizer_leftColumnOuter").style.display=""):(c=0,m("organizer_leftColumn").style.display=m("organizer_leftColumnOuter").style.display="none");m("organizer__box_top").style.width=m("organizer__box_wrap").style.width=m("organizer__box_center").style.width=m("organizer__box_bottom").style.width=k-0+"px";m("organizer_Outer").style.width=k-22+"px";m("organizer_wrapInner_bm").style.width=
...
"49%",u.style.width="15%"):1155>=k?(r.style.width="30%",t.style.width="49%",u.style.width="20%"):1155<=k&&(r.style.width="25%",t.style.width="49%",u.style.width="25%");a.pi&&a.pi.sizePanel(v,x,z,y);a._siBu();a.lastSize=k+"x"+p;a._sTLNSS()}if(w._bII()&&m("organizer_rightColumnContent"))if(w._bII(8)){if(k=m("organizer_Outer"))k.onselectstart=function(){return!1}}else{if(k=m("organizer_leftColumnOuter"))k.onselectstart=function(){return!1};if(k=m("organizer_itemCountWrap"))k.onselectstart=function(){return!1};
