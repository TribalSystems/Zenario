...
a.setDataAttributes=function(a,c){for(var d in a)r(a,d)&&"data"==d.substr(0,4)&&(c[d]=a[d])};a.setTopRightButtons=function(){delete a.map.top_right_buttons.ord;var b=a.getSortedIdsOfTUIXElements(a.map.top_right_buttons),c=-1,d,e=[],f,g,k;for(k in b)r(b,k)&&(g=b[k],d=a.map.top_right_buttons[g],a.checkButtonHidden(d)||(f=a.checkDisabled(d),e[++c]=a.setButtonAction("zenarioO.topRightButtonClick",d,f,g,l,l,"")));a.setButtonKin(e);$("#organizer_top_right_buttons").html(q.microTemplate("zenario_organizer_top_right_button",
e));q.tooltips("#organizer_top_right_buttons a[title]",{position:{my:"right center",at:"left center",collision:"flipfit"},show:!1,hide:!1})};a.setButtons=function(){var b=a.pi.returnSelectedItems();a.itemsSelected=0;for(var c in b)r(b,c)&&++a.itemsSelected;a.pi.showButtons($("#organizer_buttons"));a.setChooseButton()};a.getQuickFilters=function(){var b=-1,c,d=[],e,f,g;for(g in a.sortedQuickFilterButtons)r(a.sortedQuickFilterButtons,g)&&(f=a.sortedQuickFilterButtons[g],c=a.tuix.quick_filter_buttons[f],
a.checkButtonHidden(c)||(e=a.checkDisabled(c),d[++b]=a.setButtonAction("zenarioO.toggleQuickFilter",c,e,f,l,l,""),d[b].enabled=a.quickFilterEnabled(f)));a.setButtonKin(d);return d};a.getCollectionButtons=function(){var b=-1,c,d=[],e,f,g;for(g in a.sortedCollectionButtons)r(a.sortedCollectionButtons,g)&&(f=a.sortedCollectionButtons[g],c=a.tuix.collection_buttons[f],a.checkButtonHidden(c)||!a.searchMatches&&(t(c.do_csv_export)||t(c.hide_when_no_search_results))||(e=a.checkDisabled(c),d[++b]=a.setButtonAction("zenarioO.collectionButtonClick",
c,e,f)));a.setButtonKin(d);return d};a.buttonsPrevHTML="";a.fadeOutLastButtons=function(b,c,d){if(p("organizer_rightColumnOptions")){var e=$("#organizer_collectionToolbar"),f=$("#organizer_collectionToolbarButtons"),g=$("#organizer_itemToolbar"),k=$("#organizer_itemToolbarButtons"),h=$("#organizer_previousToolbar"),l=$("#organizer_previousToolbarButtons");e.is(":visible")&&e.clearQueue().hide();g.is(":visible")&&g.clearQueue().hide();c?k.html(b):f.html(b);h.clearQueue().hide();d&&a.buttonsPrevHTML!=
b?(a.buttonsPrevHTML&&(l.html(a.buttonsPrevHTML),h.show().fadeOut({duration:250,easing:"zenarioLinearWithDelayAfterwards",complete:function(){l.html("")}})),c?g.css("animation","none").fadeIn({duration:250,easing:"zenarioLinearWithDelayAfterwards",complete:function(){g.css("animation","");g.addClass("yellow_flash")}}):e.css("animation","none").fadeIn({duration:250,easing:"zenarioLinearWithDelay",complete:function(){e.css("animation","");e.addClass("white_flash")}})):c?g.show():e.show();a.buttonsPrevHTML=
b}};a.showCollectionButtons=function(b,c){a.fadeOutLastButtons(b,!1,c)};a.hideCollectionButtons=function(b){a.fadeOutLastButtons("",!1,b)};a.showItemButtons=function(b,c){a.fadeOutLastButtons(b,!0,c)};a.hideItemButtons=function(b){a.fadeOutLastButtons("",!0,b)};a.getItemButtons=function(){var b,c=-1,d,e=[],f,g,k=a.pi.returnSelectedItems(),h=(b=a.getKeyId(!0))&&a.tuix.items&&a.tuix.items[b];if(0<a.itemsSelected)for(g in a.sortedItemButtons)if(r(a.sortedItemButtons,g)){b=a.sortedItemButtons[g];d=a.tuix.item_buttons[b];
var m=f=1;t(d.multiple_select)&&(f=d.multiple_select_max_items,t(d.multiple_select_only)&&(m=2));a.itemsSelected<m||f&&a.itemsSelected>f||a.checkButtonHidden(d,k)||!a.checkTraits(d,k)||(f=a.checkDisabled(d,k),e[++c]=a.setButtonAction("zenarioO.itemButtonClick",d,f,b,l,h),e[c].label=a.applyMergeFieldsToLabel(w(d.label,d.name),!1,!0,d.multiple_select_label),e[c].tooltip=f&&d.disabled_tooltip?a.applyMergeFieldsToLabel(d.disabled_tooltip,!1,!0):a.applyMergeFieldsToLabel(d.tooltip,!1,!0,d.multiple_select_tooltip))}a.setButtonKin(e);
return e};a.setButtonAction=function(b,c,d,e,f,g,k){k===l&&(k="label_without_icon");k={id:e,tuix:c,css_class:c.css_class||k,label:c.label||c.name,disabled:d};d?k.onclick="return false;":c.navigation_path?k.href=g&&g.navigation_path?"#/"+g.navigation_path:"#/"+c.navigation_path:c.frontend_link?k.href=g&&g.frontend_link?a.parseReturnLink(g.frontend_link):a.parseReturnLink(c.frontend_link):c.onclick?(k.onclick=c.onclick,f&&g&&(k.onclick="zenarioO.selectItems('"+P(f)+"'); zenario.stop(event); "+k.onclick)):
k.onclick=b+"('"+P(e)+(f===l?"":"', '"+P(f))+"'); return false;";k.tooltip=d&&c.disabled_tooltip?c.disabled_tooltip:c.tooltip;return k};a.setButtonKin=function(a){var c,d,e,f={};for(c in a)r(a,c)&&(d=a[c],f[d.id]=c);for(c in a)r(a,c)&&(d=a[c],e=d.tuix.parent)&&(e=f[e],e=a[e])&&(e.children||(e.children=[],e.css_class+=" organiser_button_with_children"),d.enabled&&!t(d.tuix.remove_filter)&&(e.childEnabled=!0),e.children.push(d));for(c=a.length-1;0<=c;--c)d=a[c],(d.tuix.parent||t(d.tuix.hide_when_children_are_not_visible)&&
!d.children)&&a.splice(c,1)};a.checkDisabled=function(b,c){var d,e=l,f=l;if(t(b.disabled))return!0;if(c)for(d in c)if(r(c,d))if(f===l)f=d,e=a.tuix.items&&a.tuix.items[d];else{f=e=l;break}if(b.disabled_if!==l&&q.eval(b.disabled_if,b,e,f))return!0;if(c&&b.disabled_if_for_any_selected_items!==l)for(d in c)if(r(c,d)&&q.eval(b.disabled_if_for_any_selected_items,b,a.tuix.items[d],d))return!0;if(c&&b.disabled_if_for_all_selected_items!==l){for(d in c)if(r(c,d)&&!q.eval(b.disabled_if_for_all_selected_items,
b,a.tuix.items[d],d))return!1;return!0}return!1};a.checkButtonHidden=function(b,c){var d,e=l,f=l,g;if(c)for(d in c)if(r(c,d))if(f===l)f=d,e=a.tuix.items&&a.tuix.items[d];else{f=e=l;break}if(q.hidden(b,!0,e,f)||m.zenarioONotFull&&b.frontend_link||m.zenarioOQuickMode&&t(b.hide_in_quick_mode)||m.zenarioOSelectMode&&t(b.hide_in_select_mode)||!(m.zenarioOQuickMode||!t(b.quick_mode_only)||m.zenarioOSelectMode&&t(b.select_mode_only))||!(m.zenarioOSelectMode||!t(b.select_mode_only)||m.zenarioOQuickMode&&
t(b.quick_mode_only)))return!0;if(b.only_show_on_refiner){if(!a.refiner)return!0;if("object"==typeof b.only_show_on_refiner){if(!t(b.only_show_on_refiner[a.refiner.name]))return!0}else if(a.refiner.name!=b.only_show_on_refiner)return!0}if(a.refiner&&(g=b.hide_on_refiner)){if(1===1*g)return!0;if("object"==typeof g){if(t(g[a.refiner.name]))return!0}else if(a.refiner.name==g)return!0}return a.filteredView&&t(b.hide_on_filter)||a.pathNotAllowed(b.link)?!0:!1};a.checkTraits=function(b,c){var d,e;if(!b)return!0;
if(b.visible_if_for_all_selected_items!==l)for(d in c)if(r(c,d)&&!q.eval(b.visible_if_for_all_selected_items,b,a.tuix.items[d],d))return!1;e=!1;if(b.visible_if_for_any_selected_items!==l){for(d in c)if(r(c,d)&&q.eval(b.visible_if_for_any_selected_items,b,a.tuix.items[d],d)){e=!0;break}if(!e)return!1}e=!0;var f={traits:{condition:function(b,c){return a.tuix.items[b].traits&&t(a.tuix.items[b].traits[c])}},without_traits:{condition:function(b,c){return!a.tuix.items[b].traits||!t(a.tuix.items[b].traits[c])}},
with_columns_set:{condition:function(b,c){return t(a.tuix.items[b][c])}},without_columns_set:{condition:function(b,c){return!t(a.tuix.items[b][c])}}};f.one_with_traits=$.extend(!0,{},f.traits,{one:!0});f.one_without_traits=$.extend(!0,{},f.without_traits,{one:!0});f.one_with_columns_set=$.extend(!0,{},f.with_columns_set,{one:!0});f.one_without_columns_set=$.extend(!0,{},f.without_columns_set,{one:!0});for(var g in f)if(r(f,g)){if(b[g])for(d in e=!f[g].one,c)if(r(c,d)){var k=!0,h;for(h in b[g])if(r(b[g],
h)&&t(b[g][h])&&!f[g].condition(d,h)){k=!1;break}if(f[g].one){if(k){e=!0;break}}else if(!k){e=!1;break}}if(!e)break}return e};a.checkItemPickable=function(b){var c={};c[b]=!0;return a.checkTraits(m.zenarioOSelectObject,c)&&!a.checkDisabled(m.zenarioOSelectObject,c)};a.getInlineButtons=function(b){var c=-1,d=[],e,f,g;for(g in a.sortedInlineButtons)r(a.sortedInlineButtons,g)&&(f=a.sortedInlineButtons[g],button=a.tuix.inline_buttons[f],e={},e[b]=!0,!a.checkButtonHidden(button,e)&&a.checkTraits(button,
e)&&(e=a.checkDisabled(button,e),d[++c]=a.setButtonAction("zenarioO.inlineButtonClick",button,e,f,b,a.tuix.items[b]),d[c].tooltip&&(d[c].tooltip=a.applyMergeFields(d[c].tooltip,!1,b)),d[c].label&&(d[c].label=a.applyMergeFields(d[c].label,!1,b))));return d.length?d:l};a.chooseButtonActive=function(){return m.zenarioOSelectMode&&(a.path==m.zenarioOTargetPath||!1===m.zenarioOTargetPath)};a.setChooseButton=function(){if(m.zenarioOSelectMode){var b=w(m.zenarioOChoosePhrase,u.choose),c=!0,d="submit_disabled",
