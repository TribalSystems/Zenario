...
CREATE TABLE `[[DB_PREFIX]]admins` (
  ...
  `permissions` enum('all_permissions','specific_actions','specific_areas') NOT NULL DEFAULT 'specific_actions',
  `specific_languages` varchar(255) CHARACTER SET ascii DEFAULT NULL,
