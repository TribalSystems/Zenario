...
DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod115_zud_user_document_tag_link`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod115_zud_user_document_tag_link` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod115_zud_user_documents`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod115_zud_user_documents` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ordinal` int(10) NOT NULL,
  `type` enum('file','folder') NOT NULL DEFAULT 'file',
...
DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod115_zud_user_documents_custom_data`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod115_zud_user_documents_custom_data` (
  `user_document_id` int(10) unsigned NOT NULL,
  PRIMARY KEY (`user_document_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_form_field_values`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_form_field_values` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `form_field_id` int(10) unsigned NOT NULL,
  `ord` int(10) unsigned NOT NULL DEFAULT '0',
  `label` varchar(250) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `is_invalid` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_pages`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_pages` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_user_form_fields`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_user_form_fields` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_form_id` int(10) unsigned NOT NULL,
  `page_id` int(10) unsigned NOT NULL,
  `user_field_id` int(10) unsigned DEFAULT '0',
  `ord` int(10) unsigned NOT NULL DEFAULT '0',
  `field_type` enum('checkbox','checkboxes','date','editor','radios','centralised_radios','select','centralised_select','text','textarea','url','attachment','section_description','calculated','restatement','repeat_start','repeat_end','document_upload') DEFAULT NULL,
  `protected` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `mandatory_condition_checkboxes_operator` enum('AND','OR') NOT NULL DEFAULT 'AND',
  `mandatory_condition_field_value` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `visibility` enum('visible','hidden','visible_on_condition') DEFAULT 'visible',
  `visible_condition_field_id` int(10) unsigned DEFAULT '0',
  `visible_condition_invert` tinyint(1) NOT NULL DEFAULT '0',
  `visible_condition_checkboxes_operator` enum('AND','OR') NOT NULL DEFAULT 'AND',
  `visible_condition_field_value` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `name` varchar(250) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `custom_code_name` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `label` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `size` enum('small','medium','large') DEFAULT 'medium',
  `placeholder` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `preload_dataset_field_user_data` tinyint(1) NOT NULL DEFAULT '1',
  `default_value` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `default_value_class_name` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `default_value_method_name` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `default_value_param_1` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `default_value_param_2` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `note_to_user` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `css_classes` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `div_wrap_class` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `required_error_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `validation` enum('email','URL','integer','number','floating_point') DEFAULT NULL,
  `validation_error_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `description` text CHARACTER SET utf8mb4,
  `restatement_field` int(10) unsigned DEFAULT '0',
  `values_source` varchar(250) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `values_source_filter` varchar(250) CHARACTER SET utf8mb4 NOT NULL DEFAULT '',
  `autocomplete` tinyint(1) NOT NULL DEFAULT '0',
  `autocomplete_no_filter_placeholder` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  ...
  `calculation_code` text CHARACTER SET utf8mb4,
  `value_prefix` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `value_postfix` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `show_month_year_selectors` tinyint(1) NOT NULL DEFAULT '0',
  `no_past_dates` tinyint(1) NOT NULL DEFAULT '0',
  `invalid_field_value_error_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `word_count_max` int(10) unsigned DEFAULT NULL,
  `word_count_min` int(10) unsigned DEFAULT NULL,
  `combined_filename` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `filter_on_field` int(10) unsigned NOT NULL DEFAULT '0',
  `repeat_start_id` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `user_form_id` (`user_form_id`),
  KEY `page_id` (`page_id`),
  KEY `user_field_id` (`user_field_id`),
  KEY `custom_code_name` (`custom_code_name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_user_forms`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_user_forms` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(250) CHARACTER SET utf8mb4 NOT NULL,
  `type` enum('standard','profile','registration') NOT NULL DEFAULT 'standard',
  `status` enum('active','archived') DEFAULT 'active',
  `send_email_to_email_from_field` tinyint(1) NOT NULL DEFAULT '0',
  `user_email_field` int(10) unsigned NOT NULL DEFAULT '0',
  `send_email_to_logged_in_user` tinyint(1) NOT NULL DEFAULT '0',
  `user_email_use_template_for_email_from_field` tinyint(1) NOT NULL DEFAULT '0',
  `user_email_use_template_for_logged_in_user` tinyint(1) NOT NULL DEFAULT '0',
  `user_email_template_from_field` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `user_email_template_logged_in_user` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `send_email_to_admin` tinyint(1) NOT NULL DEFAULT '0',
  `admin_email_use_template` tinyint(1) NOT NULL DEFAULT '0',
  `admin_email_addresses` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `admin_email_template` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  ...
  `redirect_location` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `reply_to_email_field` int(10) unsigned NOT NULL DEFAULT '0',
  `reply_to_first_name` int(10) unsigned NOT NULL DEFAULT '0',
  `reply_to_last_name` int(10) unsigned NOT NULL DEFAULT '0',
  ...
  `success_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `user_duplicate_email_action` enum('merge','overwrite','ignore','stop') DEFAULT 'merge',
  `update_linked_fields` tinyint(1) NOT NULL DEFAULT '0',
  `no_duplicate_submissions` tinyint(1) NOT NULL DEFAULT '0',
  `duplicate_submission_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `add_logged_in_user_to_group` int(10) unsigned DEFAULT NULL,
  `title` varchar(250) CHARACTER SET utf8mb4 DEFAULT '',
  ...
  `submit_button_text` varchar(250) CHARACTER SET utf8mb4 DEFAULT 'Submit',
  `log_user_in_cookie` tinyint(1) NOT NULL DEFAULT '0',
  `duplicate_email_address_error_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `profanity_filter_text` tinyint(1) NOT NULL DEFAULT '0',
  `allow_partial_completion` tinyint(1) NOT NULL DEFAULT '0',
  `partial_completion_mode` enum('auto','button','auto_and_button') DEFAULT NULL,
  `partial_completion_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `allow_clear_partial_data` tinyint(1) NOT NULL DEFAULT '0',
  `clear_partial_data_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `use_honeypot` tinyint(1) NOT NULL DEFAULT '0',
  `honeypot_label` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `show_page_switcher` tinyint(1) NOT NULL DEFAULT '0',
  `page_switcher_navigation` enum('none','only_visited_pages') DEFAULT 'none',
  `enable_summary_page` tinyint(1) NOT NULL DEFAULT '0',
  `verification_email_template` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `welcome_email_template` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `welcome_message` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `welcome_redirect_location` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_user_partial_response`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_user_partial_response` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `form_id` int(10) unsigned NOT NULL,
  `response_datetime` datetime NOT NULL,
  `max_page_reached` int(10) unsigned NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `form_id` (`form_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_user_partial_response_data`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_user_partial_response_data` (
  `user_partial_response_id` int(10) unsigned NOT NULL,
  `form_field_id` int(10) unsigned NOT NULL,
  `field_row` int(10) unsigned NOT NULL DEFAULT '0',
  `value` text CHARACTER SET utf8mb4 NOT NULL,
  PRIMARY KEY (`user_partial_response_id`,`form_field_id`,`field_row`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_user_response`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_user_response` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `form_id` int(10) unsigned NOT NULL,
  `response_datetime` datetime NOT NULL,
  `crm_response` text CHARACTER SET utf8mb4,
  `blocked_by_profanity_filter` tinyint(1) NOT NULL DEFAULT '0',
  `profanity_filter_score` int(11) NOT NULL DEFAULT '0',
  `profanity_tolerance_limit` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod117_zuf_user_response_data`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod117_zuf_user_response_data` (
  `user_response_id` int(10) unsigned NOT NULL,
  `form_field_id` int(10) unsigned NOT NULL,
  `field_row` int(10) unsigned NOT NULL DEFAULT '0',
  `value` text CHARACTER SET utf8mb4 NOT NULL,
  `internal_value` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (`user_response_id`,`form_field_id`,`field_row`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod15_zs2_slides`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod15_zs2_slides` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ordinal` int(10) unsigned NOT NULL,
  `instance_id` int(10) unsigned NOT NULL,
  `image_id` int(10) unsigned NOT NULL,
  `overwrite_alt_tag` text CHARACTER SET utf8mb4,
  `tab_name` text CHARACTER SET utf8mb4,
  `slide_title` text CHARACTER SET utf8mb4,
  `slide_extra_html` text CHARACTER SET utf8mb4,
  `slide_more_link_text` varchar(250) CHARACTER SET utf8mb4 DEFAULT '',
  `rollover_image_id` int(10) unsigned DEFAULT NULL,
  `rollover_overwrite_alt_tag` text CHARACTER SET utf8mb4,
  `mobile_image_id` int(10) unsigned DEFAULT NULL,
  `mobile_overwrite_alt_tag` text CHARACTER SET utf8mb4,
  `mobile_tab_name` text CHARACTER SET utf8mb4,
  `mobile_slide_title` text CHARACTER SET utf8mb4,
  `mobile_slide_extra_html` text CHARACTER SET utf8mb4,
  `target_loc` enum('internal','external','none') DEFAULT 'none',
  `dest_url` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `open_in_new_window` tinyint(1) NOT NULL DEFAULT '0',
  `slide_visibility` enum('call_static_method','logged_in','logged_out','logged_in_with_field','logged_in_without_field','everyone') DEFAULT 'everyone',
  `link_to_translation_chain` tinyint(1) NOT NULL DEFAULT '0',
  `plugin_class` varchar(250) CHARACTER SET utf8mb4 DEFAULT '',
  `method_name` varchar(250) CHARACTER SET utf8mb4 DEFAULT '',
  `param_1` varchar(250) CHARACTER SET utf8mb4 DEFAULT '',
  `param_2` varchar(250) CHARACTER SET utf8mb4 DEFAULT '',
  `field_id` int(10) unsigned DEFAULT NULL,
  `field_value` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `hidden` tinyint(1) NOT NULL DEFAULT '0',
  `transition_code` text CHARACTER SET utf8mb4,
  `use_transition_code` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  KEY `ordinal` (`ordinal`),
  KEY `instance_id` (`instance_id`),
  KEY `image_id` (`image_id`),
  KEY `rollover_image_id` (`rollover_image_id`),
  KEY `mobile_image_id` (`mobile_image_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod34_zcm_country_manager_countries`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod34_zcm_country_manager_countries` (
  `id` varchar(5) NOT NULL,
  `english_name` varchar(255) DEFAULT NULL,
  `active` tinyint(1) DEFAULT NULL,
  `phonecode` int(5) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod34_zcm_country_manager_regions`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod34_zcm_country_manager_regions` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  ...
  `active` tinyint(1) DEFAULT NULL,
  `region_type` enum('region','state','city') NOT NULL DEFAULT 'region',
  PRIMARY KEY (`id`),
  UNIQUE KEY `name` (`name`,`parent_id`,`country_id`),
  KEY `region_type` (`region_type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod51_zel_error_log`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod51_zel_error_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `logged` datetime NOT NULL,
  `referrer_url` text CHARACTER SET utf8mb4,
  `page_alias` varchar(255) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `[[DB_NAME_PREFIX]]mod9_zetm_email_template_sending_log`;
CREATE TABLE `[[DB_NAME_PREFIX]]mod9_zetm_email_template_sending_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `module_id` int(10) unsigned DEFAULT NULL,
  `instance_id` int(10) unsigned DEFAULT NULL,
  `content_id` int(10) DEFAULT NULL,
  `content_type` varchar(25) CHARACTER SET utf8mb4 DEFAULT NULL,
  `content_version` int(10) DEFAULT NULL,
  `email_template_id` int(10) DEFAULT NULL,
  `email_template_name` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `email_subject` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `email_address_to` varchar(250) CHARACTER SET utf8mb4 NOT NULL,
  `email_address_to_overridden_by` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `email_address_from` varchar(250) CHARACTER SET utf8mb4 NOT NULL,
  `email_address_replyto` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `email_name_from` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  `email_body` mediumtext CHARACTER SET utf8mb4,
  `attachment_present` tinyint(4) DEFAULT NULL,
  `sent_datetime` datetime NOT NULL,
  `status` enum('success','failure') DEFAULT 'success',
  `email_name_replyto` varchar(250) CHARACTER SET utf8mb4 DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
