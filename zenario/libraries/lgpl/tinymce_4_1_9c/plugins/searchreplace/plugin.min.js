...
p))||b(),c.statusbar.items().slice(1).disabled(0===e),a(),d={text:q,caseState:f,wholeWord:p}):(l.done(!1),c.statusbar.items().slice(1).disabled(!0))},buttons:[{text:"Find",onclick:function(){c.submit()}},{text:"Replace",disabled:!0,onclick:function(){l.replace(c.find("#replace").value())||(c.statusbar.items().slice(1).disabled(!0),h=-1,d={})}},{text:"Replace all",disabled:!0,onclick:function(){l.replace(c.find("#replace").value(),!0,!0);c.statusbar.items().slice(1).disabled(!0);d={}}},{type:"spacer",
flex:1},{text:"Prev",name:"prev",disabled:!0,onclick:function(){l.prev();a()}},{text:"Next",name:"next",disabled:!0,onclick:function(){l.next();a()}}],title:"Find and replace",items:{type:"form",padding:20,labelGap:30,spacing:10,items:[{type:"textbox",name:"find",size:40,label:"Find",value:e.selection.getNode().src},{type:"textbox",name:"replace",size:40,label:"Replace with"},{type:"checkbox",name:"case",text:"Match case",label:" "},{type:"checkbox",name:"words",text:"Whole words",label:" "}]}}).renderTo().reflow()}
function r(a){a=a.getAttribute("data-mce-index");return"number"==typeof a?""+a:a}function t(a){var b=a.parentNode;a.firstChild&&b.insertBefore(a.firstChild,a);a.parentNode.removeChild(a)}function m(a){var b,d=[];b=tinymce.toArray(e.getBody().getElementsByTagName("span"));if(b.length)for(var c=0;c<b.length;c++){var g=r(b[c]);null!==g&&g.length&&g===a.toString()&&d.push(b[c])}return d}function s(a){var b=h,d=e.dom;!1!==a?b++:b--;d.removeClass(m(h),"mce-match-marker-selected");a=m(b);return a.length?
(d.addClass(m(b),"mce-match-marker-selected"),e.selection.scrollIntoView(a[0]),b):-1}var l=this,h=-1;l.init=function(a){a.addMenuItem("searchreplace",{text:"Find and replace",shortcut:"Meta+F",onclick:n,separator:"before",context:"edit"});a.addButton("searchreplace",{tooltip:"Find and replace",shortcut:"Meta+F",onclick:n});a.addCommand("SearchReplace",n);a.shortcuts.add("Meta+F","",n)};l.find=function(a,b,d){a=a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&");a=RegExp(d?"\\b"+a+"\\b":a,b?"g":
"gi");d=e.dom.create("span",{"data-mce-bogus":1});d.className="mce-match-marker";b=e.getBody();l.done(!1);if(a=w(a,b,d,!1,e.schema))h=-1,h=s(!0);return a};l.next=function(){var a=s(!0);-1!==a&&(h=a)};l.prev=function(){var a=s(!1);-1!==a&&(h=a)};l.replace=function(a,b,d){var c,g,f,q,p=h;b=!1!==b;c=e.getBody();g=tinymce.toArray(c.getElementsByTagName("span"));for(c=0;c<g.length;c++){var n=r(g[c]);if(null!==n&&n.length)if(f=q=parseInt(n,10),d||f===h){a.length?(g[c].firstChild.nodeValue=a,t(g[c])):(f=
g[c],f.parentNode.removeChild(f));for(;g[++c];)if(f=r(g[c]),null!==n&&n.length)if(f===q)f=g[c],f.parentNode.removeChild(f);else{c--;break}b&&p--}else q>h&&g[c].setAttribute("data-mce-index",q-1)}e.undoManager.add();h=p;b?(a=0<m(p+1).length,l.next()):(a=0<m(p-1).length,l.prev());return!d&&a};l.done=function(a){var b,d,c,g;d=tinymce.toArray(e.getBody().getElementsByTagName("span"));for(b=0;b<d.length;b++){var f=r(d[b]);null!==f&&f.length&&(f===h.toString()&&(c||(c=d[b].firstChild),g=d[b].firstChild),
