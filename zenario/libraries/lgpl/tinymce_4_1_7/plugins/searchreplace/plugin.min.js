...
(d.addClass(m(b),"mce-match-marker-selected"),e.selection.scrollIntoView(a[0]),b):-1}var l=this,h=-1;l.init=function(a){a.addMenuItem("searchreplace",{text:"Find and replace",shortcut:"Ctrl+F",onclick:n,separator:"before",context:"edit"});a.addButton("searchreplace",{tooltip:"Find and replace",shortcut:"Ctrl+F",onclick:n});a.addCommand("SearchReplace",n);a.shortcuts.add("Ctrl+F","",n)};l.find=function(a,b,d){a=a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&");a=RegExp(d?"\\b"+a+"\\b":a,b?"g":
