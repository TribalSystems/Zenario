...
b.template=function(a,c,d){var e;d=b.defaults({},d,b.templateSettings);var f=RegExp([(d.escape||z).source,(d.interpolate||z).source,(d.evaluate||z).source].join("|")+"|$","g"),h=0,g="__p+='";a.replace(f,function(b,c,e,f,k){g+=a.slice(h,k).replace(S,function(a){return"\\"+R[a]});var l;d.twigStyleSyntax&&e&&(l=e.match(/(.*)\|e(|scape)$\s*/))&&(c=l[1],e=!1);c&&(g+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'");e&&(g+="'+\n((__t=("+e+"))==null?'':__t)+\n'");f&&(g+="';\n"+f+"\n__p+='");h=k+b.length;
return b});g+="';\n";d.variable||(g="with(obj||{}){\n"+g+"}\n");g="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+g+"return __p;\n";try{e=new Function(d.variable||"obj","_",g)}catch(k){throw k.source=g,k;}if(c)return e(c,b);c=function(a){return e.call(this,a,b)};c.source="function("+(d.variable||"obj")+"){\n"+g+"}";return c};b.chain=function(a){return b(a).chain()};b.mixin(b);l("pop push reverse shift sort splice unshift".split(" "),function(a){var c=m[a];
b.prototype[a]=function(){var d=this._wrapped;c.apply(d,arguments);"shift"!=a&&"splice"!=a||0!==d.length||delete d[0];return this._chain?b(d).chain():d}});l(["concat","join","slice"],function(a){var c=m[a];b.prototype[a]=function(){var a=c.apply(this._wrapped,arguments);return this._chain?b(a).chain():a}});b.extend(b.prototype,{chain:function(){this._chain=!0;return this},value:function(){return this._wrapped}})}).call(this);
