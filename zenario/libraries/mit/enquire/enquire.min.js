...
this.isUnconditional},clear:function(){d(this.handlers,function(a){a.destroy()});this.mql.removeListener(this.listener);this.handlers.length=0},assess:function(){var a=this.matches()?"on":"off";d(this.handlers,function(b){b[a]()})}};h.prototype={register:function(a,b,c){var e=this.queries;c=c&&this.browserIsIncapable;e[a]||(e[a]=new g(a,c));"function"===typeof b&&(b={match:b});"[object Array]"!==Object.prototype.toString.apply(b)&&(b=[b]);d(b,function(b){"function"===typeof b&&(b={match:b});e[a].addHandler(b)});
return this},unregister:function(a,b){var c=this.queries[a];c&&(b?c.removeHandler(b):(c.clear(),delete this.queries[a]));return this}};return new h});
