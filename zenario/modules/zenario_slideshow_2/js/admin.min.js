...
zenario_slideshow_2.tempSaveData=function(a){if(a&&this.data.slides[a]){console.log(this.data.slides[a]);var c=[];serial=$("#zenario_slide_settings_form").serializeArray();for(var b in serial)serial.hasOwnProperty(b)&&(c[serial[b].name]=serial[b].value);b=["open_in_new_window","link_to_translation_chain","use_transition_code","hidden"];for(var d in b)b.hasOwnProperty(d)&&void 0===c[b[d]]&&(c[b[d]]=0);for(d in c)if(c.hasOwnProperty(d)){var e=c[d];-1!=$.inArray(d,b)&&(e=zenario.engToBoolean(e));this.data.slides[a][d]=
e}console.log(this.data.slides[a])}};zenario_slideshow_2.tempSaveOrder=function(){this.slideOrderedIds=$("#zenario_sortable").sortable("toArray",{attribute:"data-id"})};
