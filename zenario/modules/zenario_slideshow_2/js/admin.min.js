...
b[0].id;b={slotName:c,instanceId:zenario.slots[c].instanceId,slideDetails:b};a.recommededSize&&(b.recommededSize=!0,b.recommededSizeMessage=a.recommededSizeMessage);a=zenarioT.microTemplate("zenario_image_manager",b);zenarioA.openBox(a,"zenario_fbAdminImageManager","AdminImageManager",void 0,1E3,void 0,2,!0,!0,".zenario_dragMe",!1,!1);d.makeListSortable();d.tempSaveOrder();d.selectSlide(d.current,!0);zenarioT.canDoHTML5Upload()&&zenarioT.setHTML5UploadFromDragDrop(d.AJAXLink,{mode:"file_upload"},
