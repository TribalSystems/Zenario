zenario_slideshow_2.openImageManager=function(b,c,a){b.blur();var d=this;this.AJAXLink=a;this.slotName=c;this.errors={};this.tempSlideId=1;this.uploadChangeImage=!1;zenario._a(a+"&mode=get_details").after(function(a){a=JSON.parse(a);d.data=a;d.slides=a.slides;d.tabs=a.tabs;d.dataset_fields=a.dataset_fields;d.mobile_option=a.mobile_option;_._isEm(a.slides)&&(a.slides={});var b=_._tA(d.slides);b.sort(function(a,b){return a.ordinal-b.ordinal});0==d.slides.length?(d.slides={},d.current=0):d.current=b[0].id;
b={slotName:c,instanceId:zenario.slots[c].instanceId,slideDetails:b};a.recommededSize&&(b.recommededSize=!0,b.recommededSizeMessage=a.recommededSizeMessage);a=zenarioT._mT("zenario_image_manager",b);zenarioA._oB(a,"zenario_fbAdminImageManager","AdminImageManager",void 0,1E3,void 0,2,!0,!0,".zenario_dragMe",!1,!1);d.makeListSortable();d.tempSaveOrder();d.selectSlide(d.current,!0);zenarioT._cDHTML5U()&&zenarioT._sHTML5UFDD(d.AJAXLink,{mode:"file_upload"},!1,d.uploadImagesCallback,document.getElementById("zenario_slideshow_drop_target"));
d.resize();d.size();$("input").change(function(){d.somethingChanged=!0})})};
...
a.m_alt_tag="No image");a.open_in_new_window=zenario._eTB(a.open_in_new_window);a.link_to_translation_chain=zenario._eTB(a.link_to_translation_chain);a.use_transition_code=zenario._eTB(a.use_transition_code);a.hidden=zenario._eTB(a.hidden);a.has_tabs=this.tabs;var d=function(a,b){var c=[];for(key in a)a.hasOwnProperty(key)&&(key==b&&(a[key].selected=!0),a[key].value=key,c.push(a[key]));c.sort(e);return c},e=function(a,b){return+a.ord<+b.ord?-1:+a.ord>+b.ord?1:0},g={},g={none:{label:"Don't link",ord:1},
internal:{label:"Internal - link to a content item",ord:2},external:{label:"External - link to a full URL",ord:3}};a.target_loc_list=d(g,a.target_loc);g={everyone:{label:"Everyone",ord:1},logged_in:{label:"Logged-in users",ord:2},logged_out:{label:"Anonymous visitors",ord:3},logged_in_with_field:{label:"Logged-in users with dataset field",ord:4},logged_in_without_field:{label:"Logged-in users without dataset field",ord:5},call_static_method:{label:"Call a module's static method (advanced)",ord:6}};
a.slide_visibility_list=d(g,a.slide_visibility);this.dataset_fields[""]={label:"-- Select --",ord:0};a.field_id_list=d(this.dataset_fields,a.field_id);this.displaySlideDetails(a);this.current=b}else 0===b&&this.displaySlideDetails({id:b});this.size()};zenario_slideshow_2.displaySlideDetails=function(b){b=zenarioT._mT("zenario_slide_details",b);$("#zenario_slide_attributes_inner").html(b);this.bindEventListeners()};
...
zenario_slideshow_2.makeListSortable=function(){var b=this;$("#zenario_sortable").sortable({update:function(c,a){b.tempSaveOrder()}})};zenario_slideshow_2.deleteSlide=function(){if(!_._isEm(this.data.slides)){this.somethingChanged=!0;var b=this.current,c=0<=this.slideOrderedIds.indexOf(b)-1?this.slideOrderedIds.indexOf(b)-1:0;delete this.data.slides[b];$("li#zenario_slide_image_"+b).remove();this.tempSaveOrder();nextSlideId=_._isEm(this.data.slides)?this.current=0:this.slideOrderedIds[c];this.selectSlide(nextSlideId)}};
zenario_slideshow_2.selectLastImage=function(){_._isEm(this.data.slides)||this.selectSlide(this.slideOrderedIds[this.slideOrderedIds.length-1])};zenario_slideshow_2.selectFirstImage=function(){_._isEm(this.slides)||this.selectSlide(this.slideOrderedIds[0])};zenario_slideshow_2.nudgeImageUp=function(){if(!_._isEm(this.data.slides)){var b=$(".slideshow_selected_image");b.prev().before(b);this.tempSaveOrder()}};
zenario_slideshow_2.nudgeImageDown=function(){if(!_._isEm(this.data.slides)){var b=$(".slideshow_selected_image");b.next().after(b);this.tempSaveOrder()}};
