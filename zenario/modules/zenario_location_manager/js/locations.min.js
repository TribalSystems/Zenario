...
function placeMarker(b){var a="";pinPlacementMethod=b;"postcode_country"==pinPlacementMethod?(""!=parent.document.getElementById("postcode").value&&(a+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario.handlePluginAJAX("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a)):"street_postcode_country"==pinPlacementMethod?
(""!=parent.document.getElementById("address_line_1").value&&(a+=parent.document.getElementById("address_line_1").value+","),""!=parent.document.getElementById("postcode").value&&(a+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario.handlePluginAJAX("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a)):"street_city_country"==
pinPlacementMethod?(""!=parent.document.getElementById("address_line_1").value&&(a+=parent.document.getElementById("address_line_1").value+","),""!=parent.document.getElementById("city").value&&(a+=parent.document.getElementById("city").value+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario.handlePluginAJAX("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a)):"my_location"==
pinPlacementMethod&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(success,error)}function geoCode(b){var a=new google.maps.Geocoder;a&&a.geocode({address:b},function(a,b){b==google.maps.GeocoderStatus.OK?(placeMarkerAction(a[0].geometry.location),map.fitBounds(a[0].geometry.viewport)):alert("Geocoding was not successful.  Google returned the following error code: "+b)})}function trimTrailingComma(b){","==b.substr(-1)&&(b=b.substr(0,b.length-1));return b}
