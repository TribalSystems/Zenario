...
function placeMarker(b){var a="";pinPlacementMethod=b;"postcode_country"==pinPlacementMethod?(""!=parent.document.getElementById("postcode").value&&(a+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a)):"street_postcode_country"==pinPlacementMethod?
(""!=parent.document.getElementById("address_line_1").value&&(a+=parent.document.getElementById("address_line_1").value+","),""!=parent.document.getElementById("postcode").value&&(a+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a)):"street_city_country"==
pinPlacementMethod?(""!=parent.document.getElementById("address_line_1").value&&(a+=parent.document.getElementById("address_line_1").value+","),""!=parent.document.getElementById("city").value&&(a+=parent.document.getElementById("city").value+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a)):"locality_postcode_country"==
pinPlacementMethod&&(""!=parent.document.getElementById("locality").value&&(a+=parent.document.getElementById("locality").value+","),""!=parent.document.getElementById("postcode").value&&(a+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(b=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),a+=b+","),a=trimTrailingComma(a),geoCode(a))}
function latLngInRange(b,a,c){return!isNaN(a)&&a>=b&&a<=c?!0:!1}function placeLatLng(b,a){if(latLngInRange(-90,b,90)&&latLngInRange(-180,a,180)){var c=new google.maps.LatLng(b,a);placeMarkerAction(c)}else alert("Please enter valid latitude/longitude values.")}
