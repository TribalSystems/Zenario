'use strict';var defaultMapCentreLat,defaultMapCentreLng,defaultMapZoom,map,mapZoom,mapCenter,mapCenterLat,mapCenterLng,marker,markerLat,markerLng,pinPlacementMethod,editMode,initialized=!1;
...
function placeMarker(a){var b="";pinPlacementMethod=a;"postcode_country"==pinPlacementMethod?(""!=parent.document.getElementById("postcode").value&&(b+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(a=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),b+=a+","),b=trimTrailingComma(b),geoCode(b)):"street_postcode_country"==pinPlacementMethod?
(""!=parent.document.getElementById("address_line_1").value&&(b+=parent.document.getElementById("address_line_1").value+","),""!=parent.document.getElementById("postcode").value&&(b+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(a=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),b+=a+","),b=trimTrailingComma(b),geoCode(b)):"street_city_country"==
pinPlacementMethod?(""!=parent.document.getElementById("address_line_1").value&&(b+=parent.document.getElementById("address_line_1").value+","),""!=parent.document.getElementById("city").value&&(b+=parent.document.getElementById("city").value+","),""!=parent.document.getElementById("country").value&&(a=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),b+=a+","),b=trimTrailingComma(b),geoCode(b)):"locality_postcode_country"==
pinPlacementMethod&&(""!=parent.document.getElementById("locality").value&&(b+=parent.document.getElementById("locality").value+","),""!=parent.document.getElementById("postcode").value&&(b+=parent.document.getElementById("postcode").value.replace(" ","")+","),""!=parent.document.getElementById("country").value&&(a=parent.zenario._mNAA("zenario_location_manager","&mode=get_country_name&country_id="+parent.document.getElementById("country").value),b+=a+","),b=trimTrailingComma(b),geoCode(b))}
