...
geoCode(a)):"my_location"==pinPlacementMethod&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(success,error)}function latLngInRange(b,a,c){return!isNaN(a)&&a>=b&&a<=c?!0:!1}function placeLatLng(b,a){if(latLngInRange(-90,b,90)&&latLngInRange(-180,a,180)){var c=new google.maps.LatLng(b,a);placeMarkerAction(c)}else alert("Please enter valid latitude/longitude values.")}
