...
geoCode(a)):"my_location"==pinPlacementMethod&&navigator.geolocation&&navigator.geolocation.getCurrentPosition(success,error)}function geoCode(b){var a=new google.maps.Geocoder;a&&a.geocode({address:b},function(a,b){b==google.maps.GeocoderStatus.OK?(placeMarkerAction(a[0].geometry.location),map.fitBounds(a[0].geometry.viewport)):alert("Geocoding was not successful.  Google returned the following error code: "+b)})}
function trimTrailingComma(b){","==b.substr(-1)&&(b=b.substr(0,b.length-1));return b}
