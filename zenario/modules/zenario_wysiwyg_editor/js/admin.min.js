...
c.phrase.cancel+'"/>',!0);return}}h=e.get(h+"_save_link").value;f=$("div#"+f).tinymce().getContent();(d=a.AJAX(h,"_zenario_save_content_=1&_sync_summary="+e.engToBoolean(d&&g)+"&content__content="+encodeURIComponent(f),!0))?a.floatingMessage(d,!0,"error"):k?a.doClose(b):c.notification(c.phrase.contentSaved)};a.SK=function(b,k,d,e){a.win=e;a.field_name=b;"file"==d?c.SK("zenario_wysiwyg_editor","setLinkURL",!1,"zenario__content/nav/content/panel","zenario__content/nav/content/panel","zenario__content/nav/content/panel",
"zenario__content/nav/content/panel",!1,g,g,g,!0):"image"==d&&c.SK("zenario_wysiwyg_editor","setImageURL",!1,"zenario__content/nav/content/panel/item_buttons/images//"+a.cType+"_"+a.cID+"//","zenario__content/hidden_nav/media/panel/hidden_nav/inline_images_for_content/panel","zenario__content/hidden_nav/media/panel/hidden_nav/inline_images_for_content/panel","zenario__content/hidden_nav/media/panel/hidden_nav/inline_images_for_content/panel",!0,g,g,g,!0)};a.lastFieldValue="";a.setEditorField=function(b,
c,d){c===g&&(c=a.win.document.getElementById(a.field_name));if(d){if(""!==c.value&&c.value!=a.lastFieldValue)return;a.lastFieldValue=b}c.value=b;e.fireChangeEvent(c)};a.setLinkURL=function(b,c,d){c.getItemURL=1;b=e.pluginClassAJAX("zenario_common_features",c,!0);a.setEditorField(d.title,$(".mce-panel input.mce-link_text_to_display")[0],!0);a.setEditorField(b)};a.setImageURL=function(b,c,d){b="zenario/file.php?c="+d.checksum+"&filename="+encodeURIComponent(d.filename);a.setEditorField(d.alt_tag,$(".mce-panel input.mce-image_alt")[0]);
a.setEditorField(b)};a.setFlashURL=function(b,c,d){b="zenario/file.php?c="+d.checksum+"&filename="+encodeURIComponent(d.filename);a.setEditorField(b)};a.close=function(b){b=e.getContainerIdFromEl(b);b=e.getSlotnameFromEl(e.get(b));a.floatingMessage(c.phrase.closeEditorWarning,'<input type="button" class="submit_selected" value="'+c.phrase.abandonChanges+'" onclick="zenarioA.closeFloatingBox(); zenario_wysiwyg_editor.doClose(\''+b+'\');" /><input type="button" class="submit" value="'+c.phrase.cancel+
'"/>',!0)};a.doClose=function(b){$("#zenario_editor_toolbar").html("").hide();a.refreshPluginSlot(b,g,!1);zenarioAT.init()}})(zenario,zenarioA,zenario_wysiwyg_editor);
