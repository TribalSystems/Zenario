zenario_user_forms.recatcha=function(){onloadCallback()};zenario_user_forms.updateRestatementFields=function(a,c){$(a?':input[data-mirror-of="'+a+'"]':":input[data-mirror-of]").each(function(b,e){var a=$(e),d=$("#"+a.data("mirror-of"));"checkbox"==c||"radio"==c?a.prop("checked",d.prop("checked")):a.val(d.val())})};
