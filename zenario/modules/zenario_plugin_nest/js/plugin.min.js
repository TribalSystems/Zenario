...
a)){var b=l[a];if(b.exists&&_._isFu(b.checkChangedOnClose)&&b.checkChangedOnClose())return b.confirmOnCloseMessage}return w};d.transitionIn=function(a,b){a=k(a);a=$("#plgslt_"+a.slotName).find(".nest_plugins_wrap").css("position","relative");var c=b.options||{};_._iS(c.duration)&&(c.duration*=1);_._isAr(c.easing)&&(c.easing=$.bez(c.easing));b.initial&&a.css(b.initial);b.animate&&a.animate(b.animate,c)};d.transitionOut=function(a,b){a=k(a);if(b&&b.animate){var c=$("#plgslt_"+a.slotName),e=c.cloneProperly().attr("id",
"").css("position","absolute").css("z-index",2).addClass("zenario_conductor_slot_dummy_for_transition").width(c.width()).height(c.height()).insertBefore(c);a=c.find(".nest_plugins_wrap");var f=e.find(".nest_plugins_wrap").css("position","relative").addClass("zenario_conductor_slide_dummy_for_transition"),h=b.options||{};b=b.animate;var n=c.height(),m=c.css("min-height");_._iS(h.duration)&&(h.duration*=1);_._isAr(h.easing)&&(h.easing=$.bez(h.easing));p(b.left)&&f.css("right","");p(b.right)&&f.css("left",
