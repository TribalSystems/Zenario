...
/*
 * Customized with ideas and code from https://github.com/plank/MarkerClusterer
 * with addition of a parameter to reuse an InfoWindow instead of creating a new one
 * every time. 
 */
...
ClusterIcon.prototype.onAdd = function () {
  ...
  google.maps.event.addDomListener(this.div_, "click", function (e) {
    ...
    if (!cDraggingMapByCluster) {
      var theBounds;
      var mz, mc = cClusterIcon.cluster_.getMarkerClusterer();
      ...
      //Info on click
      var infoOnClick = (mc.getInfoOnClick() && mc.getMap().getZoom() >= mc.getInfoOnClickZoom());
      if(infoOnClick) {

          var markers = cClusterIcon.cluster_.getMarkers(),
              infoContent = [];
         ...
         var clusterInfoWindow = mc.reusableInfoWindow_;
         if(!clusterInfoWindow) clusterInfoWindow = new google.maps.InfoWindow();
         clusterInfoWindow.setContent(infoContent.join('<br>'));
         clusterInfoWindow.open(mc.getMap(), markers[0]);
      }
      else if (mc.getZoomOnClick()) {
 ...
 * @property {boolean} [infoOnClick=true] Whether we want to activate infoOnClick
 * @property {number} [infoOnClickZoom=0] What zoom level we have to be in for infoOnClick to trigger
 * @property {object} [reusableInfoWindow=null] Reusable Info window to use for infoOnClick
...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  this.infoOnClick_ = opt_options.infoOnClick || true;

  //Threshold zoom level under which we show info instead of zoomOnClick
  this.infoOnClickZoom_ = opt_options.infoOnClickZoom || 0;
  
  //When showing info for a cluster resuse this InfoWindow instead of creating a new one
  this.reusableInfoWindow_ = opt_options.reusableInfoWindow || null;
 ...
 */
MarkerClusterer.prototype.getInfoOnClick = function() {
