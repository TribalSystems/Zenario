...
ClusterIcon.prototype.onAdd=function(){var a=this,b,c;this.div_=document.createElement("div");this.div_.className=this.className_;this.visible_&&this.show();this.getPanes().overlayMouseTarget.appendChild(this.div_);google.maps.event.addListener(this.getMap(),"bounds_changed",function(){c=b});google.maps.event.addDomListener(this.div_,"mousedown",function(){b=!0;c=!1});google.maps.event.addDomListener(this.div_,"click",function(d){b=!1;if(!c){var e,h,f=a.cluster_.getMarkerClusterer();google.maps.event.trigger(f,
"click",a.cluster_);google.maps.event.trigger(f,"clusterclick",a.cluster_);if(f.getInfoOnClick()&&f.getMap().getZoom()>=f.getInfoOnClickZoom()){for(var i=a.cluster_.getMarkers(),j=[],g=0;g<i.length;g++)j.push(void 0!==i[g].content&&""!=i[g].content?i[g].content:i[g].title);(g=f.reusableInfoWindow_)||(g=new google.maps.InfoWindow);g.setContent(j.join("<br>"));g.open(f.getMap(),i[0])}else f.getZoomOnClick()&&(h=f.getMaxZoom(),e=a.cluster_.getBounds(),f.getMap().fitBounds(e),setTimeout(function(){f.getMap().fitBounds(e);
null!==h&&f.getMap().getZoom()>h&&f.getMap().setZoom(h+1)},100));d.cancelBubble=!0;d.stopPropagation&&d.stopPropagation()}});google.maps.event.addDomListener(this.div_,"mouseover",function(){var b=a.cluster_.getMarkerClusterer();google.maps.event.trigger(b,"mouseover",a.cluster_)});google.maps.event.addDomListener(this.div_,"mouseout",function(){var b=a.cluster_.getMarkerClusterer();google.maps.event.trigger(b,"mouseout",a.cluster_)})};
