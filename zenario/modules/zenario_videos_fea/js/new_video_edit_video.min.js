'use strict';window.onload=function(){$("#language_id").trigger("change")};
...
function copyLinkButtonOnclick(a){(a=document.getElementById("videoLink"))&&zenario._co(a,!0);showOrHideElement("noteCopyLink","hide");showOrHideElement("noteCopied","show")}function languagePickerOnChange(){var a=document.getElementById("language_id");document.getElementById("language_id_value").value=a.value}function videoLinkOnMouseover(){showOrHideElement("copyLinkButton","show")}function videoLinkOnMouseout(){showOrHideElement("copyLinkButton","hide")}
