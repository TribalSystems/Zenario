'use strict';(function(k,b,D){$(document).ready(function(){b&&b.setDefaultMode&&(b.setDefaultMode(),b.setDefaultFilterVisibility())});$(document).ajaxComplete(function(){b&&b.setDefaultMode&&(b.setDefaultMode(),b.setDefaultFilterVisibility())});window.onload=function(){k._bII()&&!Element.prototype.closest&&(Element.prototype.matches||(Element.prototype.matches=Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector),Element.prototype.closest=function(c){var d=this;if(!document.documentElement.contains(this))return null;
...
{};b.pluginSettings.show_location_list=c;b.pluginSettings.show_map=d};b.mapVars={};b.infoWindows={};b.saveMapVars=function(c,d,e,t,f,g,u){b.mapVars={};c!==D&&(b.mapVars[c]=[d,e,t,f,g,u])};b.initMap=function(c,d,e,t){var f=window.parent||window.opener;if(f&&f.zenario_location_map_and_listing_2&&f.zenario_location_map_and_listing_2.mapVars&&!_._isEm(f.zenario_location_map_and_listing_2.mapVars)){var g={};c&&0<c&&window&&f&&f.zenario_location_map_and_listing_2&&f.zenario_location_map_and_listing_2.mapVars&&
f.zenario_location_map_and_listing_2.mapVars[c]&&(g=f.zenario_location_map_and_listing_2.mapVars[c]||{});var u=g[0]||{};var B=g[1]||!1;var q=g[2]||{};var E=g[3]||.8;var F=g[4]||.35;imagesFolder=g[5]||"";var w;g=0;var x=d+"_map",y=new google.maps.LatLngBounds,z=window&&window.mainWindow||self&&self.parent,n=!1;d&&z&&(b.iframeHighlightItemOnList=function(p){z.zenario_location_map_and_listing_2.listingHighlightItemOnMap(d,p)},b.iframeItemRemoveHighlightOnList=function(p){z.zenario_location_map_and_listing_2.listingItemRemoveHighlight(d,
p)});b.infoWindows={};if(u&&0<u.length)for(w in u){var l=u[w],C=new google.maps.LatLng(l.latitude,l.longitude);++g;if(1===g){var h={center:new google.maps.LatLng(l.latitude,l.longitude),zoom:1*l.map_zoom||7,mapTypeId:google.maps.MapTypeId.ROADMAP,scrollwheel:B};var m=new google.maps.Map(k._g(x),h)}if(!n||l.map_zoom<n)n=1*l.map_zoom;if(l.icon_name){h=31;var r=48;iconData={url:imagesFolder+"/icon_"+l.icon_name+".svg",size:new google.maps.Size(h,r),scaledSize:new google.maps.Size(h,r)}}else h=27,r=43,
iconData={url:"https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi2.png",size:new google.maps.Size(h,r)};h=new google.maps.Marker({position:C,map:m,title:l.name,icon:iconData,optimized:!1});y.extend(h.position);r=new google.maps.InfoWindow({content:f.$("#"+l.htmlId+"_basic_details").html(),pixelOffset:new google.maps.Size(0,-r)});(function(p,G,A,v){v.setPosition(G);v._open=function(){b.closeInfoWindow();v.open(m)};google.maps.event.addListener(A,"click",function(){v._open();b.iframeHighlightItemOnList(p.htmlId);
b.iframeScrollToItem(p.htmlId)});google.maps.event.addListener(A,"mouseout",function(){b.isInfoWindowOpen()||1!=b.pluginSettings.show_location_list||b.iframeItemRemoveHighlightOnList(p.htmlId)});google.maps.event.addListener(A,"mouseover",function(){b.isInfoWindowOpen()||1!=b.pluginSettings.show_location_list||b.iframeHighlightItemOnList(p.htmlId)});google.maps.event.addListener(v,"closeclick",function(){b.closeInfoWindow()});b.infoWindows[p.id]=v})(l,C,h,r)}else"auto_include_all_locations"==e?zoom=
15:"set_manually"==e&&"number"==typeof t&&(zoom=t),h={center:new google.maps.LatLng(51.4542645,-.9781302999999753),zoom,mapTypeId:google.maps.MapTypeId.ROADMAP,scrollwheel:B},m=new google.maps.Map(k._g(x),h);m||(h={mapTypeId:google.maps.MapTypeId.ROADMAP,center:{lat:0,lng:0},zoom:1},m=new google.maps.Map(k._g(x),h));google.maps.event.addListener(m,"click",function(p){b.closeInfoWindow()});if(q)for(a in q){coords=[];for(w in q[a].coords)coords.push(new google.maps.LatLng(q[a].coords[w][0],q[a].coords[w][1]));
(new google.maps.Polygon({paths:coords,strokeColor:q[a].polygon_colour,strokeOpacity:E,strokeWeight:2,fillColor:q[a].polygon_colour,fillOpacity:F,content:q[a].name})).setMap(m)}1<g&&(m.setCenter(y.getCenter()),m.fitBounds(y),google.maps.event.addListenerOnce(m,"bounds_changed",function(){n=m.getZoom();"auto_include_all_locations"==e?10>n?n=10:13<n&&(n=13):"set_manually"==e&&"number"==typeof t&&(n=t);this.setZoom(n)}));0==b.pluginSettings.show_location_list&&f.$("#interface_list_container").remove()}else setTimeout(function(){b.initMap(c,
d)},100)};b.isInfoWindowOpen=function(){for(var c in b.infoWindows){var d=b.infoWindows[c].getMap();if(null!==d&&"undefined"!==typeof d)return!0}return!1};b.closeInfoWindow=function(){for(var c in b.infoWindows)b.infoWindows[c].close();b.iframeItemRemoveHighlightOnList()};b.listingClick=function(c,d){c=k._gCIFE(c);(c=k._g(c+"_map_iframe"))&&c.contentWindow&&c.contentWindow.zenario_location_map_and_listing_2&&c.contentWindow.zenario_location_map_and_listing_2.infoWindows&&c.contentWindow.zenario_location_map_and_listing_2.infoWindows[d]&&
c.contentWindow.zenario_location_map_and_listing_2.infoWindows[d]._open()};b.listingMouseover=function(c,d){c=k._gCIFE(c);d=c+"_loc_"+d;var e=k._g(c+"_map_iframe");e&&e.contentWindow&&e.contentWindow.zenario_location_map_and_listing_2&&!e.contentWindow.zenario_location_map_and_listing_2.isInfoWindowOpen()&&b.listingHighlightItemOnMap(c,d)};b.listingMouseout=function(c,d){c=k._gCIFE(c);d=c+"_loc_"+d;var e=k._g(c+"_map_iframe");e&&e.contentWindow&&e.contentWindow.zenario_location_map_and_listing_2&&
!e.contentWindow.zenario_location_map_and_listing_2.isInfoWindowOpen()&&b.listingItemRemoveHighlight(c,d)};b.listingHighlightItemOnMap=function(c,d){$("#"+c+" .zenario_lmal_highlighted_location").removeClass("zenario_lmal_highlighted_location");d&&$("#"+c+" ."+d).addClass("zenario_lmal_highlighted_location");mapIframeId=c+"_map_iframe";(iframe=k._g(mapIframeId))&&iframe.contentWindow&&iframe.contentWindow.zenario_location_map_and_listing_2&&(el=parent.$("#"+c+" ."+d).find("h3#location_title")[0])&&
(c=iframe.contentWindow.$('div[title|="'+el.innerText+'"]'),c.addClass("highlighted_pin"),"https://maps.gstatic.com/mapfiles/api-3/images/spotlight-poi2.png"==c.find("img").attr("src")&&c.addClass("fallback_icon"))};b.listingItemRemoveHighlight=function(c,d){$("#"+c+" .zenario_lmal_highlighted_location").removeClass("zenario_lmal_highlighted_location");d&&$("#"+c+" ."+d).removeClass("zenario_lmal_highlighted_location");mapIframeId=c+"_map_iframe";(iframe=k._g(mapIframeId))&&iframe.contentWindow&&
