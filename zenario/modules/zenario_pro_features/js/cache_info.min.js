...
a=a+("<h2>The caching rules for this "+b+" are as follows:</h2>")+("<table><tr><td></td><th>Current</th><th>"+b+" Req't</th><th>Conflicts</th></tr>");for(c in l)(l=zenarioCD.load[c]&&!h[c])&&(e="zenario_not_cached"),a+="<tr><th>"+f._h(k[c])+"</th>",a+='<td><span class="'+(zenarioCD.load[c]?"zenario_cache_one":"zenario_cache_zero")+'">&nbsp;</span></td>',a+='<td class="zenario_cache_req"><span class="zenario_cache_zero">&nbsp;</span>'+(h[c]?' or <span class="zenario_cache_one">&nbsp;</span>':"")+"</td>",
a+="<td>"+(l?'<span class="zenario_cache_cross">&nbsp;</span>':"&nbsp;")+"</td></tr>";a+="</table>";h=!1;for(c in d)m[c]&&(h||(a+="<h2>This "+b+" will be cleared from the cache when any of the following change:</h2><ul>",h=!0),a+="<li>"+f._h(k[c])+"</li>");h&&(a+="</ul>");a="zenario_not_cached"==e?'<h1 class="'+e+'">This '+b+" can be cached, but not in the current situation due to a conflict.</h1>"+a:"zenario_from_cache"==e?'<h1 class="'+e+'">This '+b+" can be cached and was just served from the cache.</h1>"+
a:g?'<h1 class="'+e+'">This '+b+" can be cached and was just written to the cache.</h1>"+a:'<h1 class="'+e+'">This '+b+" could be cached if Plugin Caching was enabled in the Site Settings.</h1>"+a}return'<x-zenario-cache-info class="'+e+'" title="'+f._h('<div class="zenario_cache_box">'+a+"</div>")+'"></x-zenario-cache-info>'};g.init=function(d){if(!g.inited){var b;$("div.zenario_slot").each(function(d,f){f.id&&(b=f.id.replace("plgslt_",""))&&zenarioCD.slots[b]&&$(f).prepend('<x-zenario-cache-info class="zenario_cache_info">'+
g.box(b,"Plugin",!1,zenarioCD.cache_plugins)+"</x-zenario-cache-info>")});f._g("zenario_cache_info").innerHTML=g.box("","Page",!d,!0);f._t("x-zenario-cache-info.zenario_cache_info *",{tooltipClass:"zenario_cache_info_tooltip",position:{my:"right-2 center",at:"left center",collision:"flipfit"}});g.inited=!0}}})(zenario,zenarioCI);
