...
a:g?'<h1 class="'+e+'">This '+b+" can be cached and was just written to the cache.</h1>"+a:'<h1 class="'+e+'">This '+b+" could be cached if Plugin Caching was enabled in the Site Settings.</h1>"+a}return'<div class="'+e+'" title="'+f._h('<div class="zenario_cache_box">'+a+"</div>")+'"></div>'};g.init=function(d){if(!g.inited){var b;$("div.zenario_slot").each(function(d,f){f.id&&(b=f.id.replace("plgslt_",""))&&zenarioCD.slots[b]&&$(f).prepend('<div class="zenario_cache_info">'+g.box(b,"Plugin",!1,
zenarioCD.cache_plugins)+"</div>")});f._g("zenario_cache_info").innerHTML=g.box("","Page",!d,!0);f._t("div.zenario_cache_info div",{tooltipClass:"zenario_cache_info_tooltip",position:{my:"right-2 center",at:"left center",collision:"flipfit"}});g.inited=!0}}})(zenario,zenarioCI);
