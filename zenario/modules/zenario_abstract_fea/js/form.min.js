...
$jscomp.polyfillIsolated=function(k,f,p,q){var x=k.split(".");k=1===x.length;q=x[0];q=!k&&q in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var C=0;C<x.length-1;C++){var m=x[C];if(!(m in q))return;q=q[m]}x=x[x.length-1];p=$jscomp.IS_SYMBOL_NATIVE&&"es6"===p?q[x]:null;f=f(p);null!=f&&(k?$jscomp.defineProperty($jscomp.polyfills,x,{configurable:!0,writable:!0,value:f}):f!==p&&(void 0===$jscomp.propertyToPolyfillSymbol[x]&&(p=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[x]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(x):$jscomp.POLYFILL_PREFIX+p+"$"+x),$jscomp.defineProperty(q,$jscomp.propertyToPolyfillSymbol[x],{configurable:!0,writable:!0,value:f})))};$jscomp.initSymbol=function(){};$jscomp.iteratorPrototype=function(k){k={next:k};k[Symbol.iterator]=function(){return this};return k};
$jscomp.iteratorFromArray=function(k,f){k instanceof String&&(k+="");var p=0,q=!1,x={next:function(){if(!q&&p<k.length){var C=p++;return{value:f(C,k[C]),done:!1}}q=!0;return{done:!0,value:void 0}}};x[Symbol.iterator]=function(){return x};return x};$jscomp.polyfill("Array.prototype.values",function(k){return k?k:function(){return $jscomp.iteratorFromArray(this,function(f,p){return p})}},"es8","es3");
zenario.lib(function(k,f,p,q,x,C,m,K,r,N,O,P,M,y,G,J,L,H,Q,R,I,z,S){f=createZenarioLibrary("FEA",zenarioF);f=I(f);f.idVarName=function(){return this.specifiedIdVarName||"id"};f.validateFormatOrRedrawForField=function(a){a=this.field(a);return G(a.save_onchange)?(4>this.ffoving&&(this.ffoving=4,this.save()),!0):I(zenarioF).validateFormatOrRedrawForField.apply(this,arguments)};f.fill=function(){return this.ffov("fill")};f.format=function(){return this.ffov("format")};f.validate=function(){return this.ffov("validate")};
...
function(){return!1};f.ffov=function(a){var b=this,d=new m.callback,c=b.setURLForSyncedRequests(a),e=!1;if("fill"==a)var g=b.modifyPostOnLoad();else b.prevPath=b.path,b.checkValues(),g={_format:!0,_tuix:b.sendStateToServer()};if(!b.loading){b.showLoader();var l=function(h){b.hideLoader();"fill"==a?b.tuix=h:b.setData(h);var t=b.tuix.js,n=b.tuix.js_after;b.tuix.reload_parent&&b.reloadParent();t&&r._e(t,b);if(n&&!_._isFu(n)){var u=n;n=function(){r._e(u,b)}}b.tuix.close_popout&&b.inPopout&&b.closePopout();
...
g)){d=e[g];var h=d.id;var t=d.label||d.name;a.values=a.values||{};a.values[h]=d;l.push({value:h,text:t,html:this.drawPickedItem(h,b,a,c,!0)})}return l};f.lookupFileDetails=function(a){return!1};f.debug=function(){this.path&&this.tuix&&this.url&&K._d(this.globalName)};f.wrapperClassName=function(){return"zfea zfea_"+this.path+" "+(this.tuix.css_class||"")+" "+(this.tsLink?" zfea_with_tslink":"")+" "+(r._sDT()?" zfea_with_dev_tools":"")};f.newSimpleForm=function(){this.form||(this.form=r._nSF(this.containerId),
...
function(a,b,d){var c,e,g=!1,l=1,h=0,t=d?b.length:0;for(c in b)if(z(b,c)&&(d=b[c],!(e=this.tuix.items[d])||this.tuix._hiddenItemButtons&&this.tuix._hiddenItemButtons[a.id]&&this.tuix._hiddenItemButtons[a.id][d]))return!1;if(this.hidden(k,e,a.id,a))return!1;G(a.multiple_select)&&(a.hide_when_children_are_not_visible||(this.multiSelectButtonsExist=!0),l=a.multiple_select_max_items,G(a.multiple_select_only)&&(h=2),a.multiple_select_min_items&&(h=Math.max(h,a.multiple_select_min_items)));if(t<h||l&&t>
l)return!1;if(y(a.visible_if_for_all_selected_items))for(c in b)if(z(b,c)&&(e=this.tuix.items[b[c]],!r._e(a.visible_if_for_all_selected_items,this,k,e,a.id,a)))return!1;if(y(a.visible_if_for_any_selected_items)){for(c in b)if(z(b,c)&&(e=this.tuix.items[b[c]],r._e(a.visible_if_for_any_selected_items,this,k,e,a.id,a))){g=!0;break}return g}return!0};f.buttonIsntDisabled=function(a,b){var d,c;a:do if(!G(a.disabled)){if(y(b))for(d in b)if(z(b,d)&&!(c=this.tuix.items[b[d]]))return!1;if(!y(a.disabled_if)||
!r._e(a.disabled_if,this,k,c,a.id,a)){if(y(b)&&y(a.disabled_if_for_any_selected_items))for(d in b)if(z(b,d)&&(c=this.tuix.items[b[d]],r._e(a.disabled_if_for_any_selected_items,this,k,c,a.id,a)))break a;if(y(b)&&y(a.disabled_if_for_all_selected_items))for(d in b){if(z(b,d)&&(c=this.tuix.items[b[d]],!r._e(a.disabled_if_for_all_selected_items,this,k,c,a.id,a)))return!0}else return!0}}while(0);a._isDisabled=!0;a.tooltip=a.disabled_tooltip||a.tooltip;return!1};f.columnVisibleForItem=function(a,b){var d=
this.tuix.columns[a]||{},c=this.tuix.items[b]||{};return this.tuix._hiddenColumns&&this.tuix._hiddenColumns[a]&&this.tuix._hiddenColumns[a][b]||y(d.visible_if_for_each_item)&&r._e(d.visible_if_for_each_item,this,k,c,b,k,d)?!1:!0};f.hidden=function(a,b,d,c,e,g,l,h){a=a||c||e||g||b||l||h;if(a.hide_with_search_bar&&this.tuix.hide_search_bar)return!0;if(c&&c.go&&c.go.command)if(zenario_conductor._e(this.containerId)){if(!zenario_conductor._cE(this.containerId,c.go.command))return!0}else if(!c.go.mode)return!0;
return r._h(a,this,b,d,c,e,g,l,h)};f.sortOutTUIX=function(){var a=this.tuix;this.hasBypass=k;this.newlyNavigated=this.path!=this.prevPath;this.multiSelectButtonsExist=!1;a.items=a.items||{};a.columns=a.columns||{};a.item_buttons=a.item_buttons||{};a.collection_buttons=a.collection_buttons||{};var b=a.sort_by||"name",d=G(a.sort_desc),c=_._si(a.items);this.sortedCollectionButtonIds=r._gSIOTE(a,a.collection_buttons);this.sortedCollectionButtons=[];this.visibleCollectionButtons={};this.sortedItemButtonIds=
r._gSIOTE(a,a.item_buttons);this.sortedItemButtons=[];this.sortedColumnIds=r._gSIOTE(a,a.columns);this.sortedColumns=[];this.visibleColumns={};for(h in this.sortedCollectionButtonIds)if(z(this.sortedCollectionButtonIds,h)){var e=this.sortedCollectionButtonIds[h];var g=_._cl(a.collection_buttons[e]);g.id=e;this.hidden(k,k,e,g)||(this.buttonIsntDisabled(g)&&this.setupButtonLinks(g),this.sortedCollectionButtons.push(g),this.visibleCollectionButtons[e]=g)}for(h in this.sortedItemButtonIds)z(this.sortedItemButtonIds,
...
1*g[e]));r._sK(this.sortedColumns);r._sK(this.sortedCollectionButtons,"zfea_button_with_children");r._sK(this.sortedItemButtons,"zfea_button_with_children");var l=a.__item_sort_order__?a.__item_sort_order__:r._gSIOTE(a,"items",b,d);var h=-1;for(this.sortedItems=[];k!==(e=l[++h]);)g=a.items[e],g.id=e,this.sortedItems.push(g),e=this.getSortedItemButtons([e],!1),g.__sortedItemButtons=e[0],g.__columnButtons=e[1];_._isEm(a.list_groupings)?this.sortedListGroupings=[k]:this.sortedListGroupings=r._gSIOTE(a,
a.list_groupings,"ord");_._isEm(a.list_outer_groupings)?this.sortedListOuterGroupings=[k]:this.sortedListOuterGroupings=r._gSIOTE(a,a.list_outer_groupings,"ord");this.last.tuix=a};f.getSortedItemButtons=function(a,b){var d,c,e,g=[],l={},h;var t=b?a.join(","):h=a[0];for(d in this.sortedItemButtons)if(z(this.sortedItemButtons,d)){var n=this.sortedItemButtons[d];n=_._cl(n);n.itemId=h;n.itemIds=t;if(this.itemButtonIsntHidden(n,a,b)){this.buttonIsntDisabled(n,a)&&(this.setupButtonLinks(n,t),n.allow_bypass&&
(this.hasBypass=n));if(n.children){var u=n.children;n.children=[];for(c in u)if(z(u,c)){var v=u[c];v=_._cl(v);v.itemId=h;v.itemIds=t;this.itemButtonIsntHidden(v,a,b)&&(this.buttonIsntDisabled(v,a)&&this.setupButtonLinks(v,t),n.children.push(v))}}u=n.children&&0<n.children.length;if(!n.hide_when_children_are_not_visible||u)b||u||n.parent||!(e=n.show_as_link_on_column)||!this.visibleColumns[e]?(this.tuix.__itemHasItemButton=!0,g.push(n)):l[e]=n}}return[g,l]};f.setupButtonLinks=function(a,b){var d,c;
...
this;if(!l.loading){var h,t=0;if(y(c)){var n=c.s(",");t=n.length}if(g||!(h=b.confirm||b.go&&b.go.confirm||b.ajax&&b.ajax.confirm)||l.hidden(h,d,b.id,b)){if(e&&(h=e.call(a),y(h)&&!h))return;h=b.go||l.checkRequests(l.last.request,!0);"search"==b.location&&(h=_._ex({search:l.getSearchFieldValue()},h));b.ajax?(g=l.checkRequests(b.ajax.request,!1,c,k,!0),l.runAJAXRequest(g,h,b.ajax,c)):l.go(h,c)}else y(c)&&(h=_._ex({},h),1===t?(h.title=m._aMF(h.title,d),h.message=m._aMF(h.message,d)):(g=function(u,v){if("item_count"==
v)return t;v=v.s("|");var B,A;u=v[0];var E=v[1]||", ",D=v[2],w=[];for(B in n)z(n,B)&&(v=n[B],(A=l.tuix.items[v])&&w.push(A[u]));D=D&&1<w.length?D+w.pop():"";return w.join(E)+D},h.title=m._aMF(h.multiple_select_title||h.title,k,g),h.message=m._aMF(h.multiple_select_message||h.message,k,g))),l.confirm(h,function(){l.button(a,b,d,c,e,!0)})}};f.checkAllCheckboxes=function(a){$("#"+this.containerId+" input.zfea_check_item").each(function(b,d){d.checked=a.checked});this.updateItemButtons()};f.clearOnScrollForItemButtons=
function(){this.updateItemButtonPositionOnScroll&&$(q).off("scroll",this.updateItemButtonPositionOnScroll)};f.updateItemButtons=function(){this.clearOnScrollForItemButtons();var a=this.containerId,b=J("zfea_check_all_"+a),d=$("#"+a+" tr.zfea_row"),c=$("#"+a+" td.single_select_buttons"),e=$("#multi_select_buttons_td_"+a),g=$("#multi_select_buttons_"+a),l=$("#"+a+" td.zfea_check_item input"),h=l.filter("input:checked"),t=h.first(),n=h.last(),u=h.length,v=[];if(u){d.each(function(w,F){w=$(F);w.height(w.height())});
h.each(function(w,F){w=$(F);v.push(w.data("item_id"))});buttons=this.getSortedItemButtons(v,!0)[0];0<buttons.length?g.html(this.pMicroTemplate("button",this.getSortedItemButtons(v,!0)[0])):g.html("No actions available");m._aJQE("#multi_select_buttons_"+a+" ");e.show();c.hide();b.checked=u==l.length;a=t.offset().top;n=n.offset().top;var B=$(q).width()/2;b=e.height()-g.outerHeight(!0);var A=e.offset().top;var E=a-A;var D=n-A;0>E&&(E=0);D>b&&(D=b);if(0<D&&($("body > div:visible:not(.ui-helper-hidden-accessible)").each(function(w,
F){w=$(F);"fixed"==w.css("position")&&w.css("top").m(/^0/)&&w.width()>B&&(A-=w.height())}),this.updateItemButtonPositionOnScroll=function(w){w=m._sT()-A;w<E?w=E:w>D&&(w=D);g.css("margin-top",Math.round(w))},this.updateItemButtonPositionOnScroll(),1<u))$(q).on("scroll",this.updateItemButtonPositionOnScroll)}else e.hide(),c.show(),b.checked=!1,d.each(function(w,F){$(F).height("")})};f.sparkline=function(){var a=this;Highcharts.SparkLine=function(l,h,t){var n="string"===typeof l||l.nodeName,u=arguments[n?
...
a,b)};f.ajax=function(a,b,d){var c=this,e=m.adminId&&C&&C.zenarioAB&&C.zenarioAB.previewPost;e&&(!1!==b&&y(b)||(b={}),_._isOb(b)?b.overrideSettings=e:b+="&overrideSettings="+M(e));return m._a(a,b,d,!1,!0,!0,k,k,function(g,l,h){c.AJAXErrorHandler(g,l,h)},function(){$.colorbox.remove()})};f.pickerLink=function(a,b){var d;return(d=this.pages[a])?this.showSingleSlotLink(d.containerId,b,!1,d.cID,d.cType):!1};f.AJAXErrorHandler=function(a,b,d){var c=this,e="",g={};a=r._sDFEM(a);d&&(e+=r.h1(L(a.status+" "+
d)));if(404==a.status)e+=r.p(c.hardcodedPhrase.error404);else if(500==a.status)e+=r.p(c.hardcodedPhrase.error500);else if(0==a.status||"timeout"==b)e+=r.p(c.hardcodedPhrase.errorTimedOut);a.responseText&&(e+=r._d(L(a.responseText)));d=function(){g.body=e;g.retry=!!a.zenario_retry;g.continueAnyway=a.zenario_continueAnyway&&a.data;$.colorbox({className:"zfea_error_box",transition:"none",closeButton:!1,html:c.pMicroTemplate("error",g)});g.retry&&$("#zfea_retry").click(function(){$.colorbox.close();m._eS("colorbox");
setTimeout(a.zenario_retry,1)});g.continueAnyway&&$("#zfea_continueAnyway").click(function(){$.colorbox.close();m._eS("colorbox");setTimeout(function(){a.zenario_continueAnyway(a.data)},1)})};0==a.status||"timeout"==b?setTimeout(d,750):d()};f.initPopout=function(a,b,d,c,e,g,l){return zenario_abstract_fea.initPopout(a,b,d,c,e,this.containerId,g,this,l)};zenario_abstract_fea.initPopout=function(a,b,d,c,e,g,l,h,t){popoutContainerId=c+"_"+g;e||(e=d);h||(h=g);zenario_abstract_fea.setupAndInit(a,b,popoutContainerId,
d,l,c,k,k,!0,h,!0,e,t);return!1};zenario_abstract_fea.setupAndInit=function(a,b,d,c,e,g,l,h,t,n,u,v,B){var A=a+"_"+d.r(/\-/g,"__");q[A]||(q[A]=new b);q[A].showCloseButtonAtTopRight=B;q[A].init(A,"fea",a,d,c,e,g,l,h,t,n,u,v);return q[A]}},zenario.getContainerIdFromEl);
