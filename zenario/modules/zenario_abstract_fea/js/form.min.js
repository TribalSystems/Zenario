...
if(!b.loading){b.showLoader();var k=function(c){b.hideLoader();"fill"==a?b.tuix=c:b.setData(c);b.tuix.reload_parent&&b.reloadParent();b.tuix.go?b.go(b.tuix.go):b.tuix.go_to_url&&!d?(g._gTU(b.tuix.go_to_url),d=!0,setTimeout(function(){k(c)},350)):b.tuix.close_popout&&b.inPopout?b.closePopout():(b.sortOutTUIX(),b.draw(),e.call())};b.ajax(c,f,!0).after(k)}return e};d.draw=function(){var a=this;a.draw2();a.tuix.confirm_on_close&&zenario_conductor._cOC(a.containerId,function(){return!a.hidden(h,a.tuix.confirm_on_close)},
function(b){a.confirm(a.tuix.confirm_on_close,b)},a.tuix.confirm_on_close.message)};d.redrawTab=function(){this.draw2();this.hideLoader(!0)};d.draw2=function(){this.sortTabs();this.tuix.form_title=this.getTitle();this.cb=new g.callback;this.putHTMLOnPage(this.drawFields(this.cb,this.mtPrefix+"_form"));var a;this.path==this.prevPath&&this.lastFocus&&(a=this.get(this.lastFocus.id))&&a.focus()};d.ajaxURL=function(){return g._pAL(h,this.containerId,_._ex({path:this.path},this.request))};d.putHTMLOnPage=
