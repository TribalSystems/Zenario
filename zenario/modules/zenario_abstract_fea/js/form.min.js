...
var t;b.legend.labelFormatter=function(){var q=(this.name+"").s(": "),A=q.shift();q=q.join(": ");t!==A&&(t=A,q=A+": "+q);return q}}if(!_._ruc(b.series))for(n in b.series=_.clone(b.series),b.series)w(b.series,n)&&a[n]&&(b.series[n]=_.clone(b.series[n]),b.series[n].data=a[n]);for(g in e)w(e,g)&&(a=e[g])&&("object"!==typeof b[a]||_._ge1(b[a])||(b[a]=_._i32(b[a])));this.putHTMLOnPage(this.microTemplate(this.tuix.microtemplate,{}));if(d){for(g in e)if(w(e,g)){a=e[g];h={};var p={};for(l in d[a])if(w(d[a],
l)){c=d[a][l];var n=c.options.id;p[n]=!0}for(l in b[a])w(b[a],l)&&(c=b[a][l],n=c.id,h[n]=c);for(n in p)w(p,n)&&(h[n]||d.get(n).remove());for(l in b[a])if(w(b[a],l)&&(c=b[a][l],n=c.id,!p[n]))switch(a){case "series":d.addSeries(c,!1);break;case "yAxis":d.addAxis(c,!1,!1)}}d.update(b)}else this._graph=Highcharts.chart(b);this.registerSignalHandlers()};f.graphCustomSetup=function(){};f.registerSignalHandlers=function(){var a=this;if(!a._addedEvents){a._addedEvents=!0;var b,c=v._mgu(a.tuix.handle_signals);
if(c!==[])for(b in c)if(w(c,b)){var d=c[b];var e=d+"OnRegister";if(_._4ty(a[e]))a[e]();_._4ty(a[d])&&function(g){a.on(g,function(l){a[g](l)})}(d)}}};f.initMap=function(){var a,b=this.tuix,c=_._i32(b.items),d=b.map.options,e=this.containerId;b=b.map.api_key;var g=function(){var h,t=!1;if(0<c.length)for(h=0;h<c.length;++h)if(c[h].latitude&&c[h].longitude){t=!0;break}if(t){d={scrollwheel:!1,draggable:!0};d.map_zoom&&d.map_lat&&d.map_lng&&(d.zoom=d.map_zoom,d.center=new google.maps.LatLng(d.map_lat,d.map_lng));
t=new google.maps.LatLngBounds;a=new google.maps.Map(r.getElementById("map_"+e),d);var p=new google.maps.InfoWindow;for(h=0;h<c.length;++h){var n=c[h].latitude;var q=c[h].longitude;n&&q&&(latlng=new google.maps.LatLng(n,q),marker=new google.maps.Marker({position:latlng,map:a,clickable:!0}),t.extend(latlng),n=$("#"+e+" .item_"+c[h].id).html(),google.maps.event.addListener(marker,"click",function(A,B,E){return function(){E.setContent(B);E.open(a,A)}}(marker,n,p)))}d.map_zoom||(google.maps.event.addListenerOnce(a,
"bounds_changed",function(){this.setZoom(Math.min(15,this.getZoom()))}),a.fitBounds(t))}else new google.maps.Map(r.getElementById("map_"+e),{center:{lat:52.48278,lng:-1.362305},zoom:2,scrollwheel:!1,draggable:!1,disableDefaultUI:!0}),$("#no_locations_"+e).show()};if("object"===typeof google&&"object"===typeof google.maps)g();else{var l=this.globalName+"__runWhenMapsLoaded";u[l]=g;g=r.createElement("script");g.type="text/javascript";g.src="https://maps.googleapis.com/maps/api/js?v=3&key="+b+"&callback="+
...
g)){c=e[g];var h=c.id;var t=c.label||c.name;a.values=a.values||{};a.values[h]=c;l.push({value:h,text:t,html:this.drawPickedItem(h,b,a,d,!0)})}return l};f.lookupFileDetails=function(a){return!1};f.debug=function(){this.path&&this.tuix&&this.url&&K.debug(this.globalName)};f.wrapperClassName=function(){return"zfea zfea_"+this.path+" "+(this.tuix.css_class||"")+" "+(this.tsLink?" zfea_with_tslink":"")+" "+(v._sik()?" zfea_with_dev_tools":"")};f.newSimpleForm=function(){this.form||(this.form=v._2q7(this.containerId),
...
function(a,b,c){var d,e,g=!1,l=1,h=0,t=c?b.length:0;for(d in b)if(w(b,d)&&(c=b[d],!(e=this.tuix.items[c])||this.tuix._hiddenItemButtons&&this.tuix._hiddenItemButtons[a.id]&&this.tuix._hiddenItemButtons[a.id][c]))return!1;if(this.hidden(k,e,a.id,a))return!1;G(a.multiple_select)&&(a.hide_when_children_are_not_visible||(this.multiSelectButtonsExist=!0),l=a.multiple_select_max_items,G(a.multiple_select_only)&&(h=2),a.multiple_select_min_items&&(h=Math.max(h,a.multiple_select_min_items)));if(t<h||l&&t>
l)return!1;if(z(a.visible_if_for_all_selected_items))for(d in b)if(w(b,d)&&(e=this.tuix.items[b[d]],!v.eval(a.visible_if_for_all_selected_items,this,k,e,a.id,a)))return!1;if(z(a.visible_if_for_any_selected_items)){for(d in b)if(w(b,d)&&(e=this.tuix.items[b[d]],v.eval(a.visible_if_for_any_selected_items,this,k,e,a.id,a))){g=!0;break}return g}return!0};f.buttonIsntDisabled=function(a,b){var c,d;a:do if(!G(a.disabled)){if(z(b))for(c in b)if(w(b,c)&&!(d=this.tuix.items[b[c]]))return!1;if(!z(a.disabled_if)||
!v.eval(a.disabled_if,this,k,d,a.id,a)){if(z(b)&&z(a.disabled_if_for_any_selected_items))for(c in b)if(w(b,c)&&(d=this.tuix.items[b[c]],v.eval(a.disabled_if_for_any_selected_items,this,k,d,a.id,a)))break a;if(z(b)&&z(a.disabled_if_for_all_selected_items))for(c in b){if(w(b,c)&&(d=this.tuix.items[b[c]],!v.eval(a.disabled_if_for_all_selected_items,this,k,d,a.id,a)))return!0}else return!0}}while(0);a._isDisabled=!0;a.tooltip=a.disabled_tooltip||a.tooltip;return!1};f.columnVisibleForItem=function(a,b){var c=
this.tuix.columns[a]||{},d=this.tuix.items[b]||{};return this.tuix._hiddenColumns&&this.tuix._hiddenColumns[a]&&this.tuix._hiddenColumns[a][b]||z(c.visible_if_for_each_item)&&v.eval(c.visible_if_for_each_item,this,k,d,b,k,c)?!1:!0};f.hidden=function(a,b,c,d,e,g,l,h){a=a||d||e||g||b||l||h;if(a.hide_with_search_bar&&this.tuix.hide_search_bar)return!0;if(d&&d.go&&d.go.command)if(zenario_conductor._tn(this.containerId)){if(!zenario_conductor._4xe(this.containerId,d.go.command))return!0}else if(!d.go.mode)return!0;
return v._58(a,this,b,c,d,e,g,l,h)};f.sortOutTUIX=function(){var a=this.tuix;this.hasBypass=k;this.newlyNavigated=this.path!=this.prevPath;this.multiSelectButtonsExist=!1;a.items=a.items||{};a.columns=a.columns||{};a.item_buttons=a.item_buttons||{};a.collection_buttons=a.collection_buttons||{};var b=a.sort_by||"name",c=G(a.sort_desc),d=_.size(a.items);this.sortedCollectionButtonIds=v._219(a,a.collection_buttons);this.sortedCollectionButtons=[];this.visibleCollectionButtons={};this.sortedItemButtonIds=
v._219(a,a.item_buttons);this.sortedItemButtons=[];this.sortedColumnIds=v._219(a,a.columns);this.sortedColumns=[];this.visibleColumns={};for(h in this.sortedCollectionButtonIds)if(w(this.sortedCollectionButtonIds,h)){var e=this.sortedCollectionButtonIds[h];var g=_.clone(a.collection_buttons[e]);g.id=e;this.hidden(k,k,e,g)||(this.buttonIsntDisabled(g)&&this.setupButtonLinks(g),this.sortedCollectionButtons.push(g),this.visibleCollectionButtons[e]=g)}for(h in this.sortedItemButtonIds)w(this.sortedItemButtonIds,
...
1*g[e]));v._1a1(this.sortedColumns);v._1a1(this.sortedCollectionButtons,"zfea_button_with_children");v._1a1(this.sortedItemButtons,"zfea_button_with_children");var l=a.__item_sort_order__?a.__item_sort_order__:v._219(a,"items",b,c);var h=-1;for(this.sortedItems=[];k!==(e=l[++h]);)g=a.items[e],g.id=e,this.sortedItems.push(g),e=this.getSortedItemButtons([e],!1),g.__sortedItemButtons=e[0],g.__columnButtons=e[1];_._ruc(a.list_groupings)?this.sortedListGroupings=[k]:this.sortedListGroupings=v._219(a,a.list_groupings,
"ord");_._ruc(a.list_outer_groupings)?this.sortedListOuterGroupings=[k]:this.sortedListOuterGroupings=v._219(a,a.list_outer_groupings,"ord");this.last.tuix=a};f.getSortedItemButtons=function(a,b){var c,d,e,g=[],l={},h;var t=b?a.join(","):h=a[0];for(c in this.sortedItemButtons)if(w(this.sortedItemButtons,c)){var p=this.sortedItemButtons[c];p=_.clone(p);p.itemId=h;p.itemIds=t;if(this.itemButtonIsntHidden(p,a,b)){this.buttonIsntDisabled(p,a)&&(this.setupButtonLinks(p,t),p.allow_bypass&&(this.hasBypass=
p));if(p.children){var n=p.children;p.children=[];for(d in n)if(w(n,d)){var q=n[d];q=_.clone(q);q.itemId=h;q.itemIds=t;this.itemButtonIsntHidden(q,a,b)&&(this.buttonIsntDisabled(q,a)&&this.setupButtonLinks(q,t),p.children.push(q))}}n=p.children&&0<p.children.length;if(!p.hide_when_children_are_not_visible||n)b||n||p.parent||!(e=p.show_as_link_on_column)||!this.visibleColumns[e]?(this.tuix.__itemHasItemButton=!0,g.push(p)):l[e]=p}}return[g,l]};f.setupButtonLinks=function(a,b){var c,d;if(a.go||a.ajax||
...
$(u).off("scroll",this.updateItemButtonPositionOnScroll)};f.updateItemButtons=function(){this.clearOnScrollForItemButtons();var a=this.containerId,b=J("zfea_check_all_"+a),c=$("#"+a+" tr.zfea_row"),d=$("#"+a+" td.single_select_buttons"),e=$("#multi_select_buttons_td_"+a),g=$("#multi_select_buttons_"+a),l=$("#"+a+" td.zfea_check_item input"),h=l.filter("input:checked"),t=h.first(),p=h.last(),n=h.length,q=[];if(n){c.each(function(x,F){x=$(F);x.height(x.height())});h.each(function(x,F){x=$(F);q.push(x.data("item_id"))});
buttons=this.getSortedItemButtons(q,!0)[0];0<buttons.length?g.html(this.pMicroTemplate("button",this.getSortedItemButtons(q,!0)[0])):g.html("No actions available");m._4oz("#multi_select_buttons_"+a+" ");e.show();d.hide();b.checked=n==l.length;a=t.offset().top;p=p.offset().top;var A=$(u).width()/2;b=e.height()-g.outerHeight(!0);var B=e.offset().top;var E=a-B;var D=p-B;0>E&&(E=0);D>b&&(D=b);if(0<D&&($("body > div:visible:not(.ui-helper-hidden-accessible)").each(function(x,F){x=$(F);"fixed"==x.css("position")&&
x.css("top").m(/^0/)&&x.width()>A&&(B-=x.height())}),this.updateItemButtonPositionOnScroll=function(x){x=m._7xu()-B;x<E?x=E:x>D&&(x=D);g.css("margin-top",Math.round(x))},this.updateItemButtonPositionOnScroll(),1<n))$(u).on("scroll",this.updateItemButtonPositionOnScroll)}else e.hide(),d.show(),b.checked=!1,c.each(function(x,F){$(F).height("")})};f.sparkline=function(){var a=this;Highcharts.SparkLine=function(l,h,t){var p="string"===typeof l||l.nodeName,n=arguments[p?1:0];n=Highcharts.merge({chart:{renderTo:n.chart&&
